...
$Class* CallableStatement::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"getBigDecimal", "(II)Ljava/math/BigDecimal;", nullptr, $PUBLIC | $ABSTRACT | $DEPRECATED, $virtualMethod(CallableStatement, getBigDecimal, $BigDecimal*, int32_t, int32_t), "java.sql.SQLException", nullptr, getBigDecimalmethodAnnotations$$},
	...
	$loadClass(CallableStatement, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
