...
$Class* ResultSet::load$($String* name, bool initialize) {
	...
	$NamedAttribute getBigDecimalmethodAnnotations$$$namedAttribute[] = {
		{"since", 's', "1.2"},
		{}
	};
	$CompoundAttribute getBigDecimalmethodAnnotations$$[] = {
		{"Ljava/lang/Deprecated;", getBigDecimalmethodAnnotations$$$namedAttribute},
		{}
	};
	$NamedAttribute getBigDecimalmethodAnnotations$$$1$namedAttribute[] = {
		{"since", 's', "1.2"},
		{}
	};
	$CompoundAttribute getBigDecimalmethodAnnotations$$$1[] = {
		{"Ljava/lang/Deprecated;", getBigDecimalmethodAnnotations$$$1$namedAttribute},
		{}
	};
	$NamedAttribute getUnicodeStreammethodAnnotations$$$namedAttribute[] = {
		{"since", 's', "1.2"},
		{}
	};
	$CompoundAttribute getUnicodeStreammethodAnnotations$$[] = {
		{"Ljava/lang/Deprecated;", getUnicodeStreammethodAnnotations$$$namedAttribute},
		{}
	};
	$NamedAttribute getUnicodeStreammethodAnnotations$$$1$namedAttribute[] = {
		{"since", 's', "1.2"},
		{}
	};
	$CompoundAttribute getUnicodeStreammethodAnnotations$$$1[] = {
		{"Ljava/lang/Deprecated;", getUnicodeStreammethodAnnotations$$$1$namedAttribute},
		{}
	};
	$MethodInfo methodInfos$$[] = {
		...
		{"getBigDecimal", "(II)Ljava/math/BigDecimal;", nullptr, $PUBLIC | $ABSTRACT | $DEPRECATED, $virtualMethod(ResultSet, getBigDecimal, $BigDecimal*, int32_t, int32_t), "java.sql.SQLException", nullptr, getBigDecimalmethodAnnotations$$},
		{"getBigDecimal", "(Ljava/lang/String;I)Ljava/math/BigDecimal;", nullptr, $PUBLIC | $ABSTRACT | $DEPRECATED, $virtualMethod(ResultSet, getBigDecimal, $BigDecimal*, $String*, int32_t), "java.sql.SQLException", nullptr, getBigDecimalmethodAnnotations$$$1},
		...
		{"getUnicodeStream", "(I)Ljava/io/InputStream;", nullptr, $PUBLIC | $ABSTRACT | $DEPRECATED, $virtualMethod(ResultSet, getUnicodeStream, $InputStream*, int32_t), "java.sql.SQLException", nullptr, getUnicodeStreammethodAnnotations$$},
		{"getUnicodeStream", "(Ljava/lang/String;)Ljava/io/InputStream;", nullptr, $PUBLIC | $ABSTRACT | $DEPRECATED, $virtualMethod(ResultSet, getUnicodeStream, $InputStream*, $String*), "java.sql.SQLException", nullptr, getUnicodeStreammethodAnnotations$$$1},
	...
	$loadClass(ResultSet, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
