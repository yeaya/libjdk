...
$Class* PreparedStatement::load$($String* name, bool initialize) {
	$NamedAttribute setUnicodeStreammethodAnnotations$$$namedAttribute[] = {
		{"since", 's', "1.2"},
		{}
	};
	$CompoundAttribute setUnicodeStreammethodAnnotations$$[] = {
		{"Ljava/lang/Deprecated;", setUnicodeStreammethodAnnotations$$$namedAttribute},
		{}
	};
	$MethodInfo methodInfos$$[] = {
		...
		{"setUnicodeStream", "(ILjava/io/InputStream;I)V", nullptr, $PUBLIC | $ABSTRACT | $DEPRECATED, $virtualMethod(PreparedStatement, setUnicodeStream, void, int32_t, $InputStream*, int32_t), "java.sql.SQLException", nullptr, setUnicodeStreammethodAnnotations$$},
		{}
	};
	$ClassInfo classInfo$$ = {
	...
	$loadClass(PreparedStatement, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
