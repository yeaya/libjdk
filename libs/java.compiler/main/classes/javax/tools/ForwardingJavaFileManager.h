#ifndef _javax_tools_ForwardingJavaFileManager_h_
#define _javax_tools_ForwardingJavaFileManager_h_
...
class $export ForwardingJavaFileManager : public ::javax::tools::JavaFileManager {
	$class(ForwardingJavaFileManager, $NO_CLASS_INIT, ::javax::tools::JavaFileManager)
public:
...
#endif // _javax_tools_ForwardingJavaFileManager_h_