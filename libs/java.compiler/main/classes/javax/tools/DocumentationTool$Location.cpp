...
void DocumentationTool$Location::clinit$($Class* clazz) {
...
$Class* DocumentationTool$Location::load$($String* name, bool initialize) {
	...
	$loadClass(DocumentationTool$Location, name, initialize, &classInfo$$, DocumentationTool$Location::clinit$, []($Class* clazz) -> $Object* {
