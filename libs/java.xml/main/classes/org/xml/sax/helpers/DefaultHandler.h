...
class $export DefaultHandler : public ::org::xml::sax::EntityResolver, public ::org::xml::sax::DTDHandler, public ::org::xml::sax::ContentHandler, public ::org::xml::sax::ErrorHandler {
