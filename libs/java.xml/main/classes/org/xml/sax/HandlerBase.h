...
class $export HandlerBase : public ::org::xml::sax::EntityResolver, public ::org::xml::sax::DTDHandler, public ::org::xml::sax::DocumentHandler, public ::org::xml::sax::ErrorHandler {
