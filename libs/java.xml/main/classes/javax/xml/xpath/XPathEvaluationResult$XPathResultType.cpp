...
bool XPathEvaluationResult$XPathResultType::isAcceptedNumberSubType($Class* clsType) {
	...
	bool var$0 = var$1 || clsType->isAssignableFrom($Integer::class$);
	return var$0 || clsType->isAssignableFrom($Long::class$);
}
...
void XPathEvaluationResult$XPathResultType::clinit$($Class* clazz) {
...
$Class* XPathEvaluationResult$XPathResultType::load$($String* name, bool initialize) {
	...
	$loadClass(XPathEvaluationResult$XPathResultType, name, initialize, &classInfo$$, XPathEvaluationResult$XPathResultType::clinit$, []($Class* clazz) -> $Object* {
