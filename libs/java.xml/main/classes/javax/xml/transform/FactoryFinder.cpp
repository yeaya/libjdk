...
$Class* FactoryFinder::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("javax.xml.transform.FactoryFinder$$Lambda$lambda$newInstance$0")) {
			return FactoryFinder$$Lambda$lambda$newInstance$0::load$(name, initialize);
		}
		if (name->equals("javax.xml.transform.FactoryFinder$$Lambda$lambda$find$1$1")) {
			return FactoryFinder$$Lambda$lambda$find$1$1::load$(name, initialize);
		}
		if (name->equals("javax.xml.transform.FactoryFinder$$Lambda$lambda$find$2$2")) {
			return FactoryFinder$$Lambda$lambda$find$2$2::load$(name, initialize);
		}
		if (name->equals("javax.xml.transform.FactoryFinder$$Lambda$lambda$find$3$3")) {
			return FactoryFinder$$Lambda$lambda$find$3$3::load$(name, initialize);
		}
		if (name->equals("javax.xml.transform.FactoryFinder$$Lambda$lambda$find$4$4")) {
			return FactoryFinder$$Lambda$lambda$find$4$4::load$(name, initialize);
		}
		if (name->equals("javax.xml.transform.FactoryFinder$$Lambda$lambda$find$5$5")) {
