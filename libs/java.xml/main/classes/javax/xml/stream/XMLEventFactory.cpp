...
void XMLEventFactory::clinit$($Class* clazz) {
...
$Class* XMLEventFactory::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"newInstance", "(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljavax/xml/stream/XMLEventFactory;", nullptr, $PUBLIC | $STATIC | $DEPRECATED, $staticMethod(XMLEventFactory, newInstance, XMLEventFactory*, $String*, $ClassLoader*), "javax.xml.stream.FactoryConfigurationError", nullptr, newInstancemethodAnnotations$$$1},
	...
	$loadClass(XMLEventFactory, name, initialize, &classInfo$$, XMLEventFactory::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(XMLEventFactory);
	});
	return class$;
}
