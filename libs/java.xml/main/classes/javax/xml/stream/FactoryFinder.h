#ifndef _javax_xml_stream_FactoryFinder_h_
#define _javax_xml_stream_FactoryFinder_h_
...
public:
	...
	static $Object* find($Class* type, $String* factoryId, ::java::lang::ClassLoader* cl, $String* fallbackClassName);
	static $Object* findServiceProvider($Class* type, ::java::lang::ClassLoader* cl);
	...
	static $String* lambda$find$3(::java::io::File* fStax);
	static $String* lambda$find$5($String* foundIn, $String* factoryClassName);
	static $String* lambda$find$6($String* fallbackClassName);
	...
	static $Object* newInstance($Class* type, $String* className, ::java::lang::ClassLoader* cl, bool doFallback, bool useBSClsLoader);
...
#endif // _javax_xml_stream_FactoryFinder_h_