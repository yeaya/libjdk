#ifndef _javax_xml_datatype_FactoryFinder_h_
#define _javax_xml_datatype_FactoryFinder_h_
//$ class javax.xml.datatype.FactoryFinder
...
#endif // _javax_xml_datatype_FactoryFinder_h_