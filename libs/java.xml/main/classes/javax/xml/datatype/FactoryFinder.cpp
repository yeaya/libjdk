...
using $FactoryFinder$1 = ::javax::xml::datatype::FactoryFinder$1;
...
$Class* FactoryFinder$$Lambda$lambda$newInstance$0::load$($String* name, bool initialize) {
	...
	$ClassInfo classInfo$$ = {
		$PUBLIC | $FINAL,
		"javax.xml.datatype.FactoryFinder$$Lambda$lambda$newInstance$0",
		"java.lang.Object",
...
$Class* FactoryFinder$$Lambda$lambda$find$1$1::load$($String* name, bool initialize) {
	...
	$ClassInfo classInfo$$ = {
		$PUBLIC | $FINAL,
		"javax.xml.datatype.FactoryFinder$$Lambda$lambda$find$1$1",
		"java.lang.Object",
		"java.util.function.Supplier",
		fieldInfos$$,
		methodInfos$$
...
$Class* FactoryFinder$$Lambda$lambda$find$2$2::load$($String* name, bool initialize) {
	...
	$ClassInfo classInfo$$ = {
		$PUBLIC | $FINAL,
		"javax.xml.datatype.FactoryFinder$$Lambda$lambda$find$2$2",
		"java.lang.Object",
		"java.util.function.Supplier",
		fieldInfos$$,
		methodInfos$$
...
$Class* FactoryFinder$$Lambda$lambda$find$3$3::load$($String* name, bool initialize) {
	...
	$ClassInfo classInfo$$ = {
		$PUBLIC | $FINAL,
		"javax.xml.datatype.FactoryFinder$$Lambda$lambda$find$3$3",
		"java.lang.Object",
		"java.util.function.Supplier",
		fieldInfos$$,
		methodInfos$$
...
$Class* FactoryFinder$$Lambda$lambda$find$4$4::load$($String* name, bool initialize) {
	...
	$ClassInfo classInfo$$ = {
		$PUBLIC | $FINAL,
		"javax.xml.datatype.FactoryFinder$$Lambda$lambda$find$4$4",
		"java.lang.Object",
		"java.util.function.Supplier",
		fieldInfos$$,
		methodInfos$$
...
$Class* FactoryFinder$$Lambda$lambda$find$5$5::load$($String* name, bool initialize) {
	...
	$ClassInfo classInfo$$ = {
		$PUBLIC | $FINAL,
		"javax.xml.datatype.FactoryFinder$$Lambda$lambda$find$5$5",
		"java.lang.Object",
		"java.util.function.Supplier",
		fieldInfos$$,
		methodInfos$$
...
$Object* FactoryFinder::find($Class* type, $String* fallbackClassName) {
	...
	if (fallbackClassName == nullptr) {
		$throwNew($DatatypeConfigurationException, $$str({"Provider for "_s, factoryId, " cannot be found"_s}));
	}
...
$Class* FactoryFinder::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("javax.xml.datatype.FactoryFinder$$Lambda$lambda$newInstance$0")) {
			return FactoryFinder$$Lambda$lambda$newInstance$0::load$(name, initialize);
		}
		if (name->equals("javax.xml.datatype.FactoryFinder$$Lambda$lambda$find$1$1")) {
			return FactoryFinder$$Lambda$lambda$find$1$1::load$(name, initialize);
		}
		if (name->equals("javax.xml.datatype.FactoryFinder$$Lambda$lambda$find$2$2")) {
			return FactoryFinder$$Lambda$lambda$find$2$2::load$(name, initialize);
		}
		if (name->equals("javax.xml.datatype.FactoryFinder$$Lambda$lambda$find$3$3")) {
			return FactoryFinder$$Lambda$lambda$find$3$3::load$(name, initialize);
		}
		if (name->equals("javax.xml.datatype.FactoryFinder$$Lambda$lambda$find$4$4")) {
			return FactoryFinder$$Lambda$lambda$find$4$4::load$(name, initialize);
		}
		if (name->equals("javax.xml.datatype.FactoryFinder$$Lambda$lambda$find$5$5")) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"find", "(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;Ljava/lang/String;)TT;", $STATIC, $staticMethod(FactoryFinder, find, $Object*, $Class*, $String*), "javax.xml.datatype.DatatypeConfigurationException"},
		{"findServiceProvider", "(Ljava/lang/Class;)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;)TT;", $PRIVATE | $STATIC, $staticMethod(FactoryFinder, findServiceProvider, $Object*, $Class*), "javax.xml.datatype.DatatypeConfigurationException"},
		...
		{"newInstance", "(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/ClassLoader;Z)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;Ljava/lang/String;Ljava/lang/ClassLoader;Z)TT;", $STATIC, $staticMethod(FactoryFinder, newInstance, $Object*, $Class*, $String*, $ClassLoader*, bool), "javax.xml.datatype.DatatypeConfigurationException"},
		{"newInstance", "(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/ClassLoader;ZZ)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;Ljava/lang/String;Ljava/lang/ClassLoader;ZZ)TT;", $STATIC, $staticMethod(FactoryFinder, newInstance, $Object*, $Class*, $String*, $ClassLoader*, bool, bool), "javax.xml.datatype.DatatypeConfigurationException"},
		{}
	};
