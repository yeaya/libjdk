#ifndef _javax_xml_parsers_FactoryFinder_h_
#define _javax_xml_parsers_FactoryFinder_h_
//$ class javax.xml.parsers.FactoryFinder
...
#endif // _javax_xml_parsers_FactoryFinder_h_