...
using $FactoryFinder$1 = ::javax::xml::parsers::FactoryFinder$1;
...
$Class* FactoryFinder$$Lambda$lambda$newInstance$0::load$($String* name, bool initialize) {
	...
	$ClassInfo classInfo$$ = {
		$PUBLIC | $FINAL,
		"javax.xml.parsers.FactoryFinder$$Lambda$lambda$newInstance$0",
		"java.lang.Object",
...
$Class* FactoryFinder$$Lambda$lambda$find$1$1::load$($String* name, bool initialize) {
	...
	$ClassInfo classInfo$$ = {
		$PUBLIC | $FINAL,
		"javax.xml.parsers.FactoryFinder$$Lambda$lambda$find$1$1",
		"java.lang.Object",
		"java.util.function.Supplier",
		fieldInfos$$,
		methodInfos$$
...
$Class* FactoryFinder$$Lambda$lambda$find$2$2::load$($String* name, bool initialize) {
	...
	$ClassInfo classInfo$$ = {
		$PUBLIC | $FINAL,
		"javax.xml.parsers.FactoryFinder$$Lambda$lambda$find$2$2",
		"java.lang.Object",
		"java.util.function.Supplier",
		fieldInfos$$,
		methodInfos$$
...
$Class* FactoryFinder$$Lambda$lambda$find$3$3::load$($String* name, bool initialize) {
	...
	$ClassInfo classInfo$$ = {
		$PUBLIC | $FINAL,
		"javax.xml.parsers.FactoryFinder$$Lambda$lambda$find$3$3",
		"java.lang.Object",
		"java.util.function.Supplier",
		fieldInfos$$,
		methodInfos$$
...
$Class* FactoryFinder$$Lambda$lambda$find$4$4::load$($String* name, bool initialize) {
	...
	$ClassInfo classInfo$$ = {
		$PUBLIC | $FINAL,
		"javax.xml.parsers.FactoryFinder$$Lambda$lambda$find$4$4",
		"java.lang.Object",
		"java.util.function.Supplier",
		fieldInfos$$,
		methodInfos$$
	};
	$loadClass(FactoryFinder$$Lambda$lambda$find$4$4, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(FactoryFinder$$Lambda$lambda$find$4$4);
	});
	return class$;
}
...
$Class* FactoryFinder$$Lambda$lambda$find$5$5::load$($String* name, bool initialize) {
	...
	$ClassInfo classInfo$$ = {
		$PUBLIC | $FINAL,
		"javax.xml.parsers.FactoryFinder$$Lambda$lambda$find$5$5",
		"java.lang.Object",
		"java.util.function.Supplier",
		fieldInfos$$,
		methodInfos$$
	};
	$loadClass(FactoryFinder$$Lambda$lambda$find$5$5, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(FactoryFinder$$Lambda$lambda$find$5$5);
	});
	return class$;
}
...
$Object* FactoryFinder::newInstance($Class* type, $String* className, $ClassLoader* cl$renamed, bool doFallback, bool useBSClsLoader) {
	...
	try {
		...
		$throwNew($FactoryConfigurationError, x, $$str({"Provider "_s, className, " not found"_s}));
	} catch ($Exception& x) {
		$throwNew($FactoryConfigurationError, x, $$str({"Provider "_s, className, " could not be instantiated: "_s, x}));
	}
	$shouldNotReachHere();
}
...
$Object* FactoryFinder::find($Class* type, $String* fallbackClassName) {
	...
	try {
		...
		if (systemProp != nullptr) {
			...
			return newInstance(type, systemProp, nullptr, true);
		}
	...
	try {
			...
			$synchronized(FactoryFinder::cacheProps) {
				if (FactoryFinder::firstTime) {
					...
					if ($SecuritySupport::doesFileExist(f)) {
						dPrint($$new(FactoryFinder$$Lambda$lambda$find$3$3, f));
						FactoryFinder::cacheProps->load($($SecuritySupport::getFileInputStream(f)));
					}
				}
			}
		}
		...
		if (factoryClassName != nullptr) {
			dPrint($$new(FactoryFinder$$Lambda$lambda$find$4$4, factoryClassName));
			return newInstance(type, factoryClassName, nullptr, true);
		}
	} catch ($Exception& ex) {
		if (FactoryFinder::debug) {
			ex->printStackTrace();
	...
	if (fallbackClassName == nullptr) {
		$throwNew($FactoryConfigurationError, $$str({"Provider for "_s, factoryId, " cannot be found"_s}));
	}
	dPrint($$new(FactoryFinder$$Lambda$lambda$find$5$5, fallbackClassName));
	return newInstance(type, fallbackClassName, nullptr, true);
}
...
$Object* FactoryFinder::findServiceProvider($Class* type) {
	...
	$beforeCallerSensitive();
	try {
		return $AccessController::doPrivileged($$new($FactoryFinder$1, type));
...
$Class* FactoryFinder::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("javax.xml.parsers.FactoryFinder$$Lambda$lambda$newInstance$0")) {
			return FactoryFinder$$Lambda$lambda$newInstance$0::load$(name, initialize);
		}
		if (name->equals("javax.xml.parsers.FactoryFinder$$Lambda$lambda$find$1$1")) {
			return FactoryFinder$$Lambda$lambda$find$1$1::load$(name, initialize);
		}
		if (name->equals("javax.xml.parsers.FactoryFinder$$Lambda$lambda$find$2$2")) {
			return FactoryFinder$$Lambda$lambda$find$2$2::load$(name, initialize);
		}
		if (name->equals("javax.xml.parsers.FactoryFinder$$Lambda$lambda$find$3$3")) {
			return FactoryFinder$$Lambda$lambda$find$3$3::load$(name, initialize);
		}
		if (name->equals("javax.xml.parsers.FactoryFinder$$Lambda$lambda$find$4$4")) {
			return FactoryFinder$$Lambda$lambda$find$4$4::load$(name, initialize);
		}
		if (name->equals("javax.xml.parsers.FactoryFinder$$Lambda$lambda$find$5$5")) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"find", "(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;Ljava/lang/String;)TT;", $STATIC, $staticMethod(FactoryFinder, find, $Object*, $Class*, $String*), "javax.xml.parsers.FactoryConfigurationError"},
		{"findServiceProvider", "(Ljava/lang/Class;)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;)TT;", $PRIVATE | $STATIC, $staticMethod(FactoryFinder, findServiceProvider, $Object*, $Class*)},
		...
		{"newInstance", "(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/ClassLoader;Z)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;Ljava/lang/String;Ljava/lang/ClassLoader;Z)TT;", $STATIC, $staticMethod(FactoryFinder, newInstance, $Object*, $Class*, $String*, $ClassLoader*, bool), "javax.xml.parsers.FactoryConfigurationError"},
		{"newInstance", "(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/ClassLoader;ZZ)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;Ljava/lang/String;Ljava/lang/ClassLoader;ZZ)TT;", $STATIC, $staticMethod(FactoryFinder, newInstance, $Object*, $Class*, $String*, $ClassLoader*, bool, bool), "javax.xml.parsers.FactoryConfigurationError"},
		{}
	};
