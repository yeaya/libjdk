...
void GroupEntry$PreferType::clinit$($Class* clazz) {
...
$Class* GroupEntry$PreferType::load$($String* name, bool initialize) {
	...
	$loadClass(GroupEntry$PreferType, name, initialize, &classInfo$$, GroupEntry$PreferType::clinit$, []($Class* clazz) -> $Object* {
