...
void XMLSecurityPropertyManager$Property::clinit$($Class* clazz) {
	$init($XMLConstants);
	$init($JdkConstants);
...
$Class* XMLSecurityPropertyManager$Property::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"$values", "()[Lcom/sun/org/apache/xerces/internal/utils/XMLSecurityPropertyManager$Property;", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $staticMethod(XMLSecurityPropertyManager$Property, $values, $XMLSecurityPropertyManager$PropertyArray*)},
		...
		{"propertyName", "()Ljava/lang/String;", nullptr, $PUBLIC, $method(XMLSecurityPropertyManager$Property, propertyName, $String*)},
		{"valueOf", "(Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/utils/XMLSecurityPropertyManager$Property;", nullptr, $PUBLIC | $STATIC, $staticMethod(XMLSecurityPropertyManager$Property, valueOf, XMLSecurityPropertyManager$Property*, $String*)},
		{"values", "()[Lcom/sun/org/apache/xerces/internal/utils/XMLSecurityPropertyManager$Property;", nullptr, $PUBLIC | $STATIC, $staticMethod(XMLSecurityPropertyManager$Property, values, $XMLSecurityPropertyManager$PropertyArray*)},
		{}
	};
	...
	$loadClass(XMLSecurityPropertyManager$Property, name, initialize, &classInfo$$, XMLSecurityPropertyManager$Property::clinit$, []($Class* clazz) -> $Object* {
