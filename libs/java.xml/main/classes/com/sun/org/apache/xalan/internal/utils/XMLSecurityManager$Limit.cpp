...
$FieldInfo _XMLSecurityManager$Limit_FieldInfo_[] = {
	{"ENTITY_EXPANSION_LIMIT", "Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$Limit;", nullptr, $PUBLIC | $STATIC | $FINAL | $ENUM, $staticField(XMLSecurityManager$Limit, ENTITY_EXPANSION_LIMIT)},
	{"MAX_OCCUR_NODE_LIMIT", "Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$Limit;", nullptr, $PUBLIC | $STATIC | $FINAL | $ENUM, $staticField(XMLSecurityManager$Limit, MAX_OCCUR_NODE_LIMIT)},
	{"ELEMENT_ATTRIBUTE_LIMIT", "Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$Limit;", nullptr, $PUBLIC | $STATIC | $FINAL | $ENUM, $staticField(XMLSecurityManager$Limit, ELEMENT_ATTRIBUTE_LIMIT)},
	{"TOTAL_ENTITY_SIZE_LIMIT", "Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$Limit;", nullptr, $PUBLIC | $STATIC | $FINAL | $ENUM, $staticField(XMLSecurityManager$Limit, TOTAL_ENTITY_SIZE_LIMIT)},
	{"GENERAL_ENTITY_SIZE_LIMIT", "Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$Limit;", nullptr, $PUBLIC | $STATIC | $FINAL | $ENUM, $staticField(XMLSecurityManager$Limit, GENERAL_ENTITY_SIZE_LIMIT)},
	{"PARAMETER_ENTITY_SIZE_LIMIT", "Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$Limit;", nullptr, $PUBLIC | $STATIC | $FINAL | $ENUM, $staticField(XMLSecurityManager$Limit, PARAMETER_ENTITY_SIZE_LIMIT)},
	{"MAX_ELEMENT_DEPTH_LIMIT", "Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$Limit;", nullptr, $PUBLIC | $STATIC | $FINAL | $ENUM, $staticField(XMLSecurityManager$Limit, MAX_ELEMENT_DEPTH_LIMIT)},
	{"MAX_NAME_LIMIT", "Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$Limit;", nullptr, $PUBLIC | $STATIC | $FINAL | $ENUM, $staticField(XMLSecurityManager$Limit, MAX_NAME_LIMIT)},
	{"ENTITY_REPLACEMENT_LIMIT", "Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$Limit;", nullptr, $PUBLIC | $STATIC | $FINAL | $ENUM, $staticField(XMLSecurityManager$Limit, ENTITY_REPLACEMENT_LIMIT)},
	{"$VALUES", "[Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$Limit;", nullptr, $PRIVATE | $STATIC | $FINAL | $SYNTHETIC, $staticField(XMLSecurityManager$Limit, $VALUES)},
...
$ClassInfo _XMLSecurityManager$Limit_ClassInfo_ = {
	...
	"Ljava/lang/Enum<Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$Limit;>;",
	nullptr,
