...
$FieldInfo _XMLSecurityManager$NameMap_FieldInfo_[] = {
	{"ENTITY_EXPANSION_LIMIT", "Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$NameMap;", nullptr, $PUBLIC | $STATIC | $FINAL | $ENUM, $staticField(XMLSecurityManager$NameMap, ENTITY_EXPANSION_LIMIT)},
	{"MAX_OCCUR_NODE_LIMIT", "Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$NameMap;", nullptr, $PUBLIC | $STATIC | $FINAL | $ENUM, $staticField(XMLSecurityManager$NameMap, MAX_OCCUR_NODE_LIMIT)},
	{"ELEMENT_ATTRIBUTE_LIMIT", "Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$NameMap;", nullptr, $PUBLIC | $STATIC | $FINAL | $ENUM, $staticField(XMLSecurityManager$NameMap, ELEMENT_ATTRIBUTE_LIMIT)},
	{"$VALUES", "[Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$NameMap;", nullptr, $PRIVATE | $STATIC | $FINAL | $SYNTHETIC, $staticField(XMLSecurityManager$NameMap, $VALUES)},
...
$MethodInfo _XMLSecurityManager$NameMap_MethodInfo_[] = {
	{"$values", "()[Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$NameMap;", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $staticMethod(XMLSecurityManager$NameMap, $values, $XMLSecurityManager$NameMapArray*)},
	...
	{"valueOf", "(Ljava/lang/String;)Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$NameMap;", nullptr, $PUBLIC | $STATIC, $staticMethod(XMLSecurityManager$NameMap, valueOf, XMLSecurityManager$NameMap*, $String*)},
	{"values", "()[Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$NameMap;", nullptr, $PUBLIC | $STATIC, $staticMethod(XMLSecurityManager$NameMap, values, $XMLSecurityManager$NameMapArray*)},
	{}
};
...
$ClassInfo _XMLSecurityManager$NameMap_ClassInfo_ = {
	...
	"Ljava/lang/Enum<Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$NameMap;>;",
	nullptr,
