...
$PropertyState* NonValidatingConfiguration::getPropertyState($String* propertyId) {
	if (NonValidatingConfiguration::LOCALE->equals(propertyId)) {
...
void NonValidatingConfiguration::clinit$($Class* clazz) {
	$init($Constants);
...
$Class* NonValidatingConfiguration::load$($String* name, bool initialize) {
	...
	$loadClass(NonValidatingConfiguration, name, initialize, &classInfo$$, NonValidatingConfiguration::clinit$, []($Class* clazz) -> $Object* {
