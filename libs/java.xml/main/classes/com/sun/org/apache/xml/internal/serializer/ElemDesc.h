#ifndef _com_sun_org_apache_xml_internal_serializer_ElemDesc_h_
#define _com_sun_org_apache_xml_internal_serializer_ElemDesc_h_
...
#undef HEAD
#pragma push_macro("HEADELEM")
#undef HEADELEM
#pragma push_macro("HEADMISC")
#undef HEADMISC
#pragma push_macro("HTMLELEM")
#undef HTMLELEM
...
public:
	...
	int32_t getFlags();
	bool is(int32_t flags);
	bool isAttrFlagSet($String* name, int32_t flags);
...
#pragma pop_macro("HEADELEM")
#pragma pop_macro("HEADMISC")
#pragma pop_macro("HTMLELEM")
...
#endif // _com_sun_org_apache_xml_internal_serializer_ElemDesc_h_