#ifndef _com_sun_org_apache_xerces_internal_dom_DeferredAttrImpl_h_
#define _com_sun_org_apache_xerces_internal_dom_DeferredAttrImpl_h_
//$ class com.sun.org.apache.xerces.internal.dom.DeferredAttrImpl
...
class DeferredAttrImpl : public ::com::sun::org::apache::xerces::internal::dom::AttrImpl, public ::com::sun::org::apache::xerces::internal::dom::DeferredNode {
	$class(DeferredAttrImpl, $NO_CLASS_INIT, ::com::sun::org::apache::xerces::internal::dom::AttrImpl, ::com::sun::org::apache::xerces::internal::dom::DeferredNode)
public:
	DeferredAttrImpl();
	using ::com::sun::org::apache::xerces::internal::dom::AttrImpl::getTextContent;
	using ::com::sun::org::apache::xerces::internal::dom::AttrImpl::getUserData;
	...
	using ::com::sun::org::apache::xerces::internal::dom::AttrImpl::setUserData;
	...
	static const int64_t serialVersionUID = (int64_t)0x5FCD35369AB8D3DC;
...
#endif // _com_sun_org_apache_xerces_internal_dom_DeferredAttrImpl_h_