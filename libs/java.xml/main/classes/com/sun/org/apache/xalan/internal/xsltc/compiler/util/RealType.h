#ifndef _com_sun_org_apache_xalan_internal_xsltc_compiler_util_RealType_h_
#define _com_sun_org_apache_xalan_internal_xsltc_compiler_util_RealType_h_
//$ class com.sun.org.apache.xalan.internal.xsltc.compiler.util.RealType
...
class RealType : public ::com::sun::org::apache::xalan::internal::xsltc::compiler::util::NumberType {
	$class(RealType, $NO_CLASS_INIT, ::com::sun::org::apache::xalan::internal::xsltc::compiler::util::NumberType)
public:
	RealType();
	void init$();
	virtual ::com::sun::org::apache::bcel::internal::generic::Instruction* ADD() override;
	virtual ::com::sun::org::apache::bcel::internal::generic::Instruction* CMP(bool less) override;
	virtual ::com::sun::org::apache::bcel::internal::generic::Instruction* DIV() override;
	virtual ::com::sun::org::apache::bcel::internal::generic::Instruction* DUP() override;
	...
	void translateTo(::com::sun::org::apache::xalan::internal::xsltc::compiler::util::ClassGenerator* classGen, ::com::sun::org::apache::xalan::internal::xsltc::compiler::util::MethodGenerator* methodGen, ::com::sun::org::apache::xalan::internal::xsltc::compiler::util::IntType* type);
...
#endif // _com_sun_org_apache_xalan_internal_xsltc_compiler_util_RealType_h_