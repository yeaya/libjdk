...
void XMLMessageFormatter_it::clinit$($Class* clazz) {
...
$Class* XMLMessageFormatter_it::load$($String* name, bool initialize) {
	...
	$loadClass(XMLMessageFormatter_it, name, initialize, &classInfo$$, XMLMessageFormatter_it::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(XMLMessageFormatter_it);
	});
	return class$;
}
