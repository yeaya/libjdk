...
bool CoreDOMImplementationImpl::hasFeature($String* feature$renamed, $String* version) {
	...
	bool var$4 = feature->equalsIgnoreCase("Core"_s);
	if (var$4) {
		bool var$6 = anyVersion || $nc(version)->equals("1.0"_s);
		bool var$5 = var$6 || $nc(version)->equals("2.0"_s);
		var$4 = var$5 || $nc(version)->equals("3.0"_s);
	}
	bool var$3 = var$4;
	if (!var$3) {
		bool var$7 = feature->equalsIgnoreCase("XML"_s);
		if (var$7) {
			bool var$9 = anyVersion || $nc(version)->equals("1.0"_s);
			bool var$8 = var$9 || $nc(version)->equals("2.0"_s);
			var$7 = var$8 || $nc(version)->equals("3.0"_s);
		}
		var$3 = var$7;
	}
	bool var$2 = var$3;
	if (!var$2) {
		bool var$10 = feature->equalsIgnoreCase("XMLVersion"_s);
		if (var$10) {
			bool var$11 = anyVersion || $nc(version)->equals("1.0"_s);
			var$10 = var$11 || $nc(version)->equals("1.1"_s);
		}
		var$2 = var$10;
	}
	bool var$1 = var$2;
	if (!var$1) {
		bool var$12 = feature->equalsIgnoreCase("LS"_s);
		var$1 = var$12 && (anyVersion || $nc(version)->equals("3.0"_s));
	}
	bool var$0 = var$1;
	if (!var$0) {
		bool var$13 = feature->equalsIgnoreCase("ElementTraversal"_s);
		var$0 = var$13 && (anyVersion || $nc(version)->equals("1.0"_s));
	}
	return var$0;
}
...
void CoreDOMImplementationImpl::checkQName($String* qname) {
	...
	int32_t lastIndex = qname->lastIndexOf(u':');
...
void CoreDOMImplementationImpl::releaseValidator($String* schemaType, $String* xmlVersion, $RevalidationHandler* validator) {
	$synchronized(this) {
		...
		if (schemaType == $XMLGrammarDescription::XML_SCHEMA) {
			...
			$var($SoftReference, ref, this->schemaValidators->get(this->freeSchemaValidatorIndex));
			if (ref != nullptr) {
			...
			if ("1.1"_s->equals(xmlVersion)) {
				...
				$var($SoftReference, ref, this->xml11DTDValidators->get(this->freeXML11DTDValidatorIndex));
				if (ref != nullptr) {
					$var($CoreDOMImplementationImpl$RevalidationHandlerHolder, holder, $cast($CoreDOMImplementationImpl$RevalidationHandlerHolder, ref->get()));
					if (holder != nullptr) {
						$set(holder, handler, validator);
				...
				$var($SoftReference, ref, this->xml10DTDValidators->get(this->freeXML10DTDValidatorIndex));
				if (ref != nullptr) {
					$var($CoreDOMImplementationImpl$RevalidationHandlerHolder, holder, $cast($CoreDOMImplementationImpl$RevalidationHandlerHolder, ref->get()));
					if (holder != nullptr) {
						$set(holder, handler, validator);
...
void CoreDOMImplementationImpl::releaseDTDLoader($String* xmlVersion, $XMLDTDLoader* loader) {
	$synchronized(this) {
		...
		if ("1.1"_s->equals(xmlVersion)) {
			...
			$var($SoftReference, ref, this->xml11DTDLoaders->get(this->freeXML11DTDLoaderIndex));
			if (ref != nullptr) {
			...
			$var($SoftReference, ref, this->xml10DTDLoaders->get(this->freeXML10DTDLoaderIndex));
			if (ref != nullptr) {
				$var($CoreDOMImplementationImpl$XMLDTDLoaderHolder, holder, $cast($CoreDOMImplementationImpl$XMLDTDLoaderHolder, ref->get()));
				if (holder != nullptr) {
					$set(holder, loader, loader);
...
void CoreDOMImplementationImpl::clinit$($Class* clazz) {
...
$Class* CoreDOMImplementationImpl::load$($String* name, bool initialize) {
	...
	$loadClass(CoreDOMImplementationImpl, name, initialize, &classInfo$$, CoreDOMImplementationImpl::clinit$, []($Class* clazz) -> $Object* {
