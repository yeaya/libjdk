...
void XML11DTDConfiguration::init$($SymbolTable* symbolTable$renamed, $XMLGrammarPool* grammarPool, $XMLComponentManager* parentSettings) {
	...
	this->fFeatures->put(XML11DTDConfiguration::NAMESPACES, $Boolean::TRUE);
	this->fFeatures->put(XML11DTDConfiguration::EXTERNAL_GENERAL_ENTITIES, $Boolean::TRUE);
	this->fFeatures->put(XML11DTDConfiguration::EXTERNAL_PARAMETER_ENTITIES, $Boolean::TRUE);
	this->fFeatures->put(XML11DTDConfiguration::CONTINUE_AFTER_FATAL_ERROR, $Boolean::FALSE);
	this->fFeatures->put(XML11DTDConfiguration::LOAD_EXTERNAL_DTD, $Boolean::TRUE);
	...
	if (this->fGrammarPool != nullptr) {
		this->fProperties->put(XML11DTDConfiguration::XMLGRAMMAR_POOL, this->fGrammarPool);
	}
	$set(this, fEntityManager, $new($XMLEntityManager));
	this->fProperties->put(XML11DTDConfiguration::ENTITY_MANAGER, this->fEntityManager);
	...
	this->fProperties->put(XML11DTDConfiguration::VALIDATION_MANAGER, this->fValidationManager);
...
void XML11DTDConfiguration::clinit$($Class* clazz) {
...
$Class* XML11DTDConfiguration::load$($String* name, bool initialize) {
	...
	$loadClass(XML11DTDConfiguration, name, initialize, &classInfo$$, XML11DTDConfiguration::clinit$, []($Class* clazz) -> $Object* {
