...
$Class* XML11NSDocumentScannerImpl$NS11ContentDriver::load$($String* name, bool initialize) {
	...
	$loadClass(XML11NSDocumentScannerImpl$NS11ContentDriver, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(XML11NSDocumentScannerImpl$NS11ContentDriver);
	});
	return class$;
}
