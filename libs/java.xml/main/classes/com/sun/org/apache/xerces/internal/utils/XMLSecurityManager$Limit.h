#ifndef _com_sun_org_apache_xerces_internal_utils_XMLSecurityManager$Limit_h_
#define _com_sun_org_apache_xerces_internal_utils_XMLSecurityManager$Limit_h_
//$ class com.sun.org.apache.xerces.internal.utils.XMLSecurityManager$Limit
...
public:
	...
	static $Array<::com::sun::org::apache::xerces::internal::utils::XMLSecurityManager$Limit>* $values();
	...
	static ::com::sun::org::apache::xerces::internal::utils::XMLSecurityManager$Limit* valueOf($String* name);
	static $Array<::com::sun::org::apache::xerces::internal::utils::XMLSecurityManager$Limit>* values();
	static ::com::sun::org::apache::xerces::internal::utils::XMLSecurityManager$Limit* ENTITY_EXPANSION_LIMIT;
	static ::com::sun::org::apache::xerces::internal::utils::XMLSecurityManager$Limit* MAX_OCCUR_NODE_LIMIT;
	static ::com::sun::org::apache::xerces::internal::utils::XMLSecurityManager$Limit* ELEMENT_ATTRIBUTE_LIMIT;
	static ::com::sun::org::apache::xerces::internal::utils::XMLSecurityManager$Limit* TOTAL_ENTITY_SIZE_LIMIT;
	static ::com::sun::org::apache::xerces::internal::utils::XMLSecurityManager$Limit* GENERAL_ENTITY_SIZE_LIMIT;
	static ::com::sun::org::apache::xerces::internal::utils::XMLSecurityManager$Limit* PARAMETER_ENTITY_SIZE_LIMIT;
	static ::com::sun::org::apache::xerces::internal::utils::XMLSecurityManager$Limit* MAX_ELEMENT_DEPTH_LIMIT;
	static ::com::sun::org::apache::xerces::internal::utils::XMLSecurityManager$Limit* MAX_NAME_LIMIT;
	static ::com::sun::org::apache::xerces::internal::utils::XMLSecurityManager$Limit* ENTITY_REPLACEMENT_LIMIT;
	static $Array<::com::sun::org::apache::xerces::internal::utils::XMLSecurityManager$Limit>* $VALUES;
	$String* key$ = nullptr;
...
#endif // _com_sun_org_apache_xerces_internal_utils_XMLSecurityManager$Limit_h_