#ifndef _com_sun_org_apache_xalan_internal_xsltc_compiler_util_ResultTreeType_h_
#define _com_sun_org_apache_xalan_internal_xsltc_compiler_util_ResultTreeType_h_
//$ class com.sun.org.apache.xalan.internal.xsltc.compiler.util.ResultTreeType
...
class ResultTreeType : public ::com::sun::org::apache::xalan::internal::xsltc::compiler::util::Type {
	$class(ResultTreeType, $NO_CLASS_INIT, ::com::sun::org::apache::xalan::internal::xsltc::compiler::util::Type)
public:
	ResultTreeType();
	void init$();
	...
	virtual bool implementedAsMethod() override;
...
#endif // _com_sun_org_apache_xalan_internal_xsltc_compiler_util_ResultTreeType_h_