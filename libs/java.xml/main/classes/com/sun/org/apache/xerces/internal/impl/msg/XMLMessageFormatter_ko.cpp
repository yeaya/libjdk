...
void XMLMessageFormatter_ko::clinit$($Class* clazz) {
...
$Class* XMLMessageFormatter_ko::load$($String* name, bool initialize) {
	...
	$loadClass(XMLMessageFormatter_ko, name, initialize, &classInfo$$, XMLMessageFormatter_ko::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(XMLMessageFormatter_ko);
	});
	return class$;
}
