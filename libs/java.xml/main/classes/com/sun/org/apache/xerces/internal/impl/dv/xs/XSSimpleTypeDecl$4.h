#ifndef _com_sun_org_apache_xerces_internal_impl_dv_xs_XSSimpleTypeDecl$4_h_
#define _com_sun_org_apache_xerces_internal_impl_dv_xs_XSSimpleTypeDecl$4_h_
//$ class com.sun.org.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl$4
...
class XSSimpleTypeDecl$4 : public ::com::sun::org::apache::xerces::internal::impl::dv::ValidationContext {
	$class(XSSimpleTypeDecl$4, $NO_CLASS_INIT, ::com::sun::org::apache::xerces::internal::impl::dv::ValidationContext)
public:
	XSSimpleTypeDecl$4();
	void init$();
...
#endif // _com_sun_org_apache_xerces_internal_impl_dv_xs_XSSimpleTypeDecl$4_h_