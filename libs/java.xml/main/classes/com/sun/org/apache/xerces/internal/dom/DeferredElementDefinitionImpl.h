#ifndef _com_sun_org_apache_xerces_internal_dom_DeferredElementDefinitionImpl_h_
#define _com_sun_org_apache_xerces_internal_dom_DeferredElementDefinitionImpl_h_
//$ class com.sun.org.apache.xerces.internal.dom.DeferredElementDefinitionImpl
//$ extends com.sun.org.apache.xerces.internal.dom.ElementDefinitionImpl
...
class DeferredElementDefinitionImpl : public ::com::sun::org::apache::xerces::internal::dom::ElementDefinitionImpl, public ::com::sun::org::apache::xerces::internal::dom::DeferredNode {
	$class(DeferredElementDefinitionImpl, $NO_CLASS_INIT, ::com::sun::org::apache::xerces::internal::dom::ElementDefinitionImpl, ::com::sun::org::apache::xerces::internal::dom::DeferredNode)
public:
	DeferredElementDefinitionImpl();
	using ::com::sun::org::apache::xerces::internal::dom::ElementDefinitionImpl::getTextContent;
	using ::com::sun::org::apache::xerces::internal::dom::ElementDefinitionImpl::getUserData;
	...
	using ::com::sun::org::apache::xerces::internal::dom::ElementDefinitionImpl::setUserData;
	...
	static const int64_t serialVersionUID = (int64_t)0x5D06AFA0904B42F7;
...
#endif // _com_sun_org_apache_xerces_internal_dom_DeferredElementDefinitionImpl_h_