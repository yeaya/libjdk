#ifndef _com_sun_org_apache_xerces_internal_jaxp_validation_DOMResultBuilder_h_
#define _com_sun_org_apache_xerces_internal_jaxp_validation_DOMResultBuilder_h_
//$ class com.sun.org.apache.xerces.internal.jaxp.validation.DOMResultBuilder
...
class DOMResultBuilder : public ::com::sun::org::apache::xerces::internal::jaxp::validation::DOMDocumentHandler {
...
public:
	...
	::org::w3c::dom::Node* fTarget = nullptr;
	::org::w3c::dom::Node* fNextSibling = nullptr;
	::org::w3c::dom::Node* fCurrentNode = nullptr;
	::org::w3c::dom::Node* fFragmentRoot = nullptr;
	::java::util::List* fTargetChildren = nullptr;
...
#endif // _com_sun_org_apache_xerces_internal_jaxp_validation_DOMResultBuilder_h_