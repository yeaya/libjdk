...
void XMLMessageFormatter::clinit$($Class* clazz) {
...
$Class* XMLMessageFormatter::load$($String* name, bool initialize) {
	...
	$loadClass(XMLMessageFormatter, name, initialize, &classInfo$$, XMLMessageFormatter::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(XMLMessageFormatter);
	});
	return class$;
}
