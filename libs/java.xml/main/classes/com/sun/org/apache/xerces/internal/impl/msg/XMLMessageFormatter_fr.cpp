...
void XMLMessageFormatter_fr::clinit$($Class* clazz) {
...
$Class* XMLMessageFormatter_fr::load$($String* name, bool initialize) {
	...
	$loadClass(XMLMessageFormatter_fr, name, initialize, &classInfo$$, XMLMessageFormatter_fr::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(XMLMessageFormatter_fr);
	});
	return class$;
}
