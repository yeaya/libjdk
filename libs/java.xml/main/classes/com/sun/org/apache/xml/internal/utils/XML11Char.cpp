...
bool XML11Char::isXML11Space(int32_t c) {
	$init(XML11Char);
	return (c < 0x00010000 && (XML11Char::XML11CHARS->get(c) & XML11Char::MASK_XML11_SPACE) != 0);
}

bool XML11Char::isXML11Valid(int32_t c) {
	$init(XML11Char);
	return (c < 0x00010000 && (XML11Char::XML11CHARS->get(c) & XML11Char::MASK_XML11_VALID) != 0) || (0x00010000 <= c && c <= 0x0010ffff);
}
...
bool XML11Char::isXML11ValidLiteral(int32_t c) {
	$init(XML11Char);
	return ((c < 0x00010000 && ((XML11Char::XML11CHARS->get(c) & XML11Char::MASK_XML11_VALID) != 0 && (XML11Char::XML11CHARS->get(c) & XML11Char::MASK_XML11_CONTROL) == 0)) || (0x00010000 <= c && c <= 0x0010ffff));
}

bool XML11Char::isXML11Content(int32_t c) {
	$init(XML11Char);
	return (c < 0x00010000 && (XML11Char::XML11CHARS->get(c) & XML11Char::MASK_XML11_CONTENT) != 0) || (0x00010000 <= c && c <= 0x0010ffff);
}

bool XML11Char::isXML11InternalEntityContent(int32_t c) {
	$init(XML11Char);
	return (c < 0x00010000 && (XML11Char::XML11CHARS->get(c) & XML11Char::MASK_XML11_CONTENT_INTERNAL) != 0) || (0x00010000 <= c && c <= 0x0010ffff);
}

bool XML11Char::isXML11NameStart(int32_t c) {
	$init(XML11Char);
	return (c < 0x00010000 && (XML11Char::XML11CHARS->get(c) & XML11Char::MASK_XML11_NAME_START) != 0) || (0x00010000 <= c && c < 0x000f0000);
}

bool XML11Char::isXML11Name(int32_t c) {
	$init(XML11Char);
	return (c < 0x00010000 && (XML11Char::XML11CHARS->get(c) & XML11Char::MASK_XML11_NAME) != 0) || (c >= 0x00010000 && c < 0x000f0000);
}

bool XML11Char::isXML11NCNameStart(int32_t c) {
	$init(XML11Char);
	return (c < 0x00010000 && (XML11Char::XML11CHARS->get(c) & XML11Char::MASK_XML11_NCNAME_START) != 0) || (0x00010000 <= c && c < 0x000f0000);
}

bool XML11Char::isXML11NCName(int32_t c) {
	$init(XML11Char);
	return (c < 0x00010000 && (XML11Char::XML11CHARS->get(c) & XML11Char::MASK_XML11_NCNAME) != 0) || (0x00010000 <= c && c < 0x000f0000);
}
...
void XML11Char::clinit$($Class* clazz) {
	$assignStatic(XML11Char::XML11CHARS, $new($bytes, 1 << 16));
	{
		...
		XML11Char::XML11CHARS->set(93, 1);
		XML11Char::XML11CHARS->set(94, 33);
		XML11Char::XML11CHARS->set(95, -19);
		XML11Char::XML11CHARS->set(96, 33);
		...
		XML11Char::XML11CHARS->set(894, 33);
		...
		XML11Char::XML11CHARS->set(8232, 35);
...
$Class* XML11Char::load$($String* name, bool initialize) {
	...
	$loadClass(XML11Char, name, initialize, &classInfo$$, XML11Char::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(XML11Char);
	});
	return class$;
}
