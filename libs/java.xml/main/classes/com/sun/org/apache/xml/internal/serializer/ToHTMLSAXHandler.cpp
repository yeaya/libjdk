...
void ToHTMLSAXHandler::closeStartTag() {
	...
	$nc(this->m_saxHandler)->startElement($SerializerConstants::EMPTYSTRING, this->m_elemContext->m_elementName, this->m_elemContext->m_elementName, this->m_attributes);
...
$Class* ToHTMLSAXHandler::load$($String* name, bool initialize) {
	...
	$loadClass(ToHTMLSAXHandler, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
