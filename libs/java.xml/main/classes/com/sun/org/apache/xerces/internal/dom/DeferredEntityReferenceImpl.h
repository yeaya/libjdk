#ifndef _com_sun_org_apache_xerces_internal_dom_DeferredEntityReferenceImpl_h_
#define _com_sun_org_apache_xerces_internal_dom_DeferredEntityReferenceImpl_h_
//$ class com.sun.org.apache.xerces.internal.dom.DeferredEntityReferenceImpl
//$ extends com.sun.org.apache.xerces.internal.dom.EntityReferenceImpl
...
class DeferredEntityReferenceImpl : public ::com::sun::org::apache::xerces::internal::dom::EntityReferenceImpl, public ::com::sun::org::apache::xerces::internal::dom::DeferredNode {
	$class(DeferredEntityReferenceImpl, $NO_CLASS_INIT, ::com::sun::org::apache::xerces::internal::dom::EntityReferenceImpl, ::com::sun::org::apache::xerces::internal::dom::DeferredNode)
public:
	DeferredEntityReferenceImpl();
	using ::com::sun::org::apache::xerces::internal::dom::EntityReferenceImpl::getTextContent;
	using ::com::sun::org::apache::xerces::internal::dom::EntityReferenceImpl::getUserData;
	...
	using ::com::sun::org::apache::xerces::internal::dom::EntityReferenceImpl::setUserData;
	...
	static const int64_t serialVersionUID = (int64_t)0x056AB1254629FC5F;
...
#endif // _com_sun_org_apache_xerces_internal_dom_DeferredEntityReferenceImpl_h_