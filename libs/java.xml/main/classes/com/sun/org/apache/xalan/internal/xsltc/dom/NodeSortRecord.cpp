...
void NodeSortRecord::clinit$($Class* clazz) {
...
$Class* NodeSortRecord::load$($String* name, bool initialize) {
	$CompoundAttribute DEFAULT_COLLATORfieldAnnotations$$[] = {
		{"Ljava/lang/Deprecated;", nullptr},
		{}
	};
	$CompoundAttribute _collatorfieldAnnotations$$[] = {
		{"Ljava/lang/Deprecated;", nullptr},
		{}
	};
	$CompoundAttribute _localefieldAnnotations$$[] = {
		{"Ljava/lang/Deprecated;", nullptr},
		{}
	};
	$FieldInfo fieldInfos$$[] = {
		...
		{"DEFAULT_COLLATOR", "Ljava/text/Collator;", nullptr, $PRIVATE | $STATIC | $FINAL | $DEPRECATED, $staticField(NodeSortRecord, DEFAULT_COLLATOR), DEFAULT_COLLATORfieldAnnotations$$},
		{"_collator", "Ljava/text/Collator;", nullptr, $PROTECTED | $DEPRECATED, $field(NodeSortRecord, _collator), _collatorfieldAnnotations$$},
		{"_collators", "[Ljava/text/Collator;", nullptr, $PROTECTED, $field(NodeSortRecord, _collators)},
		{"_locale", "Ljava/util/Locale;", nullptr, $PROTECTED | $DEPRECATED, $field(NodeSortRecord, _locale), _localefieldAnnotations$$},
	...
	$loadClass(NodeSortRecord, name, initialize, &classInfo$$, NodeSortRecord::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(NodeSortRecord);
	});
	return class$;
}
