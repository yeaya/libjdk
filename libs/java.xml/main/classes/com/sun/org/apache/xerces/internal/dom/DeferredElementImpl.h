#ifndef _com_sun_org_apache_xerces_internal_dom_DeferredElementImpl_h_
#define _com_sun_org_apache_xerces_internal_dom_DeferredElementImpl_h_
...
class DeferredElementImpl : public ::com::sun::org::apache::xerces::internal::dom::ElementImpl, public ::com::sun::org::apache::xerces::internal::dom::DeferredNode {
	$class(DeferredElementImpl, $NO_CLASS_INIT, ::com::sun::org::apache::xerces::internal::dom::ElementImpl, ::com::sun::org::apache::xerces::internal::dom::DeferredNode)
public:
	DeferredElementImpl();
	using ::com::sun::org::apache::xerces::internal::dom::ElementImpl::getTextContent;
	using ::com::sun::org::apache::xerces::internal::dom::ElementImpl::getUserData;
	...
	void init$(::com::sun::org::apache::xerces::internal::dom::DeferredDocumentImpl* ownerDoc, int32_t nodeIndex);
	virtual int32_t getNodeIndex() override;
	using ::com::sun::org::apache::xerces::internal::dom::ElementImpl::setUserData;
	...
	static const int64_t serialVersionUID = (int64_t)0x958B334D20BA3746;
...
#endif // _com_sun_org_apache_xerces_internal_dom_DeferredElementImpl_h_