#ifndef _com_sun_org_apache_xalan_internal_xsltc_compiler_util_ReferenceType_h_
#define _com_sun_org_apache_xalan_internal_xsltc_compiler_util_ReferenceType_h_
//$ class com.sun.org.apache.xalan.internal.xsltc.compiler.util.ReferenceType
...
class ReferenceType : public ::com::sun::org::apache::xalan::internal::xsltc::compiler::util::Type {
	$class(ReferenceType, $NO_CLASS_INIT, ::com::sun::org::apache::xalan::internal::xsltc::compiler::util::Type)
public:
	ReferenceType();
	void init$();
	...
	void translateTo(::com::sun::org::apache::xalan::internal::xsltc::compiler::util::ClassGenerator* classGen, ::com::sun::org::apache::xalan::internal::xsltc::compiler::util::MethodGenerator* methodGen, ::com::sun::org::apache::xalan::internal::xsltc::compiler::util::ResultTreeType* type);
...
#endif // _com_sun_org_apache_xalan_internal_xsltc_compiler_util_ReferenceType_h_