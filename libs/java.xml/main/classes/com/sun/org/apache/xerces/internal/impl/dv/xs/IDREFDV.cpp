...
int16_t IDREFDV::getAllowedFacets() {
...
void IDREFDV::checkExtraRules(Object$* value, $ValidationContext* context) {
	$nc(context)->addIdRef($cast($String, value));
}
