#ifndef _com_sun_org_apache_xpath_internal_operations_Mult_h_
#define _com_sun_org_apache_xpath_internal_operations_Mult_h_
//$ class com.sun.org.apache.xpath.internal.operations.Mult
...
class Mult : public ::com::sun::org::apache::xpath::internal::operations::Operation {
	$class(Mult, $NO_CLASS_INIT, ::com::sun::org::apache::xpath::internal::operations::Operation)
public:
	Mult();
	...
	static const int64_t serialVersionUID = (int64_t)0xBB3603D03A0130ED;
};
...
#endif // _com_sun_org_apache_xpath_internal_operations_Mult_h_