...
bool XMLDocumentScannerImpl$DTDDriver::dispatch(bool complete) {
	...
	try {
		try {
				...
				case 45:
					{
						...
						if ($instanceOf($Entity$ScannedEntity, entity)) {
							this->this$0->fEndPos = $cast($Entity$ScannedEntity, entity)->position;
						}
						this->this$0->fReadingDTD = false;
						if (!moreToScan) {
							if (!$nc(this->this$0->fEntityScanner)->skipChar(u']', nullptr)) {
								this->this$0->reportFatalError("DoctypedeclNotClosed"_s, $$new($ObjectArray, {this->this$0->fDoctypeName}));
							}
							$nc(this->this$0->fEntityScanner)->skipSpaces();
							if (!$nc(this->this$0->fEntityScanner)->skipChar(u'>', nullptr)) {
								this->this$0->reportFatalError("DoctypedeclUnterminated"_s, $$new($ObjectArray, {this->this$0->fDoctypeName}));
							}
						...
						if (!$nc(staxInputSource)->isCreatedByResolver()) {
							...
							if (accessError != nullptr) {
								this->this$0->reportFatalError("AccessExternalDTD"_s, $$new($ObjectArray, {
									$($SecuritySupport::sanitizePath(this->this$0->fDoctypeSystemId)),
									accessError
								}));
							}
						}
						$assign(xmlInputSource, staxInputSource->getXMLInputSource());
			...
			$nc(this->this$0->fErrorReporter)->reportError(var$3, var$4, $(e->getArguments()), $XMLErrorReporter::SEVERITY_FATAL_ERROR, e);
			var$2 = false;
			return$1 = true;
			goto $finally;
...
$Class* XMLDocumentScannerImpl$DTDDriver::load$($String* name, bool initialize) {
	...
	$loadClass(XMLDocumentScannerImpl$DTDDriver, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(XMLDocumentScannerImpl$DTDDriver);
	});
	return class$;
}
