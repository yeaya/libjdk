#ifndef _com_sun_org_apache_xerces_internal_impl_dv_xs_DayDV_h_
#define _com_sun_org_apache_xerces_internal_impl_dv_xs_DayDV_h_
//$ class com.sun.org.apache.xerces.internal.impl.dv.xs.DayDV
...
class DayDV : public ::com::sun::org::apache::xerces::internal::impl::dv::xs::AbstractDateTimeDV {
	$class(DayDV, $NO_CLASS_INIT, ::com::sun::org::apache::xerces::internal::impl::dv::xs::AbstractDateTimeDV)
public:
	DayDV();
	void init$();
	...
	static const int32_t DAY_SIZE = 5;
};
...
#pragma pop_macro("DAY_SIZE")

#endif // _com_sun_org_apache_xerces_internal_impl_dv_xs_DayDV_h_