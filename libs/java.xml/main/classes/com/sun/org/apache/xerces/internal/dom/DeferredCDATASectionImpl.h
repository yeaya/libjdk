#ifndef _com_sun_org_apache_xerces_internal_dom_DeferredCDATASectionImpl_h_
#define _com_sun_org_apache_xerces_internal_dom_DeferredCDATASectionImpl_h_
//$ class com.sun.org.apache.xerces.internal.dom.DeferredCDATASectionImpl
...
class DeferredCDATASectionImpl : public ::com::sun::org::apache::xerces::internal::dom::CDATASectionImpl, public ::com::sun::org::apache::xerces::internal::dom::DeferredNode {
	$class(DeferredCDATASectionImpl, $NO_CLASS_INIT, ::com::sun::org::apache::xerces::internal::dom::CDATASectionImpl, ::com::sun::org::apache::xerces::internal::dom::DeferredNode)
public:
	DeferredCDATASectionImpl();
	using ::com::sun::org::apache::xerces::internal::dom::CDATASectionImpl::getTextContent;
	using ::com::sun::org::apache::xerces::internal::dom::CDATASectionImpl::getUserData;
	...
	using ::com::sun::org::apache::xerces::internal::dom::CDATASectionImpl::isIgnorableWhitespace;
	using ::com::sun::org::apache::xerces::internal::dom::CDATASectionImpl::replaceData;
	using ::com::sun::org::apache::xerces::internal::dom::CDATASectionImpl::setUserData;
	...
	static const int64_t serialVersionUID = (int64_t)0x1B8718135EE7291E;
...
#endif // _com_sun_org_apache_xerces_internal_dom_DeferredCDATASectionImpl_h_