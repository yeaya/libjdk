#ifndef _com_sun_org_apache_xerces_internal_impl_dv_xs_MonthDV_h_
#define _com_sun_org_apache_xerces_internal_impl_dv_xs_MonthDV_h_
//$ class com.sun.org.apache.xerces.internal.impl.dv.xs.MonthDV
...
class MonthDV : public ::com::sun::org::apache::xerces::internal::impl::dv::xs::AbstractDateTimeDV {
	$class(MonthDV, $NO_CLASS_INIT, ::com::sun::org::apache::xerces::internal::impl::dv::xs::AbstractDateTimeDV)
public:
	MonthDV();
	void init$();
...
#endif // _com_sun_org_apache_xerces_internal_impl_dv_xs_MonthDV_h_