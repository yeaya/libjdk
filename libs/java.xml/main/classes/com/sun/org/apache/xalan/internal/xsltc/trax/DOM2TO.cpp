...
void DOM2TO::clinit$($Class* clazz) {
...
$Class* DOM2TO::load$($String* name, bool initialize) {
	...
	$loadClass(DOM2TO, name, initialize, &classInfo$$, DOM2TO::clinit$, []($Class* clazz) -> $Object* {
