...
$ObjectArray2* SerializerMessages_zh_TW::getContents() {
	...
	$var($ObjectArray2, contents, $new($ObjectArray2, {
		$$new($ObjectArray, {
			$MsgKey::BAD_MSGKEY,
			u"訊息索引鍵 \'\'{0}\'\' 的訊息類別不是 \'\'{1}\'\'"_s
		}),
		$$new($ObjectArray, {
			$MsgKey::BAD_MSGFORMAT,
			u"訊息類別 \'\'{1}\'\' 中的訊息 \'\'{0}\'\' 格式不正確。"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"警告:  要求的輸出文件版本為 \'\'{0}\'\'。不支援此版本的 XML。輸出文件的版本將會是 \'\'1.0\'\'。"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"傳遞給 SerializerFactory 的 Properties 物件沒有 \'\'{0}\'\' 屬性。"_s
		}),
		$$new($ObjectArray, {
			$MsgKey::ER_ENCODING_NOT_SUPPORTED,
			u"警告:  Java Runtime 不支援編碼 \'\'{0}\'\'。"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"可辨識參數 \'\'{0}\'\'，但無法設定要求的值。"_s
		}),
		$$new($ObjectArray, {
			$MsgKey::ER_STRING_TOO_LONG,
			u"結果字串太長，無法納入 DOMString: \'\'{0}\'\'。"_s
		}),
		$$new($ObjectArray, {
			$MsgKey::ER_TYPE_MISMATCH_ERR,
			u"此參數名稱的值類型與預期的值類型不相容。"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"CDATA 段落包含一或多個終止標記 \']]>\'。"_s
		}),
		$$new($ObjectArray, {
			$MsgKey::ER_WARNING_WF_NOT_CHECKED,
			u"無法建立 Well-Formedness 檢查程式執行處理。well-formed 參數設為 true，但無法執行 well-formedness 檢查。"_s
		}),
		$$new($ObjectArray, {
			$MsgKey::ER_WF_INVALID_CHARACTER,
			u"節點 \'\'{0}\'\' 包含無效的 XML 字元。"_s
		}),
		$$new($ObjectArray, {
			$MsgKey::ER_WF_INVALID_CHARACTER_IN_COMMENT,
			u"在註解中找到無效的 XML 字元 (Unicode: 0x{0})。"_s
		}),
		$$new($ObjectArray, {
			$MsgKey::ER_WF_INVALID_CHARACTER_IN_PI,
			u"在處理的指示資料中發現無效的 XML 字元 (Unicode: 0x{0})。"_s
		}),
		$$new($ObjectArray, {
			$MsgKey::ER_WF_INVALID_CHARACTER_IN_CDATA,
			u"在 CDATASection 的內容中發現無效的 XML 字元 (Unicode: 0x{0})。"_s
		}),
		$$new($ObjectArray, {
			$MsgKey::ER_WF_INVALID_CHARACTER_IN_TEXT,
			u"在節點的字元資料內容中發現無效的 XML 字元 (Unicode: 0x{0})。"_s
		}),
		$$new($ObjectArray, {
			$MsgKey::ER_WF_INVALID_CHARACTER_IN_NODE_NAME,
			u"在名稱為 \'\'{1}\'\' 的 {0} 節點中發現無效的 XML 字元。"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"實體節點 \"{0}\" 的取代文字包含具有未連結前置碼 \"{2}\" 的元素節點 \"{1}\"。"_s
		}),
		$$new($ObjectArray, {
			$MsgKey::ER_ATTR_UNBOUND_PREFIX_IN_ENTREF,
			u"實體節點 \"{0}\" 的取代文字包含具有未連結前置碼 \"{2}\" 的屬性節點 \"{1}\"。"_s
		}),
		$$new($ObjectArray, {
...
$Class* SerializerMessages_zh_TW::load$($String* name, bool initialize) {
	...
	$loadClass(SerializerMessages_zh_TW, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(SerializerMessages_zh_TW);
	});
	return class$;
}
