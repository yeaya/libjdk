		...
		case u'!':
			{
				...
				} else if ($nc(this->this$0->fEntityScanner)->skipString($XMLDocumentFragmentScannerImpl::CDATA)) {
			...
			case 37:
				{
					...
					if ($nc(this->this$0->fEntityScanner)->skipChar(u'<', nullptr)) {
						...
						if (this->this$0->dtdGrammarUtil != nullptr && this->this$0->dtdGrammarUtil->isIgnorableWhiteSpace(this->this$0->fContentBuffer)) {
							;
					...
					do {
						if (c == u'<') {
							...
							if ($XMLChar::isHighSurrogate(c)) {
								...
								this->this$0->reportFatalError("InvalidCharInContent"_s, $$new($ObjectArray, {$($Integer::toString(c, 16))}));
								$nc(this->this$0->fEntityScanner)->scanChar(nullptr);
							}
							break;
						}
					...
					if (this->this$0->fIsCoalesce) {
						this->this$0->fLastSectionWasCharacterData = true;
						continue;
					} else if (this->this$0->dtdGrammarUtil != nullptr && this->this$0->dtdGrammarUtil->isIgnorableWhiteSpace(this->this$0->fContentBuffer)) {
						;
						return $XMLEvent::SPACE;
					} else {
						return $XMLEvent::CHARACTERS;
						...
						if (this->this$0->isValidNameChar($nc(this->this$0->fEntityScanner)->peekChar())) {
							...
							if (this->this$0->fNamespaces) {
								while (this->this$0->isValidNCName($nc(this->this$0->fEntityScanner)->peekChar())) {
									$nc(this->this$0->fStringBuffer)->append((char16_t)this->this$0->fEntityScanner->scanChar(nullptr));
								}
							} else {
...
$Class* XMLDocumentFragmentScannerImpl$FragmentContentDriver::load$($String* name, bool initialize) {
	...
	$loadClass(XMLDocumentFragmentScannerImpl$FragmentContentDriver, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(XMLDocumentFragmentScannerImpl$FragmentContentDriver);
	});
	return class$;
}
