			...
			case 21:
				{
					...
					if (var$0 || this->this$0->isValidNameStartHighSurrogate(this->this$0->fEntityScanner->peekChar())) {
						...
						if ($nc(this->this$0->fEntityScanner)->skipChar(u'-', nullptr)) {
						...
						} else if ($nc(this->this$0->fEntityScanner)->skipString($XMLDocumentScannerImpl::DOCTYPE)) {
							...
							if ($instanceOf($Entity$ScannedEntity, entity)) {
								this->this$0->fStartPos = $cast($Entity$ScannedEntity, entity)->position;
							}
		...
		case 24:
			{
				...
				if (this->this$0->fDoctypeSystemId != nullptr) {
					if ((this->this$0->fValidation || this->this$0->fLoadExternalDTD) && (this->this$0->fValidationManager == nullptr || !this->this$0->fValidationManager->isCachedDTD())) {
				...
				if (this->this$0->fDTDScanner != nullptr) {
					this->this$0->fDTDScanner->setInputSource(nullptr);
				}
				this->this$0->setScannerState(43);
				return $XMLEvent::DTD;
			}
...
$Class* XMLDocumentScannerImpl$PrologDriver::load$($String* name, bool initialize) {
	...
	$loadClass(XMLDocumentScannerImpl$PrologDriver, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(XMLDocumentScannerImpl$PrologDriver);
	});
	return class$;
}
