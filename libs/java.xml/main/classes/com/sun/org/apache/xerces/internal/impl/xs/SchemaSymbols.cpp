...
void SchemaSymbols::clinit$($Class* clazz) {
...
$Class* SchemaSymbols::load$($String* name, bool initialize) {
	...
	$loadClass(SchemaSymbols, name, initialize, &classInfo$$, SchemaSymbols::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(SchemaSymbols);
	});
	return class$;
}
