#ifndef _com_sun_org_apache_xerces_internal_impl_dv_xs_XSSimpleTypeDecl$AbstractObjectList_h_
#define _com_sun_org_apache_xerces_internal_impl_dv_xs_XSSimpleTypeDecl$AbstractObjectList_h_
...
class XSSimpleTypeDecl$AbstractObjectList : public ::java::util::AbstractList, public ::com::sun::org::apache::xerces::internal::xs::datatypes::ObjectList {
	$class(XSSimpleTypeDecl$AbstractObjectList, $NO_CLASS_INIT, ::java::util::AbstractList, ::com::sun::org::apache::xerces::internal::xs::datatypes::ObjectList)
public:
...
#endif // _com_sun_org_apache_xerces_internal_impl_dv_xs_XSSimpleTypeDecl$AbstractObjectList_h_