#ifndef _com_sun_org_apache_xerces_internal_impl_dtd_XMLSimpleType_h_
#define _com_sun_org_apache_xerces_internal_impl_dtd_XMLSimpleType_h_
//$ class com.sun.org.apache.xerces.internal.impl.dtd.XMLSimpleType
...
public:
	...
	void init$();
	virtual void clear();
	virtual void setValues(int16_t type, $String* name, $StringArray* enumeration, bool list, int16_t defaultType, $String* defaultValue, $String* nonNormalizedDefaultValue, ::com::sun::org::apache::xerces::internal::impl::dv::DatatypeValidator* datatypeValidator);
	virtual void setValues(::com::sun::org::apache::xerces::internal::impl::dtd::XMLSimpleType* simpleType);
	...
	::com::sun::org::apache::xerces::internal::impl::dv::DatatypeValidator* datatypeValidator = nullptr;
};
...
#endif // _com_sun_org_apache_xerces_internal_impl_dtd_XMLSimpleType_h_