#ifndef _com_sun_org_apache_xerces_internal_impl_xpath_regex_RegularExpression$CharArrayTarget_h_
#define _com_sun_org_apache_xerces_internal_impl_xpath_regex_RegularExpression$CharArrayTarget_h_
//$ class com.sun.org.apache.xerces.internal.impl.xpath.regex.RegularExpression$CharArrayTarget
...
class RegularExpression$CharArrayTarget : public ::com::sun::org::apache::xerces::internal::impl::xpath::regex::RegularExpression$ExpressionTarget {
	$class(RegularExpression$CharArrayTarget, $NO_CLASS_INIT, ::com::sun::org::apache::xerces::internal::impl::xpath::regex::RegularExpression$ExpressionTarget)
public:
	RegularExpression$CharArrayTarget();
	void init$($chars* target);
	...
	void resetTarget($chars* target);
	$chars* target = nullptr;
};
...
#endif // _com_sun_org_apache_xerces_internal_impl_xpath_regex_RegularExpression$CharArrayTarget_h_