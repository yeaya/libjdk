...
void SAX2RTFDTM::init$($DTMManager* mgr, $Source* source, int32_t dtmIdentity, $DTMWSFilter* whiteSpaceFilter, $XMLStringFactory* xstringfactory, bool doIndexing) {
	...
	this->m_emptyNSDeclSetCount = (this->m_namespaceDeclSets == nullptr) ? 0 : this->m_namespaceDeclSets->size();
	this->m_emptyNSDeclSetElemsCount = (this->m_namespaceDeclSetElements == nullptr) ? 0 : this->m_namespaceDeclSetElements->size();
...
void SAX2RTFDTM::pushRewindMark() {
	...
	$nc(this->mark_nsdeclset_size)->push((this->m_namespaceDeclSets == nullptr) ? 0 : this->m_namespaceDeclSets->size());
	$nc(this->mark_nsdeclelem_size)->push((this->m_namespaceDeclSetElements == nullptr) ? 0 : this->m_namespaceDeclSetElements->size());
...
$Class* SAX2RTFDTM::load$($String* name, bool initialize) {
	...
	$loadClass(SAX2RTFDTM, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
