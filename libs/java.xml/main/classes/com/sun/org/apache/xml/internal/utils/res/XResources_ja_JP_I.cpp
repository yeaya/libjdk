...
$ClassInfo _XResources_ja_JP_I_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"com.sun.org.apache.xml.internal.utils.res.XResources_ja_JP_I",
	"com.sun.org.apache.xml.internal.utils.res.XResourceBundle",
	nullptr,
	_XResources_ja_JP_I_FieldInfo_,
	_XResources_ja_JP_I_MethodInfo_
};

$Object* allocate$XResources_ja_JP_I($Class* clazz) {
	return $of($alloc(XResources_ja_JP_I));
}
...
void clinit$XResources_ja_JP_I($Class* class$) {
...
$Class* XResources_ja_JP_I::load$($String* name, bool initialize) {
	$loadClass(XResources_ja_JP_I, name, initialize, &_XResources_ja_JP_I_ClassInfo_, clinit$XResources_ja_JP_I, allocate$XResources_ja_JP_I);
	return class$;
}
