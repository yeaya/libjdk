...
void XPath$Tokens::init$($SymbolTable* symbolTable) {
	...
	for (int32_t i = 0; i < symbols->length; ++i) {
		$var($Object, var$0, $nc(this->fSymbolTable)->addSymbol(symbols->get(i)));
		this->fSymbolMapping->put(var$0, $($Integer::valueOf(i)));
	}
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_OPEN_PAREN)), "EXPRTOKEN_OPEN_PAREN"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_CLOSE_PAREN)), "EXPRTOKEN_CLOSE_PAREN"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_OPEN_BRACKET)), "EXPRTOKEN_OPEN_BRACKET"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_CLOSE_BRACKET)), "EXPRTOKEN_CLOSE_BRACKET"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_PERIOD)), "EXPRTOKEN_PERIOD"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_DOUBLE_PERIOD)), "EXPRTOKEN_DOUBLE_PERIOD"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_ATSIGN)), "EXPRTOKEN_ATSIGN"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_COMMA)), "EXPRTOKEN_COMMA"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_DOUBLE_COLON)), "EXPRTOKEN_DOUBLE_COLON"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_NAMETEST_ANY)), "EXPRTOKEN_NAMETEST_ANY"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_NAMETEST_NAMESPACE)), "EXPRTOKEN_NAMETEST_NAMESPACE"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_NAMETEST_QNAME)), "EXPRTOKEN_NAMETEST_QNAME"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_NODETYPE_COMMENT)), "EXPRTOKEN_NODETYPE_COMMENT"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_NODETYPE_TEXT)), "EXPRTOKEN_NODETYPE_TEXT"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_NODETYPE_PI)), "EXPRTOKEN_NODETYPE_PI"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_NODETYPE_NODE)), "EXPRTOKEN_NODETYPE_NODE"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_OPERATOR_AND)), "EXPRTOKEN_OPERATOR_AND"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_OPERATOR_OR)), "EXPRTOKEN_OPERATOR_OR"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_OPERATOR_MOD)), "EXPRTOKEN_OPERATOR_MOD"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_OPERATOR_DIV)), "EXPRTOKEN_OPERATOR_DIV"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_OPERATOR_MULT)), "EXPRTOKEN_OPERATOR_MULT"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_OPERATOR_SLASH)), "EXPRTOKEN_OPERATOR_SLASH"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_OPERATOR_DOUBLE_SLASH)), "EXPRTOKEN_OPERATOR_DOUBLE_SLASH"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_OPERATOR_UNION)), "EXPRTOKEN_OPERATOR_UNION"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_OPERATOR_PLUS)), "EXPRTOKEN_OPERATOR_PLUS"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_OPERATOR_MINUS)), "EXPRTOKEN_OPERATOR_MINUS"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_OPERATOR_EQUAL)), "EXPRTOKEN_OPERATOR_EQUAL"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_OPERATOR_NOT_EQUAL)), "EXPRTOKEN_OPERATOR_NOT_EQUAL"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_OPERATOR_LESS)), "EXPRTOKEN_OPERATOR_LESS"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_OPERATOR_LESS_EQUAL)), "EXPRTOKEN_OPERATOR_LESS_EQUAL"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_OPERATOR_GREATER)), "EXPRTOKEN_OPERATOR_GREATER"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_OPERATOR_GREATER_EQUAL)), "EXPRTOKEN_OPERATOR_GREATER_EQUAL"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_FUNCTION_NAME)), "EXPRTOKEN_FUNCTION_NAME"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_AXISNAME_ANCESTOR)), "EXPRTOKEN_AXISNAME_ANCESTOR"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_AXISNAME_ANCESTOR_OR_SELF)), "EXPRTOKEN_AXISNAME_ANCESTOR_OR_SELF"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_AXISNAME_ATTRIBUTE)), "EXPRTOKEN_AXISNAME_ATTRIBUTE"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_AXISNAME_CHILD)), "EXPRTOKEN_AXISNAME_CHILD"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_AXISNAME_DESCENDANT)), "EXPRTOKEN_AXISNAME_DESCENDANT"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_AXISNAME_DESCENDANT_OR_SELF)), "EXPRTOKEN_AXISNAME_DESCENDANT_OR_SELF"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_AXISNAME_FOLLOWING)), "EXPRTOKEN_AXISNAME_FOLLOWING"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_AXISNAME_FOLLOWING_SIBLING)), "EXPRTOKEN_AXISNAME_FOLLOWING_SIBLING"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_AXISNAME_NAMESPACE)), "EXPRTOKEN_AXISNAME_NAMESPACE"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_AXISNAME_PARENT)), "EXPRTOKEN_AXISNAME_PARENT"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_AXISNAME_PRECEDING)), "EXPRTOKEN_AXISNAME_PRECEDING"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_AXISNAME_PRECEDING_SIBLING)), "EXPRTOKEN_AXISNAME_PRECEDING_SIBLING"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_AXISNAME_SELF)), "EXPRTOKEN_AXISNAME_SELF"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_LITERAL)), "EXPRTOKEN_LITERAL"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_NUMBER)), "EXPRTOKEN_NUMBER"_s);
	this->fTokenNames->put($($Integer::valueOf(XPath$Tokens::EXPRTOKEN_VARIABLE_REFERENCE)), "EXPRTOKEN_VARIABLE_REFERENCE"_s);
}

$String* XPath$Tokens::getTokenString(int32_t token) {
	return $cast($String, this->fTokenNames->get($($Integer::valueOf(token))));
}
...
void XPath$Tokens::addToken($String* tokenStr) {
	...
	{
		$var($Iterator, i$, $$nc(this->fTokenNames->entrySet())->iterator());
		for (; $nc(i$)->hasNext();) {
			$var($Map$Entry, entry, $cast($Map$Entry, i$->next()));
			if ($$sure($String, $nc(entry)->getValue())->equals(tokenStr)) {
...
void XPath$Tokens::dumpTokens() {
	...
	for (int32_t i = 0; i < this->fTokenCount; ++i) {
		...
		case XPath$Tokens::EXPRTOKEN_NAMETEST_NAMESPACE:
			...
			$System::out->print($$str({" prefix=\""_s, $(getTokenString(this->fTokens->get(++i))), "\""_s}));
			$System::out->print("/>"_s);
			break;
		case XPath$Tokens::EXPRTOKEN_NAMETEST_QNAME:
			...
			$System::out->print($$str({" localpart=\""_s, $(getTokenString($nc(this->fTokens)->get(++i))), "\""_s}));
			$System::out->print("/>"_s);
			break;
		...
		case XPath$Tokens::EXPRTOKEN_LITERAL:
			...
			$System::out->print($$str({" value=\""_s, $(getTokenString($nc(this->fTokens)->get(++i))), "\""_s}));
			$System::out->print("/>"_s);
			break;
		case XPath$Tokens::EXPRTOKEN_NUMBER:
			$nc($System::out)->print("<NUMBER"_s);
			$System::out->print($$str({" whole=\""_s, $(getTokenString($nc(this->fTokens)->get(++i))), "\""_s}));
			$System::out->print($$str({" part=\""_s, $(getTokenString($nc(this->fTokens)->get(++i))), "\""_s}));
			$System::out->print("/>"_s);
			break;
...
void XPath$Tokens::clinit$($Class* clazz) {
...
$Class* XPath$Tokens::load$($String* name, bool initialize) {
	...
	$loadClass(XPath$Tokens, name, initialize, &classInfo$$, XPath$Tokens::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(XPath$Tokens);
	});
	return class$;
}
