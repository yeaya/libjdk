#ifndef _com_sun_org_apache_xerces_internal_impl_dv_util_ByteListImpl_h_
#define _com_sun_org_apache_xerces_internal_impl_dv_util_ByteListImpl_h_
//$ class com.sun.org.apache.xerces.internal.impl.dv.util.ByteListImpl
//$ extends java.util.AbstractList
//$ implements com.sun.org.apache.xerces.internal.xs.datatypes.ByteList
...
class ByteListImpl : public ::java::util::AbstractList, public ::com::sun::org::apache::xerces::internal::xs::datatypes::ByteList {
	$class(ByteListImpl, $NO_CLASS_INIT, ::java::util::AbstractList, ::com::sun::org::apache::xerces::internal::xs::datatypes::ByteList)
public:
	ByteListImpl();
	...
	virtual bool contains(int8_t item) override;
	virtual $Object* get(int32_t index) override;
	virtual int32_t getLength() override;
	virtual bool isEmpty() override;
	virtual int8_t item(int32_t index) override;
...
#endif // _com_sun_org_apache_xerces_internal_impl_dv_util_ByteListImpl_h_