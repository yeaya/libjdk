#ifndef _com_sun_org_apache_xerces_internal_dom_DeferredAttrNSImpl_h_
#define _com_sun_org_apache_xerces_internal_dom_DeferredAttrNSImpl_h_
//$ class com.sun.org.apache.xerces.internal.dom.DeferredAttrNSImpl
...
class DeferredAttrNSImpl : public ::com::sun::org::apache::xerces::internal::dom::AttrNSImpl, public ::com::sun::org::apache::xerces::internal::dom::DeferredNode {
	$class(DeferredAttrNSImpl, $NO_CLASS_INIT, ::com::sun::org::apache::xerces::internal::dom::AttrNSImpl, ::com::sun::org::apache::xerces::internal::dom::DeferredNode)
public:
	DeferredAttrNSImpl();
	using ::com::sun::org::apache::xerces::internal::dom::AttrNSImpl::getTextContent;
	using ::com::sun::org::apache::xerces::internal::dom::AttrNSImpl::getUserData;
	...
	using ::com::sun::org::apache::xerces::internal::dom::AttrNSImpl::setUserData;
...
#endif // _com_sun_org_apache_xerces_internal_dom_DeferredAttrNSImpl_h_