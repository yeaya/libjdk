#ifndef _com_sun_org_apache_xerces_internal_parsers_AbstractSAXParser$AttributesProxy_h_
#define _com_sun_org_apache_xerces_internal_parsers_AbstractSAXParser$AttributesProxy_h_
//$ class com.sun.org.apache.xerces.internal.parsers.AbstractSAXParser$AttributesProxy
...
class AbstractSAXParser$AttributesProxy : public ::org::xml::sax::AttributeList, public ::org::xml::sax::ext::Attributes2 {
	$class(AbstractSAXParser$AttributesProxy, $NO_CLASS_INIT, ::org::xml::sax::AttributeList, ::org::xml::sax::ext::Attributes2)
public:
...
#endif // _com_sun_org_apache_xerces_internal_parsers_AbstractSAXParser$AttributesProxy_h_