#ifndef _com_sun_org_apache_xerces_internal_impl_xs_util_StringListImpl_h_
#define _com_sun_org_apache_xerces_internal_impl_xs_util_StringListImpl_h_
//$ class com.sun.org.apache.xerces.internal.impl.xs.util.StringListImpl
...
class StringListImpl : public ::java::util::AbstractList, public ::com::sun::org::apache::xerces::internal::xs::StringList {
	$class(StringListImpl, 0, ::java::util::AbstractList, ::com::sun::org::apache::xerces::internal::xs::StringList)
public:
	StringListImpl();
	...
	void init$(::java::util::List* v);
	void init$($StringArray* array, int32_t length);
	...
	static ::com::sun::org::apache::xerces::internal::impl::xs::util::StringListImpl* EMPTY_LIST;
	$StringArray* fArray = nullptr;
	int32_t fLength = 0;
	::java::util::List* fVector = nullptr;
};
...
#endif // _com_sun_org_apache_xerces_internal_impl_xs_util_StringListImpl_h_