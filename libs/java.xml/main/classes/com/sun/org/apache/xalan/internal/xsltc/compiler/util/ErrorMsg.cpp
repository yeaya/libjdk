...
void ErrorMsg::clinit$($Class* clazz) {
...
$Class* ErrorMsg::load$($String* name, bool initialize) {
	...
	$loadClass(ErrorMsg, name, initialize, &classInfo$$, ErrorMsg::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(ErrorMsg);
	});
	return class$;
}
