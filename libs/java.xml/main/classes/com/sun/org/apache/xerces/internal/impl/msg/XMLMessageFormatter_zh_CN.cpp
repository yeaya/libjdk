...
void XMLMessageFormatter_zh_CN::clinit$($Class* clazz) {
...
$Class* XMLMessageFormatter_zh_CN::load$($String* name, bool initialize) {
	...
	$loadClass(XMLMessageFormatter_zh_CN, name, initialize, &classInfo$$, XMLMessageFormatter_zh_CN::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(XMLMessageFormatter_zh_CN);
	});
	return class$;
}
