...
void XMLMessageFormatter_es::clinit$($Class* clazz) {
...
$Class* XMLMessageFormatter_es::load$($String* name, bool initialize) {
	...
	$loadClass(XMLMessageFormatter_es, name, initialize, &classInfo$$, XMLMessageFormatter_es::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(XMLMessageFormatter_es);
	});
	return class$;
}
