...
class $import NodeSet : public ::org::w3c::dom::NodeList, public ::org::w3c::dom::traversal::NodeIterator, public ::java::lang::Cloneable, public ::com::sun::org::apache::xpath::internal::axes::ContextNodeList {
