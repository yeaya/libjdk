...
class $import CatalogResolver : public ::org::xml::sax::EntityResolver, public ::javax::xml::stream::XMLResolver, public ::javax::xml::transform::URIResolver, public ::org::w3c::dom::ls::LSResourceResolver {
