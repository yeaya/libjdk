...
/*
 * Class:     sun_management_ThreadImpl
 * Method:    getThreadAllocatedMemory0
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_sun_management_ThreadImpl_getThreadAllocatedMemory0
  (JNIEnv *, jclass, jlong);
 ...
 * Class:     sun_management_ThreadImpl
 * Method:    dumpThreads0
 * Signature: ([JZZI)[Ljava/lang/management/ThreadInfo;
 */
JNIEXPORT jobjectArray JNICALL Java_sun_management_ThreadImpl_dumpThreads0
  (JNIEnv *, jclass, jlongArray, jboolean, jboolean, jint);
