#ifndef _java_lang_management_DefaultPlatformMBeanProvider$1_h_
#define _java_lang_management_DefaultPlatformMBeanProvider$1_h_
//$ class java.lang.management.DefaultPlatformMBeanProvider$1
...
class DefaultPlatformMBeanProvider$1 : public ::sun::management::spi::PlatformMBeanProvider$PlatformComponent {
	$class(DefaultPlatformMBeanProvider$1, $NO_CLASS_INIT, ::sun::management::spi::PlatformMBeanProvider$PlatformComponent)
public:
	...
	::java::util::Set* classLoadingInterfaceNames = nullptr;
};
...
#endif // _java_lang_management_DefaultPlatformMBeanProvider$1_h_