...
$MethodInfo _MBeanServerAccessController_MethodInfo_[] = {
	...
	{"deserialize", "(Ljavax/management/ObjectName;[B)Ljava/io/ObjectInputStream;", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(MBeanServerAccessController, deserialize, $ObjectInputStream*, $ObjectName*, $bytes*), "javax.management.InstanceNotFoundException,javax.management.OperationsException", nullptr, _MBeanServerAccessController_MethodAnnotations_deserialize13},
	{"deserialize", "(Ljava/lang/String;[B)Ljava/io/ObjectInputStream;", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(MBeanServerAccessController, deserialize, $ObjectInputStream*, $String*, $bytes*), "javax.management.OperationsException,javax.management.ReflectionException", nullptr, _MBeanServerAccessController_MethodAnnotations_deserialize14},
	{"deserialize", "(Ljava/lang/String;Ljavax/management/ObjectName;[B)Ljava/io/ObjectInputStream;", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(MBeanServerAccessController, deserialize, $ObjectInputStream*, $String*, $ObjectName*, $bytes*), "javax.management.InstanceNotFoundException,javax.management.OperationsException,javax.management.ReflectionException", nullptr, _MBeanServerAccessController_MethodAnnotations_deserialize15},
