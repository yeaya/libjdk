...
$Object* ArrayNotificationBuffer$3::run() {
	return $nc(this->this$0->mBeanServer)->queryNames(this->val$name, this->val$query);
}
...
$Class* ArrayNotificationBuffer$3::load$($String* name, bool initialize) {
	...
	$loadClass(ArrayNotificationBuffer$3, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(ArrayNotificationBuffer$3);
	});
	return class$;
}
