...
void BaseOperatingSystemImpl::clinit$($Class* clazz) {
...
$Class* BaseOperatingSystemImpl::load$($String* name, bool initialize) {
	...
	$loadClass(BaseOperatingSystemImpl, name, initialize, &classInfo$$, BaseOperatingSystemImpl::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(BaseOperatingSystemImpl);
	});
	return class$;
}
