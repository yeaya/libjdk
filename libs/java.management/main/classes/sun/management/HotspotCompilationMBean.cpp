...
$Class* HotspotCompilationMBean::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"getCompilerThreadStats", "()Ljava/util/List;", "()Ljava/util/List<Lsun/management/CompilerThreadStat;>;", $PUBLIC | $ABSTRACT | $DEPRECATED, $virtualMethod(HotspotCompilationMBean, getCompilerThreadStats, $List*), nullptr, nullptr, getCompilerThreadStatsmethodAnnotations$$},
	...
	$loadClass(HotspotCompilationMBean, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(HotspotCompilationMBean);
	});
	return class$;
}
