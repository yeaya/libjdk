...
$Class* MBeanServer::load$($String* name, bool initialize) {
	$NamedAttribute deserializemethodAnnotations$$$namedAttribute[] = {
		{"since", 's', "1.5"},
		{}
	};
	$CompoundAttribute deserializemethodAnnotations$$[] = {
		{"Ljava/lang/Deprecated;", deserializemethodAnnotations$$$namedAttribute},
		{}
	};
	$NamedAttribute deserializemethodAnnotations$$$1$namedAttribute[] = {
		{"since", 's', "1.5"},
		{}
	};
	$CompoundAttribute deserializemethodAnnotations$$$1[] = {
		{"Ljava/lang/Deprecated;", deserializemethodAnnotations$$$1$namedAttribute},
		{}
	};
	$NamedAttribute deserializemethodAnnotations$$$2$namedAttribute[] = {
		{"since", 's', "1.5"},
		{}
	};
	$CompoundAttribute deserializemethodAnnotations$$$2[] = {
		{"Ljava/lang/Deprecated;", deserializemethodAnnotations$$$2$namedAttribute},
		{}
	};
	$MethodInfo methodInfos$$[] = {
		...
		{"deserialize", "(Ljavax/management/ObjectName;[B)Ljava/io/ObjectInputStream;", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(MBeanServer, deserialize, $ObjectInputStream*, $ObjectName*, $bytes*), "javax.management.InstanceNotFoundException,javax.management.OperationsException", nullptr, deserializemethodAnnotations$$},
		{"deserialize", "(Ljava/lang/String;[B)Ljava/io/ObjectInputStream;", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(MBeanServer, deserialize, $ObjectInputStream*, $String*, $bytes*), "javax.management.OperationsException,javax.management.ReflectionException", nullptr, deserializemethodAnnotations$$$1},
		{"deserialize", "(Ljava/lang/String;Ljavax/management/ObjectName;[B)Ljava/io/ObjectInputStream;", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(MBeanServer, deserialize, $ObjectInputStream*, $String*, $ObjectName*, $bytes*), "javax.management.InstanceNotFoundException,javax.management.OperationsException,javax.management.ReflectionException", nullptr, deserializemethodAnnotations$$$2},
	...
	$loadClass(MBeanServer, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(MBeanServer);
	});
	return class$;
}
