...
$Class* CachedRowSet::load$($String* name, bool initialize) {
	$CompoundAttribute COMMIT_ON_ACCEPT_CHANGESfieldAnnotations$$[] = {
		{"Ljava/lang/Deprecated;", nullptr},
		{}
	};
	$FieldInfo fieldInfos$$[] = {
		{"COMMIT_ON_ACCEPT_CHANGES", "Z", nullptr, $PUBLIC | $STATIC | $FINAL | $DEPRECATED, $constField(CachedRowSet, COMMIT_ON_ACCEPT_CHANGES), COMMIT_ON_ACCEPT_CHANGESfieldAnnotations$$},
		{}
	};
	...
	$loadClass(CachedRowSet, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
