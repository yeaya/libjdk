# libjdk - Java SQL RowSet Library
...
This project provides a complete C++ implementation of Java's SQL RowSet functionality, including:

- RowSet interfaces and implementations
- JDBC RowSet factories
- Support for database connectivity and query execution
- Integration with Java's existing SQL APIs