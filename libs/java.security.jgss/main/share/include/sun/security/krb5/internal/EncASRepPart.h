#ifndef _sun_security_krb5_internal_EncASRepPart_h_
#define _sun_security_krb5_internal_EncASRepPart_h_
//$ class sun.security.krb5.internal.EncASRepPart
...
class $import EncASRepPart : public ::sun::security::krb5::internal::EncKDCRepPart {
	$class(EncASRepPart, $NO_CLASS_INIT, ::sun::security::krb5::internal::EncKDCRepPart)
public:
	EncASRepPart();
...
#endif // _sun_security_krb5_internal_EncASRepPart_h_