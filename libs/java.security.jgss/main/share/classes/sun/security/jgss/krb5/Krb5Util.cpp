...
$Credentials* Krb5Util::ticketToCreds($KerberosTicket* kerbTicket) {
	...
	$var($String, var$2, clientAlias != nullptr ? clientAlias->getName() : ($String*)nullptr);
	$var($String, var$3, $$nc(kerbTicket->getServer())->getName());
	$var($String, var$4, serverAlias != nullptr ? serverAlias->getName() : ($String*)nullptr);
...
void Krb5Util::clinit$($Class* clazz) {
...
$Class* Krb5Util::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"keysFromJavaxKeyTab", "(Ljavax/security/auth/kerberos/KeyTab;Lsun/security/krb5/PrincipalName;)[Lsun/security/krb5/EncryptionKey;", nullptr, $PUBLIC | $STATIC, $staticMethod(Krb5Util, keysFromJavaxKeyTab, $EncryptionKeyArray*, $1KeyTab*, $PrincipalName*)},
		{"snapshotFromJavaxKeyTab", "(Ljavax/security/auth/kerberos/KeyTab;)Lsun/security/krb5/internal/ktab/KeyTab;", nullptr, $PUBLIC | $STATIC, $staticMethod(Krb5Util, snapshotFromJavaxKeyTab, $KeyTab*, $1KeyTab*)},
	...
	$loadClass(Krb5Util, name, initialize, &classInfo$$, Krb5Util::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(Krb5Util);
	});
	return class$;
}
