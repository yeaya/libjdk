#ifndef _sun_security_krb5_internal_crypto_Aes256_h_
#define _sun_security_krb5_internal_crypto_Aes256_h_
//$ class sun.security.krb5.internal.crypto.Aes256
...
class Aes256 : public ::java::lang::Object {
	$class(Aes256, 0, ::java::lang::Object)
public:
	Aes256();
	void init$();
...
#endif // _sun_security_krb5_internal_crypto_Aes256_h_