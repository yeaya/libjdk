...
void CredentialsUtil$S4U2Type::clinit$($Class* clazz) {
...
$Class* CredentialsUtil$S4U2Type::load$($String* name, bool initialize) {
	...
	$loadClass(CredentialsUtil$S4U2Type, name, initialize, &classInfo$$, CredentialsUtil$S4U2Type::clinit$, []($Class* clazz) -> $Object* {
