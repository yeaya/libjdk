#ifndef _sun_security_krb5_internal_crypto_RsaMd5CksumType_h_
#define _sun_security_krb5_internal_crypto_RsaMd5CksumType_h_
//$ class sun.security.krb5.internal.crypto.RsaMd5CksumType
...
class RsaMd5CksumType : public ::sun::security::krb5::internal::crypto::CksumType {
	$class(RsaMd5CksumType, $NO_CLASS_INIT, ::sun::security::krb5::internal::crypto::CksumType)
public:
	RsaMd5CksumType();
	void init$();
...
#endif // _sun_security_krb5_internal_crypto_RsaMd5CksumType_h_