#ifndef _sun_security_krb5_internal_crypto_DesMacCksumType_h_
#define _sun_security_krb5_internal_crypto_DesMacCksumType_h_
//$ class sun.security.krb5.internal.crypto.DesMacCksumType
...
class DesMacCksumType : public ::sun::security::krb5::internal::crypto::CksumType {
	$class(DesMacCksumType, $NO_CLASS_INIT, ::sun::security::krb5::internal::crypto::CksumType)
public:
	DesMacCksumType();
	void init$();
...
#endif // _sun_security_krb5_internal_crypto_DesMacCksumType_h_