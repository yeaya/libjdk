#ifndef _sun_security_krb5_internal_crypto_DesMacKCksumType_h_
#define _sun_security_krb5_internal_crypto_DesMacKCksumType_h_
//$ class sun.security.krb5.internal.crypto.DesMacKCksumType
...
class DesMacKCksumType : public ::sun::security::krb5::internal::crypto::CksumType {
	$class(DesMacKCksumType, $NO_CLASS_INIT, ::sun::security::krb5::internal::crypto::CksumType)
public:
	DesMacKCksumType();
	void init$();
...
#endif // _sun_security_krb5_internal_crypto_DesMacKCksumType_h_