#ifndef _sun_security_krb5_internal_crypto_Aes128CtsHmacSha2EType_h_
#define _sun_security_krb5_internal_crypto_Aes128CtsHmacSha2EType_h_
//$ class sun.security.krb5.internal.crypto.Aes128CtsHmacSha2EType
...
class Aes128CtsHmacSha2EType : public ::sun::security::krb5::internal::crypto::EType {
	$class(Aes128CtsHmacSha2EType, $NO_CLASS_INIT, ::sun::security::krb5::internal::crypto::EType)
public:
	Aes128CtsHmacSha2EType();
	void init$();
...
#endif // _sun_security_krb5_internal_crypto_Aes128CtsHmacSha2EType_h_