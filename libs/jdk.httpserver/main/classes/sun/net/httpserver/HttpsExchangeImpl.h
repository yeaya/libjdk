#ifndef _sun_net_httpserver_HttpsExchangeImpl_h_
#define _sun_net_httpserver_HttpsExchangeImpl_h_
//$ class sun.net.httpserver.HttpsExchangeImpl
...
class HttpsExchangeImpl : public ::com::sun::net::httpserver::HttpsExchange {
	$class(HttpsExchangeImpl, $NO_CLASS_INIT, ::com::sun::net::httpserver::HttpsExchange)
public:
	HttpsExchangeImpl();
	...
	virtual ::javax::net::ssl::SSLSession* getSSLSession() override;
...
#endif // _sun_net_httpserver_HttpsExchangeImpl_h_