#ifndef _org_jcp_xml_dsig_internal_dom_DOMSignatureMethod$SHA256withECDSA_h_
#define _org_jcp_xml_dsig_internal_dom_DOMSignatureMethod$SHA256withECDSA_h_
//$ class org.jcp.xml.dsig.internal.dom.DOMSignatureMethod$SHA256withECDSA
...
class DOMSignatureMethod$SHA256withECDSA : public ::org::jcp::xml::dsig::internal::dom::DOMSignatureMethod$AbstractECDSASignatureMethod {
	$class(DOMSignatureMethod$SHA256withECDSA, $NO_CLASS_INIT, ::org::jcp::xml::dsig::internal::dom::DOMSignatureMethod$AbstractECDSASignatureMethod)
public:
...
#endif // _org_jcp_xml_dsig_internal_dom_DOMSignatureMethod$SHA256withECDSA_h_