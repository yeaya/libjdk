#ifndef _org_jcp_xml_dsig_internal_dom_DOMSignatureMethod$SHA224withECDSA_h_
#define _org_jcp_xml_dsig_internal_dom_DOMSignatureMethod$SHA224withECDSA_h_
//$ class org.jcp.xml.dsig.internal.dom.DOMSignatureMethod$SHA224withECDSA
...
class DOMSignatureMethod$SHA224withECDSA : public ::org::jcp::xml::dsig::internal::dom::DOMSignatureMethod$AbstractECDSASignatureMethod {
	$class(DOMSignatureMethod$SHA224withECDSA, $NO_CLASS_INIT, ::org::jcp::xml::dsig::internal::dom::DOMSignatureMethod$AbstractECDSASignatureMethod)
public:
...
#endif // _org_jcp_xml_dsig_internal_dom_DOMSignatureMethod$SHA224withECDSA_h_