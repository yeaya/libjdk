#ifndef _org_jcp_xml_dsig_internal_dom_DOMSignatureMethod$SHA256withRSA_h_
#define _org_jcp_xml_dsig_internal_dom_DOMSignatureMethod$SHA256withRSA_h_
...
class DOMSignatureMethod$SHA256withRSA : public ::org::jcp::xml::dsig::internal::dom::DOMSignatureMethod$AbstractRSASignatureMethod {
	$class(DOMSignatureMethod$SHA256withRSA, $NO_CLASS_INIT, ::org::jcp::xml::dsig::internal::dom::DOMSignatureMethod$AbstractRSASignatureMethod)
public:
...
#endif // _org_jcp_xml_dsig_internal_dom_DOMSignatureMethod$SHA256withRSA_h_