#ifndef _org_jcp_xml_dsig_internal_dom_DOMSignatureMethod$SHA512withECDSA_h_
#define _org_jcp_xml_dsig_internal_dom_DOMSignatureMethod$SHA512withECDSA_h_
//$ class org.jcp.xml.dsig.internal.dom.DOMSignatureMethod$SHA512withECDSA
...
class DOMSignatureMethod$SHA512withECDSA : public ::org::jcp::xml::dsig::internal::dom::DOMSignatureMethod$AbstractECDSASignatureMethod {
	$class(DOMSignatureMethod$SHA512withECDSA, $NO_CLASS_INIT, ::org::jcp::xml::dsig::internal::dom::DOMSignatureMethod$AbstractECDSASignatureMethod)
public:
...
#endif // _org_jcp_xml_dsig_internal_dom_DOMSignatureMethod$SHA512withECDSA_h_