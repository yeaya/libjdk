...
void DOMSignatureMethod$SHA512withRSAandMGF1::clinit$($Class* clazz) {
...
$Class* DOMSignatureMethod$SHA512withRSAandMGF1::load$($String* name, bool initialize) {
	...
	$loadClass(DOMSignatureMethod$SHA512withRSAandMGF1, name, initialize, &classInfo$$, DOMSignatureMethod$SHA512withRSAandMGF1::clinit$, []($Class* clazz) -> $Object* {
