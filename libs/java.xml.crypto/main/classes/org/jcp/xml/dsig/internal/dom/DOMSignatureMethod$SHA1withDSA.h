#ifndef _org_jcp_xml_dsig_internal_dom_DOMSignatureMethod$SHA1withDSA_h_
#define _org_jcp_xml_dsig_internal_dom_DOMSignatureMethod$SHA1withDSA_h_
//$ class org.jcp.xml.dsig.internal.dom.DOMSignatureMethod$SHA1withDSA
...
class DOMSignatureMethod$SHA1withDSA : public ::org::jcp::xml::dsig::internal::dom::DOMSignatureMethod$AbstractDSASignatureMethod {
	$class(DOMSignatureMethod$SHA1withDSA, $NO_CLASS_INIT, ::org::jcp::xml::dsig::internal::dom::DOMSignatureMethod$AbstractDSASignatureMethod)
public:
...
#endif // _org_jcp_xml_dsig_internal_dom_DOMSignatureMethod$SHA1withDSA_h_