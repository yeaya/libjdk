#ifndef _org_jcp_xml_dsig_internal_dom_DOMSignatureMethod$SHA1withRSAandMGF1_h_
#define _org_jcp_xml_dsig_internal_dom_DOMSignatureMethod$SHA1withRSAandMGF1_h_
//$ class org.jcp.xml.dsig.internal.dom.DOMSignatureMethod$SHA1withRSAandMGF1
...
class DOMSignatureMethod$SHA1withRSAandMGF1 : public ::org::jcp::xml::dsig::internal::dom::DOMSignatureMethod$AbstractRSAPSSSignatureMethod {
	$class(DOMSignatureMethod$SHA1withRSAandMGF1, 0, ::org::jcp::xml::dsig::internal::dom::DOMSignatureMethod$AbstractRSAPSSSignatureMethod)
public:
...
#endif // _org_jcp_xml_dsig_internal_dom_DOMSignatureMethod$SHA1withRSAandMGF1_h_