...
void DOMSignatureMethod$SHA1withRSAandMGF1::clinit$($Class* clazz) {
...
$Class* DOMSignatureMethod$SHA1withRSAandMGF1::load$($String* name, bool initialize) {
	...
	$loadClass(DOMSignatureMethod$SHA1withRSAandMGF1, name, initialize, &classInfo$$, DOMSignatureMethod$SHA1withRSAandMGF1::clinit$, []($Class* clazz) -> $Object* {
