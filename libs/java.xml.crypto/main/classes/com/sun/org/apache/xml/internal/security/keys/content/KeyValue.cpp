...
void KeyValue::init$($Document* doc, $PublicKey* pk) {
	...
	if ($instanceOf($DSAPublicKey, pk)) {
		$var($DSAKeyValue, dsa, $new($DSAKeyValue, $(getDocument()), pk));
		appendSelf(dsa);
		addReturnToSelf();
	} else if ($instanceOf($RSAPublicKey, pk)) {
		$var($RSAKeyValue, rsa, $new($RSAKeyValue, $(getDocument()), pk));
		appendSelf(rsa);
		addReturnToSelf();
	} else if ($instanceOf($ECPublicKey, pk)) {
		$var($ECKeyValue, ec, $new($ECKeyValue, $(getDocument()), pk));
		appendSelf(ec);
		addReturnToSelf();
	} else {
...
$Class* KeyValue::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		...
		{"<init>", "(Lorg/w3c/dom/Document;Lcom/sun/org/apache/xml/internal/security/keys/content/keyvalues/DSAKeyValue;)V", nullptr, $PUBLIC, $method(KeyValue, init$, void, $Document*, $DSAKeyValue*)},
		{"<init>", "(Lorg/w3c/dom/Document;Lcom/sun/org/apache/xml/internal/security/keys/content/keyvalues/RSAKeyValue;)V", nullptr, $PUBLIC, $method(KeyValue, init$, void, $Document*, $RSAKeyValue*)},
		{"<init>", "(Lorg/w3c/dom/Document;Lorg/w3c/dom/Element;)V", nullptr, $PUBLIC, $method(KeyValue, init$, void, $Document*, $Element*)},
		{"<init>", "(Lorg/w3c/dom/Document;Ljava/security/PublicKey;)V", nullptr, $PUBLIC, $method(KeyValue, init$, void, $Document*, $PublicKey*)},
		{"<init>", "(Lorg/w3c/dom/Element;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(KeyValue, init$, void, $Element*, $String*), "com.sun.org.apache.xml.internal.security.exceptions.XMLSecurityException"},
		{"getBaseLocalName", "()Ljava/lang/String;", nullptr, $PUBLIC, $virtualMethod(KeyValue, getBaseLocalName, $String*)},
		{"getPublicKey", "()Ljava/security/PublicKey;", nullptr, $PUBLIC, $virtualMethod(KeyValue, getPublicKey, $PublicKey*), "com.sun.org.apache.xml.internal.security.exceptions.XMLSecurityException"},
	...
	$loadClass(KeyValue, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
