...
$Class* SignatureBaseRSA$SignatureRSASHA512::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(SignatureBaseRSA$SignatureRSASHA512, init$, void), "com.sun.org.apache.xml.internal.security.signature.XMLSignatureException"},
		{"<init>", "(Ljava/security/Provider;)V", nullptr, $PUBLIC, $method(SignatureBaseRSA$SignatureRSASHA512, init$, void, $Provider*), "com.sun.org.apache.xml.internal.security.signature.XMLSignatureException"},
		{"engineGetURI", "()Ljava/lang/String;", nullptr, $PUBLIC, $virtualMethod(SignatureBaseRSA$SignatureRSASHA512, engineGetURI, $String*)},
		{}
	};
	...
	$loadClass(SignatureBaseRSA$SignatureRSASHA512, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(SignatureBaseRSA$SignatureRSASHA512);
	});
	return class$;
}
