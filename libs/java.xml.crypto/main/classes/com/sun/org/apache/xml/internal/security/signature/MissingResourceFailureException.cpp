...
$MethodInfo _MissingResourceFailureException_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/lang/String;Lcom/sun/org/apache/xml/internal/security/signature/Reference;)V", nullptr, $PUBLIC | $DEPRECATED, $method(MissingResourceFailureException, init$, void, $String*, $Reference*), nullptr, nullptr, _MissingResourceFailureException_MethodAnnotations_init$1},
	...
	{"<init>", "(Ljava/lang/String;[Ljava/lang/Object;Lcom/sun/org/apache/xml/internal/security/signature/Reference;)V", nullptr, $PUBLIC | $DEPRECATED, $method(MissingResourceFailureException, init$, void, $String*, $ObjectArray*, $Reference*), nullptr, nullptr, _MissingResourceFailureException_MethodAnnotations_init$3},
	...
	{"<init>", "(Ljava/lang/String;Ljava/lang/Exception;Lcom/sun/org/apache/xml/internal/security/signature/Reference;)V", nullptr, $PUBLIC | $DEPRECATED, $method(MissingResourceFailureException, init$, void, $String*, $Exception*, $Reference*), nullptr, nullptr, _MissingResourceFailureException_MethodAnnotations_init$5},
	...
	{"<init>", "(Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/Exception;Lcom/sun/org/apache/xml/internal/security/signature/Reference;)V", nullptr, $PUBLIC | $DEPRECATED, $method(MissingResourceFailureException, init$, void, $String*, $ObjectArray*, $Exception*, $Reference*), nullptr, nullptr, _MissingResourceFailureException_MethodAnnotations_init$7},
