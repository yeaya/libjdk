...
$ECKeyValue$Curve* ECKeyValue::initializeCurve($String* name, $String* oid, $String* sfield, $String* a, $String* b, $String* x, $String* y, $String* n, int32_t h) {
	...
	$var($BigInteger, var$0, bigInt(a));
	$var($EllipticCurve, curve, $new($EllipticCurve, field, var$0, $(bigInt(b))));
	$var($BigInteger, var$1, bigInt(x));
	$var($ECPoint, g, $new($ECPoint, var$1, $(bigInt(y))));
...
void ECKeyValue::init$($Document* doc, $Key* key) {
	...
	if ($instanceOf($ECPublicKey, key)) {
		$var($ECParameterSpec, ecParams, $cast($ECPublicKey, key)->getParams());
...
$PublicKey* ECKeyValue::getPublicKey() {
	...
	try {
		...
		$init($Constants);
		if (var$0 && $nc($Constants::SignatureSpec11NS)->equals($(curElem->getNamespaceURI()))) {
			$throwNew($UnsupportedOperationException, "ECParameters not supported"_s);
		} else {
			bool var$1 = "NamedCurve"_s->equals($(curElem->getLocalName()));
			if (var$1 && $nc($Constants::SignatureSpec11NS)->equals($(curElem->getNamespaceURI()))) {
				$var($String, uri, nullptr);
				if (curElem->hasAttributeNS(nullptr, "URI"_s)) {
		...
		try {
			...
			$var($bytes, var$2, $XMLUtils::decode(content));
			$assign(ecPoint, decodePoint(var$2, $($nc(ecParams)->getCurve())));
...
$String* ECKeyValue::getCurveOid($ECParameterSpec* params) {
	...
	} else if (matchCurve(params, ECKeyValue::SECP384R1)) {
		$assign(match, ECKeyValue::SECP384R1);
	} else if (matchCurve(params, ECKeyValue::SECP521R1)) {
...
$ECParameterSpec* ECKeyValue::getECParameterSpec($String* oid) {
	...
	} else if (oid->equals($($nc(ECKeyValue::SECP384R1)->getObjectId()))) {
		return ECKeyValue::SECP384R1;
	} else if (oid->equals($($nc(ECKeyValue::SECP521R1)->getObjectId()))) {
...
void ECKeyValue::clinit$($Class* clazz) {
...
$Class* ECKeyValue::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"<init>", "(Lorg/w3c/dom/Element;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(ECKeyValue, init$, void, $Element*, $String*), "com.sun.org.apache.xml.internal.security.exceptions.XMLSecurityException"},
		{"<init>", "(Lorg/w3c/dom/Document;Ljava/security/Key;)V", nullptr, $PUBLIC, $method(ECKeyValue, init$, void, $Document*, $Key*), "java.lang.IllegalArgumentException"},
		{"bigInt", "(Ljava/lang/String;)Ljava/math/BigInteger;", nullptr, $PRIVATE | $STATIC, $staticMethod(ECKeyValue, bigInt, $BigInteger*, $String*)},
		{"decodePoint", "([BLjava/security/spec/EllipticCurve;)Ljava/security/spec/ECPoint;", nullptr, $PRIVATE | $STATIC, $staticMethod(ECKeyValue, decodePoint, $ECPoint*, $bytes*, $EllipticCurve*), "java.io.IOException"},
		{"encodePoint", "(Ljava/security/spec/ECPoint;Ljava/security/spec/EllipticCurve;)[B", nullptr, $PRIVATE | $STATIC, $staticMethod(ECKeyValue, encodePoint, $bytes*, $ECPoint*, $EllipticCurve*)},
		{"getBaseLocalName", "()Ljava/lang/String;", nullptr, $PUBLIC, $virtualMethod(ECKeyValue, getBaseLocalName, $String*)},
		{"getCurveOid", "(Ljava/security/spec/ECParameterSpec;)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $staticMethod(ECKeyValue, getCurveOid, $String*, $ECParameterSpec*)},
		{"getECParameterSpec", "(Ljava/lang/String;)Ljava/security/spec/ECParameterSpec;", nullptr, $PRIVATE | $STATIC, $staticMethod(ECKeyValue, getECParameterSpec, $ECParameterSpec*, $String*)},
		{"getFirstChildElement", "(Lorg/w3c/dom/Node;)Lorg/w3c/dom/Element;", nullptr, $PRIVATE | $STATIC, $staticMethod(ECKeyValue, getFirstChildElement, $Element*, $Node*)},
		{"getNextSiblingElement", "(Lorg/w3c/dom/Node;Ljava/lang/String;Ljava/lang/String;)Lorg/w3c/dom/Element;", nullptr, $PRIVATE | $STATIC, $staticMethod(ECKeyValue, getNextSiblingElement, $Element*, $Node*, $String*, $String*), "javax.xml.crypto.MarshalException"},
		{"getNextSiblingElement", "(Lorg/w3c/dom/Node;)Lorg/w3c/dom/Element;", nullptr, $PRIVATE | $STATIC, $staticMethod(ECKeyValue, getNextSiblingElement, $Element*, $Node*)},
		{"getPublicKey", "()Ljava/security/PublicKey;", nullptr, $PUBLIC, $virtualMethod(ECKeyValue, getPublicKey, $PublicKey*), "com.sun.org.apache.xml.internal.security.exceptions.XMLSecurityException"},
		{"initializeCurve", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Lcom/sun/org/apache/xml/internal/security/keys/content/keyvalues/ECKeyValue$Curve;", nullptr, $PRIVATE | $STATIC, $staticMethod(ECKeyValue, initializeCurve, $ECKeyValue$Curve*, $String*, $String*, $String*, $String*, $String*, $String*, $String*, $String*, int32_t)},
		{"matchCurve", "(Ljava/security/spec/ECParameterSpec;Lcom/sun/org/apache/xml/internal/security/keys/content/keyvalues/ECKeyValue$Curve;)Z", nullptr, $PRIVATE | $STATIC, $staticMethod(ECKeyValue, matchCurve, bool, $ECParameterSpec*, $ECKeyValue$Curve*)},
		{"*toString", "()Ljava/lang/String;", nullptr, $PUBLIC},
		{"trimZeroes", "([B)[B", nullptr, $PRIVATE | $STATIC, $staticMethod(ECKeyValue, trimZeroes, $bytes*, $bytes*)},
		{"verifyElement", "(Lorg/w3c/dom/Element;Ljava/lang/String;Ljava/lang/String;)Lorg/w3c/dom/Element;", nullptr, $PRIVATE | $STATIC, $staticMethod(ECKeyValue, verifyElement, $Element*, $Element*, $String*, $String*), "javax.xml.crypto.MarshalException"},
		{}
	};
	...
	$loadClass(ECKeyValue, name, initialize, &classInfo$$, ECKeyValue::clinit$, []($Class* clazz) -> $Object* {
