#ifndef _com_sun_org_apache_xml_internal_security_keys_keyresolver_implementations_DSAKeyValueResolver_h_
#define _com_sun_org_apache_xml_internal_security_keys_keyresolver_implementations_DSAKeyValueResolver_h_
//$ class com.sun.org.apache.xml.internal.security.keys.keyresolver.implementations.DSAKeyValueResolver
...
class DSAKeyValueResolver : public ::com::sun::org::apache::xml::internal::security::keys::keyresolver::KeyResolverSpi {
	$class(DSAKeyValueResolver, 0, ::com::sun::org::apache::xml::internal::security::keys::keyresolver::KeyResolverSpi)
public:
	DSAKeyValueResolver();
	void init$();
...
#endif // _com_sun_org_apache_xml_internal_security_keys_keyresolver_implementations_DSAKeyValueResolver_h_