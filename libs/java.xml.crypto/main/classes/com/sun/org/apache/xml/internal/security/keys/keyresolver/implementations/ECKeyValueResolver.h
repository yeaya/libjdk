#ifndef _com_sun_org_apache_xml_internal_security_keys_keyresolver_implementations_ECKeyValueResolver_h_
#define _com_sun_org_apache_xml_internal_security_keys_keyresolver_implementations_ECKeyValueResolver_h_
//$ class com.sun.org.apache.xml.internal.security.keys.keyresolver.implementations.ECKeyValueResolver
...
class ECKeyValueResolver : public ::com::sun::org::apache::xml::internal::security::keys::keyresolver::KeyResolverSpi {
	$class(ECKeyValueResolver, 0, ::com::sun::org::apache::xml::internal::security::keys::keyresolver::KeyResolverSpi)
public:
	ECKeyValueResolver();
	void init$();
...
#endif // _com_sun_org_apache_xml_internal_security_keys_keyresolver_implementations_ECKeyValueResolver_h_