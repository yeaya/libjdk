...
$Class* SignatureBaseRSA$SignatureRSASHA256MGF1::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(SignatureBaseRSA$SignatureRSASHA256MGF1, init$, void), "com.sun.org.apache.xml.internal.security.signature.XMLSignatureException"},
		{"<init>", "(Ljava/security/Provider;)V", nullptr, $PUBLIC, $method(SignatureBaseRSA$SignatureRSASHA256MGF1, init$, void, $Provider*), "com.sun.org.apache.xml.internal.security.signature.XMLSignatureException"},
		{"engineGetURI", "()Ljava/lang/String;", nullptr, $PUBLIC, $virtualMethod(SignatureBaseRSA$SignatureRSASHA256MGF1, engineGetURI, $String*)},
		{}
	};
	...
	$loadClass(SignatureBaseRSA$SignatureRSASHA256MGF1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(SignatureBaseRSA$SignatureRSASHA256MGF1);
	});
	return class$;
}
