#ifndef _com_sun_org_apache_xml_internal_security_keys_keyresolver_implementations_RSAKeyValueResolver_h_
#define _com_sun_org_apache_xml_internal_security_keys_keyresolver_implementations_RSAKeyValueResolver_h_
//$ class com.sun.org.apache.xml.internal.security.keys.keyresolver.implementations.RSAKeyValueResolver
...
class RSAKeyValueResolver : public ::com::sun::org::apache::xml::internal::security::keys::keyresolver::KeyResolverSpi {
	$class(RSAKeyValueResolver, 0, ::com::sun::org::apache::xml::internal::security::keys::keyresolver::KeyResolverSpi)
public:
	RSAKeyValueResolver();
	void init$();
...
#endif // _com_sun_org_apache_xml_internal_security_keys_keyresolver_implementations_RSAKeyValueResolver_h_