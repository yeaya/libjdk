...
void CompositeName::init$($Enumeration* comps) {
	$set(this, impl, $new($NameImpl, nullptr, comps));
}

void CompositeName::init$($String* n) {
	$set(this, impl, $new($NameImpl, nullptr, n));
}
...
bool CompositeName::equals(Object$* obj) {
	return (obj != nullptr && $instanceOf(CompositeName, obj) && $nc(this->impl)->equals($cast(CompositeName, obj)->impl));
}
...
$Class* CompositeName::load$($String* name, bool initialize) {
	...
	$loadClass(CompositeName, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
