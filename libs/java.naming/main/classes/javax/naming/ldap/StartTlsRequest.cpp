...
$Class* StartTlsRequest$$Lambda$getContextClassLoader::load$($String* name, bool initialize) {
	...
	$loadClass(StartTlsRequest$$Lambda$getContextClassLoader, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(StartTlsRequest$$Lambda$getContextClassLoader);
	});
	return class$;
}
...
$Class* StartTlsRequest$$Lambda$hasNext$1::load$($String* name, bool initialize) {
	...
	$loadClass(StartTlsRequest$$Lambda$hasNext$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(StartTlsRequest$$Lambda$hasNext$1);
	});
	return class$;
}
...
$ClassLoader* StartTlsRequest::getContextClassLoader() {
	$useLocalObjectStack();
	$beforeCallerSensitive();
	$var($PrivilegedAction, pa, $new(StartTlsRequest$$Lambda$getContextClassLoader, $($Thread::currentThread())));
...
bool StartTlsRequest::privilegedHasNext($Iterator* iter) {
	...
	$useLocalObjectStack();
	$beforeCallerSensitive();
	$var($PrivilegedAction, pa, $new(StartTlsRequest$$Lambda$hasNext$1, $nc(iter)));
...
$Class* StartTlsRequest::load$($String* name, bool initialize) {
	...
	$loadClass(StartTlsRequest, name, initialize, &classInfo$$, StartTlsRequest::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(StartTlsRequest);
	});
	return class$;
}
