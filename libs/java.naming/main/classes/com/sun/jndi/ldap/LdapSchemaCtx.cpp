...
$Attributes* LdapSchemaCtx::deepClone($Attributes* orig) {
	...
	while ($nc(attrs)->hasMore()) {
		copy->put($$cast($Attribute, $$sure($Attribute, attrs->next())->clone()));
	}
	return copy;
}
...
$Class* LdapSchemaCtx::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "(ILjava/util/Hashtable;Lcom/sun/jndi/ldap/LdapSchemaCtx$SchemaInfo;)V", "(ILjava/util/Hashtable<Ljava/lang/String;Ljava/lang/Object;>;Lcom/sun/jndi/ldap/LdapSchemaCtx$SchemaInfo;)V", $PRIVATE, $method(LdapSchemaCtx, init$, void, int32_t, $Hashtable*, $LdapSchemaCtx$SchemaInfo*)},
		{"addServerSchema", "(Ljavax/naming/directory/Attributes;)V", nullptr, $PRIVATE | $FINAL, $method(LdapSchemaCtx, addServerSchema, void, $Attributes*), "javax.naming.NamingException"},
		{"bind", "(Ljavax/naming/Name;Ljava/lang/Object;Ljavax/naming/directory/Attributes;)V", nullptr, $PUBLIC | $FINAL, $virtualMethod(LdapSchemaCtx, bind, void, $Name*, Object$*, $Attributes*), "javax.naming.NamingException"},
		{"close", "()V", nullptr, $PUBLIC, $virtualMethod(LdapSchemaCtx, close, void), "javax.naming.NamingException"},
		{"createNewCtx", "()Lcom/sun/jndi/toolkit/dir/HierMemDirCtx;", nullptr, $PROTECTED | $FINAL, $virtualMethod(LdapSchemaCtx, createNewCtx, $HierMemDirCtx*)},
		{"createSchemaTree", "(Ljava/util/Hashtable;Ljava/lang/String;Lcom/sun/jndi/ldap/LdapCtx;Ljavax/naming/directory/Attributes;Z)Ljavax/naming/directory/DirContext;", "(Ljava/util/Hashtable<Ljava/lang/String;Ljava/lang/Object;>;Ljava/lang/String;Lcom/sun/jndi/ldap/LdapCtx;Ljavax/naming/directory/Attributes;Z)Ljavax/naming/directory/DirContext;", $STATIC, $staticMethod(LdapSchemaCtx, createSchemaTree, $DirContext*, $Hashtable*, $String*, $LdapCtx*, $Attributes*, bool), "javax.naming.NamingException"},
		{"deepClone", "(Ljavax/naming/directory/Attributes;)Ljavax/naming/directory/Attributes;", nullptr, $PRIVATE | $STATIC | $FINAL, $staticMethod(LdapSchemaCtx, deepClone, $Attributes*, $Attributes*), "javax.naming.NamingException"},
		{"deleteServerSchema", "(Ljavax/naming/directory/Attributes;)V", nullptr, $PRIVATE | $FINAL, $method(LdapSchemaCtx, deleteServerSchema, void, $Attributes*), "javax.naming.NamingException"},
		{"doBind", "(Ljavax/naming/Name;Ljava/lang/Object;Ljavax/naming/directory/Attributes;Z)V", nullptr, $PROTECTED | $FINAL, $virtualMethod(LdapSchemaCtx, doBind, void, $Name*, Object$*, $Attributes*, bool), "javax.naming.NamingException"},
		{"doCreateSubcontext", "(Ljavax/naming/Name;Ljavax/naming/directory/Attributes;)Ljavax/naming/directory/DirContext;", nullptr, $PROTECTED | $FINAL, $virtualMethod(LdapSchemaCtx, doCreateSubcontext, $DirContext*, $Name*, $Attributes*), "javax.naming.NamingException"},
		{"doDestroySubcontext", "(Ljavax/naming/Name;)V", nullptr, $PROTECTED | $FINAL, $virtualMethod(LdapSchemaCtx, doDestroySubcontext, void, $Name*), "javax.naming.NamingException"},
		{"doModifyAttributes", "([Ljavax/naming/directory/ModificationItem;)V", nullptr, $PROTECTED | $FINAL, $virtualMethod(LdapSchemaCtx, doModifyAttributes, void, $ModificationItemArray*), "javax.naming.NamingException"},
		{"doRebind", "(Ljavax/naming/Name;Ljava/lang/Object;Ljavax/naming/directory/Attributes;Z)V", nullptr, $PROTECTED | $FINAL, $virtualMethod(LdapSchemaCtx, doRebind, void, $Name*, Object$*, $Attributes*, bool), "javax.naming.NamingException"},
		{"doRename", "(Ljavax/naming/Name;Ljavax/naming/Name;)V", nullptr, $PROTECTED | $FINAL, $virtualMethod(LdapSchemaCtx, doRename, void, $Name*, $Name*), "javax.naming.NamingException"},
		{"doUnbind", "(Ljavax/naming/Name;)V", nullptr, $PROTECTED | $FINAL, $virtualMethod(LdapSchemaCtx, doUnbind, void, $Name*), "javax.naming.NamingException"},
		{"modifyServerSchema", "(Ljavax/naming/directory/Attributes;Ljavax/naming/directory/Attributes;)V", nullptr, $PRIVATE | $FINAL, $method(LdapSchemaCtx, modifyServerSchema, void, $Attributes*, $Attributes*), "javax.naming.NamingException"},
		{"rebind", "(Ljavax/naming/Name;Ljava/lang/Object;Ljavax/naming/directory/Attributes;)V", nullptr, $PUBLIC | $FINAL, $virtualMethod(LdapSchemaCtx, rebind, void, $Name*, Object$*, $Attributes*), "javax.naming.NamingException"},
		{"setup", "(ILjava/lang/String;Ljavax/naming/directory/Attributes;)Lcom/sun/jndi/ldap/LdapSchemaCtx;", nullptr, $FINAL, $method(LdapSchemaCtx, setup, LdapSchemaCtx*, int32_t, $String*, $Attributes*), "javax.naming.NamingException"},
		{}
	};
	...
	$loadClass(LdapSchemaCtx, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(LdapSchemaCtx);
	});
	return class$;
}
