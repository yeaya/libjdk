...
void MockE1000g0Inet6Address::clinit$($Class* clazz) {
...
$Class* MockE1000g0Inet6Address::load$($String* name, bool initialize) {
	...
	$loadClass(MockE1000g0Inet6Address, name, initialize, &classInfo$$, MockE1000g0Inet6Address::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(MockE1000g0Inet6Address);
	});
	return class$;
}
