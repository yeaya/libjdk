#ifndef _HeadersTest$1_h_
#define _HeadersTest$1_h_
//$ class HeadersTest$1
...
class HeadersTest$1 : public ::java::net::http::HttpRequest {
	$class(HeadersTest$1, $NO_CLASS_INIT, ::java::net::http::HttpRequest)
public:
	HeadersTest$1();
