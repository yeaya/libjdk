...
$Class* BuffersTestingKit$$Lambda$lambda$relocateBuffers$0::load$($String* name, bool initialize) {
	...
	$loadClass(BuffersTestingKit$$Lambda$lambda$relocateBuffers$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(BuffersTestingKit$$Lambda$lambda$relocateBuffers$0);
	});
	return class$;
}
...
$Class* BuffersTestingKit$$Lambda$lambda$injectEmptyBuffers$1$1::load$($String* name, bool initialize) {
	...
	$loadClass(BuffersTestingKit$$Lambda$lambda$injectEmptyBuffers$1$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(BuffersTestingKit$$Lambda$lambda$injectEmptyBuffers$1$1);
	});
	return class$;
}
...
$Class* BuffersTestingKit$$Lambda$lambda$injectEmptyBuffers$2$2::load$($String* name, bool initialize) {
	...
	$loadClass(BuffersTestingKit$$Lambda$lambda$injectEmptyBuffers$2$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(BuffersTestingKit$$Lambda$lambda$injectEmptyBuffers$2$2);
	});
	return class$;
}
...
$Class* BuffersTestingKit$$Lambda$allocate$3::load$($String* name, bool initialize) {
	...
	$loadClass(BuffersTestingKit$$Lambda$allocate$3, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(BuffersTestingKit$$Lambda$allocate$3);
	});
	return class$;
}
...
$Class* BuffersTestingKit$$Lambda$lambda$forEachSplit$3$4::load$($String* name, bool initialize) {
	...
	$loadClass(BuffersTestingKit$$Lambda$lambda$forEachSplit$3$4, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(BuffersTestingKit$$Lambda$lambda$forEachSplit$3$4);
	});
	return class$;
}
...
$Iterable* BuffersTestingKit::relocateBuffers($Iterable* source) {
	$init(BuffersTestingKit);
	return $new(BuffersTestingKit$$Lambda$lambda$relocateBuffers$0, source);
}

$Iterable* BuffersTestingKit::injectEmptyBuffers($Iterable* source) {
	$init(BuffersTestingKit);
	return injectEmptyBuffers(source, $$new(BuffersTestingKit$$Lambda$lambda$injectEmptyBuffers$1$1));
}

$Iterable* BuffersTestingKit::injectEmptyBuffers($Iterable* source, $Supplier* emptyBufferFactory) {
	$init(BuffersTestingKit);
	return $new(BuffersTestingKit$$Lambda$lambda$injectEmptyBuffers$2$2, source, emptyBufferFactory);
}

$ByteBuffer* BuffersTestingKit::concat($Iterable* split) {
	$init(BuffersTestingKit);
	return concat(split, $$new(BuffersTestingKit$$Lambda$allocate$3));
}
...
void BuffersTestingKit::forEachSplit($ByteBuffer* bb, $Consumer* action) {
	...
	forEachSplit(var$0, $$new(BuffersTestingKit$$Lambda$lambda$forEachSplit$3$4, bb, action));
}
...
void BuffersTestingKit::clinit$($Class* clazz) {
...
$Class* BuffersTestingKit::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("jdk.internal.net.http.hpack.BuffersTestingKit$$Lambda$lambda$relocateBuffers$0")) {
			return BuffersTestingKit$$Lambda$lambda$relocateBuffers$0::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.hpack.BuffersTestingKit$$Lambda$lambda$injectEmptyBuffers$1$1")) {
			return BuffersTestingKit$$Lambda$lambda$injectEmptyBuffers$1$1::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.hpack.BuffersTestingKit$$Lambda$lambda$injectEmptyBuffers$2$2")) {
			return BuffersTestingKit$$Lambda$lambda$injectEmptyBuffers$2$2::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.hpack.BuffersTestingKit$$Lambda$allocate$3")) {
			return BuffersTestingKit$$Lambda$allocate$3::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.hpack.BuffersTestingKit$$Lambda$lambda$forEachSplit$3$4")) {
	...
	$loadClass(BuffersTestingKit, name, initialize, &classInfo$$, BuffersTestingKit::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(BuffersTestingKit);
	});
	return class$;
}
