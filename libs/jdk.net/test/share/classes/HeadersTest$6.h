#ifndef _HeadersTest$6_h_
#define _HeadersTest$6_h_
//$ class HeadersTest$6
...
class HeadersTest$6 : public ::java::net::http::HttpRequest {
	$class(HeadersTest$6, $NO_CLASS_INIT, ::java::net::http::HttpRequest)
public:
	HeadersTest$6();
	void init$();
