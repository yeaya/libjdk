...
$MethodInfo _Frame$Masker_MethodInfo_[] = {
	...
	{"mask", "(I)LFrame$Masker;", nullptr, 0, $method(static_cast<Frame$Masker*(Frame$Masker::*)(int32_t)>(&Frame$Masker::mask))},
	...
	{"transferMasking", "(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;)LFrame$Masker;", nullptr, 0, $method(static_cast<Frame$Masker*(Frame$Masker::*)($ByteBuffer*,$ByteBuffer*)>(&Frame$Masker::transferMasking))},
	{}
};
