#ifndef _HeadersTest$9_h_
#define _HeadersTest$9_h_
//$ class HeadersTest$9
...
class HeadersTest$9 : public ::java::net::http::HttpRequest {
	$class(HeadersTest$9, $NO_CLASS_INIT, ::java::net::http::HttpRequest)
public:
	HeadersTest$9();
	void init$();
