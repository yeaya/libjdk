#ifndef _HeadersTest$11_h_
#define _HeadersTest$11_h_
//$ class HeadersTest$11
...
class HeadersTest$11 : public ::java::net::http::HttpRequest {
	$class(HeadersTest$11, $NO_CLASS_INIT, ::java::net::http::HttpRequest)
public:
	HeadersTest$11();
	void init$();
