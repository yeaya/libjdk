#ifndef _HeadersTest$3_h_
#define _HeadersTest$3_h_
//$ class HeadersTest$3
...
class HeadersTest$3 : public ::java::net::http::HttpRequest {
	$class(HeadersTest$3, $NO_CLASS_INIT, ::java::net::http::HttpRequest)
public:
	HeadersTest$3();
	void init$();
