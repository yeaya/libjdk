...
$MethodInfo _SetTTLAndGetTTL_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(SetTTLAndGetTTL::*)()>(&SetTTLAndGetTTL::init$))},
	{"main", "([Ljava/lang/String;)V", nullptr, $PUBLIC | $STATIC, $method(static_cast<void(*)($StringArray*)>(&SetTTLAndGetTTL::main)), "java.lang.Exception"},
	{}
};
