...
$Class* WindowsInternalFrameTitlePane$ScalableIconUIResource::load$($String* name, bool initialize) {
	...
	$loadClass(WindowsInternalFrameTitlePane$ScalableIconUIResource, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
