#ifndef _com_sun_java_swing_plaf_windows_WindowsFileChooserUI$DirectoryComboBoxRenderer_h_
#define _com_sun_java_swing_plaf_windows_WindowsFileChooserUI$DirectoryComboBoxRenderer_h_
//$ class com.sun.java.swing.plaf.windows.WindowsFileChooserUI$DirectoryComboBoxRenderer
			...
			namespace swing {
				namespace plaf {
					namespace windows {
						...
						class WindowsFileChooserUI$IndentIcon;
					}
				}
			}
		}
...
class $export WindowsFileChooserUI$DirectoryComboBoxRenderer : public ::javax::swing::DefaultListCellRenderer {
	$class(WindowsFileChooserUI$DirectoryComboBoxRenderer, $NO_CLASS_INIT, ::javax::swing::DefaultListCellRenderer)
public:
	...
	::com::sun::java::swing::plaf::windows::WindowsFileChooserUI$IndentIcon* ii = nullptr;
};
...
#endif // _com_sun_java_swing_plaf_windows_WindowsFileChooserUI$DirectoryComboBoxRenderer_h_