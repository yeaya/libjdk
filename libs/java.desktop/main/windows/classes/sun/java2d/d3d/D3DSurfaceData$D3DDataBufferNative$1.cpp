...
$Class* D3DSurfaceData$D3DDataBufferNative$1::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "(Lsun/java2d/d3d/D3DSurfaceData$D3DDataBufferNative;Lsun/java2d/SurfaceData;II)V", "()V", 0, $method(D3DSurfaceData$D3DDataBufferNative$1, init$, void, $D3DSurfaceData$D3DDataBufferNative*, $SurfaceData*, int32_t, int32_t)},
		{"run", "()V", nullptr, $PUBLIC, $virtualMethod(D3DSurfaceData$D3DDataBufferNative$1, run, void)},
		{}
	};
	...
	$loadClass(D3DSurfaceData$D3DDataBufferNative$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(D3DSurfaceData$D3DDataBufferNative$1);
	});
	return class$;
}
