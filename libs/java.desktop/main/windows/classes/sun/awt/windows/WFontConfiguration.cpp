...
void WFontConfiguration::initReorderMap() {
	...
	if ($nc($FontConfiguration::encoding)->equalsIgnoreCase("windows-31j"_s)) {
		...
		$FontConfiguration::localeMap->put("dialoginput.plain.japanese"_s, "MS Mincho"_s);
		$FontConfiguration::localeMap->put("dialoginput.bold.japanese"_s, "MS Mincho"_s);
		$FontConfiguration::localeMap->put("dialoginput.italic.japanese"_s, "MS Mincho"_s);
		$FontConfiguration::localeMap->put("dialoginput.bolditalic.japanese"_s, "MS Mincho"_s);
	}
	$set(this, reorderMap, $new($HashMap));
	this->reorderMap->put("UTF-8.hi"_s, "devanagari"_s);
	this->reorderMap->put("windows-1255"_s, "hebrew"_s);
	this->reorderMap->put("x-windows-874"_s, "thai"_s);
	this->reorderMap->put("windows-31j"_s, "japanese"_s);
	this->reorderMap->put("x-windows-949"_s, "korean"_s);
	this->reorderMap->put("GBK"_s, "chinese-ms936"_s);
	this->reorderMap->put("GB18030"_s, "chinese-gb18030"_s);
	this->reorderMap->put("x-windows-950"_s, "chinese-ms950"_s);
	this->reorderMap->put("x-MS950-HKSCS"_s, $(split("chinese-ms950,chinese-hkscs"_s)));
}
...
void WFontConfiguration::setOsNameAndVersion() {
	...
	if ($nc($FontConfiguration::osName)->startsWith("Windows"_s)) {
		int32_t p = 0;
		int32_t q = 0;
		p = $FontConfiguration::osName->indexOf(u' ');
		if (p == -1) {
			$assignStatic($FontConfiguration::osName, nullptr);
		} else {
			q = $FontConfiguration::osName->indexOf(u' ', p + 1);
			if (q == -1) {
				$assignStatic($FontConfiguration::osName, $FontConfiguration::osName->substring(p + 1));
			} else {
				$assignStatic($FontConfiguration::osName, $FontConfiguration::osName->substring(p + 1, q));
			}
		}
...
$String* WFontConfiguration::getTextComponentFontName($String* familyName, int32_t style) {
	...
	if (fontName == nullptr) {
		$assign(fontName, ($nc(fontDescriptors)->length > 0) ? $nc(fontDescriptors->get(0))->getNativeName() : "Arial,ANSI_CHARSET"_s);
	}
	return fontName;
}
...
void WFontConfiguration::initTables($String* defaultEncoding) {
	...
	WFontConfiguration::subsetCharsetMap->put("alphabetic/1252"_s, "ANSI_CHARSET"_s);
	WFontConfiguration::subsetCharsetMap->put("alphabetic/default"_s, "DEFAULT_CHARSET"_s);
	WFontConfiguration::subsetCharsetMap->put("arabic"_s, "ARABIC_CHARSET"_s);
	WFontConfiguration::subsetCharsetMap->put("chinese-ms936"_s, "GB2312_CHARSET"_s);
	WFontConfiguration::subsetCharsetMap->put("chinese-gb18030"_s, "GB2312_CHARSET"_s);
	WFontConfiguration::subsetCharsetMap->put("chinese-ms950"_s, "CHINESEBIG5_CHARSET"_s);
	WFontConfiguration::subsetCharsetMap->put("chinese-hkscs"_s, "CHINESEBIG5_CHARSET"_s);
	WFontConfiguration::subsetCharsetMap->put("cyrillic"_s, "RUSSIAN_CHARSET"_s);
	WFontConfiguration::subsetCharsetMap->put("devanagari"_s, "DEFAULT_CHARSET"_s);
	WFontConfiguration::subsetCharsetMap->put("dingbats"_s, "SYMBOL_CHARSET"_s);
	WFontConfiguration::subsetCharsetMap->put("greek"_s, "GREEK_CHARSET"_s);
	WFontConfiguration::subsetCharsetMap->put("hebrew"_s, "HEBREW_CHARSET"_s);
	WFontConfiguration::subsetCharsetMap->put("japanese"_s, "SHIFTJIS_CHARSET"_s);
	WFontConfiguration::subsetCharsetMap->put("korean"_s, "HANGEUL_CHARSET"_s);
	WFontConfiguration::subsetCharsetMap->put("latin"_s, "ANSI_CHARSET"_s);
	WFontConfiguration::subsetCharsetMap->put("symbol"_s, "SYMBOL_CHARSET"_s);
	WFontConfiguration::subsetCharsetMap->put("thai"_s, "THAI_CHARSET"_s);
	$nc(WFontConfiguration::subsetEncodingMap)->put("alphabetic"_s, "default"_s);
	WFontConfiguration::subsetEncodingMap->put("alphabetic/1252"_s, "windows-1252"_s);
	WFontConfiguration::subsetEncodingMap->put("alphabetic/default"_s, defaultEncoding);
	WFontConfiguration::subsetEncodingMap->put("arabic"_s, "windows-1256"_s);
	WFontConfiguration::subsetEncodingMap->put("chinese-ms936"_s, "GBK"_s);
	WFontConfiguration::subsetEncodingMap->put("chinese-gb18030"_s, "GB18030"_s);
	if ("x-MS950-HKSCS"_s->equals(defaultEncoding)) {
		WFontConfiguration::subsetEncodingMap->put("chinese-ms950"_s, "x-MS950-HKSCS"_s);
	} else {
		WFontConfiguration::subsetEncodingMap->put("chinese-ms950"_s, "x-windows-950"_s);
	}
	WFontConfiguration::subsetEncodingMap->put("chinese-hkscs"_s, "sun.awt.HKSCS"_s);
	WFontConfiguration::subsetEncodingMap->put("cyrillic"_s, "windows-1251"_s);
	WFontConfiguration::subsetEncodingMap->put("devanagari"_s, "UTF-16LE"_s);
	WFontConfiguration::subsetEncodingMap->put("dingbats"_s, "sun.awt.windows.WingDings"_s);
	WFontConfiguration::subsetEncodingMap->put("greek"_s, "windows-1253"_s);
	WFontConfiguration::subsetEncodingMap->put("hebrew"_s, "windows-1255"_s);
	WFontConfiguration::subsetEncodingMap->put("japanese"_s, "windows-31j"_s);
	WFontConfiguration::subsetEncodingMap->put("korean"_s, "x-windows-949"_s);
	WFontConfiguration::subsetEncodingMap->put("latin"_s, "windows-1252"_s);
	WFontConfiguration::subsetEncodingMap->put("symbol"_s, "sun.awt.Symbol"_s);
	WFontConfiguration::subsetEncodingMap->put("thai"_s, "x-windows-874"_s);
...
void WFontConfiguration::clinit$($Class* clazz) {
...
$Class* WFontConfiguration::load$($String* name, bool initialize) {
	...
	$loadClass(WFontConfiguration, name, initialize, &classInfo$$, WFontConfiguration::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(WFontConfiguration);
	});
	return class$;
}
