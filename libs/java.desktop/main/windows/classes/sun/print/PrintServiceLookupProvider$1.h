...
class PrintServiceLookupProvider$1 : public ::java::security::PrivilegedAction {
	$class(PrintServiceLookupProvider$1, $NO_CLASS_INIT, ::java::security::PrivilegedAction)
public:
