...
class $import WindowsInternalFrameTitlePane$WindowsPropertyChangeHandler : public ::javax::swing::plaf::basic::BasicInternalFrameTitlePane$PropertyChangeHandler {
