#ifndef _com_sun_java_swing_plaf_windows_WindowsFileChooserUI$FilterComboBoxRenderer_h_
#define _com_sun_java_swing_plaf_windows_WindowsFileChooserUI$FilterComboBoxRenderer_h_
//$ class com.sun.java.swing.plaf.windows.WindowsFileChooserUI$FilterComboBoxRenderer
...
class $import WindowsFileChooserUI$FilterComboBoxRenderer : public ::javax::swing::DefaultListCellRenderer {
	$class(WindowsFileChooserUI$FilterComboBoxRenderer, $NO_CLASS_INIT, ::javax::swing::DefaultListCellRenderer)
public:
...
#endif // _com_sun_java_swing_plaf_windows_WindowsFileChooserUI$FilterComboBoxRenderer_h_