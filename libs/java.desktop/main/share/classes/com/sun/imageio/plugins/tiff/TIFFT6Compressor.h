#ifndef _com_sun_imageio_plugins_tiff_TIFFT6Compressor_h_
#define _com_sun_imageio_plugins_tiff_TIFFT6Compressor_h_
//$ class com.sun.imageio.plugins.tiff.TIFFT6Compressor
...
class TIFFT6Compressor : public ::com::sun::imageio::plugins::tiff::TIFFFaxCompressor {
	$class(TIFFT6Compressor, $NO_CLASS_INIT, ::com::sun::imageio::plugins::tiff::TIFFFaxCompressor)
public:
	TIFFT6Compressor();
	void init$();
	...
	virtual int32_t encodeT6($bytes* data, int32_t lineStride, int32_t colOffset, int32_t width, int32_t height, $bytes* compData);
...
#endif // _com_sun_imageio_plugins_tiff_TIFFT6Compressor_h_