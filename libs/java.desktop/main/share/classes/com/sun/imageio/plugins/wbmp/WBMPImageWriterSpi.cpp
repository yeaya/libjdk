...
void WBMPImageWriterSpi::clinit$($Class* clazz) {
...
$Class* WBMPImageWriterSpi::load$($String* name, bool initialize) {
	...
	$loadClass(WBMPImageWriterSpi, name, initialize, &classInfo$$, WBMPImageWriterSpi::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(WBMPImageWriterSpi);
	});
	return class$;
}
