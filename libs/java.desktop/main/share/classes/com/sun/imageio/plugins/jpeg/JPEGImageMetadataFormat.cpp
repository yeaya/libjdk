...
void JPEGImageMetadataFormat::init$() {
	...
	codes->add("17"_s);
	codes->add("19"_s);
	addAttribute("app0JFXX"_s, "extensionCode"_s, $IIOMetadataFormat::DATATYPE_INTEGER, false, nullptr, codes);
	...
	$load($ICC_Profile);
	addObjectValue("app2ICC"_s, $ICC_Profile::class$, false, nullptr);
	...
	transforms->add("1"_s);
	transforms->add("2"_s);
	addAttribute("app14Adobe"_s, "transform"_s, $IIOMetadataFormat::DATATYPE_INTEGER, true, nullptr, transforms);
	addElement("componentSpec"_s, "sof"_s, $IIOMetadataFormat::CHILD_POLICY_EMPTY);
	$var($List, procs, $new($ArrayList));
	procs->add("0"_s);
	procs->add("1"_s);
	procs->add("2"_s);
	addAttribute("sof"_s, "process"_s, $IIOMetadataFormat::DATATYPE_INTEGER, false, nullptr, procs);
	...
	comps->add("3"_s);
	comps->add("4"_s);
	addAttribute("sof"_s, "numFrameComponents"_s, $IIOMetadataFormat::DATATYPE_INTEGER, false, nullptr, comps);
	...
	tabids->add("2"_s);
	tabids->add("3"_s);
	addAttribute("componentSpec"_s, "QtableSelector"_s, $IIOMetadataFormat::DATATYPE_INTEGER, true, nullptr, tabids);
	addElement("scanComponentSpec"_s, "sos"_s, $IIOMetadataFormat::CHILD_POLICY_EMPTY);
	addAttribute("sos"_s, "numScanComponents"_s, $IIOMetadataFormat::DATATYPE_INTEGER, true, nullptr, comps);
	...
	addAttribute("scanComponentSpec"_s, "dcHuffTable"_s, $IIOMetadataFormat::DATATYPE_INTEGER, true, nullptr, tabids);
	addAttribute("scanComponentSpec"_s, "acHuffTable"_s, $IIOMetadataFormat::DATATYPE_INTEGER, true, nullptr, tabids);
}
...
bool JPEGImageMetadataFormat::canNodeAppear($String* elementName, $ImageTypeSpecifier* imageType) {
	...
	bool var$0 = var$1 || elementName->equals("JPEGvariety"_s);
...
void JPEGImageMetadataFormat::clinit$($Class* clazz) {
...
$Class* JPEGImageMetadataFormat::load$($String* name, bool initialize) {
	...
	$loadClass(JPEGImageMetadataFormat, name, initialize, &classInfo$$, JPEGImageMetadataFormat::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(JPEGImageMetadataFormat);
	});
	return class$;
}
