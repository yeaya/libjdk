#ifndef _com_sun_imageio_plugins_tiff_TIFFRLECompressor_h_
#define _com_sun_imageio_plugins_tiff_TIFFRLECompressor_h_
//$ class com.sun.imageio.plugins.tiff.TIFFRLECompressor
...
class TIFFRLECompressor : public ::com::sun::imageio::plugins::tiff::TIFFFaxCompressor {
	$class(TIFFRLECompressor, $NO_CLASS_INIT, ::com::sun::imageio::plugins::tiff::TIFFFaxCompressor)
public:
	TIFFRLECompressor();
	void init$();
	...
	virtual int32_t encodeRLE($bytes* data, int32_t rowOffset, int32_t colOffset, int32_t rowLength, $bytes* compData);
...
#endif // _com_sun_imageio_plugins_tiff_TIFFRLECompressor_h_