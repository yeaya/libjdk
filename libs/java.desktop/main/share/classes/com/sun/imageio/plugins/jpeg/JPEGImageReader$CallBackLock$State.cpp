...
void JPEGImageReader$CallBackLock$State::clinit$($Class* clazz) {
...
$Class* JPEGImageReader$CallBackLock$State::load$($String* name, bool initialize) {
	...
	$loadClass(JPEGImageReader$CallBackLock$State, name, initialize, &classInfo$$, JPEGImageReader$CallBackLock$State::clinit$, []($Class* clazz) -> $Object* {
