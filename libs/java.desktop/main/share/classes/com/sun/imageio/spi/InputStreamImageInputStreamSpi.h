#ifndef _com_sun_imageio_spi_InputStreamImageInputStreamSpi_h_
#define _com_sun_imageio_spi_InputStreamImageInputStreamSpi_h_
//$ class com.sun.imageio.spi.InputStreamImageInputStreamSpi
...
class InputStreamImageInputStreamSpi : public ::javax::imageio::spi::ImageInputStreamSpi {
	$class(InputStreamImageInputStreamSpi, 0, ::javax::imageio::spi::ImageInputStreamSpi)
public:
...
#endif // _com_sun_imageio_spi_InputStreamImageInputStreamSpi_h_