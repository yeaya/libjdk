#ifndef _com_sun_media_sound_AlawCodec_h_
#define _com_sun_media_sound_AlawCodec_h_
//$ class com.sun.media.sound.AlawCodec
//$ extends javax.sound.sampled.spi.FormatConversionProvider

#include <java/lang/Array.h>
#include <javax/sound/sampled/spi/FormatConversionProvider.h>

#pragma push_macro("ALAW_TABH")
#undef ALAW_TABH
#pragma push_macro("ALAW_TABL")
#undef ALAW_TABL
...
class AlawCodec : public ::javax::sound::sampled::spi::FormatConversionProvider {
	$class(AlawCodec, 0, ::javax::sound::sampled::spi::FormatConversionProvider)
public:
	AlawCodec();
	void init$();
	...
	static $bytes* ALAW_TABH;
	static $bytes* ALAW_TABL;
...
#pragma pop_macro("ALAW_TABH")
#pragma pop_macro("ALAW_TABL")

#endif // _com_sun_media_sound_AlawCodec_h_