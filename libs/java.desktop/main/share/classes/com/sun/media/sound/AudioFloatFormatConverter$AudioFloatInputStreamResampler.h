#ifndef _com_sun_media_sound_AudioFloatFormatConverter$AudioFloatInputStreamResampler_h_
#define _com_sun_media_sound_AudioFloatFormatConverter$AudioFloatInputStreamResampler_h_
//$ class com.sun.media.sound.AudioFloatFormatConverter$AudioFloatInputStreamResampler
...
class AudioFloatFormatConverter$AudioFloatInputStreamResampler : public ::com::sun::media::sound::AudioFloatInputStream {
	$class(AudioFloatFormatConverter$AudioFloatInputStreamResampler, $NO_CLASS_INIT, ::com::sun::media::sound::AudioFloatInputStream)
public:
...
#endif // _com_sun_media_sound_AudioFloatFormatConverter$AudioFloatInputStreamResampler_h_