#ifndef _com_sun_media_sound_AudioFloatConverter$AudioFloatConversion64B_h_
#define _com_sun_media_sound_AudioFloatConverter$AudioFloatConversion64B_h_
//$ class com.sun.media.sound.AudioFloatConverter$AudioFloatConversion64B
...
class AudioFloatConverter$AudioFloatConversion64B : public ::com::sun::media::sound::AudioFloatConverter {
	$class(AudioFloatConverter$AudioFloatConversion64B, $NO_CLASS_INIT, ::com::sun::media::sound::AudioFloatConverter)
public:
...
#endif // _com_sun_media_sound_AudioFloatConverter$AudioFloatConversion64B_h_