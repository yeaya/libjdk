#ifndef _com_sun_java_swing_plaf_motif_MotifInternalFrameTitlePane$MinimizeButton_h_
#define _com_sun_java_swing_plaf_motif_MotifInternalFrameTitlePane$MinimizeButton_h_
//$ class com.sun.java.swing.plaf.motif.MotifInternalFrameTitlePane$MinimizeButton
...
class $export MotifInternalFrameTitlePane$MinimizeButton : public ::com::sun::java::swing::plaf::motif::MotifInternalFrameTitlePane$FrameButton {
	$class(MotifInternalFrameTitlePane$MinimizeButton, $NO_CLASS_INIT, ::com::sun::java::swing::plaf::motif::MotifInternalFrameTitlePane$FrameButton)
public:
...
#endif // _com_sun_java_swing_plaf_motif_MotifInternalFrameTitlePane$MinimizeButton_h_