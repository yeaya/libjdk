#ifndef _com_sun_java_swing_plaf_motif_MotifFileChooserUI$FilterComboBoxRenderer_h_
#define _com_sun_java_swing_plaf_motif_MotifFileChooserUI$FilterComboBoxRenderer_h_
//$ class com.sun.java.swing.plaf.motif.MotifFileChooserUI$FilterComboBoxRenderer
...
class $export MotifFileChooserUI$FilterComboBoxRenderer : public ::javax::swing::DefaultListCellRenderer {
	$class(MotifFileChooserUI$FilterComboBoxRenderer, $NO_CLASS_INIT, ::javax::swing::DefaultListCellRenderer)
public:
...
#endif // _com_sun_java_swing_plaf_motif_MotifFileChooserUI$FilterComboBoxRenderer_h_