...
$Object* MotifLookAndFeel$7::createValue($UIDefaults* table) {
	...
	return $of($new($ColorUIResource, var$0, var$1, $Math::max($cast(int32_t, (c->getBlue() * 0.85)), 0)));
}
...
$Class* MotifLookAndFeel$7::load$($String* name, bool initialize) {
	...
	$loadClass(MotifLookAndFeel$7, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(MotifLookAndFeel$7);
	});
	return class$;
}
