...
$Class* motif_it::load$($String* name, bool initialize) {
	...
	$loadClass(motif_it, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(motif_it);
	});
	return class$;
}
