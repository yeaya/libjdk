#ifndef _com_sun_java_swing_plaf_motif_MotifInternalFrameTitlePane$Title$1_h_
#define _com_sun_java_swing_plaf_motif_MotifInternalFrameTitlePane$Title$1_h_
//$ class com.sun.java.swing.plaf.motif.MotifInternalFrameTitlePane$Title$1
...
class $export MotifInternalFrameTitlePane$Title$1 : public ::java::awt::event::MouseMotionListener {
	$class(MotifInternalFrameTitlePane$Title$1, $NO_CLASS_INIT, ::java::awt::event::MouseMotionListener)
public:
...
#endif // _com_sun_java_swing_plaf_motif_MotifInternalFrameTitlePane$Title$1_h_