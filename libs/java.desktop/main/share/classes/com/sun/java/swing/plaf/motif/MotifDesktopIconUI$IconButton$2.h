#ifndef _com_sun_java_swing_plaf_motif_MotifDesktopIconUI$IconButton$2_h_
#define _com_sun_java_swing_plaf_motif_MotifDesktopIconUI$IconButton$2_h_
//$ class com.sun.java.swing.plaf.motif.MotifDesktopIconUI$IconButton$2
...
class $export MotifDesktopIconUI$IconButton$2 : public ::java::awt::event::MouseListener {
	$class(MotifDesktopIconUI$IconButton$2, $NO_CLASS_INIT, ::java::awt::event::MouseListener)
public:
...
#endif // _com_sun_java_swing_plaf_motif_MotifDesktopIconUI$IconButton$2_h_