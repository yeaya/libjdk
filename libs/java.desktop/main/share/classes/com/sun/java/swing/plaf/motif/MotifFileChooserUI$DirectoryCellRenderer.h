#ifndef _com_sun_java_swing_plaf_motif_MotifFileChooserUI$DirectoryCellRenderer_h_
#define _com_sun_java_swing_plaf_motif_MotifFileChooserUI$DirectoryCellRenderer_h_
//$ class com.sun.java.swing.plaf.motif.MotifFileChooserUI$DirectoryCellRenderer
...
class $export MotifFileChooserUI$DirectoryCellRenderer : public ::javax::swing::DefaultListCellRenderer {
	$class(MotifFileChooserUI$DirectoryCellRenderer, $NO_CLASS_INIT, ::javax::swing::DefaultListCellRenderer)
public:
...
#endif // _com_sun_java_swing_plaf_motif_MotifFileChooserUI$DirectoryCellRenderer_h_