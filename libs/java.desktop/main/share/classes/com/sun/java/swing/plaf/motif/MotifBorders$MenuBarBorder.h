#ifndef _com_sun_java_swing_plaf_motif_MotifBorders$MenuBarBorder_h_
#define _com_sun_java_swing_plaf_motif_MotifBorders$MenuBarBorder_h_
//$ class com.sun.java.swing.plaf.motif.MotifBorders$MenuBarBorder
...
class $export MotifBorders$MenuBarBorder : public ::com::sun::java::swing::plaf::motif::MotifBorders$ButtonBorder {
	$class(MotifBorders$MenuBarBorder, $NO_CLASS_INIT, ::com::sun::java::swing::plaf::motif::MotifBorders$ButtonBorder)
public:
...
#endif // _com_sun_java_swing_plaf_motif_MotifBorders$MenuBarBorder_h_