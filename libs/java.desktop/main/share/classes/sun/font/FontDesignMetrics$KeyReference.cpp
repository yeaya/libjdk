...
void FontDesignMetrics$KeyReference::clinit$($Class* clazz) {
...
$Class* FontDesignMetrics$KeyReference::load$($String* name, bool initialize) {
	...
	$loadClass(FontDesignMetrics$KeyReference, name, initialize, &classInfo$$, FontDesignMetrics$KeyReference::clinit$, []($Class* clazz) -> $Object* {
