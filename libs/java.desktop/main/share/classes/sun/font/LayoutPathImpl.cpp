...
$Class* LayoutPathImpl::load$($String* name, bool initialize) {
	...
	$loadClass(LayoutPathImpl, name, initialize, &classInfo$$, LayoutPathImpl::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(LayoutPathImpl);
	});
	return class$;
}
