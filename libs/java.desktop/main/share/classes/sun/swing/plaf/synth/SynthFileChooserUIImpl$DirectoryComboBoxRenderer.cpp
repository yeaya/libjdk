...
void SynthFileChooserUIImpl$DirectoryComboBoxRenderer::clinit$($Class* clazz) {
...
$Class* SynthFileChooserUIImpl$DirectoryComboBoxRenderer::load$($String* name, bool initialize) {
	...
	$loadClass(SynthFileChooserUIImpl$DirectoryComboBoxRenderer, name, initialize, &classInfo$$, SynthFileChooserUIImpl$DirectoryComboBoxRenderer::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(SynthFileChooserUIImpl$DirectoryComboBoxRenderer);
	});
	return class$;
}
