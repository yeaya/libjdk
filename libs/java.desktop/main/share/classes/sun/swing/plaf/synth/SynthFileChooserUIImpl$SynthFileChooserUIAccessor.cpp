...
$Class* SynthFileChooserUIImpl$SynthFileChooserUIAccessor::load$($String* name, bool initialize) {
	...
	$loadClass(SynthFileChooserUIImpl$SynthFileChooserUIAccessor, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(SynthFileChooserUIImpl$SynthFileChooserUIAccessor);
	});
	return class$;
}
