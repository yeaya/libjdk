...
$Class* FilePane$DirectoriesFirstComparatorWrapper::load$($String* name, bool initialize) {
	...
	$loadClass(FilePane$DirectoriesFirstComparatorWrapper, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(FilePane$DirectoriesFirstComparatorWrapper);
	});
	return class$;
}
