#ifndef _sun_java2d_loops_DrawGlyphListAA_h_
#define _sun_java2d_loops_DrawGlyphListAA_h_
//$ class sun.java2d.loops.DrawGlyphListAA
...
class DrawGlyphListAA : public ::sun::java2d::loops::GraphicsPrimitive {
	$class(DrawGlyphListAA, 0, ::sun::java2d::loops::GraphicsPrimitive)
public:
	DrawGlyphListAA();
	...
	virtual void DrawGlyphListAA$(::sun::java2d::SunGraphics2D* sg2d, ::sun::java2d::SurfaceData* dest, ::sun::font::GlyphList* srcData, int32_t fromGlyph, int32_t toGlyph);
	static ::sun::java2d::loops::DrawGlyphListAA* locate(::sun::java2d::loops::SurfaceType* srctype, ::sun::java2d::loops::CompositeType* comptype, ::sun::java2d::loops::SurfaceType* dsttype);
...
#endif // _sun_java2d_loops_DrawGlyphListAA_h_