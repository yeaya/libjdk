#ifndef _sun_java2d_opengl_OGLGeneralTransformedBlit_h_
#define _sun_java2d_opengl_OGLGeneralTransformedBlit_h_
...
class OGLGeneralTransformedBlit : public ::sun::java2d::loops::TransformBlit {
	$class(OGLGeneralTransformedBlit, $NO_CLASS_INIT, ::sun::java2d::loops::TransformBlit)
public:
...
#endif // _sun_java2d_opengl_OGLGeneralTransformedBlit_h_