#ifndef _sun_java2d_opengl_OGLRenderer$Tracer_h_
#define _sun_java2d_opengl_OGLRenderer$Tracer_h_
//$ class sun.java2d.opengl.OGLRenderer$Tracer
//$ extends sun.java2d.opengl.OGLRenderer
...
class OGLRenderer$Tracer : public ::sun::java2d::opengl::OGLRenderer {
	$class(OGLRenderer$Tracer, $NO_CLASS_INIT, ::sun::java2d::opengl::OGLRenderer)
public:
	OGLRenderer$Tracer();
	using ::sun::java2d::opengl::OGLRenderer::drawPoly;
	void init$(::sun::java2d::opengl::OGLRenderer* this$0, ::sun::java2d::opengl::OGLRenderer* oglr);
	...
	::sun::java2d::opengl::OGLRenderer* this$0 = nullptr;
	::sun::java2d::opengl::OGLRenderer* oglr = nullptr;
};
...
#endif // _sun_java2d_opengl_OGLRenderer$Tracer_h_