#ifndef _sun_java2d_opengl_OGLAnyCompositeBlit_h_
#define _sun_java2d_opengl_OGLAnyCompositeBlit_h_
//$ class sun.java2d.opengl.OGLAnyCompositeBlit
...
class OGLAnyCompositeBlit : public ::sun::java2d::loops::Blit {
	$class(OGLAnyCompositeBlit, $NO_CLASS_INIT, ::sun::java2d::loops::Blit)
public:
	OGLAnyCompositeBlit();
...
#endif // _sun_java2d_opengl_OGLAnyCompositeBlit_h_