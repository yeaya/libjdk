...
void LCMSImageLayout$BandOrder::clinit$($Class* clazz) {
...
$Class* LCMSImageLayout$BandOrder::load$($String* name, bool initialize) {
	...
	$loadClass(LCMSImageLayout$BandOrder, name, initialize, &classInfo$$, LCMSImageLayout$BandOrder::clinit$, []($Class* clazz) -> $Object* {
