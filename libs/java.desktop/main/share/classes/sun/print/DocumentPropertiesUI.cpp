...
void DocumentPropertiesUI::clinit$($Class* clazz) {
...
$Class* DocumentPropertiesUI::load$($String* name, bool initialize) {
	...
	$loadClass(DocumentPropertiesUI, name, initialize, &classInfo$$, DocumentPropertiesUI::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(DocumentPropertiesUI);
	});
	return class$;
}
