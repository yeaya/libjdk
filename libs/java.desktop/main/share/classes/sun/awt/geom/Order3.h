#ifndef _sun_awt_geom_Order3_h_
#define _sun_awt_geom_Order3_h_
//$ class sun.awt.geom.Order3
...
class Order3 : public ::sun::awt::geom::Curve {
	$class(Order3, $NO_CLASS_INIT, ::sun::awt::geom::Curve)
public:
	Order3();
	using ::sun::awt::geom::Curve::getSubCurve;
	void init$(double x0, double y0, double cx0, double cy0, double cx1, double cy1, double x1, double y1, int32_t direction);
	...
	static void addInstance(::java::util::Vector* curves, double x0, double y0, double cx0, double cy0, double cx1, double cy1, double x1, double y1, int32_t direction);
	...
	double getCY0();
	double getCY1();
	static int32_t getHorizontalParams(double c0, double cp0, double cp1, double c1, $doubles* ret);
	...
	static void insert(::java::util::Vector* curves, $doubles* tmp, double x0, double y0, double cx0, double cy0, double cx1, double cy1, double x1, double y1, int32_t direction);
