#ifndef _sun_awt_image_ShortComponentRaster_h_
#define _sun_awt_image_ShortComponentRaster_h_
//$ class sun.awt.image.ShortComponentRaster
...
class ShortComponentRaster : public ::sun::awt::image::SunWritableRaster {
	$class(ShortComponentRaster, 0, ::sun::awt::image::SunWritableRaster)
public:
...
#endif // _sun_awt_image_ShortComponentRaster_h_