...
void BaselineTIFFTagSet::initTags() {
	...
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$Artist));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$BitsPerSample));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$CellLength));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$CellWidth));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$ColorMap));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$Compression));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$Copyright));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$DateTime));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$DocumentName));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$DotRange));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$ExtraSamples));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$FillOrder));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$FreeByteCounts));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$FreeOffsets));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$GrayResponseCurve));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$GrayResponseUnit));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$HalftoneHints));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$HostComputer));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$ImageDescription));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$ICCProfile));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$ImageLength));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$ImageWidth));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$InkNames));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$InkSet));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$JPEGACTables));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$JPEGDCTables));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$JPEGInterchangeFormat));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$JPEGInterchangeFormatLength));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$JPEGLosslessPredictors));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$JPEGPointTransforms));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$JPEGProc));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$JPEGQTables));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$JPEGRestartInterval));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$JPEGTables));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$Make));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$MaxSampleValue));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$MinSampleValue));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$Model));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$NewSubfileType));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$NumberOfInks));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$Orientation));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$PageName));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$PageNumber));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$PhotometricInterpretation));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$PlanarConfiguration));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$Predictor));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$PrimaryChromaticities));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$ReferenceBlackWhite));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$ResolutionUnit));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$RowsPerStrip));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$SampleFormat));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$SamplesPerPixel));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$SMaxSampleValue));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$SMinSampleValue));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$Software));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$StripByteCounts));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$StripOffsets));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$SubfileType));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$T4Options));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$T6Options));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$TargetPrinter));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$Threshholding));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$TileByteCounts));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$TileOffsets));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$TileLength));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$TileWidth));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$TransferFunction));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$TransferRange));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$WhitePoint));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$XPosition));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$XResolution));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$YCbCrCoefficients));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$YCbCrPositioning));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$YCbCrSubSampling));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$YPosition));
	BaselineTIFFTagSet::tags->add($$new($BaselineTIFFTagSet$YResolution));
}
...
void BaselineTIFFTagSet::clinit$($Class* clazz) {
...
$Class* BaselineTIFFTagSet::load$($String* name, bool initialize) {
	...
	$loadClass(BaselineTIFFTagSet, name, initialize, &classInfo$$, BaselineTIFFTagSet::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(BaselineTIFFTagSet);
	});
	return class$;
}
