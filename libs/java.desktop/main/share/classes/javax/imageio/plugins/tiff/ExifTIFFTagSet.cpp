...
void ExifTIFFTagSet::initTags() {
	...
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$ExifVersion));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$FlashPixVersion));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$ColorSpace));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$ComponentsConfiguration));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$CompressedBitsPerPixel));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$PixelXDimension));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$PixelYDimension));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$MakerNote));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$UserComment));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$RelatedSoundFile));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$DateTimeOriginal));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$DateTimeDigitized));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$SubSecTime));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$SubSecTimeOriginal));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$SubSecTimeDigitized));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$ExposureTime));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$FNumber));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$ExposureProgram));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$SpectralSensitivity));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$ISOSpeedRatings));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$OECF));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$ShutterSpeedValue));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$ApertureValue));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$BrightnessValue));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$ExposureBiasValue));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$MaxApertureValue));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$SubjectDistance));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$MeteringMode));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$LightSource));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$Flash));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$FocalLength));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$SubjectArea));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$FlashEnergy));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$SpatialFrequencyResponse));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$FocalPlaneXResolution));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$FocalPlaneYResolution));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$FocalPlaneResolutionUnit));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$SubjectLocation));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$ExposureIndex));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$SensingMethod));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$FileSource));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$SceneType));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$CFAPattern));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$CustomRendered));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$ExposureMode));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$WhiteBalance));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$DigitalZoomRatio));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$FocalLengthIn35mmFilm));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$SceneCaptureType));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$GainControl));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$Contrast));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$Saturation));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$Sharpness));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$DeviceSettingDescription));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$SubjectDistanceRange));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$ImageUniqueID));
	ExifTIFFTagSet::tags->add($$new($ExifTIFFTagSet$InteroperabilityIFD));
}
...
void ExifTIFFTagSet::clinit$($Class* clazz) {
...
$Class* ExifTIFFTagSet::load$($String* name, bool initialize) {
	...
	$loadClass(ExifTIFFTagSet, name, initialize, &classInfo$$, ExifTIFFTagSet::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(ExifTIFFTagSet);
	});
	return class$;
}
