...
bool ResolutionSyntax::equals(Object$* object) {
	return (object != nullptr && $instanceOf(ResolutionSyntax, object) && this->crossFeedResolution == $cast(ResolutionSyntax, object)->crossFeedResolution && this->feedResolution == $cast(ResolutionSyntax, object)->feedResolution);
}
...
$Class* ResolutionSyntax::load$($String* name, bool initialize) {
	...
	$loadClass(ResolutionSyntax, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
