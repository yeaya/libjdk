...
$EnumSyntaxArray* PrinterIsAcceptingJobs::getEnumValueTable() {
	return $cast($EnumSyntaxArray, PrinterIsAcceptingJobs::myEnumValueTable);
}
...
void PrinterIsAcceptingJobs::clinit$($Class* clazz) {
...
$Class* PrinterIsAcceptingJobs::load$($String* name, bool initialize) {
	...
	$loadClass(PrinterIsAcceptingJobs, name, initialize, &classInfo$$, PrinterIsAcceptingJobs::clinit$, []($Class* clazz) -> $Object* {
