...
void JRootPane::setDoubleBuffered(bool aFlag) {
	if (isDoubleBuffered() != aFlag) {
		...
		$$nc($RepaintManager::currentManager(this))->doubleBufferingChanged(this);
	}
}
...
void JRootPane::setJMenuBar($JMenuBar* menu) {
	if (this->menuBar != nullptr && $equals(this->menuBar->getParent(), this->layeredPane)) {
		$nc(this->layeredPane)->remove(this->menuBar);
	}
	$set(this, menuBar, menu);
	if (this->menuBar != nullptr) {
		this->menuBar->updateUI();
		$init($JLayeredPane);
		$nc(this->layeredPane)->add(this->menuBar, $JLayeredPane::FRAME_CONTENT_LAYER);
	}
}
...
void JRootPane::setContentPane($Container* content) {
	...
	if (this->contentPane != nullptr && $equals(this->contentPane->getParent(), this->layeredPane)) {
		$nc(this->layeredPane)->remove(this->contentPane);
	}
	$set(this, contentPane, content);
	$init($JLayeredPane);
	$nc(this->layeredPane)->add(this->contentPane, $JLayeredPane::FRAME_CONTENT_LAYER);
}
...
void JRootPane::setLayeredPane($JLayeredPane* layered) {
	...
	if (this->layeredPane != nullptr && $equals(this->layeredPane->getParent(), this)) {
...
void JRootPane::setGlassPane($Component* glass) {
	...
	bool visible = false;
	if (this->glassPane != nullptr && $equals(this->glassPane->getParent(), this)) {
...
void JRootPane::setDefaultButton($JButton* defaultButton) {
	...
	firePropertyChange("defaultButton"_s, oldDefault, defaultButton);
}
...
void JRootPane::addImpl($Component* comp, Object$* constraints, int32_t index) {
	...
	bool var$0 = this->glassPane != nullptr && $equals(this->glassPane->getParent(), this);
...
void JRootPane::clinit$($Class* clazz) {
	$useLocalObjectStack();
	$assignStatic(JRootPane::uiClassID, "RootPaneUI"_s);
	$beforeCallerSensitive();
	{
		JRootPane::LOG_DISABLE_TRUE_DOUBLE_BUFFERING = $$sure($Boolean, $AccessController::doPrivileged($$new($GetBooleanAction, "swing.logDoubleBufferingDisable"_s)))->booleanValue();
		JRootPane::IGNORE_DISABLE_TRUE_DOUBLE_BUFFERING = $$sure($Boolean, $AccessController::doPrivileged($$new($GetBooleanAction, "swing.ignoreDoubleBufferingDisable"_s)))->booleanValue();
	}
}
...
$Class* JRootPane::load$($String* name, bool initialize) {
	...
	$NamedAttribute setDefaultButtonmethodAnnotations$$$namedAttribute[] = {
		{"description", 's', "The button activated by default in this root pane"},
		{}
	};
	$CompoundAttribute setDefaultButtonmethodAnnotations$$[] = {
		{"Ljava/beans/BeanProperty;", setDefaultButtonmethodAnnotations$$$namedAttribute},
		{}
	};
	...
	$NamedAttribute setWindowDecorationStylemethodAnnotations$$$namedAttribute[] = {
		{"expert", 'Z', "true"},
		{"visualUpdate", 'Z', "true"},
	...
	$CompoundAttribute setWindowDecorationStylemethodAnnotations$$[] = {
		{"Ljava/beans/BeanProperty;", setWindowDecorationStylemethodAnnotations$$$namedAttribute},
		{}
	};
	$MethodInfo methodInfos$$[] = {
		...
		{"getMenuBar", "()Ljavax/swing/JMenuBar;", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(JRootPane, getMenuBar, $JMenuBar*), nullptr, nullptr, getMenuBarmethodAnnotations$$},
		...
		{"setDefaultButton", "(Ljavax/swing/JButton;)V", nullptr, $PUBLIC, $virtualMethod(JRootPane, setDefaultButton, void, $JButton*), nullptr, nullptr, setDefaultButtonmethodAnnotations$$},
		...
		{"setMenuBar", "(Ljavax/swing/JMenuBar;)V", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(JRootPane, setMenuBar, void, $JMenuBar*), nullptr, nullptr, setMenuBarmethodAnnotations$$},
		{"setUI", "(Ljavax/swing/plaf/RootPaneUI;)V", nullptr, $PUBLIC, $virtualMethod(JRootPane, setUI, void, $RootPaneUI*), nullptr, nullptr, setUImethodAnnotations$$},
		{"setUseTrueDoubleBuffering", "(Z)V", nullptr, $FINAL, $method(JRootPane, setUseTrueDoubleBuffering, void, bool)},
		{"setWindowDecorationStyle", "(I)V", nullptr, $PUBLIC, $virtualMethod(JRootPane, setWindowDecorationStyle, void, int32_t), nullptr, nullptr, setWindowDecorationStylemethodAnnotations$$},
	...
	$loadClass(JRootPane, name, initialize, &classInfo$$, JRootPane::clinit$, []($Class* clazz) -> $Object* {
