...
void StrokeBorder::paintBorder($Component* c, $Graphics* g$renamed, int32_t x, int32_t y, int32_t width, int32_t height) {
	...
	if (size > 0.0f) {
		...
		if ($instanceOf($Graphics2D, g)) {
			...
			g2d->setPaint(this->paint != nullptr ? this->paint : c == nullptr ? ($Paint*)nullptr : $$cast($Paint, c->getForeground()));
			$init($RenderingHints);
...
$Class* StrokeBorder::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"<init>", "(Ljava/awt/BasicStroke;Ljava/awt/Paint;)V", nullptr, $PUBLIC, $method(StrokeBorder, init$, void, $BasicStroke*, $Paint*), nullptr, nullptr, init$methodAnnotations$$$1},
	...
	$loadClass(StrokeBorder, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
