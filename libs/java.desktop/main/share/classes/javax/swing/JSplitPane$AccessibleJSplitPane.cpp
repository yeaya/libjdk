...
$Number* JSplitPane$AccessibleJSplitPane::getMinimumAccessibleValue() {
	return $Integer::valueOf($$sure($SplitPaneUI, this->this$0->getUI())->getMinimumDividerLocation(this->this$0));
}

$Number* JSplitPane$AccessibleJSplitPane::getMaximumAccessibleValue() {
	return $Integer::valueOf($$sure($SplitPaneUI, this->this$0->getUI())->getMaximumDividerLocation(this->this$0));
}
...
$Class* JSplitPane$AccessibleJSplitPane::load$($String* name, bool initialize) {
	...
	$loadClass(JSplitPane$AccessibleJSplitPane, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
