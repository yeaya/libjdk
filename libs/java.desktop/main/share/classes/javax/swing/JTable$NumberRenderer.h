#ifndef _javax_swing_JTable$NumberRenderer_h_
#define _javax_swing_JTable$NumberRenderer_h_
//$ class javax.swing.JTable$NumberRenderer
...
class $export JTable$NumberRenderer : public ::javax::swing::table::DefaultTableCellRenderer$UIResource {
	$class(JTable$NumberRenderer, $NO_CLASS_INIT, ::javax::swing::table::DefaultTableCellRenderer$UIResource)
public:
...
#endif // _javax_swing_JTable$NumberRenderer_h_