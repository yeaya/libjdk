...
$Class* JComboBox$AccessibleJComboBox$AccessibleJComboBoxPopupMenuListener::load$($String* name, bool initialize) {
	...
	$loadClass(JComboBox$AccessibleJComboBox$AccessibleJComboBoxPopupMenuListener, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(JComboBox$AccessibleJComboBox$AccessibleJComboBoxPopupMenuListener);
	});
	return class$;
}
