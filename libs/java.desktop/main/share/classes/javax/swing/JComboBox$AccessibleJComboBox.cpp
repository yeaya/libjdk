...
void JComboBox$AccessibleJComboBox::init$($JComboBox* this$0) {
	...
	$var($Accessible, a, $$sure($ComboBoxUI, this$0->getUI())->getAccessibleChild(this$0, 0));
	if ($instanceOf($ComboPopup, a)) {
		$set(this, popupList, $cast($ComboPopup, a)->getList());
...
$Accessible* JComboBox$AccessibleJComboBox::getAccessibleChild(int32_t i) {
	if (this->this$0->ui != nullptr) {
		return this->this$0->ui->getAccessibleChild(this->this$0, i);
	} else {
...
$Accessible* JComboBox$AccessibleJComboBox::getAccessibleSelection(int32_t i) {
	$useLocalObjectStack();
	$var($Accessible, a, $$sure($ComboBoxUI, this->this$0->getUI())->getAccessibleChild(this->this$0, 0));
	if (a != nullptr && $instanceOf($ComboPopup, a)) {
		$var($JList, list, $cast($ComboPopup, a)->getList());
...
$Class* JComboBox$AccessibleJComboBox::load$($String* name, bool initialize) {
	...
	$loadClass(JComboBox$AccessibleJComboBox, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
