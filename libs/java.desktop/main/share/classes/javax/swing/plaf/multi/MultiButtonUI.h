#ifndef _javax_swing_plaf_multi_MultiButtonUI_h_
#define _javax_swing_plaf_multi_MultiButtonUI_h_
...
class $export MultiButtonUI : public ::javax::swing::plaf::ButtonUI {
	$class(MultiButtonUI, $NO_CLASS_INIT, ::javax::swing::plaf::ButtonUI)
public:
	MultiButtonUI();
	void init$();
...
#endif // _javax_swing_plaf_multi_MultiButtonUI_h_