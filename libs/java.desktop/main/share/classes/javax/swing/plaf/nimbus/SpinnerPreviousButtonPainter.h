#ifndef _javax_swing_plaf_nimbus_SpinnerPreviousButtonPainter_h_
#define _javax_swing_plaf_nimbus_SpinnerPreviousButtonPainter_h_
...
class SpinnerPreviousButtonPainter : public ::javax::swing::plaf::nimbus::AbstractRegionPainter {
	$class(SpinnerPreviousButtonPainter, $NO_CLASS_INIT, ::javax::swing::plaf::nimbus::AbstractRegionPainter)
public:
...
#endif // _javax_swing_plaf_nimbus_SpinnerPreviousButtonPainter_h_