#ifndef _javax_swing_plaf_nimbus_ComboBoxArrowButtonPainter_h_
#define _javax_swing_plaf_nimbus_ComboBoxArrowButtonPainter_h_
...
#pragma push_macro("BACKGROUND_DISABLED_EDITABLE")
#undef BACKGROUND_DISABLED_EDITABLE
#pragma push_macro("BACKGROUND_ENABLED")
#undef BACKGROUND_ENABLED
#pragma push_macro("BACKGROUND_ENABLED_EDITABLE")
...
#pragma push_macro("BACKGROUND_MOUSEOVER_EDITABLE")
#undef BACKGROUND_MOUSEOVER_EDITABLE
#pragma push_macro("BACKGROUND_PRESSED_EDITABLE")
#undef BACKGROUND_PRESSED_EDITABLE
#pragma push_macro("BACKGROUND_SELECTED_EDITABLE")
...
#pragma push_macro("FOREGROUND_SELECTED")
...
class ComboBoxArrowButtonPainter : public ::javax::swing::plaf::nimbus::AbstractRegionPainter {
	$class(ComboBoxArrowButtonPainter, $NO_CLASS_INIT, ::javax::swing::plaf::nimbus::AbstractRegionPainter)
public:
	...
	void paintBackgroundDisabledAndEditable(::java::awt::Graphics2D* g);
	void paintBackgroundEnabledAndEditable(::java::awt::Graphics2D* g);
	void paintBackgroundMouseOverAndEditable(::java::awt::Graphics2D* g);
	void paintBackgroundPressedAndEditable(::java::awt::Graphics2D* g);
	void paintBackgroundSelectedAndEditable(::java::awt::Graphics2D* g);
	...
	void paintForegroundSelected(::java::awt::Graphics2D* g);
	static const int32_t BACKGROUND_DISABLED = 1;
	static const int32_t BACKGROUND_ENABLED = 2;
	static const int32_t BACKGROUND_ENABLED_MOUSEOVER = 3;
	static const int32_t BACKGROUND_ENABLED_PRESSED = 4;
	static const int32_t BACKGROUND_DISABLED_EDITABLE = 5;
	static const int32_t BACKGROUND_ENABLED_EDITABLE = 6;
	static const int32_t BACKGROUND_MOUSEOVER_EDITABLE = 7;
	static const int32_t BACKGROUND_PRESSED_EDITABLE = 8;
	static const int32_t BACKGROUND_SELECTED_EDITABLE = 9;
	static const int32_t FOREGROUND_ENABLED = 10;
	static const int32_t FOREGROUND_MOUSEOVER = 11;
	static const int32_t FOREGROUND_DISABLED = 12;
	static const int32_t FOREGROUND_PRESSED = 13;
	static const int32_t FOREGROUND_SELECTED = 14;
	int32_t state = 0;
...
#pragma pop_macro("BACKGROUND_DISABLED_EDITABLE")
#pragma pop_macro("BACKGROUND_ENABLED")
#pragma pop_macro("BACKGROUND_ENABLED_EDITABLE")
#pragma pop_macro("BACKGROUND_ENABLED_MOUSEOVER")
#pragma pop_macro("BACKGROUND_ENABLED_PRESSED")
#pragma pop_macro("BACKGROUND_MOUSEOVER_EDITABLE")
#pragma pop_macro("BACKGROUND_PRESSED_EDITABLE")
#pragma pop_macro("BACKGROUND_SELECTED_EDITABLE")
...
#pragma pop_macro("FOREGROUND_SELECTED")

#endif // _javax_swing_plaf_nimbus_ComboBoxArrowButtonPainter_h_