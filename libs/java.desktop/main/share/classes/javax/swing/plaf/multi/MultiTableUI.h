#ifndef _javax_swing_plaf_multi_MultiTableUI_h_
#define _javax_swing_plaf_multi_MultiTableUI_h_
...
class $export MultiTableUI : public ::javax::swing::plaf::TableUI {
	$class(MultiTableUI, $NO_CLASS_INIT, ::javax::swing::plaf::TableUI)
public:
	MultiTableUI();
	void init$();
...
#endif // _javax_swing_plaf_multi_MultiTableUI_h_