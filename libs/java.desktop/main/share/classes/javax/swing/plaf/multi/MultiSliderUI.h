#ifndef _javax_swing_plaf_multi_MultiSliderUI_h_
#define _javax_swing_plaf_multi_MultiSliderUI_h_
...
class $export MultiSliderUI : public ::javax::swing::plaf::SliderUI {
	$class(MultiSliderUI, $NO_CLASS_INIT, ::javax::swing::plaf::SliderUI)
public:
	MultiSliderUI();
	void init$();
...
#endif // _javax_swing_plaf_multi_MultiSliderUI_h_