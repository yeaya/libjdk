...
$Path2D* TableHeaderPainter::decodePath1() {
	...
	double var$1 = decodeX(1.7070175f);
...
$Path2D* TableHeaderPainter::decodePath2() {
	...
	double var$2 = decodeX(1.5025063f);
	$nc(this->path)->lineTo(var$2, decodeY(2.0f));
	double var$3 = decodeX(1.0f);
...
$Class* TableHeaderPainter::load$($String* name, bool initialize) {
	...
	$loadClass(TableHeaderPainter, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TableHeaderPainter);
	});
	return class$;
}
