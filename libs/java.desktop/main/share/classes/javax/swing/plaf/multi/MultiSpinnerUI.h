#ifndef _javax_swing_plaf_multi_MultiSpinnerUI_h_
#define _javax_swing_plaf_multi_MultiSpinnerUI_h_
...
class $export MultiSpinnerUI : public ::javax::swing::plaf::SpinnerUI {
	$class(MultiSpinnerUI, $NO_CLASS_INIT, ::javax::swing::plaf::SpinnerUI)
public:
	MultiSpinnerUI();
	void init$();
...
#endif // _javax_swing_plaf_multi_MultiSpinnerUI_h_