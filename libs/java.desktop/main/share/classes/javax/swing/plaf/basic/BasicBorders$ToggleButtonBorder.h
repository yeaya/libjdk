#ifndef _javax_swing_plaf_basic_BasicBorders$ToggleButtonBorder_h_
#define _javax_swing_plaf_basic_BasicBorders$ToggleButtonBorder_h_
...
class $export BasicBorders$ToggleButtonBorder : public ::javax::swing::plaf::basic::BasicBorders$ButtonBorder {
	$class(BasicBorders$ToggleButtonBorder, $NO_CLASS_INIT, ::javax::swing::plaf::basic::BasicBorders$ButtonBorder)
public:
...
#endif // _javax_swing_plaf_basic_BasicBorders$ToggleButtonBorder_h_