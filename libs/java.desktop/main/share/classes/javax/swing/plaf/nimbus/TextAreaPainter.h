#ifndef _javax_swing_plaf_nimbus_TextAreaPainter_h_
#define _javax_swing_plaf_nimbus_TextAreaPainter_h_
//$ class javax.swing.plaf.nimbus.TextAreaPainter
...
class TextAreaPainter : public ::javax::swing::plaf::nimbus::AbstractRegionPainter {
	$class(TextAreaPainter, $NO_CLASS_INIT, ::javax::swing::plaf::nimbus::AbstractRegionPainter)
public:
	TextAreaPainter();
	...
	void paintBackgroundDisabledAndNotInScrollPane(::java::awt::Graphics2D* g);
	void paintBackgroundEnabled(::java::awt::Graphics2D* g);
	void paintBackgroundEnabledAndNotInScrollPane(::java::awt::Graphics2D* g);
	void paintBackgroundSelected(::java::awt::Graphics2D* g);
	void paintBorderDisabledAndNotInScrollPane(::java::awt::Graphics2D* g);
	void paintBorderEnabledAndNotInScrollPane(::java::awt::Graphics2D* g);
	void paintBorderFocusedAndNotInScrollPane(::java::awt::Graphics2D* g);
	static const int32_t BACKGROUND_DISABLED = 1;
	static const int32_t BACKGROUND_ENABLED = 2;
	static const int32_t BACKGROUND_DISABLED_NOTINSCROLLPANE = 3;
	static const int32_t BACKGROUND_ENABLED_NOTINSCROLLPANE = 4;
	static const int32_t BACKGROUND_SELECTED = 5;
	static const int32_t BORDER_DISABLED_NOTINSCROLLPANE = 6;
	static const int32_t BORDER_FOCUSED_NOTINSCROLLPANE = 7;
	static const int32_t BORDER_ENABLED_NOTINSCROLLPANE = 8;
	int32_t state = 0;
...
#pragma pop_macro("BACKGROUND_DISABLED_NOTINSCROLLPANE")
#pragma pop_macro("BACKGROUND_ENABLED")
#pragma pop_macro("BACKGROUND_ENABLED_NOTINSCROLLPANE")
#pragma pop_macro("BACKGROUND_SELECTED")
#pragma pop_macro("BORDER_DISABLED_NOTINSCROLLPANE")
#pragma pop_macro("BORDER_ENABLED_NOTINSCROLLPANE")
#pragma pop_macro("BORDER_FOCUSED_NOTINSCROLLPANE")

#endif // _javax_swing_plaf_nimbus_TextAreaPainter_h_