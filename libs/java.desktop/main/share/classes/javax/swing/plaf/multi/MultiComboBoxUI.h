#ifndef _javax_swing_plaf_multi_MultiComboBoxUI_h_
#define _javax_swing_plaf_multi_MultiComboBoxUI_h_
...
class $export MultiComboBoxUI : public ::javax::swing::plaf::ComboBoxUI {
	$class(MultiComboBoxUI, $NO_CLASS_INIT, ::javax::swing::plaf::ComboBoxUI)
public:
	MultiComboBoxUI();
	void init$();
	...
	virtual bool isFocusTraversable(::javax::swing::JComboBox* a) override;
	virtual bool isPopupVisible(::javax::swing::JComboBox* a) override;
	virtual void paint(::java::awt::Graphics* a, ::javax::swing::JComponent* b) override;
	virtual void setPopupVisible(::javax::swing::JComboBox* a, bool b) override;
...
#endif // _javax_swing_plaf_multi_MultiComboBoxUI_h_