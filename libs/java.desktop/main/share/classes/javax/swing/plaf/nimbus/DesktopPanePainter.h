#ifndef _javax_swing_plaf_nimbus_DesktopPanePainter_h_
#define _javax_swing_plaf_nimbus_DesktopPanePainter_h_
...
class DesktopPanePainter : public ::javax::swing::plaf::nimbus::AbstractRegionPainter {
	$class(DesktopPanePainter, $NO_CLASS_INIT, ::javax::swing::plaf::nimbus::AbstractRegionPainter)
public:
	DesktopPanePainter();
...
#endif // _javax_swing_plaf_nimbus_DesktopPanePainter_h_