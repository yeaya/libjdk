#ifndef _javax_swing_plaf_multi_MultiMenuItemUI_h_
#define _javax_swing_plaf_multi_MultiMenuItemUI_h_
...
class $export MultiMenuItemUI : public ::javax::swing::plaf::MenuItemUI {
	$class(MultiMenuItemUI, $NO_CLASS_INIT, ::javax::swing::plaf::MenuItemUI)
public:
	MultiMenuItemUI();
	void init$();
...
#endif // _javax_swing_plaf_multi_MultiMenuItemUI_h_