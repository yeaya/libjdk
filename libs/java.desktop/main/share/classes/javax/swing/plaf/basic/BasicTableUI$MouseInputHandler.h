#ifndef _javax_swing_plaf_basic_BasicTableUI$MouseInputHandler_h_
#define _javax_swing_plaf_basic_BasicTableUI$MouseInputHandler_h_
...
class $export BasicTableUI$MouseInputHandler : public ::javax::swing::event::MouseInputListener {
	$class(BasicTableUI$MouseInputHandler, $NO_CLASS_INIT, ::javax::swing::event::MouseInputListener)
public:
...
#endif // _javax_swing_plaf_basic_BasicTableUI$MouseInputHandler_h_