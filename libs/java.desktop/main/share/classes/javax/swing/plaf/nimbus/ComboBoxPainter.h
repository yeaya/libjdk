#ifndef _javax_swing_plaf_nimbus_ComboBoxPainter_h_
#define _javax_swing_plaf_nimbus_ComboBoxPainter_h_
...
#pragma push_macro("BACKGROUND_DISABLED_PRESSED")
...
#pragma push_macro("BACKGROUND_FOCUSED_EDITABLE")
...
class ComboBoxPainter : public ::javax::swing::plaf::nimbus::AbstractRegionPainter {
	$class(ComboBoxPainter, $NO_CLASS_INIT, ::javax::swing::plaf::nimbus::AbstractRegionPainter)
public:
	ComboBoxPainter();
	...
	void paintBackgroundDisabledAndPressed(::java::awt::Graphics2D* g);
	...
	void paintBackgroundFocusedAndEditable(::java::awt::Graphics2D* g);
	...
	static const int32_t BACKGROUND_DISABLED_PRESSED = 2;
	static const int32_t BACKGROUND_ENABLED = 3;
	static const int32_t BACKGROUND_FOCUSED = 4;
	static const int32_t BACKGROUND_MOUSEOVER_FOCUSED = 5;
	static const int32_t BACKGROUND_MOUSEOVER = 6;
	static const int32_t BACKGROUND_PRESSED_FOCUSED = 7;
	static const int32_t BACKGROUND_PRESSED = 8;
	static const int32_t BACKGROUND_ENABLED_SELECTED = 9;
	static const int32_t BACKGROUND_DISABLED_EDITABLE = 10;
	static const int32_t BACKGROUND_ENABLED_EDITABLE = 11;
	static const int32_t BACKGROUND_FOCUSED_EDITABLE = 12;
	static const int32_t BACKGROUND_MOUSEOVER_EDITABLE = 13;
	static const int32_t BACKGROUND_PRESSED_EDITABLE = 14;
	int32_t state = 0;
...
#pragma pop_macro("BACKGROUND_DISABLED_PRESSED")
...
#pragma pop_macro("BACKGROUND_FOCUSED_EDITABLE")
...
#endif // _javax_swing_plaf_nimbus_ComboBoxPainter_h_