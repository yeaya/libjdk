#ifndef _javax_swing_plaf_nimbus_ToggleButtonPainter_h_
#define _javax_swing_plaf_nimbus_ToggleButtonPainter_h_
//$ class javax.swing.plaf.nimbus.ToggleButtonPainter
...
class ToggleButtonPainter : public ::javax::swing::plaf::nimbus::AbstractRegionPainter {
	$class(ToggleButtonPainter, $NO_CLASS_INIT, ::javax::swing::plaf::nimbus::AbstractRegionPainter)
public:
	ToggleButtonPainter();
	...
	static const int32_t BACKGROUND_PRESSED = 6;
	static const int32_t BACKGROUND_PRESSED_FOCUSED = 7;
	static const int32_t BACKGROUND_SELECTED = 8;
	static const int32_t BACKGROUND_SELECTED_FOCUSED = 9;
	static const int32_t BACKGROUND_PRESSED_SELECTED = 10;
	static const int32_t BACKGROUND_PRESSED_SELECTED_FOCUSED = 11;
	static const int32_t BACKGROUND_MOUSEOVER_SELECTED = 12;
	static const int32_t BACKGROUND_MOUSEOVER_SELECTED_FOCUSED = 13;
	static const int32_t BACKGROUND_DISABLED_SELECTED = 14;
	int32_t state = 0;
...
#endif // _javax_swing_plaf_nimbus_ToggleButtonPainter_h_