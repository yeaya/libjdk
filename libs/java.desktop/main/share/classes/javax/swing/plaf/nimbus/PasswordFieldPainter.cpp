...
$Class* PasswordFieldPainter::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "(Ljavax/swing/plaf/nimbus/AbstractRegionPainter$PaintContext;I)V", nullptr, $PUBLIC, $method(PasswordFieldPainter, init$, void, $AbstractRegionPainter$PaintContext*, int32_t)},
		{"decodeGradient1", "(Ljava/awt/Shape;)Ljava/awt/Paint;", nullptr, $PRIVATE, $method(PasswordFieldPainter, decodeGradient1, $Paint*, $Shape*)},
		{"decodeGradient2", "(Ljava/awt/Shape;)Ljava/awt/Paint;", nullptr, $PRIVATE, $method(PasswordFieldPainter, decodeGradient2, $Paint*, $Shape*)},
		{"decodeGradient3", "(Ljava/awt/Shape;)Ljava/awt/Paint;", nullptr, $PRIVATE, $method(PasswordFieldPainter, decodeGradient3, $Paint*, $Shape*)},
		{"decodeGradient4", "(Ljava/awt/Shape;)Ljava/awt/Paint;", nullptr, $PRIVATE, $method(PasswordFieldPainter, decodeGradient4, $Paint*, $Shape*)},
		{"decodeGradient5", "(Ljava/awt/Shape;)Ljava/awt/Paint;", nullptr, $PRIVATE, $method(PasswordFieldPainter, decodeGradient5, $Paint*, $Shape*)},
		{"decodePath1", "()Ljava/awt/geom/Path2D;", nullptr, $PRIVATE, $method(PasswordFieldPainter, decodePath1, $Path2D*)},
		{"decodeRect1", "()Ljava/awt/geom/Rectangle2D;", nullptr, $PRIVATE, $method(PasswordFieldPainter, decodeRect1, $Rectangle2D*)},
		{"decodeRect10", "()Ljava/awt/geom/Rectangle2D;", nullptr, $PRIVATE, $method(PasswordFieldPainter, decodeRect10, $Rectangle2D*)},
		{"decodeRect11", "()Ljava/awt/geom/Rectangle2D;", nullptr, $PRIVATE, $method(PasswordFieldPainter, decodeRect11, $Rectangle2D*)},
		{"decodeRect2", "()Ljava/awt/geom/Rectangle2D;", nullptr, $PRIVATE, $method(PasswordFieldPainter, decodeRect2, $Rectangle2D*)},
		{"decodeRect3", "()Ljava/awt/geom/Rectangle2D;", nullptr, $PRIVATE, $method(PasswordFieldPainter, decodeRect3, $Rectangle2D*)},
		{"decodeRect4", "()Ljava/awt/geom/Rectangle2D;", nullptr, $PRIVATE, $method(PasswordFieldPainter, decodeRect4, $Rectangle2D*)},
		{"decodeRect5", "()Ljava/awt/geom/Rectangle2D;", nullptr, $PRIVATE, $method(PasswordFieldPainter, decodeRect5, $Rectangle2D*)},
		{"decodeRect6", "()Ljava/awt/geom/Rectangle2D;", nullptr, $PRIVATE, $method(PasswordFieldPainter, decodeRect6, $Rectangle2D*)},
		{"decodeRect7", "()Ljava/awt/geom/Rectangle2D;", nullptr, $PRIVATE, $method(PasswordFieldPainter, decodeRect7, $Rectangle2D*)},
		{"decodeRect8", "()Ljava/awt/geom/Rectangle2D;", nullptr, $PRIVATE, $method(PasswordFieldPainter, decodeRect8, $Rectangle2D*)},
		{"decodeRect9", "()Ljava/awt/geom/Rectangle2D;", nullptr, $PRIVATE, $method(PasswordFieldPainter, decodeRect9, $Rectangle2D*)},
		{"doPaint", "(Ljava/awt/Graphics2D;Ljavax/swing/JComponent;II[Ljava/lang/Object;)V", nullptr, $PROTECTED, $virtualMethod(PasswordFieldPainter, doPaint, void, $Graphics2D*, $JComponent*, int32_t, int32_t, $ObjectArray*)},
		{"getExtendedCacheKeys", "(Ljavax/swing/JComponent;)[Ljava/lang/Object;", nullptr, $PROTECTED, $virtualMethod(PasswordFieldPainter, getExtendedCacheKeys, $ObjectArray*, $JComponent*)},
		{"getPaintContext", "()Ljavax/swing/plaf/nimbus/AbstractRegionPainter$PaintContext;", nullptr, $PROTECTED | $FINAL, $virtualMethod(PasswordFieldPainter, getPaintContext, $AbstractRegionPainter$PaintContext*)},
		{"paintBackgroundDisabled", "(Ljava/awt/Graphics2D;)V", nullptr, $PRIVATE, $method(PasswordFieldPainter, paintBackgroundDisabled, void, $Graphics2D*)},
		{"paintBackgroundEnabled", "(Ljava/awt/Graphics2D;)V", nullptr, $PRIVATE, $method(PasswordFieldPainter, paintBackgroundEnabled, void, $Graphics2D*)},
		{"paintBackgroundSelected", "(Ljava/awt/Graphics2D;)V", nullptr, $PRIVATE, $method(PasswordFieldPainter, paintBackgroundSelected, void, $Graphics2D*)},
		{"paintBorderDisabled", "(Ljava/awt/Graphics2D;)V", nullptr, $PRIVATE, $method(PasswordFieldPainter, paintBorderDisabled, void, $Graphics2D*)},
		{"paintBorderEnabled", "(Ljava/awt/Graphics2D;)V", nullptr, $PRIVATE, $method(PasswordFieldPainter, paintBorderEnabled, void, $Graphics2D*)},
		{"paintBorderFocused", "(Ljava/awt/Graphics2D;)V", nullptr, $PRIVATE, $method(PasswordFieldPainter, paintBorderFocused, void, $Graphics2D*)},
		{}
	};
	$ClassInfo classInfo$$ = {
		$FINAL | $ACC_SUPER,
	...
	$loadClass(PasswordFieldPainter, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(PasswordFieldPainter);
	});
	return class$;
}
