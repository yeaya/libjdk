#ifndef _javax_swing_plaf_nimbus_OptionPaneMessageAreaOptionPaneLabelPainter_h_
#define _javax_swing_plaf_nimbus_OptionPaneMessageAreaOptionPaneLabelPainter_h_
//$ class javax.swing.plaf.nimbus.OptionPaneMessageAreaOptionPaneLabelPainter
...
class OptionPaneMessageAreaOptionPaneLabelPainter : public ::javax::swing::plaf::nimbus::AbstractRegionPainter {
	$class(OptionPaneMessageAreaOptionPaneLabelPainter, $NO_CLASS_INIT, ::javax::swing::plaf::nimbus::AbstractRegionPainter)
public:
...
#endif // _javax_swing_plaf_nimbus_OptionPaneMessageAreaOptionPaneLabelPainter_h_