...
void ImageScalingHelper$PaintType::clinit$($Class* clazz) {
...
$Class* ImageScalingHelper$PaintType::load$($String* name, bool initialize) {
	...
	$loadClass(ImageScalingHelper$PaintType, name, initialize, &classInfo$$, ImageScalingHelper$PaintType::clinit$, []($Class* clazz) -> $Object* {
