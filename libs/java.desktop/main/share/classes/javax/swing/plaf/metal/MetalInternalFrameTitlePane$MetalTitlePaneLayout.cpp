...
$Dimension* MetalInternalFrameTitlePane$MetalTitlePaneLayout::minimumLayoutSize($Container* c) {
	...
	if (title_length > 2) {
		$var($JComponent, var$0, $MetalInternalFrameTitlePane::access$1300(this->this$0));
		int32_t subtitle_w = $SwingUtilities2::stringWidth(var$0, fm, $$str({$($$nc($$nc($MetalInternalFrameTitlePane::access$1400(this->this$0))->getTitle())->substring(0, 2)), "..."_s}));
...
$Class* MetalInternalFrameTitlePane$MetalTitlePaneLayout::load$($String* name, bool initialize) {
	...
	$loadClass(MetalInternalFrameTitlePane$MetalTitlePaneLayout, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(MetalInternalFrameTitlePane$MetalTitlePaneLayout);
	});
	return class$;
}
