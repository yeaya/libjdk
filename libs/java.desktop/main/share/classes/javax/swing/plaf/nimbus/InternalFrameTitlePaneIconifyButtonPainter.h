#ifndef _javax_swing_plaf_nimbus_InternalFrameTitlePaneIconifyButtonPainter_h_
#define _javax_swing_plaf_nimbus_InternalFrameTitlePaneIconifyButtonPainter_h_
//$ class javax.swing.plaf.nimbus.InternalFrameTitlePaneIconifyButtonPainter
...
class InternalFrameTitlePaneIconifyButtonPainter : public ::javax::swing::plaf::nimbus::AbstractRegionPainter {
	$class(InternalFrameTitlePaneIconifyButtonPainter, $NO_CLASS_INIT, ::javax::swing::plaf::nimbus::AbstractRegionPainter)
public:
	...
	static const int32_t BACKGROUND_PRESSED = 4;
	static const int32_t BACKGROUND_ENABLED_WINDOWNOTFOCUSED = 5;
	static const int32_t BACKGROUND_MOUSEOVER_WINDOWNOTFOCUSED = 6;
	static const int32_t BACKGROUND_PRESSED_WINDOWNOTFOCUSED = 7;
	int32_t state = 0;
...
#endif // _javax_swing_plaf_nimbus_InternalFrameTitlePaneIconifyButtonPainter_h_