...
$Rectangle2D* PopupMenuPainter::decodeRect2() {
	double var$0 = decodeX(1.0045455f);
	double var$1 = decodeY(0.11111111f);
	float var$3 = decodeX(1.9954545f);
	double var$2 = var$3 - decodeX(1.0045455f);
...
$Rectangle2D* PopupMenuPainter::decodeRect4() {
	...
	double var$1 = decodeY(0.09090909f);
	float var$3 = decodeX(2.5f);
	double var$2 = var$3 - decodeX(0.5f);
	float var$4 = decodeY(2.909091f);
...
$Class* PopupMenuPainter::load$($String* name, bool initialize) {
	...
	$loadClass(PopupMenuPainter, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(PopupMenuPainter);
	});
	return class$;
}
