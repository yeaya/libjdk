#ifndef _javax_swing_plaf_nimbus_RadioButtonMenuItemPainter_h_
#define _javax_swing_plaf_nimbus_RadioButtonMenuItemPainter_h_
//$ class javax.swing.plaf.nimbus.RadioButtonMenuItemPainter
...
class RadioButtonMenuItemPainter : public ::javax::swing::plaf::nimbus::AbstractRegionPainter {
	$class(RadioButtonMenuItemPainter, $NO_CLASS_INIT, ::javax::swing::plaf::nimbus::AbstractRegionPainter)
public:
	...
	static const int32_t ICON_DISABLED = 8;
	static const int32_t ICON_ENABLED = 9;
	static const int32_t ICON_MOUSEOVER = 10;
	int32_t state = 0;
...
#endif // _javax_swing_plaf_nimbus_RadioButtonMenuItemPainter_h_