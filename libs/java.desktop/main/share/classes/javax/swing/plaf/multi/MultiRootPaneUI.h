#ifndef _javax_swing_plaf_multi_MultiRootPaneUI_h_
#define _javax_swing_plaf_multi_MultiRootPaneUI_h_
...
class $export MultiRootPaneUI : public ::javax::swing::plaf::RootPaneUI {
	$class(MultiRootPaneUI, $NO_CLASS_INIT, ::javax::swing::plaf::RootPaneUI)
public:
	MultiRootPaneUI();
	void init$();
...
#endif // _javax_swing_plaf_multi_MultiRootPaneUI_h_