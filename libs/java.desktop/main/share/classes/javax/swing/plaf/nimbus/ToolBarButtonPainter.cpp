...
$Path2D* ToolBarButtonPainter::decodePath1() {
	...
	double var$5 = decodeAnchorY(1.0434783f, -3.0f);
	...
	double var$9 = decodeAnchorY(1.9565217f, 3.0f);
	double var$10 = decodeAnchorX(1.9893618f, 3.0f);
	double var$11 = decodeAnchorY(2.8714287f, 0.0f);
	...
	double var$15 = decodeAnchorY(2.8714287f, 0.0f);
	double var$16 = decodeAnchorX(0.120000005f, 0.0f);
	double var$17 = decodeAnchorY(1.9565217f, 3.0f);
	...
	double var$21 = decodeAnchorY(1.0465839f, -3.0f);
	...
	double var$31 = decodeAnchorY(1.0403726f, -2.429218f);
	...
	double var$35 = decodeAnchorY(1.9565217f, 2.2142856f);
	double var$36 = decodeAnchorX(1.0106384f, -1.7857143f);
	double var$37 = decodeAnchorY(2.5142856f, 0.0f);
	...
	double var$41 = decodeAnchorY(2.5142856f, 0.0f);
	double var$42 = decodeAnchorX(2.5f, 0.0f);
	double var$43 = decodeAnchorY(1.9565217f, 2.2142856f);
	...
	double var$47 = decodeAnchorY(1.0434783f, -2.142857f);
...
$Class* ToolBarButtonPainter::load$($String* name, bool initialize) {
	...
	$loadClass(ToolBarButtonPainter, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(ToolBarButtonPainter);
	});
	return class$;
}
