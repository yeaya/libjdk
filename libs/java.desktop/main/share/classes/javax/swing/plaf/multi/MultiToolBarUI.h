#ifndef _javax_swing_plaf_multi_MultiToolBarUI_h_
#define _javax_swing_plaf_multi_MultiToolBarUI_h_
...
class $export MultiToolBarUI : public ::javax::swing::plaf::ToolBarUI {
	$class(MultiToolBarUI, $NO_CLASS_INIT, ::javax::swing::plaf::ToolBarUI)
public:
	MultiToolBarUI();
	void init$();
...
#endif // _javax_swing_plaf_multi_MultiToolBarUI_h_