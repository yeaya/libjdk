...
$Class* JTextComponent$AccessibleJTextComponent$4::load$($String* name, bool initialize) {
	...
	$loadClass(JTextComponent$AccessibleJTextComponent$4, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(JTextComponent$AccessibleJTextComponent$4);
	});
	return class$;
}
