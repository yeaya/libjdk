...
$Class* JTextComponent$AccessibleJTextComponent$3::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "(Ljavax/swing/text/JTextComponent$AccessibleJTextComponent;Ljava/lang/Integer;)V", "()V", 0, $method(JTextComponent$AccessibleJTextComponent$3, init$, void, $JTextComponent$AccessibleJTextComponent*, $Integer*)},
		{"run", "()V", nullptr, $PUBLIC, $virtualMethod(JTextComponent$AccessibleJTextComponent$3, run, void)},
		{}
	};
	...
	$loadClass(JTextComponent$AccessibleJTextComponent$3, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(JTextComponent$AccessibleJTextComponent$3);
	});
	return class$;
}
