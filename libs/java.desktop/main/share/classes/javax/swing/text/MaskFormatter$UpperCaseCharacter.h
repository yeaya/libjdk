#ifndef _javax_swing_text_MaskFormatter$UpperCaseCharacter_h_
#define _javax_swing_text_MaskFormatter$UpperCaseCharacter_h_
...
class MaskFormatter$UpperCaseCharacter : public ::javax::swing::text::MaskFormatter$MaskCharacter {
	$class(MaskFormatter$UpperCaseCharacter, $NO_CLASS_INIT, ::javax::swing::text::MaskFormatter$MaskCharacter)
public:
...
#endif // _javax_swing_text_MaskFormatter$UpperCaseCharacter_h_