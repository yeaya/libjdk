...
void NumericShaper$Range::clinit$($Class* clazz) {
	$assignStatic(NumericShaper$Range::EUROPEAN, $new(NumericShaper$Range, "EUROPEAN"_s, 0, u'0', u'\0', (char16_t)0x0300));
	$assignStatic(NumericShaper$Range::ARABIC, $new(NumericShaper$Range, "ARABIC"_s, 1, (char16_t)0x0660, (char16_t)0x0600, (char16_t)0x0780));
	$assignStatic(NumericShaper$Range::EASTERN_ARABIC, $new(NumericShaper$Range, "EASTERN_ARABIC"_s, 2, (char16_t)0x06f0, (char16_t)0x0600, (char16_t)0x0780));
	$assignStatic(NumericShaper$Range::DEVANAGARI, $new(NumericShaper$Range, "DEVANAGARI"_s, 3, (char16_t)0x0966, (char16_t)0x0900, (char16_t)0x0980));
	$assignStatic(NumericShaper$Range::BENGALI, $new(NumericShaper$Range, "BENGALI"_s, 4, (char16_t)0x09e6, (char16_t)0x0980, (char16_t)0x0a00));
	$assignStatic(NumericShaper$Range::GURMUKHI, $new(NumericShaper$Range, "GURMUKHI"_s, 5, (char16_t)0x0a66, (char16_t)0x0a00, (char16_t)0x0a80));
	$assignStatic(NumericShaper$Range::GUJARATI, $new(NumericShaper$Range, "GUJARATI"_s, 6, (char16_t)0x0ae6, (char16_t)0x0b00, (char16_t)0x0b80));
	$assignStatic(NumericShaper$Range::ORIYA, $new(NumericShaper$Range, "ORIYA"_s, 7, (char16_t)0x0b66, (char16_t)0x0b00, (char16_t)0x0b80));
	$assignStatic(NumericShaper$Range::TAMIL, $new(NumericShaper$Range, "TAMIL"_s, 8, (char16_t)0x0be6, (char16_t)0x0b80, (char16_t)0x0c00));
	$assignStatic(NumericShaper$Range::TELUGU, $new(NumericShaper$Range, "TELUGU"_s, 9, (char16_t)0x0c66, (char16_t)0x0c00, (char16_t)0x0c80));
	$assignStatic(NumericShaper$Range::KANNADA, $new(NumericShaper$Range, "KANNADA"_s, 10, (char16_t)0x0ce6, (char16_t)0x0c80, (char16_t)0x0d00));
	$assignStatic(NumericShaper$Range::MALAYALAM, $new(NumericShaper$Range, "MALAYALAM"_s, 11, (char16_t)0x0d66, (char16_t)0x0d00, (char16_t)0x0d80));
	$assignStatic(NumericShaper$Range::THAI, $new(NumericShaper$Range, "THAI"_s, 12, (char16_t)0x0e50, (char16_t)0x0e00, (char16_t)0x0e80));
	$assignStatic(NumericShaper$Range::LAO, $new(NumericShaper$Range, "LAO"_s, 13, (char16_t)0x0ed0, (char16_t)0x0e80, (char16_t)0x0f00));
	$assignStatic(NumericShaper$Range::TIBETAN, $new(NumericShaper$Range, "TIBETAN"_s, 14, (char16_t)0x0f20, (char16_t)0x0f00, (char16_t)0x1000));
	...
	$assignStatic(NumericShaper$Range::NKO, $new(NumericShaper$Range, "NKO"_s, 19, (char16_t)0x07c0, (char16_t)0x07c0, (char16_t)0x0800));
	...
	$assignStatic(NumericShaper$Range::SINHALA, $new(NumericShaper$Range, "SINHALA"_s, 35, (char16_t)0x0de6, (char16_t)0x0d80, (char16_t)0x0e00));
...
$Class* NumericShaper$Range::load$($String* name, bool initialize) {
	...
	$loadClass(NumericShaper$Range, name, initialize, &classInfo$$, NumericShaper$Range::clinit$, []($Class* clazz) -> $Object* {
