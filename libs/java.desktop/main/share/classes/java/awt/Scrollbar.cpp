...
$String* Scrollbar::constructComponentName() {
	$synchronized(Scrollbar::class$) {
		...
		var$0->append(Scrollbar::base);
		var$0->append(Scrollbar::nameCounter++);
		return $str(var$0);
	}
}
...
void Scrollbar::setOrientation(int32_t orientation) {
	...
	if (this->accessibleContext != nullptr) {
		...
		this->accessibleContext->firePropertyChange($AccessibleContext::ACCESSIBLE_STATE_PROPERTY, ((orientation == Scrollbar::VERTICAL) ? $AccessibleState::HORIZONTAL : $AccessibleState::VERTICAL), ((orientation == Scrollbar::VERTICAL) ? $AccessibleState::VERTICAL : $AccessibleState::HORIZONTAL));
	}
}
...
void Scrollbar::setValues(int32_t value, int32_t visible, int32_t minimum, int32_t maximum) {
	...
	if ((oldValue != value) && (this->accessibleContext != nullptr)) {
		...
		this->accessibleContext->firePropertyChange(var$0, var$1, $($Integer::valueOf(value)));
	}
}
...
$AdjustmentListenerArray* Scrollbar::getAdjustmentListeners() {
	$synchronized(this) {
		...
		return $cast($AdjustmentListenerArray, getListeners($AdjustmentListener::class$));
	}
}
...
bool Scrollbar::eventEnabled($AWTEvent* e) {
	if ($nc(e)->id == $AdjustmentEvent::ADJUSTMENT_VALUE_CHANGED) {
		if ((this->eventMask & $AWTEvent::ADJUSTMENT_EVENT_MASK) != 0 || this->adjustmentListener != nullptr) {
			return true;
		}
		return false;
	}
...
void Scrollbar::clinit$($Class* clazz) {
...
$Class* Scrollbar::load$($String* name, bool initialize) {
	...
	$CompoundAttribute getLineIncrementmethodAnnotations$$[] = {
		{"Ljava/lang/Deprecated;", nullptr},
		{}
	};
	$CompoundAttribute getPageIncrementmethodAnnotations$$[] = {
		{"Ljava/lang/Deprecated;", nullptr},
		{}
	};
	$CompoundAttribute getVisiblemethodAnnotations$$[] = {
		{"Ljava/lang/Deprecated;", nullptr},
		{}
	};
	$CompoundAttribute setLineIncrementmethodAnnotations$$[] = {
		{"Ljava/lang/Deprecated;", nullptr},
		{}
	};
	$CompoundAttribute setPageIncrementmethodAnnotations$$[] = {
		{"Ljava/lang/Deprecated;", nullptr},
		{}
	};
	$MethodInfo methodInfos$$[] = {
		...
		{"getLineIncrement", "()I", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(Scrollbar, getLineIncrement, int32_t), nullptr, nullptr, getLineIncrementmethodAnnotations$$},
		...
		{"getPageIncrement", "()I", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(Scrollbar, getPageIncrement, int32_t), nullptr, nullptr, getPageIncrementmethodAnnotations$$},
		...
		{"getVisible", "()I", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(Scrollbar, getVisible, int32_t), nullptr, nullptr, getVisiblemethodAnnotations$$},
		...
		{"setLineIncrement", "(I)V", nullptr, $PUBLIC | $SYNCHRONIZED | $DEPRECATED, $virtualMethod(Scrollbar, setLineIncrement, void, int32_t), nullptr, nullptr, setLineIncrementmethodAnnotations$$},
		...
		{"setPageIncrement", "(I)V", nullptr, $PUBLIC | $SYNCHRONIZED | $DEPRECATED, $virtualMethod(Scrollbar, setPageIncrement, void, int32_t), nullptr, nullptr, setPageIncrementmethodAnnotations$$},
	...
	$loadClass(Scrollbar, name, initialize, &classInfo$$, Scrollbar::clinit$, []($Class* clazz) -> $Object* {
