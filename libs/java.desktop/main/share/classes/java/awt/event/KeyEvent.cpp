...
void KeyEvent::clinit$($Class* clazz) {
	{
...
$Class* KeyEvent::load$($String* name, bool initialize) {
	...
	$NamedAttribute getKeyModifiersTextmethodAnnotations$$$namedAttribute[] = {
		{"since", 's', "9"},
		{}
	};
	$CompoundAttribute getKeyModifiersTextmethodAnnotations$$[] = {
		{"Ljava/lang/Deprecated;", getKeyModifiersTextmethodAnnotations$$$namedAttribute},
		{}
	};
	$CompoundAttribute setModifiersmethodAnnotations$$[] = {
		{"Ljava/lang/Deprecated;", nullptr},
		{}
	};
	$MethodInfo methodInfos$$[] = {
		...
		{"<init>", "(Ljava/awt/Component;IJII)V", nullptr, $PUBLIC | $DEPRECATED, $method(KeyEvent, init$, void, $Component*, int32_t, int64_t, int32_t, int32_t), nullptr, nullptr, init$methodAnnotations$$$3},
		...
		{"getKeyModifiersText", "(I)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC | $DEPRECATED, $staticMethod(KeyEvent, getKeyModifiersText, $String*, int32_t), nullptr, nullptr, getKeyModifiersTextmethodAnnotations$$},
		...
		{"setModifiers", "(I)V", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(KeyEvent, setModifiers, void, int32_t), nullptr, nullptr, setModifiersmethodAnnotations$$},
	...
	$loadClass(KeyEvent, name, initialize, &classInfo$$, KeyEvent::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(KeyEvent);
	});
	return class$;
}
