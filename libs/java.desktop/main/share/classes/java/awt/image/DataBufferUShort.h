#ifndef _java_awt_image_DataBufferUShort_h_
#define _java_awt_image_DataBufferUShort_h_
...
class $export DataBufferUShort : public ::java::awt::image::DataBuffer {
	$class(DataBufferUShort, $NO_CLASS_INIT, ::java::awt::image::DataBuffer)
public:
	DataBufferUShort();
...
#endif // _java_awt_image_DataBufferUShort_h_