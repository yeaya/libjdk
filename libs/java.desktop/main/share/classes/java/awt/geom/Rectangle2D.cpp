...
void Rectangle2D::intersect(Rectangle2D* src1, Rectangle2D* src2, Rectangle2D* dest) {
	...
	double var$1 = src1->getMinY();
	double y1 = $Math::max(var$1, src2->getMinY());
	double var$2 = src1->getMaxX();
	double x2 = $Math::min(var$2, src2->getMaxX());
	double var$3 = src1->getMaxY();
	double y2 = $Math::min(var$3, src2->getMaxY());
...
void Rectangle2D::union$(Rectangle2D* src1, Rectangle2D* src2, Rectangle2D* dest) {
	...
	double var$1 = src1->getMinY();
	double y1 = $Math::min(var$1, src2->getMinY());
	double var$2 = src1->getMaxX();
	double x2 = $Math::max(var$2, src2->getMaxX());
	double var$3 = src1->getMaxY();
	double y2 = $Math::max(var$3, src2->getMaxY());
...
void Rectangle2D::add(Rectangle2D* r) {
	...
	double x2 = $Math::max(var$1, r->getMaxX());
	double var$2 = getMinY();
	double y1 = $Math::min(var$2, r->getMinY());
	double var$3 = getMaxY();
	double y2 = $Math::max(var$3, r->getMaxY());
	setRect(x1, y1, x2 - x1, y2 - y1);
}
...
$Class* Rectangle2D::load$($String* name, bool initialize) {
	...
	$loadClass(Rectangle2D, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
