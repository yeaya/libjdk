...
bool ComponentOrientation::isHorizontal() {
	return (this->orientation & ComponentOrientation::HORIZ_BIT) != 0;
}

bool ComponentOrientation::isLeftToRight() {
	return (this->orientation & ComponentOrientation::LTR_BIT) != 0;
}
...
void ComponentOrientation::clinit$($Class* clazz) {
...
$Class* ComponentOrientation::load$($String* name, bool initialize) {
	...
	$CompoundAttribute getOrientationmethodAnnotations$$$1[] = {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"getOrientation", "(Ljava/util/ResourceBundle;)Ljava/awt/ComponentOrientation;", nullptr, $PUBLIC | $STATIC | $DEPRECATED, $staticMethod(ComponentOrientation, getOrientation, ComponentOrientation*, $ResourceBundle*), nullptr, nullptr, getOrientationmethodAnnotations$$$1},
	...
	$loadClass(ComponentOrientation, name, initialize, &classInfo$$, ComponentOrientation::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(ComponentOrientation);
	});
	return class$;
}
