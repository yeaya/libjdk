...
void JobAttributes$SidesType::clinit$($Class* clazz) {
...
$Class* JobAttributes$SidesType::load$($String* name, bool initialize) {
	...
	$loadClass(JobAttributes$SidesType, name, initialize, &classInfo$$, JobAttributes$SidesType::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(JobAttributes$SidesType);
	});
	return class$;
}
