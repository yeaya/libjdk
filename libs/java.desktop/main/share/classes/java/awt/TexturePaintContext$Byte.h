#ifndef _java_awt_TexturePaintContext$Byte_h_
#define _java_awt_TexturePaintContext$Byte_h_
...
class TexturePaintContext$Byte : public ::java::awt::TexturePaintContext {
	$class(TexturePaintContext$Byte, $NO_CLASS_INIT, ::java::awt::TexturePaintContext)
public:
...
#endif // _java_awt_TexturePaintContext$Byte_h_