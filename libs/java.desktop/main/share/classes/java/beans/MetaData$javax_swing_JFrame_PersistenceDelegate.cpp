...
void MetaData$javax_swing_JFrame_PersistenceDelegate::initialize($Class* type, Object$* oldInstance, Object$* newInstance, $Encoder* out) {
	...
	if (newV != oldV) {
		...
		invokeStatement(oldInstance, "setVisible"_s, $$new($ObjectArray, {$($Boolean::valueOf(oldV))}), out);
...
$Class* MetaData$javax_swing_JFrame_PersistenceDelegate::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, 0, $method(MetaData$javax_swing_JFrame_PersistenceDelegate, init$, void)},
		{"initialize", "(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/Object;Ljava/beans/Encoder;)V", "(Ljava/lang/Class<*>;Ljava/lang/Object;Ljava/lang/Object;Ljava/beans/Encoder;)V", $PROTECTED, $virtualMethod(MetaData$javax_swing_JFrame_PersistenceDelegate, initialize, void, $Class*, Object$*, Object$*, $Encoder*)},
		{}
	};
	...
	$loadClass(MetaData$javax_swing_JFrame_PersistenceDelegate, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(MetaData$javax_swing_JFrame_PersistenceDelegate);
	});
	return class$;
}
