...
$Class* MetaData$java_util_Collections$EmptyMap_PersistenceDelegate::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, 0, $method(MetaData$java_util_Collections$EmptyMap_PersistenceDelegate, init$, void)},
		{"instantiate", "(Ljava/lang/Object;Ljava/beans/Encoder;)Ljava/beans/Expression;", nullptr, $PROTECTED, $virtualMethod(MetaData$java_util_Collections$EmptyMap_PersistenceDelegate, instantiate, $Expression*, Object$*, $Encoder*)},
		{}
	};
	...
	$loadClass(MetaData$java_util_Collections$EmptyMap_PersistenceDelegate, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(MetaData$java_util_Collections$EmptyMap_PersistenceDelegate);
	});
	return class$;
}
