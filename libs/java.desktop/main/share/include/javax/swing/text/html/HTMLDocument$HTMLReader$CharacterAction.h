#ifndef _javax_swing_text_html_HTMLDocument$HTMLReader$CharacterAction_h_
#define _javax_swing_text_html_HTMLDocument$HTMLReader$CharacterAction_h_
...
class $import HTMLDocument$HTMLReader$CharacterAction : public ::javax::swing::text::html::HTMLDocument$HTMLReader$TagAction {
	$class(HTMLDocument$HTMLReader$CharacterAction, $NO_CLASS_INIT, ::javax::swing::text::html::HTMLDocument$HTMLReader$TagAction)
public:
...
#endif // _javax_swing_text_html_HTMLDocument$HTMLReader$CharacterAction_h_