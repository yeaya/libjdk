#ifndef _javax_swing_text_html_HTMLDocument$HTMLReader$StyleAction_h_
#define _javax_swing_text_html_HTMLDocument$HTMLReader$StyleAction_h_
//$ class javax.swing.text.html.HTMLDocument$HTMLReader$StyleAction
...
class $import HTMLDocument$HTMLReader$StyleAction : public ::javax::swing::text::html::HTMLDocument$HTMLReader$TagAction {
	$class(HTMLDocument$HTMLReader$StyleAction, $NO_CLASS_INIT, ::javax::swing::text::html::HTMLDocument$HTMLReader$TagAction)
public:
...
#endif // _javax_swing_text_html_HTMLDocument$HTMLReader$StyleAction_h_