#ifndef _javax_swing_text_html_HTMLDocument$HTMLReader$IsindexAction_h_
#define _javax_swing_text_html_HTMLDocument$HTMLReader$IsindexAction_h_
...
class $import HTMLDocument$HTMLReader$IsindexAction : public ::javax::swing::text::html::HTMLDocument$HTMLReader$TagAction {
	$class(HTMLDocument$HTMLReader$IsindexAction, $NO_CLASS_INIT, ::javax::swing::text::html::HTMLDocument$HTMLReader$TagAction)
public:
...
#endif // _javax_swing_text_html_HTMLDocument$HTMLReader$IsindexAction_h_