#ifndef _javax_swing_plaf_synth_SynthPasswordFieldUI_h_
#define _javax_swing_plaf_synth_SynthPasswordFieldUI_h_
...
class $import SynthPasswordFieldUI : public ::javax::swing::plaf::synth::SynthTextFieldUI {
	$class(SynthPasswordFieldUI, $NO_CLASS_INIT, ::javax::swing::plaf::synth::SynthTextFieldUI)
public:
...
#endif // _javax_swing_plaf_synth_SynthPasswordFieldUI_h_