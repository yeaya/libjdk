#ifndef _javax_swing_plaf_basic_BasicMenuItemUI$MouseInputHandler_h_
#define _javax_swing_plaf_basic_BasicMenuItemUI$MouseInputHandler_h_
...
class $import BasicMenuItemUI$MouseInputHandler : public ::javax::swing::event::MouseInputListener {
	$class(BasicMenuItemUI$MouseInputHandler, $NO_CLASS_INIT, ::javax::swing::event::MouseInputListener)
public:
...
#endif // _javax_swing_plaf_basic_BasicMenuItemUI$MouseInputHandler_h_