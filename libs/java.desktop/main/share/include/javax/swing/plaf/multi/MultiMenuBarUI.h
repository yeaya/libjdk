#ifndef _javax_swing_plaf_multi_MultiMenuBarUI_h_
#define _javax_swing_plaf_multi_MultiMenuBarUI_h_
...
class $import MultiMenuBarUI : public ::javax::swing::plaf::MenuBarUI {
	$class(MultiMenuBarUI, $NO_CLASS_INIT, ::javax::swing::plaf::MenuBarUI)
public:
	MultiMenuBarUI();
	void init$();
...
#endif // _javax_swing_plaf_multi_MultiMenuBarUI_h_