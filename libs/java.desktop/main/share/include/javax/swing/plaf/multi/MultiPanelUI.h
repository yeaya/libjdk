#ifndef _javax_swing_plaf_multi_MultiPanelUI_h_
#define _javax_swing_plaf_multi_MultiPanelUI_h_
...
class $import MultiPanelUI : public ::javax::swing::plaf::PanelUI {
	$class(MultiPanelUI, $NO_CLASS_INIT, ::javax::swing::plaf::PanelUI)
public:
	MultiPanelUI();
	void init$();
...
#endif // _javax_swing_plaf_multi_MultiPanelUI_h_