#ifndef _javax_swing_plaf_multi_MultiTableHeaderUI_h_
#define _javax_swing_plaf_multi_MultiTableHeaderUI_h_
...
class $import MultiTableHeaderUI : public ::javax::swing::plaf::TableHeaderUI {
	$class(MultiTableHeaderUI, $NO_CLASS_INIT, ::javax::swing::plaf::TableHeaderUI)
public:
	MultiTableHeaderUI();
	void init$();
...
#endif // _javax_swing_plaf_multi_MultiTableHeaderUI_h_