#ifndef _javax_swing_plaf_multi_MultiProgressBarUI_h_
#define _javax_swing_plaf_multi_MultiProgressBarUI_h_
...
class $import MultiProgressBarUI : public ::javax::swing::plaf::ProgressBarUI {
	$class(MultiProgressBarUI, $NO_CLASS_INIT, ::javax::swing::plaf::ProgressBarUI)
public:
	MultiProgressBarUI();
	void init$();
...
#endif // _javax_swing_plaf_multi_MultiProgressBarUI_h_