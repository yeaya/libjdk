#ifndef _javax_swing_plaf_multi_MultiLabelUI_h_
#define _javax_swing_plaf_multi_MultiLabelUI_h_
...
class $import MultiLabelUI : public ::javax::swing::plaf::LabelUI {
	$class(MultiLabelUI, $NO_CLASS_INIT, ::javax::swing::plaf::LabelUI)
public:
	MultiLabelUI();
	void init$();
...
#endif // _javax_swing_plaf_multi_MultiLabelUI_h_