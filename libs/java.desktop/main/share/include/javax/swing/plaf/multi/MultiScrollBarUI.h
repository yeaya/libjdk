#ifndef _javax_swing_plaf_multi_MultiScrollBarUI_h_
#define _javax_swing_plaf_multi_MultiScrollBarUI_h_
...
class $import MultiScrollBarUI : public ::javax::swing::plaf::ScrollBarUI {
	$class(MultiScrollBarUI, $NO_CLASS_INIT, ::javax::swing::plaf::ScrollBarUI)
public:
	MultiScrollBarUI();
	void init$();
...
#endif // _javax_swing_plaf_multi_MultiScrollBarUI_h_