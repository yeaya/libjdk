#ifndef _javax_swing_plaf_multi_MultiScrollPaneUI_h_
#define _javax_swing_plaf_multi_MultiScrollPaneUI_h_
...
class $import MultiScrollPaneUI : public ::javax::swing::plaf::ScrollPaneUI {
	$class(MultiScrollPaneUI, $NO_CLASS_INIT, ::javax::swing::plaf::ScrollPaneUI)
public:
	MultiScrollPaneUI();
	void init$();
...
#endif // _javax_swing_plaf_multi_MultiScrollPaneUI_h_