#ifndef _javax_swing_plaf_multi_MultiSeparatorUI_h_
#define _javax_swing_plaf_multi_MultiSeparatorUI_h_
...
class $import MultiSeparatorUI : public ::javax::swing::plaf::SeparatorUI {
	$class(MultiSeparatorUI, $NO_CLASS_INIT, ::javax::swing::plaf::SeparatorUI)
public:
	MultiSeparatorUI();
	void init$();
...
#endif // _javax_swing_plaf_multi_MultiSeparatorUI_h_