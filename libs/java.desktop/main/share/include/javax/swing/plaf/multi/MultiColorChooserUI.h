#ifndef _javax_swing_plaf_multi_MultiColorChooserUI_h_
#define _javax_swing_plaf_multi_MultiColorChooserUI_h_
...
class $import MultiColorChooserUI : public ::javax::swing::plaf::ColorChooserUI {
	$class(MultiColorChooserUI, $NO_CLASS_INIT, ::javax::swing::plaf::ColorChooserUI)
public:
	MultiColorChooserUI();
	void init$();
...
#endif // _javax_swing_plaf_multi_MultiColorChooserUI_h_