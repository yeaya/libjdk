#ifndef _javax_swing_plaf_multi_MultiDesktopPaneUI_h_
#define _javax_swing_plaf_multi_MultiDesktopPaneUI_h_
...
class $import MultiDesktopPaneUI : public ::javax::swing::plaf::DesktopPaneUI {
	$class(MultiDesktopPaneUI, $NO_CLASS_INIT, ::javax::swing::plaf::DesktopPaneUI)
public:
	MultiDesktopPaneUI();
	void init$();
...
#endif // _javax_swing_plaf_multi_MultiDesktopPaneUI_h_