#ifndef _com_sun_java_swing_plaf_motif_MotifInternalFrameTitlePane$MaximizeButton_h_
#define _com_sun_java_swing_plaf_motif_MotifInternalFrameTitlePane$MaximizeButton_h_
//$ class com.sun.java.swing.plaf.motif.MotifInternalFrameTitlePane$MaximizeButton
...
class $import MotifInternalFrameTitlePane$MaximizeButton : public ::com::sun::java::swing::plaf::motif::MotifInternalFrameTitlePane$FrameButton {
	$class(MotifInternalFrameTitlePane$MaximizeButton, $NO_CLASS_INIT, ::com::sun::java::swing::plaf::motif::MotifInternalFrameTitlePane$FrameButton)
public:
...
#endif // _com_sun_java_swing_plaf_motif_MotifInternalFrameTitlePane$MaximizeButton_h_