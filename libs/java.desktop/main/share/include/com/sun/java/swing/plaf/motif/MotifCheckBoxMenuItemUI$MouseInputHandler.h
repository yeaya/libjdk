#ifndef _com_sun_java_swing_plaf_motif_MotifCheckBoxMenuItemUI$MouseInputHandler_h_
#define _com_sun_java_swing_plaf_motif_MotifCheckBoxMenuItemUI$MouseInputHandler_h_
//$ class com.sun.java.swing.plaf.motif.MotifCheckBoxMenuItemUI$MouseInputHandler
...
class $import MotifCheckBoxMenuItemUI$MouseInputHandler : public ::javax::swing::event::MouseInputListener {
	$class(MotifCheckBoxMenuItemUI$MouseInputHandler, $NO_CLASS_INIT, ::javax::swing::event::MouseInputListener)
public:
...
#endif // _com_sun_java_swing_plaf_motif_MotifCheckBoxMenuItemUI$MouseInputHandler_h_