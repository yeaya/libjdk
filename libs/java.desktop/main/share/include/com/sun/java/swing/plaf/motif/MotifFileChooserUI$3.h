#ifndef _com_sun_java_swing_plaf_motif_MotifFileChooserUI$3_h_
#define _com_sun_java_swing_plaf_motif_MotifFileChooserUI$3_h_
//$ class com.sun.java.swing.plaf.motif.MotifFileChooserUI$3
...
class $import MotifFileChooserUI$3 : public ::javax::swing::JTextField {
	$class(MotifFileChooserUI$3, $NO_CLASS_INIT, ::javax::swing::JTextField)
public:
	...
	void init$(::com::sun::java::swing::plaf::motif::MotifFileChooserUI* this$0, $String* text, int32_t columns);
...
#endif // _com_sun_java_swing_plaf_motif_MotifFileChooserUI$3_h_