#ifndef _com_sun_java_swing_plaf_gtk_GTKFileChooserUI$DirectoryCellRenderer_h_
#define _com_sun_java_swing_plaf_gtk_GTKFileChooserUI$DirectoryCellRenderer_h_
//$ class com.sun.java.swing.plaf.gtk.GTKFileChooserUI$DirectoryCellRenderer
...
class GTKFileChooserUI$DirectoryCellRenderer : public ::javax::swing::DefaultListCellRenderer {
	$class(GTKFileChooserUI$DirectoryCellRenderer, $NO_CLASS_INIT, ::javax::swing::DefaultListCellRenderer)
public:
...
#endif // _com_sun_java_swing_plaf_gtk_GTKFileChooserUI$DirectoryCellRenderer_h_