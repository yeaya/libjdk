...
void GTKLookAndFeel$GnomeLayoutStyle::clinit$($Class* clazz) {
...
$Class* GTKLookAndFeel$GnomeLayoutStyle::load$($String* name, bool initialize) {
	...
	$loadClass(GTKLookAndFeel$GnomeLayoutStyle, name, initialize, &classInfo$$, GTKLookAndFeel$GnomeLayoutStyle::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(GTKLookAndFeel$GnomeLayoutStyle);
	});
	return class$;
}
