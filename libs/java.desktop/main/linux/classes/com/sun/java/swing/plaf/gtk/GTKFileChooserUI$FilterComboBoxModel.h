#ifndef _com_sun_java_swing_plaf_gtk_GTKFileChooserUI$FilterComboBoxModel_h_
#define _com_sun_java_swing_plaf_gtk_GTKFileChooserUI$FilterComboBoxModel_h_
//$ class com.sun.java.swing.plaf.gtk.GTKFileChooserUI$FilterComboBoxModel
...
class GTKFileChooserUI$FilterComboBoxModel : public ::javax::swing::AbstractListModel, public ::javax::swing::ComboBoxModel, public ::java::beans::PropertyChangeListener {
	$class(GTKFileChooserUI$FilterComboBoxModel, $NO_CLASS_INIT, ::javax::swing::AbstractListModel, ::javax::swing::ComboBoxModel, ::java::beans::PropertyChangeListener)
public:
...
#endif // _com_sun_java_swing_plaf_gtk_GTKFileChooserUI$FilterComboBoxModel_h_