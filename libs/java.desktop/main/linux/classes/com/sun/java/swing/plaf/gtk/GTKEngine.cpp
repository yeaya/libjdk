...
void GTKEngine::native_paint_arrow(int32_t widgetType, int32_t state, int32_t shadowType, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height, int32_t arrowType) {
	$prepareNative(native_paint_arrow, void, int32_t widgetType, int32_t state, int32_t shadowType, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height, int32_t arrowType);
...
void GTKEngine::native_paint_box(int32_t widgetType, int32_t state, int32_t shadowType, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height, int32_t synthState, int32_t dir) {
	$prepareNative(native_paint_box, void, int32_t widgetType, int32_t state, int32_t shadowType, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height, int32_t synthState, int32_t dir);
...
void GTKEngine::native_paint_box_gap(int32_t widgetType, int32_t state, int32_t shadowType, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height, int32_t gapSide, int32_t gapX, int32_t gapWidth) {
	$prepareNative(native_paint_box_gap, void, int32_t widgetType, int32_t state, int32_t shadowType, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height, int32_t gapSide, int32_t gapX, int32_t gapWidth);
...
void GTKEngine::native_paint_check(int32_t widgetType, int32_t synthState, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height) {
	$prepareNative(native_paint_check, void, int32_t widgetType, int32_t synthState, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height);
...
void GTKEngine::native_paint_expander(int32_t widgetType, int32_t state, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height, int32_t expanderStyle) {
	$prepareNative(native_paint_expander, void, int32_t widgetType, int32_t state, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height, int32_t expanderStyle);
...
void GTKEngine::native_paint_extension(int32_t widgetType, int32_t state, int32_t shadowType, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height, int32_t placement) {
	$prepareNative(native_paint_extension, void, int32_t widgetType, int32_t state, int32_t shadowType, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height, int32_t placement);
...
void GTKEngine::native_paint_flat_box(int32_t widgetType, int32_t state, int32_t shadowType, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height, bool hasFocus) {
	$prepareNative(native_paint_flat_box, void, int32_t widgetType, int32_t state, int32_t shadowType, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height, bool hasFocus);
...
void GTKEngine::native_paint_focus(int32_t widgetType, int32_t state, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height) {
	$prepareNative(native_paint_focus, void, int32_t widgetType, int32_t state, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height);
...
void GTKEngine::native_paint_handle(int32_t widgetType, int32_t state, int32_t shadowType, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height, int32_t orientation) {
	$prepareNative(native_paint_handle, void, int32_t widgetType, int32_t state, int32_t shadowType, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height, int32_t orientation);
...
void GTKEngine::native_paint_hline(int32_t widgetType, int32_t state, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height) {
	$prepareNative(native_paint_hline, void, int32_t widgetType, int32_t state, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height);
	$invokeNative(widgetType, state, detail, x, y, width, height);
	$finishNative();
}
...
void GTKEngine::native_paint_option(int32_t widgetType, int32_t synthState, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height) {
	$prepareNative(native_paint_option, void, int32_t widgetType, int32_t synthState, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height);
	$invokeNative(widgetType, synthState, detail, x, y, width, height);
	$finishNative();
}
...
void GTKEngine::native_paint_shadow(int32_t widgetType, int32_t state, int32_t shadowType, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height, int32_t synthState, int32_t dir) {
	$prepareNative(native_paint_shadow, void, int32_t widgetType, int32_t state, int32_t shadowType, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height, int32_t synthState, int32_t dir);
	$invokeNative(widgetType, state, shadowType, detail, x, y, width, height, synthState, dir);
	$finishNative();
}
...
void GTKEngine::native_paint_slider(int32_t widgetType, int32_t state, int32_t shadowType, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height, int32_t orientation, bool hasFocus) {
	$prepareNative(native_paint_slider, void, int32_t widgetType, int32_t state, int32_t shadowType, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height, int32_t orientation, bool hasFocus);
...
void GTKEngine::native_paint_vline(int32_t widgetType, int32_t state, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height) {
	$prepareNative(native_paint_vline, void, int32_t widgetType, int32_t state, $String* detail, int32_t x, int32_t y, int32_t width, int32_t height);
	$invokeNative(widgetType, state, detail, x, y, width, height);
	$finishNative();
}

void GTKEngine::native_paint_background(int32_t widgetType, int32_t state, int32_t x, int32_t y, int32_t width, int32_t height) {
	$prepareNative(native_paint_background, void, int32_t widgetType, int32_t state, int32_t x, int32_t y, int32_t width, int32_t height);
	$invokeNative(widgetType, state, x, y, width, height);
	$finishNative();
}

$Object* GTKEngine::native_get_gtk_setting(int32_t property) {
	$prepareNative(native_get_gtk_setting, $Object*, int32_t property);
	$var($Object, $ret, $invokeNativeObject(property));
	$finishNative();
	return $ret;
}

void GTKEngine::nativeSetRangeValue(int32_t widgetType, double value, double min, double max, double visible) {
	$prepareNative(nativeSetRangeValue, void, int32_t widgetType, double value, double min, double max, double visible);
	$invokeNative(widgetType, value, min, max, visible);
	$finishNative();
}

void GTKEngine::nativeStartPainting(int32_t w, int32_t h) {
	$prepareNative(nativeStartPainting, void, int32_t w, int32_t h);
	$invokeNative(w, h);
	$finishNative();
}

int32_t GTKEngine::nativeFinishPainting($ints* buffer, int32_t width, int32_t height) {
	$prepareNative(nativeFinishPainting, int32_t, $ints* buffer, int32_t width, int32_t height);
	int32_t $ret = $invokeNative(buffer, width, height);
	$finishNative();
	return $ret;
}

void GTKEngine::native_switch_theme() {
	$prepareNative(native_switch_theme, void);
	$invokeNative();
	$finishNative();
}
...
$GTKEngine$WidgetType* GTKEngine::getWidgetType($JComponent* c, $Region* id) {
	...
	if ($instanceOf($JScrollBar, c)) {
		return ($cast($JScrollBar, c)->getOrientation() == $JScrollBar::HORIZONTAL) ? $nc(widgets)->get(0) : $nc(widgets)->get(1);
	} else if ($instanceOf($JSeparator, c)) {
		$var($JSeparator, separator, $cast($JSeparator, c));
		if ($instanceOf($JPopupMenu, $(separator->getParent()))) {
		...
		return (separator->getOrientation() == $JSeparator::HORIZONTAL) ? $nc(widgets)->get(0) : $nc(widgets)->get(1);
	} else if ($instanceOf($JSlider, c)) {
		return ($cast($JSlider, c)->getOrientation() == $JSlider::HORIZONTAL) ? $nc(widgets)->get(0) : $nc(widgets)->get(1);
	} else if ($instanceOf($JProgressBar, c)) {
		return ($cast($JProgressBar, c)->getOrientation() == $JProgressBar::HORIZONTAL) ? $nc(widgets)->get(0) : $nc(widgets)->get(1);
	} else if ($instanceOf($JSplitPane, c)) {
		return ($cast($JSplitPane, c)->getOrientation() == $JSplitPane::HORIZONTAL_SPLIT) ? $nc(widgets)->get(1) : $nc(widgets)->get(0);
	} else {
		$init($Region);
		if (id == $Region::LABEL) {
			...
			if ($instanceOf($JScrollBar, $($nc(c)->getParent()))) {
				...
				int32_t dir = (prop != nullptr) ? prop->intValue() : $SwingConstants::WEST;
				switch (dir) {
...
void GTKEngine::paintArrow($Graphics* g, $SynthContext* context, $Region* id, int32_t state, $GTKConstants$ShadowType* shadowType, $GTKConstants$ArrowType* direction, $String* detail, int32_t x, int32_t y, int32_t w, int32_t h) {
	...
	int32_t var$0 = $nc(shadowType)->ordinal();
	int32_t var$1 = x - this->x0;
	int32_t var$2 = y - this->y0;
	native_paint_arrow(widget, state, var$0, detail, var$1, var$2, w, h, $nc(direction)->ordinal());
}
...
void GTKEngine::paintBoxGap($Graphics* g, $SynthContext* context, $Region* id, int32_t state, $GTKConstants$ShadowType* shadowType, $String* detail, int32_t x, int32_t y, int32_t w, int32_t h, $GTKConstants$PositionType* boxGapType, int32_t tabBegin, int32_t size) {
	...
	int32_t var$1 = x - this->x0;
	int32_t var$2 = y - this->y0;
	native_paint_box_gap(widget, state, var$0, detail, var$1, var$2, w, h, $nc(boxGapType)->ordinal(), tabBegin, size);
}
...
void GTKEngine::paintExtension($Graphics* g, $SynthContext* context, $Region* id, int32_t state, $GTKConstants$ShadowType* shadowType, $String* detail, int32_t x, int32_t y, int32_t w, int32_t h, $GTKConstants$PositionType* placement, int32_t tabIndex) {
	...
	int32_t var$1 = x - this->x0;
	int32_t var$2 = y - this->y0;
	native_paint_extension(widget, state, var$0, detail, var$1, var$2, w, h, $nc(placement)->ordinal());
}
...
void GTKEngine::paintFlatBox($Graphics* g, $SynthContext* context, $Region* id, int32_t state, $GTKConstants$ShadowType* shadowType, $String* detail, int32_t x, int32_t y, int32_t w, int32_t h, $ColorType* colorType) {
	...
	int32_t var$1 = x - this->x0;
	int32_t var$2 = y - this->y0;
	native_paint_flat_box(widget, state, var$0, detail, var$1, var$2, w, h, $$nc(context->getComponent())->hasFocus());
}
...
void GTKEngine::paintHandle($Graphics* g, $SynthContext* context, $Region* id, int32_t state, $GTKConstants$ShadowType* shadowType, $String* detail, int32_t x, int32_t y, int32_t w, int32_t h, $GTKConstants$Orientation* orientation) {
	...
	int32_t var$1 = x - this->x0;
	int32_t var$2 = y - this->y0;
	native_paint_handle(widget, state, var$0, detail, var$1, var$2, w, h, $nc(orientation)->ordinal());
}
...
void GTKEngine::paintSlider($Graphics* g, $SynthContext* context, $Region* id, int32_t state, $GTKConstants$ShadowType* shadowType, $String* detail, int32_t x, int32_t y, int32_t w, int32_t h, $GTKConstants$Orientation* orientation, bool hasFocus) {
	...
	int32_t var$1 = x - this->x0;
	int32_t var$2 = y - this->y0;
	native_paint_slider(widget, state, var$0, detail, var$1, var$2, w, h, $nc(orientation)->ordinal(), hasFocus);
}
...
$BufferedImage* GTKEngine::finishPainting(bool useCache) {
	...
	$var($ints, bands, GTKEngine::BAND_OFFSETS->get(transparency - 1));
	$var($WritableRaster, raster, $Raster::createPackedRaster(dataBuffer, this->w0, this->h0, this->w0, bands, nullptr));
	$var($ColorModel, cm, GTKEngine::COLOR_MODELS->get(transparency - 1));
	$var($BufferedImage, img, $new($BufferedImage, cm, raster, false, nullptr));
	if (useCache) {
...
$Object* GTKEngine::getSetting($GTKEngine$Settings* property) {
	$init($UNIXToolkit);
	$synchronized($UNIXToolkit::GTK_LOCK) {
		return native_get_gtk_setting($nc(property)->ordinal());
	}
}
...
void GTKEngine::clinit$($Class* clazz) {
	$useLocalObjectStack();
	$assignStatic(GTKEngine::INSTANCE, $new(GTKEngine));
	{
		...
		$init($Region);
		$init($GTKEngine$WidgetType);
		GTKEngine::regionToWidgetTypeMap->put($Region::ARROW_BUTTON, $$new($GTKEngine$WidgetTypeArray, {
		...
		GTKEngine::regionToWidgetTypeMap->put($Region::BUTTON, $GTKEngine$WidgetType::BUTTON);
		GTKEngine::regionToWidgetTypeMap->put($Region::CHECK_BOX, $GTKEngine$WidgetType::CHECK_BOX);
		GTKEngine::regionToWidgetTypeMap->put($Region::CHECK_BOX_MENU_ITEM, $GTKEngine$WidgetType::CHECK_BOX_MENU_ITEM);
		GTKEngine::regionToWidgetTypeMap->put($Region::COLOR_CHOOSER, $GTKEngine$WidgetType::COLOR_CHOOSER);
		GTKEngine::regionToWidgetTypeMap->put($Region::FILE_CHOOSER, $GTKEngine$WidgetType::OPTION_PANE);
		GTKEngine::regionToWidgetTypeMap->put($Region::COMBO_BOX, $GTKEngine$WidgetType::COMBO_BOX);
		GTKEngine::regionToWidgetTypeMap->put($Region::DESKTOP_ICON, $GTKEngine$WidgetType::DESKTOP_ICON);
		GTKEngine::regionToWidgetTypeMap->put($Region::DESKTOP_PANE, $GTKEngine$WidgetType::DESKTOP_PANE);
		GTKEngine::regionToWidgetTypeMap->put($Region::EDITOR_PANE, $GTKEngine$WidgetType::EDITOR_PANE);
		GTKEngine::regionToWidgetTypeMap->put($Region::FORMATTED_TEXT_FIELD, $$new($GTKEngine$WidgetTypeArray, {
			$GTKEngine$WidgetType::FORMATTED_TEXT_FIELD,
			$GTKEngine$WidgetType::SPINNER_TEXT_FIELD
		}));
		$init($GTKRegion);
		GTKEngine::regionToWidgetTypeMap->put($GTKRegion::HANDLE_BOX, $GTKEngine$WidgetType::HANDLE_BOX);
		GTKEngine::regionToWidgetTypeMap->put($Region::INTERNAL_FRAME, $GTKEngine$WidgetType::INTERNAL_FRAME);
		GTKEngine::regionToWidgetTypeMap->put($Region::INTERNAL_FRAME_TITLE_PANE, $GTKEngine$WidgetType::INTERNAL_FRAME_TITLE_PANE);
		GTKEngine::regionToWidgetTypeMap->put($Region::LABEL, $$new($GTKEngine$WidgetTypeArray, {
			$GTKEngine$WidgetType::LABEL,
			$GTKEngine$WidgetType::COMBO_BOX_TEXT_FIELD
		}));
		GTKEngine::regionToWidgetTypeMap->put($Region::LIST, $GTKEngine$WidgetType::LIST);
		GTKEngine::regionToWidgetTypeMap->put($Region::MENU, $GTKEngine$WidgetType::MENU);
		GTKEngine::regionToWidgetTypeMap->put($Region::MENU_BAR, $GTKEngine$WidgetType::MENU_BAR);
		GTKEngine::regionToWidgetTypeMap->put($Region::MENU_ITEM, $GTKEngine$WidgetType::MENU_ITEM);
		GTKEngine::regionToWidgetTypeMap->put($Region::MENU_ITEM_ACCELERATOR, $GTKEngine$WidgetType::MENU_ITEM_ACCELERATOR);
		GTKEngine::regionToWidgetTypeMap->put($Region::OPTION_PANE, $GTKEngine$WidgetType::OPTION_PANE);
		GTKEngine::regionToWidgetTypeMap->put($Region::PANEL, $GTKEngine$WidgetType::PANEL);
		GTKEngine::regionToWidgetTypeMap->put($Region::PASSWORD_FIELD, $GTKEngine$WidgetType::PASSWORD_FIELD);
		GTKEngine::regionToWidgetTypeMap->put($Region::POPUP_MENU, $GTKEngine$WidgetType::POPUP_MENU);
		GTKEngine::regionToWidgetTypeMap->put($Region::POPUP_MENU_SEPARATOR, $GTKEngine$WidgetType::POPUP_MENU_SEPARATOR);
		GTKEngine::regionToWidgetTypeMap->put($Region::PROGRESS_BAR, $$new($GTKEngine$WidgetTypeArray, {
			$GTKEngine$WidgetType::HPROGRESS_BAR,
			$GTKEngine$WidgetType::VPROGRESS_BAR
		}));
		GTKEngine::regionToWidgetTypeMap->put($Region::RADIO_BUTTON, $GTKEngine$WidgetType::RADIO_BUTTON);
		GTKEngine::regionToWidgetTypeMap->put($Region::RADIO_BUTTON_MENU_ITEM, $GTKEngine$WidgetType::RADIO_BUTTON_MENU_ITEM);
		GTKEngine::regionToWidgetTypeMap->put($Region::ROOT_PANE, $GTKEngine$WidgetType::ROOT_PANE);
		GTKEngine::regionToWidgetTypeMap->put($Region::SCROLL_BAR, $$new($GTKEngine$WidgetTypeArray, {
			$GTKEngine$WidgetType::HSCROLL_BAR,
			$GTKEngine$WidgetType::VSCROLL_BAR
		}));
		GTKEngine::regionToWidgetTypeMap->put($Region::SCROLL_BAR_THUMB, $$new($GTKEngine$WidgetTypeArray, {
			$GTKEngine$WidgetType::HSCROLL_BAR_THUMB,
			$GTKEngine$WidgetType::VSCROLL_BAR_THUMB
		}));
		GTKEngine::regionToWidgetTypeMap->put($Region::SCROLL_BAR_TRACK, $$new($GTKEngine$WidgetTypeArray, {
			$GTKEngine$WidgetType::HSCROLL_BAR_TRACK,
			$GTKEngine$WidgetType::VSCROLL_BAR_TRACK
		}));
		GTKEngine::regionToWidgetTypeMap->put($Region::SCROLL_PANE, $GTKEngine$WidgetType::SCROLL_PANE);
		GTKEngine::regionToWidgetTypeMap->put($Region::SEPARATOR, $$new($GTKEngine$WidgetTypeArray, {
			$GTKEngine$WidgetType::HSEPARATOR,
			$GTKEngine$WidgetType::VSEPARATOR
		}));
		GTKEngine::regionToWidgetTypeMap->put($Region::SLIDER, $$new($GTKEngine$WidgetTypeArray, {
			$GTKEngine$WidgetType::HSLIDER,
			$GTKEngine$WidgetType::VSLIDER
		}));
		GTKEngine::regionToWidgetTypeMap->put($Region::SLIDER_THUMB, $$new($GTKEngine$WidgetTypeArray, {
			$GTKEngine$WidgetType::HSLIDER_THUMB,
			$GTKEngine$WidgetType::VSLIDER_THUMB
		}));
		GTKEngine::regionToWidgetTypeMap->put($Region::SLIDER_TRACK, $$new($GTKEngine$WidgetTypeArray, {
			$GTKEngine$WidgetType::HSLIDER_TRACK,
			$GTKEngine$WidgetType::VSLIDER_TRACK
		}));
		GTKEngine::regionToWidgetTypeMap->put($Region::SPINNER, $GTKEngine$WidgetType::SPINNER);
		GTKEngine::regionToWidgetTypeMap->put($Region::SPLIT_PANE, $GTKEngine$WidgetType::SPLIT_PANE);
		GTKEngine::regionToWidgetTypeMap->put($Region::SPLIT_PANE_DIVIDER, $$new($GTKEngine$WidgetTypeArray, {
			$GTKEngine$WidgetType::HSPLIT_PANE_DIVIDER,
			$GTKEngine$WidgetType::VSPLIT_PANE_DIVIDER
		}));
		GTKEngine::regionToWidgetTypeMap->put($Region::TABBED_PANE, $GTKEngine$WidgetType::TABBED_PANE);
		GTKEngine::regionToWidgetTypeMap->put($Region::TABBED_PANE_CONTENT, $GTKEngine$WidgetType::TABBED_PANE_CONTENT);
		GTKEngine::regionToWidgetTypeMap->put($Region::TABBED_PANE_TAB, $GTKEngine$WidgetType::TABBED_PANE_TAB);
		GTKEngine::regionToWidgetTypeMap->put($Region::TABBED_PANE_TAB_AREA, $GTKEngine$WidgetType::TABBED_PANE_TAB_AREA);
		GTKEngine::regionToWidgetTypeMap->put($Region::TABLE, $GTKEngine$WidgetType::TABLE);
		GTKEngine::regionToWidgetTypeMap->put($Region::TABLE_HEADER, $GTKEngine$WidgetType::TABLE_HEADER);
		GTKEngine::regionToWidgetTypeMap->put($Region::TEXT_AREA, $GTKEngine$WidgetType::TEXT_AREA);
		GTKEngine::regionToWidgetTypeMap->put($Region::TEXT_FIELD, $$new($GTKEngine$WidgetTypeArray, {
			$GTKEngine$WidgetType::TEXT_FIELD,
			$GTKEngine$WidgetType::COMBO_BOX_TEXT_FIELD
		}));
		GTKEngine::regionToWidgetTypeMap->put($Region::TEXT_PANE, $GTKEngine$WidgetType::TEXT_PANE);
		$init($GTKEngine$CustomRegion);
		GTKEngine::regionToWidgetTypeMap->put($GTKEngine$CustomRegion::TITLED_BORDER, $GTKEngine$WidgetType::TITLED_BORDER);
		GTKEngine::regionToWidgetTypeMap->put($Region::TOGGLE_BUTTON, $GTKEngine$WidgetType::TOGGLE_BUTTON);
		GTKEngine::regionToWidgetTypeMap->put($Region::TOOL_BAR, $GTKEngine$WidgetType::TOOL_BAR);
		GTKEngine::regionToWidgetTypeMap->put($Region::TOOL_BAR_CONTENT, $GTKEngine$WidgetType::TOOL_BAR);
		GTKEngine::regionToWidgetTypeMap->put($Region::TOOL_BAR_DRAG_WINDOW, $GTKEngine$WidgetType::TOOL_BAR_DRAG_WINDOW);
		GTKEngine::regionToWidgetTypeMap->put($Region::TOOL_BAR_SEPARATOR, $GTKEngine$WidgetType::TOOL_BAR_SEPARATOR);
		GTKEngine::regionToWidgetTypeMap->put($Region::TOOL_TIP, $GTKEngine$WidgetType::TOOL_TIP);
		GTKEngine::regionToWidgetTypeMap->put($Region::TREE, $GTKEngine$WidgetType::TREE);
		GTKEngine::regionToWidgetTypeMap->put($Region::TREE_CELL, $GTKEngine$WidgetType::TREE_CELL);
		GTKEngine::regionToWidgetTypeMap->put($Region::VIEWPORT, $GTKEngine$WidgetType::VIEWPORT);
	}
	$assignStatic(GTKEngine::COLOR_MODELS, $new($ColorModelArray, {
		$$new($DirectColorModel, 24, 0x00ff0000, 0x0000ff00, 255, 0),
		$$new($DirectColorModel, 25, 0x00ff0000, 0x0000ff00, 255, 0x01000000),
...
$Class* GTKEngine::load$($String* name, bool initialize) {
	...
	$loadClass(GTKEngine, name, initialize, &classInfo$$, GTKEngine::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(GTKEngine);
	});
	return class$;
}
