#ifndef _com_sun_java_swing_plaf_gtk_GTKFileChooserUI$FileCellRenderer_h_
#define _com_sun_java_swing_plaf_gtk_GTKFileChooserUI$FileCellRenderer_h_
//$ class com.sun.java.swing.plaf.gtk.GTKFileChooserUI$FileCellRenderer
...
class GTKFileChooserUI$FileCellRenderer : public ::javax::swing::DefaultListCellRenderer {
	$class(GTKFileChooserUI$FileCellRenderer, $NO_CLASS_INIT, ::javax::swing::DefaultListCellRenderer)
public:
...
#endif // _com_sun_java_swing_plaf_gtk_GTKFileChooserUI$FileCellRenderer_h_