#ifndef _sun_java2d_xr_XRPMBlit_h_
#define _sun_java2d_xr_XRPMBlit_h_
//$ class sun.java2d.xr.XRPMBlit
...
class XRPMBlit : public ::sun::java2d::loops::Blit {
	$class(XRPMBlit, $NO_CLASS_INIT, ::sun::java2d::loops::Blit)
public:
	XRPMBlit();
...
#endif // _sun_java2d_xr_XRPMBlit_h_