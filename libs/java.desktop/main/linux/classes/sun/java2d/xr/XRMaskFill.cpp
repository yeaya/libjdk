...
void XRMaskFill::register$() {
	...
	$var($GraphicsPrimitiveArray, primitives, $new($GraphicsPrimitiveArray, {
		$$new(XRMaskFill, $SurfaceType::AnyColor, $CompositeType::SrcOver, $XRSurfaceData::IntRgbX11),
		$$new(XRMaskFill, $SurfaceType::OpaqueColor, $CompositeType::SrcNoEa, $XRSurfaceData::IntRgbX11),
		$$new(XRMaskFill, $SurfaceType::GradientPaint, $CompositeType::SrcOver, $XRSurfaceData::IntRgbX11),
		$$new(XRMaskFill, $SurfaceType::OpaqueGradientPaint, $CompositeType::SrcNoEa, $XRSurfaceData::IntRgbX11),
		$$new(XRMaskFill, $SurfaceType::LinearGradientPaint, $CompositeType::SrcOver, $XRSurfaceData::IntRgbX11),
		$$new(XRMaskFill, $SurfaceType::OpaqueLinearGradientPaint, $CompositeType::SrcNoEa, $XRSurfaceData::IntRgbX11),
		$$new(XRMaskFill, $SurfaceType::RadialGradientPaint, $CompositeType::SrcOver, $XRSurfaceData::IntRgbX11),
		$$new(XRMaskFill, $SurfaceType::OpaqueRadialGradientPaint, $CompositeType::SrcNoEa, $XRSurfaceData::IntRgbX11),
		$$new(XRMaskFill, $SurfaceType::TexturePaint, $CompositeType::SrcOver, $XRSurfaceData::IntRgbX11),
		$$new(XRMaskFill, $SurfaceType::OpaqueTexturePaint, $CompositeType::SrcNoEa, $XRSurfaceData::IntRgbX11),
		$$new(XRMaskFill, $SurfaceType::AnyColor, $CompositeType::SrcOver, $XRSurfaceData::IntArgbPreX11),
		$$new(XRMaskFill, $SurfaceType::OpaqueColor, $CompositeType::SrcNoEa, $XRSurfaceData::IntArgbPreX11),
		$$new(XRMaskFill, $SurfaceType::GradientPaint, $CompositeType::SrcOver, $XRSurfaceData::IntArgbPreX11),
		$$new(XRMaskFill, $SurfaceType::OpaqueGradientPaint, $CompositeType::SrcNoEa, $XRSurfaceData::IntArgbPreX11),
		$$new(XRMaskFill, $SurfaceType::LinearGradientPaint, $CompositeType::SrcOver, $XRSurfaceData::IntArgbPreX11),
		$$new(XRMaskFill, $SurfaceType::OpaqueLinearGradientPaint, $CompositeType::SrcNoEa, $XRSurfaceData::IntArgbPreX11),
		$$new(XRMaskFill, $SurfaceType::RadialGradientPaint, $CompositeType::SrcOver, $XRSurfaceData::IntArgbPreX11),
		$$new(XRMaskFill, $SurfaceType::OpaqueRadialGradientPaint, $CompositeType::SrcNoEa, $XRSurfaceData::IntArgbPreX11),
		$$new(XRMaskFill, $SurfaceType::TexturePaint, $CompositeType::SrcOver, $XRSurfaceData::IntArgbPreX11),
		$$new(XRMaskFill, $SurfaceType::OpaqueTexturePaint, $CompositeType::SrcNoEa, $XRSurfaceData::IntArgbPreX11)
	}));
...
void XRMaskFill::maskFill(int64_t xsdo, int32_t x, int32_t y, int32_t w, int32_t h, int32_t maskoff, int32_t maskscan, int32_t masklen, $bytes* mask) {
	$prepareNative(maskFill, void, int64_t xsdo, int32_t x, int32_t y, int32_t w, int32_t h, int32_t maskoff, int32_t maskscan, int32_t masklen, $bytes* mask);
...
void XRMaskFill::MaskFill$($SunGraphics2D* sg2d, $SurfaceData* sData, $Composite* comp, int32_t x, int32_t y, int32_t w, int32_t h, $bytes* mask, int32_t maskoff, int32_t maskscan) {
	...
	try {
		...
		$nc(maskBuffer)->validateCompositeState(comp, sg2d->transform$, sg2d->paint, sg2d);
...
$Class* XRMaskFill::load$($String* name, bool initialize) {
	...
	$loadClass(XRMaskFill, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(XRMaskFill);
	});
	return class$;
}
