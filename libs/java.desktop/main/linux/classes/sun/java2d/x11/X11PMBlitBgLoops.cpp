...
void X11PMBlitBgLoops::register$() {
	...
	$var($GraphicsPrimitiveArray, primitives, $new($GraphicsPrimitiveArray, {
		$$new(X11PMBlitBgLoops, $X11SurfaceData::IntBgrX11_BM, $X11SurfaceData::IntBgrX11),
		$$new(X11PMBlitBgLoops, $X11SurfaceData::IntRgbX11_BM, $X11SurfaceData::IntRgbX11),
		$$new(X11PMBlitBgLoops, $X11SurfaceData::ThreeByteBgrX11_BM, $X11SurfaceData::ThreeByteBgrX11),
		$$new(X11PMBlitBgLoops, $X11SurfaceData::ThreeByteRgbX11_BM, $X11SurfaceData::ThreeByteRgbX11),
		$$new(X11PMBlitBgLoops, $X11SurfaceData::ByteIndexedX11_BM, $X11SurfaceData::ByteIndexedOpaqueX11),
		$$new(X11PMBlitBgLoops, $X11SurfaceData::ByteGrayX11_BM, $X11SurfaceData::ByteGrayX11),
		$$new(X11PMBlitBgLoops, $X11SurfaceData::Index8GrayX11_BM, $X11SurfaceData::Index8GrayX11),
		$$new(X11PMBlitBgLoops, $X11SurfaceData::UShort555RgbX11_BM, $X11SurfaceData::UShort555RgbX11),
		$$new(X11PMBlitBgLoops, $X11SurfaceData::UShort565RgbX11_BM, $X11SurfaceData::UShort565RgbX11),
		$$new(X11PMBlitBgLoops, $X11SurfaceData::UShortIndexedX11_BM, $X11SurfaceData::UShortIndexedX11),
		$$new(X11PMBlitBgLoops, $X11SurfaceData::IntRgbX11_BM, $X11SurfaceData::IntArgbPreX11),
		$$new(X11PMBlitBgLoops, $X11SurfaceData::IntBgrX11_BM, $X11SurfaceData::FourByteAbgrPreX11)
	}));
...
void X11PMBlitBgLoops::nativeBlitBg(int64_t srcData, int64_t dstData, int64_t xgc, int32_t pixel, int32_t sx, int32_t sy, int32_t dx, int32_t dy, int32_t w, int32_t h) {
	$prepareNative(nativeBlitBg, void, int64_t srcData, int64_t dstData, int64_t xgc, int32_t pixel, int32_t sx, int32_t sy, int32_t dx, int32_t dy, int32_t w, int32_t h);
...
$Class* X11PMBlitBgLoops::load$($String* name, bool initialize) {
	...
	$loadClass(X11PMBlitBgLoops, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(X11PMBlitBgLoops);
	});
	return class$;
}
