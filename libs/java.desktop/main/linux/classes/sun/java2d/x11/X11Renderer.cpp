...
X11Renderer* X11Renderer::getInstance() {
	$init(X11Renderer);
	return ($GraphicsPrimitive::tracingEnabled() ? $cast(X11Renderer, $new($X11Renderer$X11TracingRenderer)) : $new(X11Renderer));
}
...
void X11Renderer::XDrawLine(int64_t pXSData, int64_t xgc, int32_t x1, int32_t y1, int32_t x2, int32_t y2) {
	$prepareNative(XDrawLine, void, int64_t pXSData, int64_t xgc, int32_t x1, int32_t y1, int32_t x2, int32_t y2);
...
void X11Renderer::XDrawRect(int64_t pXSData, int64_t xgc, int32_t x, int32_t y, int32_t w, int32_t h) {
	$prepareNative(XDrawRect, void, int64_t pXSData, int64_t xgc, int32_t x, int32_t y, int32_t w, int32_t h);
...
void X11Renderer::drawRect($SunGraphics2D* sg2d, int32_t x, int32_t y, int32_t width, int32_t height) {
	...
	try {
		int64_t xgc = validate(sg2d);
		XDrawRect($nc($nc(sg2d)->surfaceData)->getNativeOps(), xgc, x + $nc(sg2d)->transX, y + $nc(sg2d)->transY, width, height);
	} catch ($Throwable& var$1) {
		$assign(var$0, var$1);
	} /*finally*/ {
		$SunToolkit::awtUnlock();
...
void X11Renderer::XDrawRoundRect(int64_t pXSData, int64_t xgc, int32_t x, int32_t y, int32_t w, int32_t h, int32_t arcW, int32_t arcH) {
	$prepareNative(XDrawRoundRect, void, int64_t pXSData, int64_t xgc, int32_t x, int32_t y, int32_t w, int32_t h, int32_t arcW, int32_t arcH);
...
void X11Renderer::drawRoundRect($SunGraphics2D* sg2d, int32_t x, int32_t y, int32_t width, int32_t height, int32_t arcWidth, int32_t arcHeight) {
	...
	try {
		int64_t xgc = validate(sg2d);
		XDrawRoundRect($nc($nc(sg2d)->surfaceData)->getNativeOps(), xgc, x + $nc(sg2d)->transX, y + $nc(sg2d)->transY, width, height, arcWidth, arcHeight);
	} catch ($Throwable& var$1) {
		$assign(var$0, var$1);
	} /*finally*/ {
		$SunToolkit::awtUnlock();
...
void X11Renderer::XDrawOval(int64_t pXSData, int64_t xgc, int32_t x, int32_t y, int32_t w, int32_t h) {
	$prepareNative(XDrawOval, void, int64_t pXSData, int64_t xgc, int32_t x, int32_t y, int32_t w, int32_t h);
	$invokeNative(pXSData, xgc, x, y, w, h);
	$finishNative();
}
...
void X11Renderer::drawOval($SunGraphics2D* sg2d, int32_t x, int32_t y, int32_t width, int32_t height) {
	...
	try {
		int64_t xgc = validate(sg2d);
		XDrawOval($nc($nc(sg2d)->surfaceData)->getNativeOps(), xgc, x + $nc(sg2d)->transX, y + $nc(sg2d)->transY, width, height);
	} catch ($Throwable& var$1) {
		$assign(var$0, var$1);
	} /*finally*/ {
		$SunToolkit::awtUnlock();
...
void X11Renderer::XDrawArc(int64_t pXSData, int64_t xgc, int32_t x, int32_t y, int32_t w, int32_t h, int32_t angleStart, int32_t angleExtent) {
	$prepareNative(XDrawArc, void, int64_t pXSData, int64_t xgc, int32_t x, int32_t y, int32_t w, int32_t h, int32_t angleStart, int32_t angleExtent);
...
void X11Renderer::drawArc($SunGraphics2D* sg2d, int32_t x, int32_t y, int32_t width, int32_t height, int32_t startAngle, int32_t arcAngle) {
	...
	try {
		int64_t xgc = validate(sg2d);
		XDrawArc($nc($nc(sg2d)->surfaceData)->getNativeOps(), xgc, x + $nc(sg2d)->transX, y + $nc(sg2d)->transY, width, height, startAngle, arcAngle);
	} catch ($Throwable& var$1) {
		$assign(var$0, var$1);
	} /*finally*/ {
		$SunToolkit::awtUnlock();
...
void X11Renderer::XDrawPoly(int64_t pXSData, int64_t xgc, int32_t transx, int32_t transy, $ints* xpoints, $ints* ypoints, int32_t npoints, bool isclosed) {
	$prepareNative(XDrawPoly, void, int64_t pXSData, int64_t xgc, int32_t transx, int32_t transy, $ints* xpoints, $ints* ypoints, int32_t npoints, bool isclosed);
...
void X11Renderer::drawPolyline($SunGraphics2D* sg2d, $ints* xpoints, $ints* ypoints, int32_t npoints) {
	...
	try {
		int64_t xgc = validate(sg2d);
		XDrawPoly($nc($nc(sg2d)->surfaceData)->getNativeOps(), xgc, $nc(sg2d)->transX, $nc(sg2d)->transY, xpoints, ypoints, npoints, false);
	} catch ($Throwable& var$1) {
		$assign(var$0, var$1);
	} /*finally*/ {
		$SunToolkit::awtUnlock();
...
void X11Renderer::drawPolygon($SunGraphics2D* sg2d, $ints* xpoints, $ints* ypoints, int32_t npoints) {
	...
	try {
		int64_t xgc = validate(sg2d);
		XDrawPoly($nc($nc(sg2d)->surfaceData)->getNativeOps(), xgc, $nc(sg2d)->transX, $nc(sg2d)->transY, xpoints, ypoints, npoints, true);
	} catch ($Throwable& var$1) {
		$assign(var$0, var$1);
	} /*finally*/ {
		$SunToolkit::awtUnlock();
...
void X11Renderer::XFillRect(int64_t pXSData, int64_t xgc, int32_t x, int32_t y, int32_t w, int32_t h) {
	$prepareNative(XFillRect, void, int64_t pXSData, int64_t xgc, int32_t x, int32_t y, int32_t w, int32_t h);
	$invokeNative(pXSData, xgc, x, y, w, h);
	$finishNative();
}
...
void X11Renderer::fillRect($SunGraphics2D* sg2d, int32_t x, int32_t y, int32_t width, int32_t height) {
	...
	try {
		int64_t xgc = validate(sg2d);
		XFillRect($nc($nc(sg2d)->surfaceData)->getNativeOps(), xgc, x + $nc(sg2d)->transX, y + $nc(sg2d)->transY, width, height);
	} catch ($Throwable& var$1) {
		$assign(var$0, var$1);
	} /*finally*/ {
		$SunToolkit::awtUnlock();
...
void X11Renderer::XFillRoundRect(int64_t pXSData, int64_t xgc, int32_t x, int32_t y, int32_t w, int32_t h, int32_t arcW, int32_t arcH) {
	$prepareNative(XFillRoundRect, void, int64_t pXSData, int64_t xgc, int32_t x, int32_t y, int32_t w, int32_t h, int32_t arcW, int32_t arcH);
	$invokeNative(pXSData, xgc, x, y, w, h, arcW, arcH);
	$finishNative();
}
...
void X11Renderer::fillRoundRect($SunGraphics2D* sg2d, int32_t x, int32_t y, int32_t width, int32_t height, int32_t arcWidth, int32_t arcHeight) {
	...
	try {
		int64_t xgc = validate(sg2d);
		XFillRoundRect($nc($nc(sg2d)->surfaceData)->getNativeOps(), xgc, x + $nc(sg2d)->transX, y + $nc(sg2d)->transY, width, height, arcWidth, arcHeight);
	} catch ($Throwable& var$1) {
		$assign(var$0, var$1);
	} /*finally*/ {
		$SunToolkit::awtUnlock();
...
void X11Renderer::XFillOval(int64_t pXSData, int64_t xgc, int32_t x, int32_t y, int32_t w, int32_t h) {
	$prepareNative(XFillOval, void, int64_t pXSData, int64_t xgc, int32_t x, int32_t y, int32_t w, int32_t h);
	$invokeNative(pXSData, xgc, x, y, w, h);
	$finishNative();
}
...
void X11Renderer::fillOval($SunGraphics2D* sg2d, int32_t x, int32_t y, int32_t width, int32_t height) {
	...
	try {
		int64_t xgc = validate(sg2d);
		XFillOval($nc($nc(sg2d)->surfaceData)->getNativeOps(), xgc, x + $nc(sg2d)->transX, y + $nc(sg2d)->transY, width, height);
	} catch ($Throwable& var$1) {
		$assign(var$0, var$1);
	} /*finally*/ {
		$SunToolkit::awtUnlock();
...
void X11Renderer::XFillArc(int64_t pXSData, int64_t xgc, int32_t x, int32_t y, int32_t w, int32_t h, int32_t angleStart, int32_t angleExtent) {
	$prepareNative(XFillArc, void, int64_t pXSData, int64_t xgc, int32_t x, int32_t y, int32_t w, int32_t h, int32_t angleStart, int32_t angleExtent);
	$invokeNative(pXSData, xgc, x, y, w, h, angleStart, angleExtent);
	$finishNative();
}
...
void X11Renderer::fillArc($SunGraphics2D* sg2d, int32_t x, int32_t y, int32_t width, int32_t height, int32_t startAngle, int32_t arcAngle) {
	...
	try {
		int64_t xgc = validate(sg2d);
		XFillArc($nc($nc(sg2d)->surfaceData)->getNativeOps(), xgc, x + $nc(sg2d)->transX, y + $nc(sg2d)->transY, width, height, startAngle, arcAngle);
	} catch ($Throwable& var$1) {
		$assign(var$0, var$1);
	} /*finally*/ {
		$SunToolkit::awtUnlock();
...
void X11Renderer::XFillPoly(int64_t pXSData, int64_t xgc, int32_t transx, int32_t transy, $ints* xpoints, $ints* ypoints, int32_t npoints) {
	$prepareNative(XFillPoly, void, int64_t pXSData, int64_t xgc, int32_t transx, int32_t transy, $ints* xpoints, $ints* ypoints, int32_t npoints);
...
void X11Renderer::fillPolygon($SunGraphics2D* sg2d, $ints* xpoints, $ints* ypoints, int32_t npoints) {
	...
	try {
		int64_t xgc = validate(sg2d);
		XFillPoly($nc($nc(sg2d)->surfaceData)->getNativeOps(), xgc, $nc(sg2d)->transX, $nc(sg2d)->transY, xpoints, ypoints, npoints);
	} catch ($Throwable& var$1) {
		$assign(var$0, var$1);
	} /*finally*/ {
		$SunToolkit::awtUnlock();
...
void X11Renderer::XFillSpans(int64_t pXSData, int64_t xgc, $SpanIterator* si, int64_t iterator, int32_t transx, int32_t transy) {
	$prepareNative(XFillSpans, void, int64_t pXSData, int64_t xgc, $SpanIterator* si, int64_t iterator, int32_t transx, int32_t transy);
...
void X11Renderer::XDoPath($SunGraphics2D* sg2d, int64_t pXSData, int64_t xgc, int32_t transX, int32_t transY, $Path2D$Float* p2df, bool isFill) {
	$prepareNative(XDoPath, void, $SunGraphics2D* sg2d, int64_t pXSData, int64_t xgc, int32_t transX, int32_t transY, $Path2D$Float* p2df, bool isFill);
...
void X11Renderer::doPath($SunGraphics2D* sg2d, $Shape* s, bool isFill) {
	...
	try {
		int64_t xgc = validate(sg2d);
		XDoPath(sg2d, $nc(sg2d->surfaceData)->getNativeOps(), xgc, transx, transy, p2df, isFill);
	} catch ($Throwable& var$1) {
		$assign(var$0, var$1);
	} /*finally*/ {
		$SunToolkit::awtUnlock();
	...
	if ($nc(sg2d)->strokeState == $SunGraphics2D::STROKE_THIN) {
		...
		try {
			...
			try {
				...
				XFillSpans(var$2, xgc, si, $nc(si)->getNativeIterator(), 0, 0);
...
void X11Renderer::fill($SunGraphics2D* sg2d, $Shape* s) {
	...
	try {
		...
		$nc(ssi)->appendPath($($nc(s)->getPathIterator(at)));
		$SunToolkit::awtLock();
		$var($Throwable, var$4, nullptr);
		try {
			int64_t xgc = validate(sg2d);
			int64_t var$5 = $nc(sg2d->surfaceData)->getNativeOps();
			XFillSpans(var$5, xgc, ssi, ssi->getNativeIterator(), transx, transy);
...
void X11Renderer::devCopyArea(int64_t sdOps, int64_t xgc, int32_t srcx, int32_t srcy, int32_t dstx, int32_t dsty, int32_t w, int32_t h) {
	$prepareNative(devCopyArea, void, int64_t sdOps, int64_t xgc, int32_t srcx, int32_t srcy, int32_t dstx, int32_t dsty, int32_t w, int32_t h);
...
$Class* X11Renderer::load$($String* name, bool initialize) {
	...
	$loadClass(X11Renderer, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
