#ifndef _sun_awt_X11_XExposeEvent_h_
#define _sun_awt_X11_XExposeEvent_h_
//$ class sun.awt.X11.XExposeEvent
...
class XExposeEvent : public ::sun::awt::X11::XWrapperBase {
	$class(XExposeEvent, $NO_CLASS_INIT, ::sun::awt::X11::XWrapperBase)
public:
	XExposeEvent();
...
#endif // _sun_awt_X11_XExposeEvent_h_