...
void XlibWrapper::XFree(int64_t ptr) {
	$init(XlibWrapper);
	$prepareNativeStatic(XFree, void, int64_t ptr);
...
void XlibWrapper::memcpy(int64_t dest_ptr, int64_t src_ptr, int64_t length) {
	$init(XlibWrapper);
	$prepareNativeStatic(memcpy, void, int64_t dest_ptr, int64_t src_ptr, int64_t length);
...
int64_t XlibWrapper::getAddress(Object$* o) {
	$init(XlibWrapper);
	$prepareNativeStatic(getAddress, int64_t, Object$* o);
	int64_t $ret = $invokeNativeStatic(o);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::copyIntArray(int64_t dest_ptr, Object$* array, int32_t size_bytes) {
	$init(XlibWrapper);
	$prepareNativeStatic(copyIntArray, void, int64_t dest_ptr, Object$* array, int32_t size_bytes);
...
void XlibWrapper::copyLongArray(int64_t dest_ptr, Object$* array, int32_t size_bytes) {
	$init(XlibWrapper);
	$prepareNativeStatic(copyLongArray, void, int64_t dest_ptr, Object$* array, int32_t size_bytes);
	$invokeNativeStatic(dest_ptr, array, size_bytes);
	$finishNativeStatic();
}
...
$bytes* XlibWrapper::getStringBytes(int64_t str_ptr) {
	$init(XlibWrapper);
	$prepareNativeStatic(getStringBytes, $bytes*, int64_t str_ptr);
	$var($bytes, $ret, $invokeNativeStaticObject(str_ptr));
	$finishNativeStatic();
	return $ret;
}
...
int64_t XlibWrapper::XOpenDisplay(int64_t display) {
	$init(XlibWrapper);
	$prepareNativeStatic(XOpenDisplay, int64_t, int64_t display);
	int64_t $ret = $invokeNativeStatic(display);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XCloseDisplay(int64_t display) {
	$init(XlibWrapper);
	$prepareNativeStatic(XCloseDisplay, void, int64_t display);
...
int64_t XlibWrapper::XDisplayString(int64_t display) {
	$init(XlibWrapper);
	$prepareNativeStatic(XDisplayString, int64_t, int64_t display);
	int64_t $ret = $invokeNativeStatic(display);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XSetCloseDownMode(int64_t display, int32_t close_mode) {
	$init(XlibWrapper);
	$prepareNativeStatic(XSetCloseDownMode, void, int64_t display, int32_t close_mode);
...
int64_t XlibWrapper::DefaultScreen(int64_t display) {
	$init(XlibWrapper);
	$prepareNativeStatic(DefaultScreen, int64_t, int64_t display);
	int64_t $ret = $invokeNativeStatic(display);
	$finishNativeStatic();
	return $ret;
}
...
int64_t XlibWrapper::ScreenOfDisplay(int64_t display, int64_t screen_number) {
	$init(XlibWrapper);
	$prepareNativeStatic(ScreenOfDisplay, int64_t, int64_t display, int64_t screen_number);
	int64_t $ret = $invokeNativeStatic(display, screen_number);
	$finishNativeStatic();
	return $ret;
}
...
int32_t XlibWrapper::DoesBackingStore(int64_t screen) {
	$init(XlibWrapper);
	$prepareNativeStatic(DoesBackingStore, int32_t, int64_t screen);
	int32_t $ret = $invokeNativeStatic(screen);
	$finishNativeStatic();
	return $ret;
}
...
int64_t XlibWrapper::DisplayWidth(int64_t display, int64_t screen) {
	$init(XlibWrapper);
	$prepareNativeStatic(DisplayWidth, int64_t, int64_t display, int64_t screen);
	int64_t $ret = $invokeNativeStatic(display, screen);
	$finishNativeStatic();
	return $ret;
}
...
int64_t XlibWrapper::DisplayWidthMM(int64_t display, int64_t screen) {
	$init(XlibWrapper);
	$prepareNativeStatic(DisplayWidthMM, int64_t, int64_t display, int64_t screen);
	int64_t $ret = $invokeNativeStatic(display, screen);
	$finishNativeStatic();
	return $ret;
}
...
int64_t XlibWrapper::DisplayHeight(int64_t display, int64_t screen) {
	$init(XlibWrapper);
	$prepareNativeStatic(DisplayHeight, int64_t, int64_t display, int64_t screen);
	int64_t $ret = $invokeNativeStatic(display, screen);
	$finishNativeStatic();
	return $ret;
}
...
int64_t XlibWrapper::DisplayHeightMM(int64_t display, int64_t screen) {
	$init(XlibWrapper);
	$prepareNativeStatic(DisplayHeightMM, int64_t, int64_t display, int64_t screen);
	int64_t $ret = $invokeNativeStatic(display, screen);
	$finishNativeStatic();
	return $ret;
}
...
int64_t XlibWrapper::RootWindow(int64_t display, int64_t screen_number) {
	$init(XlibWrapper);
	$prepareNativeStatic(RootWindow, int64_t, int64_t display, int64_t screen_number);
	int64_t $ret = $invokeNativeStatic(display, screen_number);
	$finishNativeStatic();
	return $ret;
}
...
int32_t XlibWrapper::ScreenCount(int64_t display) {
	$init(XlibWrapper);
	$prepareNativeStatic(ScreenCount, int32_t, int64_t display);
	int32_t $ret = $invokeNativeStatic(display);
	$finishNativeStatic();
	return $ret;
}
...
int64_t XlibWrapper::XCreateWindow(int64_t display, int64_t parent, int32_t x, int32_t y, int32_t width, int32_t height, int32_t border_width, int32_t depth, int64_t wclass, int64_t visual, int64_t valuemask, int64_t attributes) {
	$init(XlibWrapper);
	$prepareNativeStatic(XCreateWindow, int64_t, int64_t display, int64_t parent, int32_t x, int32_t y, int32_t width, int32_t height, int32_t border_width, int32_t depth, int64_t wclass, int64_t visual, int64_t valuemask, int64_t attributes);
	int64_t $ret = $invokeNativeStatic(display, parent, x, y, width, height, border_width, depth, wclass, visual, valuemask, attributes);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XDestroyWindow(int64_t display, int64_t window) {
	$init(XlibWrapper);
	$prepareNativeStatic(XDestroyWindow, void, int64_t display, int64_t window);
...
int32_t XlibWrapper::XGrabPointer(int64_t display, int64_t grab_window, int32_t owner_events, int32_t event_mask, int32_t pointer_mode, int32_t keyboard_mode, int64_t confine_to, int64_t cursor, int64_t time) {
	$init(XlibWrapper);
	$prepareNativeStatic(XGrabPointer, int32_t, int64_t display, int64_t grab_window, int32_t owner_events, int32_t event_mask, int32_t pointer_mode, int32_t keyboard_mode, int64_t confine_to, int64_t cursor, int64_t time);
	int32_t $ret = $invokeNativeStatic(display, grab_window, owner_events, event_mask, pointer_mode, keyboard_mode, confine_to, cursor, time);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XUngrabPointer(int64_t display, int64_t time) {
	$init(XlibWrapper);
	$prepareNativeStatic(XUngrabPointer, void, int64_t display, int64_t time);
...
int32_t XlibWrapper::XGrabKeyboard(int64_t display, int64_t grab_window, int32_t owner_events, int32_t pointer_mode, int32_t keyboard_mode, int64_t time) {
	$init(XlibWrapper);
	$prepareNativeStatic(XGrabKeyboard, int32_t, int64_t display, int64_t grab_window, int32_t owner_events, int32_t pointer_mode, int32_t keyboard_mode, int64_t time);
	int32_t $ret = $invokeNativeStatic(display, grab_window, owner_events, pointer_mode, keyboard_mode, time);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XUngrabKeyboard(int64_t display, int64_t time) {
	$init(XlibWrapper);
	$prepareNativeStatic(XUngrabKeyboard, void, int64_t display, int64_t time);
	$invokeNativeStatic(display, time);
	$finishNativeStatic();
}
...
void XlibWrapper::XGrabServer(int64_t display) {
	$init(XlibWrapper);
	$prepareNativeStatic(XGrabServer, void, int64_t display);
	$invokeNativeStatic(display);
	$finishNativeStatic();
}
...
void XlibWrapper::XUngrabServer(int64_t display) {
	$init(XlibWrapper);
	$prepareNativeStatic(XUngrabServer, void, int64_t display);
	$invokeNativeStatic(display);
	$finishNativeStatic();
}
...
void XlibWrapper::XMapWindow(int64_t display, int64_t window) {
	$init(XlibWrapper);
	$prepareNativeStatic(XMapWindow, void, int64_t display, int64_t window);
	$invokeNativeStatic(display, window);
	$finishNativeStatic();
}
...
void XlibWrapper::XMapRaised(int64_t display, int64_t window) {
	$init(XlibWrapper);
	$prepareNativeStatic(XMapRaised, void, int64_t display, int64_t window);
	$invokeNativeStatic(display, window);
	$finishNativeStatic();
}
...
void XlibWrapper::XRaiseWindow(int64_t display, int64_t window) {
	$init(XlibWrapper);
	$prepareNativeStatic(XRaiseWindow, void, int64_t display, int64_t window);
	$invokeNativeStatic(display, window);
	$finishNativeStatic();
}
...
void XlibWrapper::XLowerWindow(int64_t display, int64_t window) {
	$init(XlibWrapper);
	$prepareNativeStatic(XLowerWindow, void, int64_t display, int64_t window);
	$invokeNativeStatic(display, window);
	$finishNativeStatic();
}
...
void XlibWrapper::XRestackWindows(int64_t display, int64_t windows, int32_t length) {
	$init(XlibWrapper);
	$prepareNativeStatic(XRestackWindows, void, int64_t display, int64_t windows, int32_t length);
...
void XlibWrapper::XConfigureWindow(int64_t display, int64_t window, int64_t value_mask, int64_t values) {
	$init(XlibWrapper);
	$prepareNativeStatic(XConfigureWindow, void, int64_t display, int64_t window, int64_t value_mask, int64_t values);
...
void XlibWrapper::XSetInputFocus(int64_t display, int64_t window) {
	$init(XlibWrapper);
	$prepareNativeStatic(XSetInputFocus, void, int64_t display, int64_t window);
	$invokeNativeStatic(display, window);
	$finishNativeStatic();
}
...
void XlibWrapper::XSetInputFocus2(int64_t display, int64_t window, int64_t time) {
	$init(XlibWrapper);
	$prepareNativeStatic(XSetInputFocus2, void, int64_t display, int64_t window, int64_t time);
...
int64_t XlibWrapper::XGetInputFocus(int64_t display) {
	$init(XlibWrapper);
	$prepareNativeStatic(XGetInputFocus, int64_t, int64_t display);
	int64_t $ret = $invokeNativeStatic(display);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XUnmapWindow(int64_t display, int64_t window) {
	$init(XlibWrapper);
	$prepareNativeStatic(XUnmapWindow, void, int64_t display, int64_t window);
	$invokeNativeStatic(display, window);
	$finishNativeStatic();
}
...
void XlibWrapper::XSelectInput(int64_t display, int64_t window, int64_t event_mask) {
	$init(XlibWrapper);
	$prepareNativeStatic(XSelectInput, void, int64_t display, int64_t window, int64_t event_mask);
...
void XlibWrapper::XNextEvent(int64_t display, int64_t ptr) {
	$init(XlibWrapper);
	$prepareNativeStatic(XNextEvent, void, int64_t display, int64_t ptr);
...
void XlibWrapper::XMaskEvent(int64_t display, int64_t event_mask, int64_t event_return) {
	$init(XlibWrapper);
	$prepareNativeStatic(XMaskEvent, void, int64_t display, int64_t event_mask, int64_t event_return);
...
void XlibWrapper::XWindowEvent(int64_t display, int64_t window, int64_t event_mask, int64_t event_return) {
	$init(XlibWrapper);
	$prepareNativeStatic(XWindowEvent, void, int64_t display, int64_t window, int64_t event_mask, int64_t event_return);
...
bool XlibWrapper::XFilterEvent(int64_t ptr, int64_t window) {
	$init(XlibWrapper);
	$prepareNativeStatic(XFilterEvent, bool, int64_t ptr, int64_t window);
	bool $ret = $invokeNativeStatic(ptr, window);
	$finishNativeStatic();
	return $ret;
}
...
bool XlibWrapper::XSupportsLocale() {
	$init(XlibWrapper);
	$prepareNativeStatic(XSupportsLocale, bool);
...
$String* XlibWrapper::XSetLocaleModifiers($String* modifier_list) {
	$init(XlibWrapper);
	$prepareNativeStatic(XSetLocaleModifiers, $String*, $String* modifier_list);
	$var($String, $ret, $invokeNativeStaticObject(modifier_list));
	$finishNativeStatic();
	return $ret;
}
...
int32_t XlibWrapper::XTranslateCoordinates(int64_t display, int64_t src_w, int64_t dest_w, int64_t src_x, int64_t src_y, int64_t dest_x_return, int64_t dest_y_return, int64_t child_return) {
	$init(XlibWrapper);
	$prepareNativeStatic(XTranslateCoordinates, int32_t, int64_t display, int64_t src_w, int64_t dest_w, int64_t src_x, int64_t src_y, int64_t dest_x_return, int64_t dest_y_return, int64_t child_return);
	int32_t $ret = $invokeNativeStatic(display, src_w, dest_w, src_x, src_y, dest_x_return, dest_y_return, child_return);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XPeekEvent(int64_t display, int64_t ptr) {
	$init(XlibWrapper);
	$prepareNativeStatic(XPeekEvent, void, int64_t display, int64_t ptr);
	$invokeNativeStatic(display, ptr);
	$finishNativeStatic();
}
...
void XlibWrapper::XFlush(int64_t display) {
	$init(XlibWrapper);
	$prepareNativeStatic(XFlush, void, int64_t display);
	$invokeNativeStatic(display);
	$finishNativeStatic();
}
...
void XlibWrapper::XSync(int64_t display, int32_t discard) {
	$init(XlibWrapper);
	$prepareNativeStatic(XSync, void, int64_t display, int32_t discard);
...
void XlibWrapper::XMoveResizeWindow(int64_t display, int64_t window, int32_t x, int32_t y, int32_t width, int32_t height) {
	$init(XlibWrapper);
	$prepareNativeStatic(XMoveResizeWindow, void, int64_t display, int64_t window, int32_t x, int32_t y, int32_t width, int32_t height);
...
void XlibWrapper::XResizeWindow(int64_t display, int64_t window, int32_t width, int32_t height) {
	$init(XlibWrapper);
	$prepareNativeStatic(XResizeWindow, void, int64_t display, int64_t window, int32_t width, int32_t height);
...
void XlibWrapper::XMoveWindow(int64_t display, int64_t window, int32_t x, int32_t y) {
	$init(XlibWrapper);
	$prepareNativeStatic(XMoveWindow, void, int64_t display, int64_t window, int32_t x, int32_t y);
...
bool XlibWrapper::XQueryPointer(int64_t display, int64_t window, int64_t root_return, int64_t child_return, int64_t root_x_return, int64_t root_y_return, int64_t win_x_return, int64_t win_y_return, int64_t mask_return) {
	$init(XlibWrapper);
	$prepareNativeStatic(XQueryPointer, bool, int64_t display, int64_t window, int64_t root_return, int64_t child_return, int64_t root_x_return, int64_t root_y_return, int64_t win_x_return, int64_t win_y_return, int64_t mask_return);
	bool $ret = $invokeNativeStatic(display, window, root_return, child_return, root_x_return, root_y_return, win_x_return, win_y_return, mask_return);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XFreeCursor(int64_t display, int64_t cursor) {
	$init(XlibWrapper);
	$prepareNativeStatic(XFreeCursor, void, int64_t display, int64_t cursor);
...
void XlibWrapper::XSetWindowBackground(int64_t display, int64_t window, int64_t background_pixel) {
	$init(XlibWrapper);
	$prepareNativeStatic(XSetWindowBackground, void, int64_t display, int64_t window, int64_t background_pixel);
...
int32_t XlibWrapper::XEventsQueued(int64_t display, int32_t mode) {
	$init(XlibWrapper);
	$prepareNativeStatic(XEventsQueued, int32_t, int64_t display, int32_t mode);
	int32_t $ret = $invokeNativeStatic(display, mode);
	$finishNativeStatic();
	return $ret;
}
...
int32_t XlibWrapper::XInternAtoms(int64_t display, $StringArray* names, bool only_if_exists, int64_t atoms) {
	$init(XlibWrapper);
	$prepareNativeStatic(XInternAtoms, int32_t, int64_t display, $StringArray* names, bool only_if_exists, int64_t atoms);
	int32_t $ret = $invokeNativeStatic(display, names, only_if_exists, atoms);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::SetProperty(int64_t display, int64_t window, int64_t atom, $String* str) {
	$init(XlibWrapper);
	$prepareNativeStatic(SetProperty, void, int64_t display, int64_t window, int64_t atom, $String* str);
...
$String* XlibWrapper::GetProperty(int64_t display, int64_t window, int64_t atom) {
	$init(XlibWrapper);
	$prepareNativeStatic(GetProperty, $String*, int64_t display, int64_t window, int64_t atom);
	$var($String, $ret, $invokeNativeStaticObject(display, window, atom));
	$finishNativeStatic();
	return $ret;
}
...
int64_t XlibWrapper::InternAtom(int64_t display, $String* string, int32_t only_if_exists) {
	$init(XlibWrapper);
	$prepareNativeStatic(InternAtom, int64_t, int64_t display, $String* string, int32_t only_if_exists);
	int64_t $ret = $invokeNativeStatic(display, string, only_if_exists);
	$finishNativeStatic();
	return $ret;
}
...
int32_t XlibWrapper::XGetWindowProperty(int64_t display, int64_t window, int64_t atom, int64_t long_offset, int64_t long_length, int64_t delete$, int64_t req_type, int64_t actualy_type, int64_t actualy_format, int64_t nitems_ptr, int64_t bytes_after, int64_t data_ptr) {
	$init(XlibWrapper);
	$prepareNativeStatic(XGetWindowProperty, int32_t, int64_t display, int64_t window, int64_t atom, int64_t long_offset, int64_t long_length, int64_t delete$, int64_t req_type, int64_t actualy_type, int64_t actualy_format, int64_t nitems_ptr, int64_t bytes_after, int64_t data_ptr);
	int32_t $ret = $invokeNativeStatic(display, window, atom, long_offset, long_length, delete$, req_type, actualy_type, actualy_format, nitems_ptr, bytes_after, data_ptr);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XChangePropertyImpl(int64_t display, int64_t window, int64_t atom, int64_t type, int32_t format, int32_t mode, int64_t data, int32_t nelements) {
	$init(XlibWrapper);
	$prepareNativeStatic(XChangePropertyImpl, void, int64_t display, int64_t window, int64_t atom, int64_t type, int32_t format, int32_t mode, int64_t data, int32_t nelements);
...
void XlibWrapper::XChangeProperty(int64_t display, int64_t window, int64_t atom, int64_t type, int32_t format, int32_t mode, int64_t data, int32_t nelements) {
	...
	if (var$0 && $WindowPropertyGetter::isCacheableProperty($($XAtom::get(atom))) && mode == $XConstants::PropModeReplace) {
		...
		$XPropertyCache::storeCache(var$2, window, $($XAtom::get(atom)));
	}
...
void XlibWrapper::XChangePropertyS(int64_t display, int64_t window, int64_t atom, int64_t type, int32_t format, int32_t mode, $String* value) {
	$init(XlibWrapper);
	$prepareNativeStatic(XChangePropertyS, void, int64_t display, int64_t window, int64_t atom, int64_t type, int32_t format, int32_t mode, $String* value);
...
void XlibWrapper::XDeleteProperty(int64_t display, int64_t window, int64_t atom) {
	$init(XlibWrapper);
	$prepareNativeStatic(XDeleteProperty, void, int64_t display, int64_t window, int64_t atom);
...
void XlibWrapper::XSetTransientFor(int64_t display, int64_t window, int64_t transient_for_window) {
	$init(XlibWrapper);
	$prepareNativeStatic(XSetTransientFor, void, int64_t display, int64_t window, int64_t transient_for_window);
...
void XlibWrapper::XSetWMHints(int64_t display, int64_t window, int64_t wmhints) {
	$init(XlibWrapper);
	$prepareNativeStatic(XSetWMHints, void, int64_t display, int64_t window, int64_t wmhints);
...
void XlibWrapper::XGetWMHints(int64_t display, int64_t window, int64_t wmhints) {
	$init(XlibWrapper);
	$prepareNativeStatic(XGetWMHints, void, int64_t display, int64_t window, int64_t wmhints);
	$invokeNativeStatic(display, window, wmhints);
	$finishNativeStatic();
}
...
int64_t XlibWrapper::XAllocWMHints() {
	$init(XlibWrapper);
	$prepareNativeStatic(XAllocWMHints, int64_t);
...
int32_t XlibWrapper::XGetPointerMapping(int64_t display, int64_t map, int32_t buttonNumber) {
	$init(XlibWrapper);
	$prepareNativeStatic(XGetPointerMapping, int32_t, int64_t display, int64_t map, int32_t buttonNumber);
	int32_t $ret = $invokeNativeStatic(display, map, buttonNumber);
	$finishNativeStatic();
	return $ret;
}
...
$String* XlibWrapper::XGetDefault(int64_t display, $String* program, $String* option) {
	$init(XlibWrapper);
	$prepareNativeStatic(XGetDefault, $String*, int64_t display, $String* program, $String* option);
	$var($String, $ret, $invokeNativeStaticObject(display, program, option));
	$finishNativeStatic();
	return $ret;
}
...
int64_t XlibWrapper::getScreenOfWindow(int64_t display, int64_t window) {
	$init(XlibWrapper);
	$prepareNativeStatic(getScreenOfWindow, int64_t, int64_t display, int64_t window);
	int64_t $ret = $invokeNativeStatic(display, window);
	$finishNativeStatic();
	return $ret;
}
...
int64_t XlibWrapper::XScreenNumberOfScreen(int64_t screen) {
	$init(XlibWrapper);
	$prepareNativeStatic(XScreenNumberOfScreen, int64_t, int64_t screen);
	int64_t $ret = $invokeNativeStatic(screen);
	$finishNativeStatic();
	return $ret;
}
...
int32_t XlibWrapper::XIconifyWindow(int64_t display, int64_t window, int64_t screenNumber) {
	$init(XlibWrapper);
	$prepareNativeStatic(XIconifyWindow, int32_t, int64_t display, int64_t window, int64_t screenNumber);
	int32_t $ret = $invokeNativeStatic(display, window, screenNumber);
	$finishNativeStatic();
	return $ret;
}
...
$String* XlibWrapper::ServerVendor(int64_t display) {
	$init(XlibWrapper);
	$prepareNativeStatic(ServerVendor, $String*, int64_t display);
	$var($String, $ret, $invokeNativeStaticObject(display));
	$finishNativeStatic();
	return $ret;
}
...
int32_t XlibWrapper::VendorRelease(int64_t display) {
	$init(XlibWrapper);
	$prepareNativeStatic(VendorRelease, int32_t, int64_t display);
	int32_t $ret = $invokeNativeStatic(display);
	$finishNativeStatic();
	return $ret;
}
...
bool XlibWrapper::IsXsunKPBehavior(int64_t display) {
	$init(XlibWrapper);
	$prepareNativeStatic(IsXsunKPBehavior, bool, int64_t display);
	bool $ret = $invokeNativeStatic(display);
	$finishNativeStatic();
	return $ret;
}
...
bool XlibWrapper::IsSunKeyboard(int64_t display) {
	$init(XlibWrapper);
	$prepareNativeStatic(IsSunKeyboard, bool, int64_t display);
	bool $ret = $invokeNativeStatic(display);
	$finishNativeStatic();
	return $ret;
}
...
bool XlibWrapper::IsKanaKeyboard(int64_t display) {
	$init(XlibWrapper);
	$prepareNativeStatic(IsKanaKeyboard, bool, int64_t display);
	bool $ret = $invokeNativeStatic(display);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XBell(int64_t display, int32_t percent) {
	$init(XlibWrapper);
	$prepareNativeStatic(XBell, void, int64_t display, int32_t percent);
...
int32_t XlibWrapper::XCreateFontCursor(int64_t display, int32_t shape) {
	$init(XlibWrapper);
	$prepareNativeStatic(XCreateFontCursor, int32_t, int64_t display, int32_t shape);
	int32_t $ret = $invokeNativeStatic(display, shape);
	$finishNativeStatic();
	return $ret;
}
...
int64_t XlibWrapper::XCreateBitmapFromData(int64_t display, int64_t drawable, int64_t data, int32_t width, int32_t height) {
	$init(XlibWrapper);
	$prepareNativeStatic(XCreateBitmapFromData, int64_t, int64_t display, int64_t drawable, int64_t data, int32_t width, int32_t height);
	int64_t $ret = $invokeNativeStatic(display, drawable, data, width, height);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XFreePixmap(int64_t display, int64_t pixmap) {
	$init(XlibWrapper);
	$prepareNativeStatic(XFreePixmap, void, int64_t display, int64_t pixmap);
...
int64_t XlibWrapper::XCreatePixmapCursor(int64_t display, int64_t source, int64_t mask, int64_t fore, int64_t back, int32_t x, int32_t y) {
	$init(XlibWrapper);
	$prepareNativeStatic(XCreatePixmapCursor, int64_t, int64_t display, int64_t source, int64_t mask, int64_t fore, int64_t back, int32_t x, int32_t y);
	int64_t $ret = $invokeNativeStatic(display, source, mask, fore, back, x, y);
	$finishNativeStatic();
	return $ret;
}
...
bool XlibWrapper::XQueryBestCursor(int64_t display, int64_t drawable, int32_t width, int32_t height, int64_t width_return, int64_t height_return) {
	$init(XlibWrapper);
	$prepareNativeStatic(XQueryBestCursor, bool, int64_t display, int64_t drawable, int32_t width, int32_t height, int64_t width_return, int64_t height_return);
	bool $ret = $invokeNativeStatic(display, drawable, width, height, width_return, height_return);
	$finishNativeStatic();
	return $ret;
}
...
bool XlibWrapper::XAllocColor(int64_t display, int64_t colormap, int64_t screen_in_out) {
	$init(XlibWrapper);
	$prepareNativeStatic(XAllocColor, bool, int64_t display, int64_t colormap, int64_t screen_in_out);
	bool $ret = $invokeNativeStatic(display, colormap, screen_in_out);
	$finishNativeStatic();
	return $ret;
}
...
int64_t XlibWrapper::SetToolkitErrorHandler() {
	$init(XlibWrapper);
	$prepareNativeStatic(SetToolkitErrorHandler, int64_t);
	int64_t $ret = $invokeNativeStatic();
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XSetErrorHandler(int64_t handler) {
	$init(XlibWrapper);
	$prepareNativeStatic(XSetErrorHandler, void, int64_t handler);
...
int32_t XlibWrapper::CallErrorHandler(int64_t handler, int64_t display, int64_t event_ptr) {
	$init(XlibWrapper);
	$prepareNativeStatic(CallErrorHandler, int32_t, int64_t handler, int64_t display, int64_t event_ptr);
	int32_t $ret = $invokeNativeStatic(handler, display, event_ptr);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XChangeWindowAttributes(int64_t display, int64_t window, int64_t valuemask, int64_t attributes) {
	$init(XlibWrapper);
	$prepareNativeStatic(XChangeWindowAttributes, void, int64_t display, int64_t window, int64_t valuemask, int64_t attributes);
...
int32_t XlibWrapper::XGetWindowAttributes(int64_t display, int64_t window, int64_t attr_ptr) {
	$init(XlibWrapper);
	$prepareNativeStatic(XGetWindowAttributes, int32_t, int64_t display, int64_t window, int64_t attr_ptr);
	int32_t $ret = $invokeNativeStatic(display, window, attr_ptr);
	$finishNativeStatic();
	return $ret;
}
...
int32_t XlibWrapper::XGetGeometry(int64_t display, int64_t drawable, int64_t root_return, int64_t x_return, int64_t y_return, int64_t width_return, int64_t height_return, int64_t border_width_return, int64_t depth_return) {
	$init(XlibWrapper);
	$prepareNativeStatic(XGetGeometry, int32_t, int64_t display, int64_t drawable, int64_t root_return, int64_t x_return, int64_t y_return, int64_t width_return, int64_t height_return, int64_t border_width_return, int64_t depth_return);
	int32_t $ret = $invokeNativeStatic(display, drawable, root_return, x_return, y_return, width_return, height_return, border_width_return, depth_return);
	$finishNativeStatic();
	return $ret;
}
...
int32_t XlibWrapper::XGetWMNormalHints(int64_t display, int64_t window, int64_t hints, int64_t supplied_return) {
	$init(XlibWrapper);
	$prepareNativeStatic(XGetWMNormalHints, int32_t, int64_t display, int64_t window, int64_t hints, int64_t supplied_return);
	int32_t $ret = $invokeNativeStatic(display, window, hints, supplied_return);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XSetWMNormalHints(int64_t display, int64_t window, int64_t hints) {
	$init(XlibWrapper);
	$prepareNativeStatic(XSetWMNormalHints, void, int64_t display, int64_t window, int64_t hints);
...
void XlibWrapper::XSetMinMaxHints(int64_t display, int64_t window, int32_t x, int32_t y, int32_t width, int32_t height, int64_t flags) {
	$init(XlibWrapper);
	$prepareNativeStatic(XSetMinMaxHints, void, int64_t display, int64_t window, int32_t x, int32_t y, int32_t width, int32_t height, int64_t flags);
...
int64_t XlibWrapper::XAllocSizeHints() {
	$init(XlibWrapper);
	$prepareNativeStatic(XAllocSizeHints, int64_t);
	int64_t $ret = $invokeNativeStatic();
	$finishNativeStatic();
	return $ret;
}
...
int32_t XlibWrapper::XSendEvent(int64_t display, int64_t window, bool propagate, int64_t event_mask, int64_t event) {
	$init(XlibWrapper);
	$prepareNativeStatic(XSendEvent, int32_t, int64_t display, int64_t window, bool propagate, int64_t event_mask, int64_t event);
	int32_t $ret = $invokeNativeStatic(display, window, propagate, event_mask, event);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XPutBackEvent(int64_t display, int64_t event) {
	$init(XlibWrapper);
	$prepareNativeStatic(XPutBackEvent, void, int64_t display, int64_t event);
...
int32_t XlibWrapper::XQueryTree(int64_t display, int64_t window, int64_t root_return, int64_t parent_return, int64_t children_return, int64_t nchildren_return) {
	$init(XlibWrapper);
	$prepareNativeStatic(XQueryTree, int32_t, int64_t display, int64_t window, int64_t root_return, int64_t parent_return, int64_t children_return, int64_t nchildren_return);
	int32_t $ret = $invokeNativeStatic(display, window, root_return, parent_return, children_return, nchildren_return);
	$finishNativeStatic();
	return $ret;
}
...
int64_t XlibWrapper::XGetVisualInfo(int64_t display, int64_t vinfo_mask, int64_t vinfo_template, int64_t nitems_return) {
	$init(XlibWrapper);
	$prepareNativeStatic(XGetVisualInfo, int64_t, int64_t display, int64_t vinfo_mask, int64_t vinfo_template, int64_t nitems_return);
	int64_t $ret = $invokeNativeStatic(display, vinfo_mask, vinfo_template, nitems_return);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XReparentWindow(int64_t display, int64_t window, int64_t parent, int32_t x, int32_t y) {
	$init(XlibWrapper);
	$prepareNativeStatic(XReparentWindow, void, int64_t display, int64_t window, int64_t parent, int32_t x, int32_t y);
...
void XlibWrapper::XConvertSelection(int64_t display, int64_t selection, int64_t target, int64_t property, int64_t requestor, int64_t time) {
	$init(XlibWrapper);
	$prepareNativeStatic(XConvertSelection, void, int64_t display, int64_t selection, int64_t target, int64_t property, int64_t requestor, int64_t time);
...
void XlibWrapper::XSetSelectionOwner(int64_t display, int64_t selection, int64_t owner, int64_t time) {
	$init(XlibWrapper);
	$prepareNativeStatic(XSetSelectionOwner, void, int64_t display, int64_t selection, int64_t owner, int64_t time);
...
int64_t XlibWrapper::XGetSelectionOwner(int64_t display, int64_t selection) {
	$init(XlibWrapper);
	$prepareNativeStatic(XGetSelectionOwner, int64_t, int64_t display, int64_t selection);
	int64_t $ret = $invokeNativeStatic(display, selection);
	$finishNativeStatic();
	return $ret;
}
...
$String* XlibWrapper::XGetAtomName(int64_t display, int64_t atom) {
	$init(XlibWrapper);
	$prepareNativeStatic(XGetAtomName, $String*, int64_t display, int64_t atom);
	$var($String, $ret, $invokeNativeStaticObject(display, atom));
	$finishNativeStatic();
	return $ret;
}
...
int64_t XlibWrapper::XMaxRequestSize(int64_t display) {
	$init(XlibWrapper);
	$prepareNativeStatic(XMaxRequestSize, int64_t, int64_t display);
	int64_t $ret = $invokeNativeStatic(display);
	$finishNativeStatic();
	return $ret;
}
...
int64_t XlibWrapper::XCreatePixmap(int64_t display, int64_t drawable, int32_t width, int32_t height, int32_t depth) {
	$init(XlibWrapper);
	$prepareNativeStatic(XCreatePixmap, int64_t, int64_t display, int64_t drawable, int32_t width, int32_t height, int32_t depth);
	int64_t $ret = $invokeNativeStatic(display, drawable, width, height, depth);
	$finishNativeStatic();
	return $ret;
}
...
int64_t XlibWrapper::XCreateImage(int64_t display, int64_t visual_ptr, int32_t depth, int32_t format, int32_t offset, int64_t data, int32_t width, int32_t height, int32_t bitmap_pad, int32_t bytes_per_line) {
	$init(XlibWrapper);
	$prepareNativeStatic(XCreateImage, int64_t, int64_t display, int64_t visual_ptr, int32_t depth, int32_t format, int32_t offset, int64_t data, int32_t width, int32_t height, int32_t bitmap_pad, int32_t bytes_per_line);
	int64_t $ret = $invokeNativeStatic(display, visual_ptr, depth, format, offset, data, width, height, bitmap_pad, bytes_per_line);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XDestroyImage(int64_t image) {
	$init(XlibWrapper);
	$prepareNativeStatic(XDestroyImage, void, int64_t image);
...
void XlibWrapper::XPutImage(int64_t display, int64_t drawable, int64_t gc, int64_t image, int32_t src_x, int32_t src_y, int32_t dest_x, int32_t dest_y, int32_t width, int32_t height) {
	$init(XlibWrapper);
	$prepareNativeStatic(XPutImage, void, int64_t display, int64_t drawable, int64_t gc, int64_t image, int32_t src_x, int32_t src_y, int32_t dest_x, int32_t dest_y, int32_t width, int32_t height);
...
int64_t XlibWrapper::XCreateGC(int64_t display, int64_t drawable, int64_t valuemask, int64_t values) {
	$init(XlibWrapper);
	$prepareNativeStatic(XCreateGC, int64_t, int64_t display, int64_t drawable, int64_t valuemask, int64_t values);
	int64_t $ret = $invokeNativeStatic(display, drawable, valuemask, values);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XFreeGC(int64_t display, int64_t gc) {
	$init(XlibWrapper);
	$prepareNativeStatic(XFreeGC, void, int64_t display, int64_t gc);
...
void XlibWrapper::XSetWindowBackgroundPixmap(int64_t display, int64_t window, int64_t pixmap) {
	$init(XlibWrapper);
	$prepareNativeStatic(XSetWindowBackgroundPixmap, void, int64_t display, int64_t window, int64_t pixmap);
...
void XlibWrapper::XClearWindow(int64_t display, int64_t window) {
	$init(XlibWrapper);
	$prepareNativeStatic(XClearWindow, void, int64_t display, int64_t window);
	$invokeNativeStatic(display, window);
	$finishNativeStatic();
}
...
int32_t XlibWrapper::XGetIconSizes(int64_t display, int64_t window, int64_t ret_sizes, int64_t ret_count) {
	$init(XlibWrapper);
	$prepareNativeStatic(XGetIconSizes, int32_t, int64_t display, int64_t window, int64_t ret_sizes, int64_t ret_count);
	int32_t $ret = $invokeNativeStatic(display, window, ret_sizes, ret_count);
	$finishNativeStatic();
	return $ret;
}
...
int32_t XlibWrapper::XdbeQueryExtension(int64_t display, int64_t major_version_return, int64_t minor_version_return) {
	$init(XlibWrapper);
	$prepareNativeStatic(XdbeQueryExtension, int32_t, int64_t display, int64_t major_version_return, int64_t minor_version_return);
	int32_t $ret = $invokeNativeStatic(display, major_version_return, minor_version_return);
	$finishNativeStatic();
	return $ret;
}
...
bool XlibWrapper::XQueryExtension(int64_t display, $String* name, int64_t mop_return, int64_t feve_return, int64_t err_return) {
	$init(XlibWrapper);
	$prepareNativeStatic(XQueryExtension, bool, int64_t display, $String* name, int64_t mop_return, int64_t feve_return, int64_t err_return);
	bool $ret = $invokeNativeStatic(display, name, mop_return, feve_return, err_return);
	$finishNativeStatic();
	return $ret;
}
...
bool XlibWrapper::IsKeypadKey(int64_t keysym) {
	$init(XlibWrapper);
	$prepareNativeStatic(IsKeypadKey, bool, int64_t keysym);
	bool $ret = $invokeNativeStatic(keysym);
	$finishNativeStatic();
	return $ret;
}
...
int64_t XlibWrapper::XdbeAllocateBackBufferName(int64_t display, int64_t window, int32_t swap_action) {
	$init(XlibWrapper);
	$prepareNativeStatic(XdbeAllocateBackBufferName, int64_t, int64_t display, int64_t window, int32_t swap_action);
	int64_t $ret = $invokeNativeStatic(display, window, swap_action);
	$finishNativeStatic();
	return $ret;
}
...
int32_t XlibWrapper::XdbeDeallocateBackBufferName(int64_t display, int64_t buffer) {
	$init(XlibWrapper);
	$prepareNativeStatic(XdbeDeallocateBackBufferName, int32_t, int64_t display, int64_t buffer);
	int32_t $ret = $invokeNativeStatic(display, buffer);
	$finishNativeStatic();
	return $ret;
}
...
int32_t XlibWrapper::XdbeBeginIdiom(int64_t display) {
	$init(XlibWrapper);
	$prepareNativeStatic(XdbeBeginIdiom, int32_t, int64_t display);
	int32_t $ret = $invokeNativeStatic(display);
	$finishNativeStatic();
	return $ret;
}
...
int32_t XlibWrapper::XdbeEndIdiom(int64_t display) {
	$init(XlibWrapper);
	$prepareNativeStatic(XdbeEndIdiom, int32_t, int64_t display);
	int32_t $ret = $invokeNativeStatic(display);
	$finishNativeStatic();
	return $ret;
}
...
int32_t XlibWrapper::XdbeSwapBuffers(int64_t display, int64_t swap_info, int32_t num_windows) {
	$init(XlibWrapper);
	$prepareNativeStatic(XdbeSwapBuffers, int32_t, int64_t display, int64_t swap_info, int32_t num_windows);
	int32_t $ret = $invokeNativeStatic(display, swap_info, num_windows);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XQueryKeymap(int64_t display, int64_t vector) {
	$init(XlibWrapper);
	$prepareNativeStatic(XQueryKeymap, void, int64_t display, int64_t vector);
...
int64_t XlibWrapper::XKeycodeToKeysym(int64_t display, int32_t keycode, int32_t index) {
	$init(XlibWrapper);
	$prepareNativeStatic(XKeycodeToKeysym, int64_t, int64_t display, int32_t keycode, int32_t index);
	int64_t $ret = $invokeNativeStatic(display, keycode, index);
	$finishNativeStatic();
	return $ret;
}
...
int32_t XlibWrapper::XKeysymToKeycode(int64_t display, int64_t keysym) {
	$init(XlibWrapper);
	$prepareNativeStatic(XKeysymToKeycode, int32_t, int64_t display, int64_t keysym);
	int32_t $ret = $invokeNativeStatic(display, keysym);
	$finishNativeStatic();
	return $ret;
}
...
int32_t XlibWrapper::XkbGetEffectiveGroup(int64_t display) {
	$init(XlibWrapper);
	$prepareNativeStatic(XkbGetEffectiveGroup, int32_t, int64_t display);
	int32_t $ret = $invokeNativeStatic(display);
	$finishNativeStatic();
	return $ret;
}
...
int64_t XlibWrapper::XkbKeycodeToKeysym(int64_t display, int32_t keycode, int32_t group, int32_t level) {
	$init(XlibWrapper);
	$prepareNativeStatic(XkbKeycodeToKeysym, int64_t, int64_t display, int32_t keycode, int32_t group, int32_t level);
	int64_t $ret = $invokeNativeStatic(display, keycode, group, level);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XkbSelectEvents(int64_t display, int64_t device, int64_t bits_to_change, int64_t values_for_bits) {
	$init(XlibWrapper);
	$prepareNativeStatic(XkbSelectEvents, void, int64_t display, int64_t device, int64_t bits_to_change, int64_t values_for_bits);
...
void XlibWrapper::XkbSelectEventDetails(int64_t display, int64_t device, int64_t event_type, int64_t bits_to_change, int64_t values_for_bits) {
	$init(XlibWrapper);
	$prepareNativeStatic(XkbSelectEventDetails, void, int64_t display, int64_t device, int64_t event_type, int64_t bits_to_change, int64_t values_for_bits);
...
bool XlibWrapper::XkbQueryExtension(int64_t display, int64_t opcode_rtrn, int64_t event_rtrn, int64_t error_rtrn, int64_t major_in_out, int64_t minor_in_out) {
	$init(XlibWrapper);
	$prepareNativeStatic(XkbQueryExtension, bool, int64_t display, int64_t opcode_rtrn, int64_t event_rtrn, int64_t error_rtrn, int64_t major_in_out, int64_t minor_in_out);
	bool $ret = $invokeNativeStatic(display, opcode_rtrn, event_rtrn, error_rtrn, major_in_out, minor_in_out);
	$finishNativeStatic();
	return $ret;
}
...
bool XlibWrapper::XkbLibraryVersion(int64_t lib_major_in_out, int64_t lib_minor_in_out) {
	$init(XlibWrapper);
	$prepareNativeStatic(XkbLibraryVersion, bool, int64_t lib_major_in_out, int64_t lib_minor_in_out);
	bool $ret = $invokeNativeStatic(lib_major_in_out, lib_minor_in_out);
	$finishNativeStatic();
	return $ret;
}
...
int64_t XlibWrapper::XkbGetMap(int64_t display, int64_t which, int64_t device_spec) {
	$init(XlibWrapper);
	$prepareNativeStatic(XkbGetMap, int64_t, int64_t display, int64_t which, int64_t device_spec);
	int64_t $ret = $invokeNativeStatic(display, which, device_spec);
	$finishNativeStatic();
	return $ret;
}
...
int64_t XlibWrapper::XkbGetUpdatedMap(int64_t display, int64_t which, int64_t xkb) {
	$init(XlibWrapper);
	$prepareNativeStatic(XkbGetUpdatedMap, int64_t, int64_t display, int64_t which, int64_t xkb);
	int64_t $ret = $invokeNativeStatic(display, which, xkb);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XkbFreeKeyboard(int64_t xkb, int64_t which, bool free_all) {
	$init(XlibWrapper);
	$prepareNativeStatic(XkbFreeKeyboard, void, int64_t xkb, int64_t which, bool free_all);
...
bool XlibWrapper::XkbTranslateKeyCode(int64_t xkb, int32_t keycode, int64_t mods, int64_t mods_rtrn, int64_t keysym_rtrn) {
	$init(XlibWrapper);
	$prepareNativeStatic(XkbTranslateKeyCode, bool, int64_t xkb, int32_t keycode, int64_t mods, int64_t mods_rtrn, int64_t keysym_rtrn);
	bool $ret = $invokeNativeStatic(xkb, keycode, mods, mods_rtrn, keysym_rtrn);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XkbSetDetectableAutoRepeat(int64_t display, bool detectable) {
	$init(XlibWrapper);
	$prepareNativeStatic(XkbSetDetectableAutoRepeat, void, int64_t display, bool detectable);
...
void XlibWrapper::XConvertCase(int64_t keysym, int64_t keysym_lowercase, int64_t keysym_uppercase) {
	$init(XlibWrapper);
	$prepareNativeStatic(XConvertCase, void, int64_t keysym, int64_t keysym_lowercase, int64_t keysym_uppercase);
...
int64_t XlibWrapper::XGetModifierMapping(int64_t display) {
	$init(XlibWrapper);
	$prepareNativeStatic(XGetModifierMapping, int64_t, int64_t display);
	int64_t $ret = $invokeNativeStatic(display);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::XFreeModifiermap(int64_t keymap) {
	$init(XlibWrapper);
	$prepareNativeStatic(XFreeModifiermap, void, int64_t keymap);
...
void XlibWrapper::XRefreshKeyboardMapping(int64_t event) {
	$init(XlibWrapper);
	$prepareNativeStatic(XRefreshKeyboardMapping, void, int64_t event);
...
void XlibWrapper::XChangeActivePointerGrab(int64_t display, int32_t mask, int64_t cursor, int64_t time) {
	$init(XlibWrapper);
	$prepareNativeStatic(XChangeActivePointerGrab, void, int64_t display, int32_t mask, int64_t cursor, int64_t time);
...
int32_t XlibWrapper::XSynchronize(int64_t display, bool onoff) {
	$init(XlibWrapper);
	$prepareNativeStatic(XSynchronize, int32_t, int64_t display, bool onoff);
	int32_t $ret = $invokeNativeStatic(display, onoff);
	$finishNativeStatic();
	return $ret;
}
...
bool XlibWrapper::XNextSecondaryLoopEvent(int64_t display, int64_t ptr) {
	$init(XlibWrapper);
	$prepareNativeStatic(XNextSecondaryLoopEvent, bool, int64_t display, int64_t ptr);
	bool $ret = $invokeNativeStatic(display, ptr);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::ExitSecondaryLoop() {
	$init(XlibWrapper);
	$prepareNativeStatic(ExitSecondaryLoop, void);
	$invokeNativeStatic();
	$finishNativeStatic();
}
...
$StringArray* XlibWrapper::XTextPropertyToStringList($bytes* bytes, int64_t encoding_atom) {
	$init(XlibWrapper);
	$prepareNativeStatic(XTextPropertyToStringList, $StringArray*, $bytes* bytes, int64_t encoding_atom);
	$var($StringArray, $ret, $invokeNativeStaticObject(bytes, encoding_atom));
	$finishNativeStatic();
	return $ret;
}
...
bool XlibWrapper::XShapeQueryExtension(int64_t display, int64_t event_base_return, int64_t error_base_return) {
	$init(XlibWrapper);
	$prepareNativeStatic(XShapeQueryExtension, bool, int64_t display, int64_t event_base_return, int64_t error_base_return);
	bool $ret = $invokeNativeStatic(display, event_base_return, error_base_return);
	$finishNativeStatic();
	return $ret;
}
...
void XlibWrapper::SetRectangularShape(int64_t display, int64_t window, int32_t lox, int32_t loy, int32_t hix, int32_t hiy, $Region* region) {
	$init(XlibWrapper);
	$prepareNativeStatic(SetRectangularShape, void, int64_t display, int64_t window, int32_t lox, int32_t loy, int32_t hix, int32_t hiy, $Region* region);
...
void XlibWrapper::SetBitmapShape(int64_t display, int64_t window, int32_t width, int32_t height, $ints* bitmap) {
	$init(XlibWrapper);
	$prepareNativeStatic(SetBitmapShape, void, int64_t display, int64_t window, int32_t width, int32_t height, $ints* bitmap);
...
void XlibWrapper::SetZOrder(int64_t display, int64_t window, int64_t above) {
	$init(XlibWrapper);
	$prepareNativeStatic(SetZOrder, void, int64_t display, int64_t window, int64_t above);
...
$String* XlibWrapper::getEventToString(int32_t type) {
	$init(XlibWrapper);
	if ((type >= 0) && (type < XlibWrapper::eventToString->length)) {
		return XlibWrapper::eventToString->get(type);
	} else if (type == $XToolkit::getXKBBaseEventCode()) {
		return "XkbEvent"_s;
	}
	return XlibWrapper::eventToString->get(0);
}
...
void XlibWrapper::PrintXErrorEvent(int64_t display, int64_t event_ptr) {
	$init(XlibWrapper);
	$prepareNativeStatic(PrintXErrorEvent, void, int64_t display, int64_t event_ptr);
	$invokeNativeStatic(display, event_ptr);
	$finishNativeStatic();
}

void XlibWrapper::clinit$($Class* clazz) {
	$useLocalObjectStack();
	$beforeCallerSensitive();
	...
	XlibWrapper::ibuffer = XlibWrapper::unsafe->allocateMemory(32);
	...
	{
		$var($String, dataModelProp, $cast($String, $AccessController::doPrivileged($$new($GetPropertyAction, "sun.arch.data.model"_s))));
		try {
...
$Class* XlibWrapper::load$($String* name, bool initialize) {
	...
	$loadClass(XlibWrapper, name, initialize, &classInfo$$, XlibWrapper::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(XlibWrapper);
	});
	return class$;
}
