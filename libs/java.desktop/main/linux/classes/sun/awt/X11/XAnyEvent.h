#ifndef _sun_awt_X11_XAnyEvent_h_
#define _sun_awt_X11_XAnyEvent_h_
//$ class sun.awt.X11.XAnyEvent
...
class XAnyEvent : public ::sun::awt::X11::XWrapperBase {
	$class(XAnyEvent, $NO_CLASS_INIT, ::sun::awt::X11::XWrapperBase)
public:
	XAnyEvent();
...
#endif // _sun_awt_X11_XAnyEvent_h_