...
char16_t XKeysym::convertKeysym(int64_t ks, int32_t state) {
	...
	if ((ks & (int32_t)0xff000000) == 0x01000000) {
		return (char16_t)(ks & 0x00ffffff);
	}
	$var($Character, ch, $cast($Character, $nc(XKeysym::keysym2UCSHash)->get($($Long::valueOf(ks)))));
	return ch == nullptr ? (char16_t)0 : ch->charValue();
}
...
int64_t XKeysym::getUppercaseAlphabetic(int64_t keysym) {
	...
	try {
		...
		$var($Object, var$1, $Long::valueOf(keysym));
...
int64_t XKeysym::getKeypadKeysym($XKeyEvent* ev) {
	...
	if (var$0 && !$XToolkit::isXKBenabled()) {
		if (($nc(ev)->get_state() & $XConstants::ShiftMask) != 0) {
			ndx = 3;
		...
		bool var$1 = ($nc(ev)->get_state() & $XConstants::ShiftMask) != 0;
		if (var$1 || ((ev->get_state() & $XConstants::LockMask) != 0 && ($XToolkit::modLockIsShiftLock != 0))) {
			ndx = 0;
			keysym = xkeycode2keysym(ev, ndx);
		} else {
			ndx = 1;
...
$XKeysym$Keysym2JavaKeycode* XKeysym::getJavaKeycode($XKeyEvent* ev) {
	...
	int32_t ndx = 0;
	$init($XToolkit);
	bool var$0 = ($nc(ev)->get_state() & $XToolkit::numLockMask) != 0;
...
int32_t XKeysym::getJavaKeycodeOnly($XKeyEvent* ev) {
	...
	return jkc == nullptr ? $KeyEvent::VK_UNDEFINED : jkc->getJavaKeycode();
}
...
int64_t XKeysym::javaKeycode2Keysym(int32_t jkey) {
	...
	return (ks == nullptr ? 0 : ks->longValue());
}
...
void XKeysym::clinit$($Class* clazz) {
	$useLocalObjectStack();
	$init($XlibWrapper);
	...
	$assignStatic(XKeysym::keyEventLog, $PlatformLogger::getLogger("sun.awt.X11.key.XKeysym"_s));
	{
		...
		$var($Object, var$1026, $Long::valueOf($XKeySymConstants::XK_b));
		...
		$var($Object, var$1027, $Long::valueOf($XKeySymConstants::XK_c));
		...
		$var($Object, var$1028, $Long::valueOf($XKeySymConstants::XK_d));
		...
		$var($Object, var$1029, $Long::valueOf($XKeySymConstants::XK_e));
		...
		$var($Object, var$1030, $Long::valueOf($XKeySymConstants::XK_f));
		...
		$var($Object, var$1031, $Long::valueOf($XKeySymConstants::XK_g));
		...
		$var($Object, var$1032, $Long::valueOf($XKeySymConstants::XK_h));
		...
		$var($Object, var$1033, $Long::valueOf($XKeySymConstants::XK_i));
		...
		$var($Object, var$1034, $Long::valueOf($XKeySymConstants::XK_j));
		...
		$var($Object, var$1035, $Long::valueOf($XKeySymConstants::XK_k));
		...
		$var($Object, var$1036, $Long::valueOf($XKeySymConstants::XK_l));
		...
		$var($Object, var$1037, $Long::valueOf($XKeySymConstants::XK_m));
		...
		$var($Object, var$1038, $Long::valueOf($XKeySymConstants::XK_n));
		...
		$var($Object, var$1039, $Long::valueOf($XKeySymConstants::XK_o));
		...
		$var($Object, var$1040, $Long::valueOf($XKeySymConstants::XK_p));
		...
		$var($Object, var$1041, $Long::valueOf($XKeySymConstants::XK_q));
		...
		$var($Object, var$1042, $Long::valueOf($XKeySymConstants::XK_r));
		...
		$var($Object, var$1043, $Long::valueOf($XKeySymConstants::XK_s));
		...
		$var($Object, var$1044, $Long::valueOf($XKeySymConstants::XK_t));
		...
		$var($Object, var$1045, $Long::valueOf($XKeySymConstants::XK_u));
		...
		$var($Object, var$1046, $Long::valueOf($XKeySymConstants::XK_v));
		...
		$var($Object, var$1047, $Long::valueOf($XKeySymConstants::XK_w));
		...
		$var($Object, var$1048, $Long::valueOf($XKeySymConstants::XK_x));
		...
		$var($Object, var$1049, $Long::valueOf($XKeySymConstants::XK_y));
		...
		$var($Object, var$1050, $Long::valueOf($XKeySymConstants::XK_z));
		...
		$var($Object, var$1051, $Long::valueOf($XKeySymConstants::XK_BackSpace));
		...
		$var($Object, var$1052, $Long::valueOf($XKeySymConstants::XK_Tab));
		...
		$var($Object, var$1053, $Long::valueOf($XKeySymConstants::XK_ISO_Left_Tab));
		...
		$var($Object, var$1054, $Long::valueOf($XKeySymConstants::XK_Clear));
		...
		$var($Object, var$1055, $Long::valueOf($XKeySymConstants::XK_Return));
		...
		$var($Object, var$1056, $Long::valueOf($XKeySymConstants::XK_Linefeed));
		...
		$var($Object, var$1057, $Long::valueOf($XKeySymConstants::XK_Pause));
		...
		$var($Object, var$1058, $Long::valueOf($XKeySymConstants::XK_F21));
		...
		$var($Object, var$1059, $Long::valueOf($XKeySymConstants::XK_R1));
		...
		$var($Object, var$1060, $Long::valueOf($XKeySymConstants::XK_Scroll_Lock));
		...
		$var($Object, var$1061, $Long::valueOf($XKeySymConstants::XK_F23));
		...
		$var($Object, var$1062, $Long::valueOf($XKeySymConstants::XK_R3));
		...
		$var($Object, var$1063, $Long::valueOf($XKeySymConstants::XK_Escape));
		...
		$var($Object, var$1064, $Long::valueOf($XKeySymConstants::osfXK_BackSpace));
		...
		$var($Object, var$1065, $Long::valueOf($XKeySymConstants::osfXK_Clear));
		...
		$var($Object, var$1066, $Long::valueOf($XKeySymConstants::osfXK_Escape));
		...
		$var($Object, var$1067, $Long::valueOf($XKeySymConstants::XK_Shift_L));
		...
		$var($Object, var$1068, $Long::valueOf($XKeySymConstants::XK_Shift_R));
		...
		$var($Object, var$1069, $Long::valueOf($XKeySymConstants::XK_Control_L));
		...
		$var($Object, var$1070, $Long::valueOf($XKeySymConstants::XK_Control_R));
		...
		$var($Object, var$1073, $Long::valueOf($XKeySymConstants::XK_Meta_L));
		...
		$var($Object, var$1074, $Long::valueOf($XKeySymConstants::XK_Meta_R));
		...
		$var($Object, var$1075, $Long::valueOf($XKeySymConstants::XK_Caps_Lock));
		...
		$var($Object, var$1076, $Long::valueOf($XKeySymConstants::XK_Shift_Lock));
		...
		$var($Object, var$1077, $Long::valueOf($XKeySymConstants::XK_Print));
		...
		$var($Object, var$1078, $Long::valueOf($XKeySymConstants::XK_F22));
		...
		$var($Object, var$1079, $Long::valueOf($XKeySymConstants::XK_R2));
		...
		$var($Object, var$1080, $Long::valueOf($XKeySymConstants::XK_Cancel));
		...
		$var($Object, var$1081, $Long::valueOf($XKeySymConstants::XK_Help));
		...
		$var($Object, var$1082, $Long::valueOf($XKeySymConstants::XK_Num_Lock));
		...
		$var($Object, var$1083, $Long::valueOf($XKeySymConstants::osfXK_Cancel));
		...
		$var($Object, var$1084, $Long::valueOf($XKeySymConstants::osfXK_Help));
		...
		$var($Object, var$1085, $Long::valueOf($XKeySymConstants::XK_Home));
		...
		$var($Object, var$1086, $Long::valueOf($XKeySymConstants::XK_R7));
		...
		$var($Object, var$1087, $Long::valueOf($XKeySymConstants::XK_Page_Up));
		...
		$var($Object, var$1088, $Long::valueOf($XKeySymConstants::XK_Prior));
		...
		$var($Object, var$1089, $Long::valueOf($XKeySymConstants::XK_R9));
		...
		$var($Object, var$1090, $Long::valueOf($XKeySymConstants::XK_Page_Down));
		...
		$var($Object, var$1091, $Long::valueOf($XKeySymConstants::XK_Next));
		...
		$var($Object, var$1092, $Long::valueOf($XKeySymConstants::XK_R15));
		...
		$var($Object, var$1093, $Long::valueOf($XKeySymConstants::XK_End));
		...
		$var($Object, var$1094, $Long::valueOf($XKeySymConstants::XK_R13));
		...
		$var($Object, var$1095, $Long::valueOf($XKeySymConstants::XK_Insert));
		...
		$var($Object, var$1096, $Long::valueOf($XKeySymConstants::XK_Delete));
		...
		$var($Object, var$1097, $Long::valueOf($XKeySymConstants::XK_KP_Home));
		...
		$var($Object, var$1098, $Long::valueOf($XKeySymConstants::XK_KP_Page_Up));
		...
		$var($Object, var$1099, $Long::valueOf($XKeySymConstants::XK_KP_Prior));
		...
		$var($Object, var$1100, $Long::valueOf($XKeySymConstants::XK_KP_Page_Down));
		...
		$var($Object, var$1101, $Long::valueOf($XKeySymConstants::XK_KP_Next));
		...
		$var($Object, var$1102, $Long::valueOf($XKeySymConstants::XK_KP_End));
		...
		$var($Object, var$1103, $Long::valueOf($XKeySymConstants::XK_KP_Insert));
		...
		$var($Object, var$1104, $Long::valueOf($XKeySymConstants::XK_KP_Delete));
		...
		$var($Object, var$1105, $Long::valueOf($XKeySymConstants::osfXK_PageUp));
		...
		$var($Object, var$1106, $Long::valueOf($XKeySymConstants::osfXK_Prior));
		...
		$var($Object, var$1107, $Long::valueOf($XKeySymConstants::osfXK_PageDown));
		...
		$var($Object, var$1108, $Long::valueOf($XKeySymConstants::osfXK_Next));
		...
		$var($Object, var$1109, $Long::valueOf($XKeySymConstants::osfXK_EndLine));
		...
		$var($Object, var$1110, $Long::valueOf($XKeySymConstants::osfXK_Insert));
		...
		$var($Object, var$1111, $Long::valueOf($XKeySymConstants::osfXK_Delete));
		...
		$var($Object, var$1112, $Long::valueOf($XKeySymConstants::XK_Left));
		...
		$var($Object, var$1113, $Long::valueOf($XKeySymConstants::XK_Up));
		...
		$var($Object, var$1114, $Long::valueOf($XKeySymConstants::XK_Right));
		...
		$var($Object, var$1115, $Long::valueOf($XKeySymConstants::XK_Down));
		...
		$var($Object, var$1116, $Long::valueOf($XKeySymConstants::XK_KP_Left));
		...
		$var($Object, var$1117, $Long::valueOf($XKeySymConstants::XK_KP_Up));
		...
		$var($Object, var$1118, $Long::valueOf($XKeySymConstants::XK_KP_Right));
		...
		$var($Object, var$1119, $Long::valueOf($XKeySymConstants::XK_KP_Down));
		...
		$var($Object, var$1120, $Long::valueOf($XKeySymConstants::osfXK_Left));
		...
		$var($Object, var$1121, $Long::valueOf($XKeySymConstants::osfXK_Up));
		...
		$var($Object, var$1122, $Long::valueOf($XKeySymConstants::osfXK_Right));
		...
		$var($Object, var$1123, $Long::valueOf($XKeySymConstants::osfXK_Down));
		...
		$var($Object, var$1124, $Long::valueOf($XKeySymConstants::XK_Begin));
		...
		$var($Object, var$1125, $Long::valueOf($XKeySymConstants::XK_KP_Begin));
		...
		$var($Object, var$1126, $Long::valueOf($XKeySymConstants::XK_0));
		...
		$var($Object, var$1127, $Long::valueOf($XKeySymConstants::XK_1));
		...
		$var($Object, var$1128, $Long::valueOf($XKeySymConstants::XK_2));
		...
		$var($Object, var$1129, $Long::valueOf($XKeySymConstants::XK_3));
		...
		$var($Object, var$1130, $Long::valueOf($XKeySymConstants::XK_4));
		...
		$var($Object, var$1131, $Long::valueOf($XKeySymConstants::XK_5));
		...
		$var($Object, var$1132, $Long::valueOf($XKeySymConstants::XK_6));
		...
		$var($Object, var$1133, $Long::valueOf($XKeySymConstants::XK_7));
		...
		$var($Object, var$1134, $Long::valueOf($XKeySymConstants::XK_8));
		...
		$var($Object, var$1135, $Long::valueOf($XKeySymConstants::XK_9));
		...
		$var($Object, var$1136, $Long::valueOf($XKeySymConstants::XK_space));
		...
		$var($Object, var$1137, $Long::valueOf($XKeySymConstants::XK_exclam));
		...
		$var($Object, var$1138, $Long::valueOf($XKeySymConstants::XK_quotedbl));
		...
		$var($Object, var$1139, $Long::valueOf($XKeySymConstants::XK_numbersign));
		...
		$var($Object, var$1140, $Long::valueOf($XKeySymConstants::XK_dollar));
		...
		$var($Object, var$1141, $Long::valueOf($XKeySymConstants::XK_ampersand));
		...
		$var($Object, var$1142, $Long::valueOf($XKeySymConstants::XK_apostrophe));
		...
		$var($Object, var$1143, $Long::valueOf($XKeySymConstants::XK_parenleft));
		...
		$var($Object, var$1144, $Long::valueOf($XKeySymConstants::XK_parenright));
		...
		$var($Object, var$1145, $Long::valueOf($XKeySymConstants::XK_asterisk));
		...
		$var($Object, var$1146, $Long::valueOf($XKeySymConstants::XK_plus));
		...
		$var($Object, var$1147, $Long::valueOf($XKeySymConstants::XK_comma));
		...
		$var($Object, var$1148, $Long::valueOf($XKeySymConstants::XK_minus));
		...
		$var($Object, var$1149, $Long::valueOf($XKeySymConstants::XK_period));
		...
		$var($Object, var$1150, $Long::valueOf($XKeySymConstants::XK_slash));
		...
		$var($Object, var$1151, $Long::valueOf($XKeySymConstants::XK_colon));
		...
		$var($Object, var$1152, $Long::valueOf($XKeySymConstants::XK_semicolon));
		...
		$var($Object, var$1153, $Long::valueOf($XKeySymConstants::XK_less));
		...
		$var($Object, var$1154, $Long::valueOf($XKeySymConstants::XK_equal));
		...
		$var($Object, var$1155, $Long::valueOf($XKeySymConstants::XK_greater));
		...
		$var($Object, var$1156, $Long::valueOf($XKeySymConstants::XK_at));
		...
		$var($Object, var$1157, $Long::valueOf($XKeySymConstants::XK_bracketleft));
		...
		$var($Object, var$1158, $Long::valueOf($XKeySymConstants::XK_backslash));
		...
		$var($Object, var$1159, $Long::valueOf($XKeySymConstants::XK_bracketright));
		...
		$var($Object, var$1160, $Long::valueOf($XKeySymConstants::XK_asciicircum));
		...
		$var($Object, var$1161, $Long::valueOf($XKeySymConstants::XK_underscore));
		...
		$var($Object, var$1162, $Long::valueOf($XKeySymConstants::XK_Super_L));
		...
		$var($Object, var$1163, $Long::valueOf($XKeySymConstants::XK_Super_R));
		...
		$var($Object, var$1164, $Long::valueOf($XKeySymConstants::XK_Menu));
		...
		$var($Object, var$1165, $Long::valueOf($XKeySymConstants::XK_grave));
		...
		$var($Object, var$1166, $Long::valueOf($XKeySymConstants::XK_braceleft));
		...
		$var($Object, var$1167, $Long::valueOf($XKeySymConstants::XK_braceright));
		...
		$var($Object, var$1168, $Long::valueOf($XKeySymConstants::XK_exclamdown));
		...
		$var($Object, var$1169, $Long::valueOf($XKeySymConstants::XK_KP_0));
		...
		$var($Object, var$1170, $Long::valueOf($XKeySymConstants::XK_KP_1));
		...
		$var($Object, var$1171, $Long::valueOf($XKeySymConstants::XK_KP_2));
		...
		$var($Object, var$1172, $Long::valueOf($XKeySymConstants::XK_KP_3));
		...
		$var($Object, var$1173, $Long::valueOf($XKeySymConstants::XK_KP_4));
		...
		$var($Object, var$1174, $Long::valueOf($XKeySymConstants::XK_KP_5));
		...
		$var($Object, var$1175, $Long::valueOf($XKeySymConstants::XK_KP_6));
		...
		$var($Object, var$1176, $Long::valueOf($XKeySymConstants::XK_KP_7));
		...
		$var($Object, var$1177, $Long::valueOf($XKeySymConstants::XK_KP_8));
		...
		$var($Object, var$1178, $Long::valueOf($XKeySymConstants::XK_KP_9));
		...
		$var($Object, var$1179, $Long::valueOf($XKeySymConstants::XK_KP_Space));
		...
		$var($Object, var$1180, $Long::valueOf($XKeySymConstants::XK_KP_Tab));
		...
		$var($Object, var$1181, $Long::valueOf($XKeySymConstants::XK_KP_Enter));
		...
		$var($Object, var$1182, $Long::valueOf($XKeySymConstants::XK_KP_Equal));
		...
		$var($Object, var$1183, $Long::valueOf($XKeySymConstants::XK_R4));
		...
		$var($Object, var$1184, $Long::valueOf($XKeySymConstants::XK_KP_Multiply));
		...
		$var($Object, var$1185, $Long::valueOf($XKeySymConstants::XK_F26));
		...
		$var($Object, var$1186, $Long::valueOf($XKeySymConstants::XK_R6));
		...
		$var($Object, var$1187, $Long::valueOf($XKeySymConstants::XK_KP_Add));
		...
		$var($Object, var$1188, $Long::valueOf($XKeySymConstants::XK_KP_Separator));
		...
		$var($Object, var$1189, $Long::valueOf($XKeySymConstants::XK_KP_Subtract));
		...
		$var($Object, var$1190, $Long::valueOf($XKeySymConstants::XK_F24));
		...
		$var($Object, var$1191, $Long::valueOf($XKeySymConstants::XK_KP_Decimal));
		...
		$var($Object, var$1192, $Long::valueOf($XKeySymConstants::XK_KP_Divide));
		...
		$var($Object, var$1193, $Long::valueOf($XKeySymConstants::XK_F25));
		...
		$var($Object, var$1194, $Long::valueOf($XKeySymConstants::XK_R5));
		...
		$var($Object, var$1195, $Long::valueOf($XKeySymConstants::XK_F1));
		...
		$var($Object, var$1196, $Long::valueOf($XKeySymConstants::XK_F2));
		...
		$var($Object, var$1197, $Long::valueOf($XKeySymConstants::XK_F3));
		...
		$var($Object, var$1198, $Long::valueOf($XKeySymConstants::XK_F4));
		...
		$var($Object, var$1199, $Long::valueOf($XKeySymConstants::XK_F5));
		...
		$var($Object, var$1200, $Long::valueOf($XKeySymConstants::XK_F6));
		...
		$var($Object, var$1201, $Long::valueOf($XKeySymConstants::XK_F7));
		...
		$var($Object, var$1202, $Long::valueOf($XKeySymConstants::XK_F8));
		...
		$var($Object, var$1203, $Long::valueOf($XKeySymConstants::XK_F9));
		...
		$var($Object, var$1204, $Long::valueOf($XKeySymConstants::XK_F10));
		...
		$var($Object, var$1205, $Long::valueOf($XKeySymConstants::XK_F11));
		...
		$var($Object, var$1206, $Long::valueOf($XKeySymConstants::XK_F12));
		...
		$var($Object, var$1207, $Long::valueOf($XKeySymConstants::SunXK_F36));
		...
		$var($Object, var$1208, $Long::valueOf($XKeySymConstants::SunXK_F37));
		...
		$var($Object, var$1209, $Long::valueOf($XKeySymConstants::XK_Execute));
		...
		$var($Object, var$1210, $Long::valueOf($XKeySymConstants::XK_Kanji));
		...
		$var($Object, var$1211, $Long::valueOf($XKeySymConstants::XK_Henkan_Mode));
		...
		$var($Object, var$1212, $Long::valueOf($XKeySymConstants::XK_Eisu_Shift));
		...
		$var($Object, var$1213, $Long::valueOf($XKeySymConstants::XK_Eisu_toggle));
		...
		$var($Object, var$1214, $Long::valueOf($XKeySymConstants::XK_Zenkaku));
		...
		$var($Object, var$1215, $Long::valueOf($XKeySymConstants::XK_Hankaku));
		...
		$var($Object, var$1216, $Long::valueOf($XKeySymConstants::XK_Hiragana));
		...
		$var($Object, var$1217, $Long::valueOf($XKeySymConstants::XK_Katakana));
		...
		$var($Object, var$1218, $Long::valueOf($XKeySymConstants::XK_Romaji));
		...
		$var($Object, var$1219, $Long::valueOf($XKeySymConstants::XK_Kana_Shift));
		...
		$var($Object, var$1220, $Long::valueOf($XKeySymConstants::XK_Kana_Lock));
		...
		$var($Object, var$1221, $Long::valueOf($XKeySymConstants::XK_Muhenkan));
		...
		$var($Object, var$1222, $Long::valueOf($XKeySymConstants::XK_Zen_Koho));
		...
		$var($Object, var$1223, $Long::valueOf($XKeySymConstants::XK_Kanji_Bangou));
		...
		$var($Object, var$1224, $Long::valueOf($XKeySymConstants::XK_Mae_Koho));
		...
		$var($Object, var$1225, $Long::valueOf($XKeySymConstants::XK_Multi_key));
		...
		$var($Object, var$1226, $Long::valueOf($XKeySymConstants::XK_Mode_switch));
		...
		$var($Object, var$1227, $Long::valueOf($XKeySymConstants::XK_ISO_Level3_Shift));
		...
		$var($Object, var$1228, $Long::valueOf($XKeySymConstants::XK_Redo));
		...
		$var($Object, var$1229, $Long::valueOf($XKeySymConstants::XK_Undo));
		...
		$var($Object, var$1230, $Long::valueOf($XKeySymConstants::XK_L4));
		...
		$var($Object, var$1231, $Long::valueOf($XKeySymConstants::XK_L6));
		...
		$var($Object, var$1232, $Long::valueOf($XKeySymConstants::XK_L8));
		...
		$var($Object, var$1233, $Long::valueOf($XKeySymConstants::XK_L10));
		...
		$var($Object, var$1234, $Long::valueOf($XKeySymConstants::XK_Find));
		...
		$var($Object, var$1235, $Long::valueOf($XKeySymConstants::XK_L9));
		...
		$var($Object, var$1236, $Long::valueOf($XKeySymConstants::XK_L3));
		...
		$var($Object, var$1237, $Long::valueOf($XKeySymConstants::SunXK_Again));
		...
		$var($Object, var$1238, $Long::valueOf($XKeySymConstants::SunXK_Undo));
		...
		$var($Object, var$1239, $Long::valueOf($XKeySymConstants::SunXK_Copy));
		...
		$var($Object, var$1240, $Long::valueOf($XKeySymConstants::SunXK_Paste));
		...
		$var($Object, var$1241, $Long::valueOf($XKeySymConstants::SunXK_Cut));
		...
		$var($Object, var$1242, $Long::valueOf($XKeySymConstants::SunXK_Find));
		...
		$var($Object, var$1243, $Long::valueOf($XKeySymConstants::SunXK_Props));
		...
		$var($Object, var$1244, $Long::valueOf($XKeySymConstants::SunXK_Stop));
		...
		$var($Object, var$1245, $Long::valueOf($XKeySymConstants::apXK_Copy));
		...
		$var($Object, var$1246, $Long::valueOf($XKeySymConstants::apXK_Cut));
		...
		$var($Object, var$1247, $Long::valueOf($XKeySymConstants::apXK_Paste));
		...
		$var($Object, var$1248, $Long::valueOf($XKeySymConstants::osfXK_Copy));
		...
		$var($Object, var$1249, $Long::valueOf($XKeySymConstants::osfXK_Cut));
		...
		$var($Object, var$1250, $Long::valueOf($XKeySymConstants::osfXK_Paste));
		...
		$var($Object, var$1251, $Long::valueOf($XKeySymConstants::osfXK_Undo));
		...
		$var($Object, var$1252, $Long::valueOf($XKeySymConstants::XK_dead_grave));
		...
		$var($Object, var$1253, $Long::valueOf($XKeySymConstants::XK_dead_acute));
		...
		$var($Object, var$1254, $Long::valueOf($XKeySymConstants::XK_dead_circumflex));
		...
		$var($Object, var$1255, $Long::valueOf($XKeySymConstants::XK_dead_tilde));
		...
		$var($Object, var$1256, $Long::valueOf($XKeySymConstants::XK_dead_macron));
		...
		$var($Object, var$1257, $Long::valueOf($XKeySymConstants::XK_dead_breve));
		...
		$var($Object, var$1258, $Long::valueOf($XKeySymConstants::XK_dead_abovedot));
		...
		$var($Object, var$1259, $Long::valueOf($XKeySymConstants::XK_dead_diaeresis));
		...
		$var($Object, var$1260, $Long::valueOf($XKeySymConstants::XK_dead_abovering));
		...
		$var($Object, var$1261, $Long::valueOf($XKeySymConstants::XK_dead_doubleacute));
		...
		$var($Object, var$1262, $Long::valueOf($XKeySymConstants::XK_dead_caron));
		...
		$var($Object, var$1263, $Long::valueOf($XKeySymConstants::XK_dead_cedilla));
		...
		$var($Object, var$1264, $Long::valueOf($XKeySymConstants::XK_dead_ogonek));
		...
		$var($Object, var$1265, $Long::valueOf($XKeySymConstants::XK_dead_iota));
		...
		$var($Object, var$1266, $Long::valueOf($XKeySymConstants::XK_dead_voiced_sound));
		...
		$var($Object, var$1267, $Long::valueOf($XKeySymConstants::XK_dead_semivoiced_sound));
		...
		$var($Object, var$1268, $Long::valueOf($XKeySymConstants::SunXK_FA_Grave));
		...
		$var($Object, var$1269, $Long::valueOf($XKeySymConstants::SunXK_FA_Circum));
		...
		$var($Object, var$1270, $Long::valueOf($XKeySymConstants::SunXK_FA_Tilde));
		...
		$var($Object, var$1271, $Long::valueOf($XKeySymConstants::SunXK_FA_Acute));
		...
		$var($Object, var$1272, $Long::valueOf($XKeySymConstants::SunXK_FA_Diaeresis));
		...
		$var($Object, var$1273, $Long::valueOf($XKeySymConstants::SunXK_FA_Cedilla));
		...
		$var($Object, var$1274, $Long::valueOf($XKeySymConstants::DXK_ring_accent));
		...
		$var($Object, var$1275, $Long::valueOf($XKeySymConstants::DXK_circumflex_accent));
		...
		$var($Object, var$1276, $Long::valueOf($XKeySymConstants::DXK_cedilla_accent));
		...
		$var($Object, var$1277, $Long::valueOf($XKeySymConstants::DXK_acute_accent));
		...
		$var($Object, var$1278, $Long::valueOf($XKeySymConstants::DXK_grave_accent));
		...
		$var($Object, var$1279, $Long::valueOf($XKeySymConstants::DXK_tilde));
		...
		$var($Object, var$1280, $Long::valueOf($XKeySymConstants::DXK_diaeresis));
		...
		$var($Object, var$1281, $Long::valueOf($XKeySymConstants::hpXK_mute_acute));
		...
		$var($Object, var$1282, $Long::valueOf($XKeySymConstants::hpXK_mute_grave));
		...
		$var($Object, var$1283, $Long::valueOf($XKeySymConstants::hpXK_mute_asciicircum));
		...
		$var($Object, var$1284, $Long::valueOf($XKeySymConstants::hpXK_mute_diaeresis));
		...
		$var($Object, var$1285, $Long::valueOf($XKeySymConstants::hpXK_mute_asciitilde));
		...
		$var($Object, var$1286, $Long::valueOf($XConstants::NoSymbol));
...
$Class* XKeysym::load$($String* name, bool initialize) {
	...
	$loadClass(XKeysym, name, initialize, &classInfo$$, XKeysym::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(XKeysym);
	});
	return class$;
}
