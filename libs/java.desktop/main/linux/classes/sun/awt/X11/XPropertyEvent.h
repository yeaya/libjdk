#ifndef _sun_awt_X11_XPropertyEvent_h_
#define _sun_awt_X11_XPropertyEvent_h_
//$ class sun.awt.X11.XPropertyEvent
...
class XPropertyEvent : public ::sun::awt::X11::XWrapperBase {
	$class(XPropertyEvent, $NO_CLASS_INIT, ::sun::awt::X11::XWrapperBase)
public:
	XPropertyEvent();
	...
	virtual void set_atom(int64_t v);
...
#endif // _sun_awt_X11_XPropertyEvent_h_