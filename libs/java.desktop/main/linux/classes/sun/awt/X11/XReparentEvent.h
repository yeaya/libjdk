#ifndef _sun_awt_X11_XReparentEvent_h_
#define _sun_awt_X11_XReparentEvent_h_
//$ class sun.awt.X11.XReparentEvent
...
class XReparentEvent : public ::sun::awt::X11::XWrapperBase {
	$class(XReparentEvent, $NO_CLASS_INIT, ::sun::awt::X11::XWrapperBase)
public:
	XReparentEvent();
...
#endif // _sun_awt_X11_XReparentEvent_h_