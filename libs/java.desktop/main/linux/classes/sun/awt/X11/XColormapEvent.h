#ifndef _sun_awt_X11_XColormapEvent_h_
#define _sun_awt_X11_XColormapEvent_h_
//$ class sun.awt.X11.XColormapEvent
...
class XColormapEvent : public ::sun::awt::X11::XWrapperBase {
	$class(XColormapEvent, $NO_CLASS_INIT, ::sun::awt::X11::XWrapperBase)
public:
	XColormapEvent();
...
#endif // _sun_awt_X11_XColormapEvent_h_