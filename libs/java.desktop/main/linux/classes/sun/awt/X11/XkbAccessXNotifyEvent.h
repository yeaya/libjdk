#ifndef _sun_awt_X11_XkbAccessXNotifyEvent_h_
#define _sun_awt_X11_XkbAccessXNotifyEvent_h_
//$ class sun.awt.X11.XkbAccessXNotifyEvent
...
class XkbAccessXNotifyEvent : public ::sun::awt::X11::XWrapperBase {
	$class(XkbAccessXNotifyEvent, $NO_CLASS_INIT, ::sun::awt::X11::XWrapperBase)
public:
	...
	virtual int32_t get_debounce_delay();
	...
	virtual void set_sk_delay(int32_t v);
...
#endif // _sun_awt_X11_XkbAccessXNotifyEvent_h_