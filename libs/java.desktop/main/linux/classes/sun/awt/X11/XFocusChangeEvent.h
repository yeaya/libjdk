#ifndef _sun_awt_X11_XFocusChangeEvent_h_
#define _sun_awt_X11_XFocusChangeEvent_h_
//$ class sun.awt.X11.XFocusChangeEvent
...
class XFocusChangeEvent : public ::sun::awt::X11::XWrapperBase {
	$class(XFocusChangeEvent, $NO_CLASS_INIT, ::sun::awt::X11::XWrapperBase)
public:
	XFocusChangeEvent();
...
#endif // _sun_awt_X11_XFocusChangeEvent_h_