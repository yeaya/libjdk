#ifndef _sun_awt_X11_XVisibilityEvent_h_
#define _sun_awt_X11_XVisibilityEvent_h_
//$ class sun.awt.X11.XVisibilityEvent
...
class XVisibilityEvent : public ::sun::awt::X11::XWrapperBase {
	$class(XVisibilityEvent, $NO_CLASS_INIT, ::sun::awt::X11::XWrapperBase)
public:
	XVisibilityEvent();
...
#endif // _sun_awt_X11_XVisibilityEvent_h_