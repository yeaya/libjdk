#ifndef _sun_awt_X11_XDestroyWindowEvent_h_
#define _sun_awt_X11_XDestroyWindowEvent_h_
//$ class sun.awt.X11.XDestroyWindowEvent
...
class XDestroyWindowEvent : public ::sun::awt::X11::XWrapperBase {
	$class(XDestroyWindowEvent, $NO_CLASS_INIT, ::sun::awt::X11::XWrapperBase)
public:
	XDestroyWindowEvent();
...
#endif // _sun_awt_X11_XDestroyWindowEvent_h_