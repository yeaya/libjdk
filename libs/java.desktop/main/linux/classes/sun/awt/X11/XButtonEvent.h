#ifndef _sun_awt_X11_XButtonEvent_h_
#define _sun_awt_X11_XButtonEvent_h_
//$ class sun.awt.X11.XButtonEvent
...
class XButtonEvent : public ::sun::awt::X11::XWrapperBase {
	$class(XButtonEvent, $NO_CLASS_INIT, ::sun::awt::X11::XWrapperBase)
public:
	XButtonEvent();
	...
	virtual void set_button(int32_t v);
...
#endif // _sun_awt_X11_XButtonEvent_h_