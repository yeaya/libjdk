#ifndef _sun_awt_X11_XMapEvent_h_
#define _sun_awt_X11_XMapEvent_h_
//$ class sun.awt.X11.XMapEvent
...
class XMapEvent : public ::sun::awt::X11::XWrapperBase {
	$class(XMapEvent, $NO_CLASS_INIT, ::sun::awt::X11::XWrapperBase)
public:
	XMapEvent();
	...
	virtual int32_t get_override_redirect();
	...
	virtual void set_override_redirect(int32_t v);
...
#endif // _sun_awt_X11_XMapEvent_h_