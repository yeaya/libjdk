#ifndef _sun_awt_X11_XMotionEvent_h_
#define _sun_awt_X11_XMotionEvent_h_
//$ class sun.awt.X11.XMotionEvent
...
class XMotionEvent : public ::sun::awt::X11::XWrapperBase {
	$class(XMotionEvent, $NO_CLASS_INIT, ::sun::awt::X11::XWrapperBase)
public:
	XMotionEvent();
	...
	virtual void set_is_hint(int8_t v);
...
#endif // _sun_awt_X11_XMotionEvent_h_