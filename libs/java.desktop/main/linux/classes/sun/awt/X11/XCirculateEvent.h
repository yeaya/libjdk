#ifndef _sun_awt_X11_XCirculateEvent_h_
#define _sun_awt_X11_XCirculateEvent_h_
//$ class sun.awt.X11.XCirculateEvent
...
class XCirculateEvent : public ::sun::awt::X11::XWrapperBase {
	$class(XCirculateEvent, $NO_CLASS_INIT, ::sun::awt::X11::XWrapperBase)
public:
	XCirculateEvent();
...
#endif // _sun_awt_X11_XCirculateEvent_h_