#ifndef _sun_awt_X11_XCreateWindowEvent_h_
#define _sun_awt_X11_XCreateWindowEvent_h_
//$ class sun.awt.X11.XCreateWindowEvent
...
class XCreateWindowEvent : public ::sun::awt::X11::XWrapperBase {
	$class(XCreateWindowEvent, $NO_CLASS_INIT, ::sun::awt::X11::XWrapperBase)
public:
	XCreateWindowEvent();
...
#endif // _sun_awt_X11_XCreateWindowEvent_h_