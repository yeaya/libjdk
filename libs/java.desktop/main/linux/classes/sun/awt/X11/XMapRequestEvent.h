#ifndef _sun_awt_X11_XMapRequestEvent_h_
#define _sun_awt_X11_XMapRequestEvent_h_
//$ class sun.awt.X11.XMapRequestEvent
...
class XMapRequestEvent : public ::sun::awt::X11::XWrapperBase {
	$class(XMapRequestEvent, $NO_CLASS_INIT, ::sun::awt::X11::XWrapperBase)
public:
	XMapRequestEvent();
...
#endif // _sun_awt_X11_XMapRequestEvent_h_