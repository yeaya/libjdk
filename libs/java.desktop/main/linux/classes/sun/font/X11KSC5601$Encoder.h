#ifndef _sun_font_X11KSC5601$Encoder_h_
#define _sun_font_X11KSC5601$Encoder_h_
//$ class sun.font.X11KSC5601$Encoder
...
class X11KSC5601$Encoder : public ::java::nio::charset::CharsetEncoder {
	$class(X11KSC5601$Encoder, $NO_CLASS_INIT, ::java::nio::charset::CharsetEncoder)
public:
	X11KSC5601$Encoder();
...
#endif // _sun_font_X11KSC5601$Encoder_h_