...
void JRSUIConstants$Focused::clinit$($Class* clazz) {
...
$Class* JRSUIConstants$Focused::load$($String* name, bool initialize) {
	...
	$loadClass(JRSUIConstants$Focused, name, initialize, &classInfo$$, JRSUIConstants$Focused::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(JRSUIConstants$Focused);
	});
	return class$;
}
