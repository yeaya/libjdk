...
void JRSUIConstants$Widget::clinit$($Class* clazz) {
...
$Class* JRSUIConstants$Widget::load$($String* name, bool initialize) {
	...
	$loadClass(JRSUIConstants$Widget, name, initialize, &classInfo$$, JRSUIConstants$Widget::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(JRSUIConstants$Widget);
	});
	return class$;
}
