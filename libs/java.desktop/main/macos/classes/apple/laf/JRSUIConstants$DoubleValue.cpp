...
bool JRSUIConstants$DoubleValue::equals(Object$* obj) {
	return ($instanceOf(JRSUIConstants$DoubleValue, obj)) && ($cast(JRSUIConstants$DoubleValue, obj)->doubleValue == this->doubleValue);
}
...
$Class* JRSUIConstants$DoubleValue::load$($String* name, bool initialize) {
	...
	$loadClass(JRSUIConstants$DoubleValue, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(JRSUIConstants$DoubleValue);
	});
	return class$;
}
