...
void JRSUIConstants$WindowType::clinit$($Class* clazz) {
...
$Class* JRSUIConstants$WindowType::load$($String* name, bool initialize) {
	...
	$loadClass(JRSUIConstants$WindowType, name, initialize, &classInfo$$, JRSUIConstants$WindowType::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(JRSUIConstants$WindowType);
	});
	return class$;
}
