...
void JRSUIConstants$ScrollBarPart::clinit$($Class* clazz) {
...
$Class* JRSUIConstants$ScrollBarPart::load$($String* name, bool initialize) {
	...
	$loadClass(JRSUIConstants$ScrollBarPart, name, initialize, &classInfo$$, JRSUIConstants$ScrollBarPart::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(JRSUIConstants$ScrollBarPart);
	});
	return class$;
}
