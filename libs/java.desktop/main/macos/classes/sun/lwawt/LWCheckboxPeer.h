#ifndef _sun_lwawt_LWCheckboxPeer_h_
#define _sun_lwawt_LWCheckboxPeer_h_
//$ class sun.lwawt.LWCheckboxPeer
//$ extends sun.lwawt.LWComponentPeer
//$ implements java.awt.peer.CheckboxPeer,java.awt.event.ItemListener
...
class LWCheckboxPeer : public ::sun::lwawt::LWComponentPeer, public ::java::awt::peer::CheckboxPeer, public ::java::awt::event::ItemListener {
	$class(LWCheckboxPeer, $NO_CLASS_INIT, ::sun::lwawt::LWComponentPeer, ::java::awt::peer::CheckboxPeer, ::java::awt::event::ItemListener)
public:
	LWCheckboxPeer();
	...
	void init$(::java::awt::Checkbox* target, ::sun::lwawt::PlatformComponent* platformComponent);
...
#endif // _sun_lwawt_LWCheckboxPeer_h_