#ifndef _sun_lwawt_LWChoicePeer_h_
#define _sun_lwawt_LWChoicePeer_h_
//$ class sun.lwawt.LWChoicePeer
//$ extends sun.lwawt.LWComponentPeer
//$ implements java.awt.peer.ChoicePeer,java.awt.event.ItemListener
...
class LWChoicePeer : public ::sun::lwawt::LWComponentPeer, public ::java::awt::peer::ChoicePeer, public ::java::awt::event::ItemListener {
	$class(LWChoicePeer, $NO_CLASS_INIT, ::sun::lwawt::LWComponentPeer, ::java::awt::peer::ChoicePeer, ::java::awt::event::ItemListener)
public:
	LWChoicePeer();
	...
	void init$(::java::awt::Choice* target, ::sun::lwawt::PlatformComponent* platformComponent);
	...
	bool skipPostMessage = false;
};

	} // lwawt
} // sun

#endif // _sun_lwawt_LWChoicePeer_h_