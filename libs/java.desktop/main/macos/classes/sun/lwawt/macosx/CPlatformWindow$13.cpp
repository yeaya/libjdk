...
void CPlatformWindow$13::applyProperty($CPlatformWindow* c, Object$* value) {
	$nc(c)->setStyleBits(0x02000000, value == nullptr ? true : $Boolean::parseBoolean($($of(value)->toString())));
}
...
$Class* CPlatformWindow$13::load$($String* name, bool initialize) {
	...
	$loadClass(CPlatformWindow$13, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CPlatformWindow$13);
	});
	return class$;
}
