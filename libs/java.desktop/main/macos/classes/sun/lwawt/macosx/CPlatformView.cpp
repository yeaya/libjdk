...
$Class* CPlatformView$$Lambda$lambda$setBounds$0::load$($String* name, bool initialize) {
	...
	$loadClass(CPlatformView$$Lambda$lambda$setBounds$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CPlatformView$$Lambda$lambda$setBounds$0);
	});
	return class$;
}
...
$Class* CPlatformView$$Lambda$lambda$setToolTip$1$1::load$($String* name, bool initialize) {
	...
	$loadClass(CPlatformView$$Lambda$lambda$setToolTip$1$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CPlatformView$$Lambda$lambda$setToolTip$1$1);
	});
	return class$;
}
...
$Class* CPlatformView$$Lambda$lambda$setAutoResizable$2$2::load$($String* name, bool initialize) {
	...
	$loadClass(CPlatformView$$Lambda$lambda$setAutoResizable$2$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CPlatformView$$Lambda$lambda$setAutoResizable$2$2);
	});
	return class$;
}
...
$Class* CPlatformView$$Lambda$lambda$isUnderMouse$3$3::load$($String* name, bool initialize) {
	...
	$loadClass(CPlatformView$$Lambda$lambda$isUnderMouse$3$3, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CPlatformView$$Lambda$lambda$isUnderMouse$3$3);
	});
	return class$;
}
...
$Class* CPlatformView$$Lambda$lambda$getGraphicsDevice$4$4::load$($String* name, bool initialize) {
	...
	$loadClass(CPlatformView$$Lambda$lambda$getGraphicsDevice$4$4, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CPlatformView$$Lambda$lambda$getGraphicsDevice$4$4);
	});
	return class$;
}
...
$Class* CPlatformView$$Lambda$lambda$getLocationOnScreen$5$5::load$($String* name, bool initialize) {
	...
	$loadClass(CPlatformView$$Lambda$lambda$getLocationOnScreen$5$5, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CPlatformView$$Lambda$lambda$getLocationOnScreen$5$5);
	});
	return class$;
}
...
int64_t CPlatformView::nativeCreateView(int32_t x, int32_t y, int32_t width, int32_t height, int64_t windowLayerPtr) {
	$prepareNative(nativeCreateView, int64_t, int32_t x, int32_t y, int32_t width, int32_t height, int64_t windowLayerPtr);
	int64_t $ret = $invokeNative(x, y, width, height, windowLayerPtr);
	$finishNative();
	return $ret;
}
...
void CPlatformView::nativeSetAutoResizable(int64_t awtView, bool toResize) {
	$init(CPlatformView);
	$prepareNativeStatic(nativeSetAutoResizable, void, int64_t awtView, bool toResize);
...
int32_t CPlatformView::nativeGetNSViewDisplayID(int64_t awtView) {
	$init(CPlatformView);
	$prepareNativeStatic(nativeGetNSViewDisplayID, int32_t, int64_t awtView);
	int32_t $ret = $invokeNativeStatic(awtView);
	$finishNativeStatic();
	return $ret;
}
...
$Rectangle2D* CPlatformView::nativeGetLocationOnScreen(int64_t awtView) {
	$init(CPlatformView);
	$prepareNativeStatic(nativeGetLocationOnScreen, $Rectangle2D*, int64_t awtView);
	$var($Rectangle2D, $ret, $invokeNativeStaticObject(awtView));
	$finishNativeStatic();
	return $ret;
}
...
bool CPlatformView::nativeIsViewUnderMouse(int64_t ptr) {
	$init(CPlatformView);
	$prepareNativeStatic(nativeIsViewUnderMouse, bool, int64_t ptr);
	bool $ret = $invokeNativeStatic(ptr);
	$finishNativeStatic();
	return $ret;
}
...
void CPlatformView::initialize($LWWindowPeer* peer, $CPlatformResponder* responder) {
	...
	$set(this, windowLayer, $CGraphicsDevice::usingMetalPipeline() ? $cast($CFLayer, createMTLLayer()) : $cast($CFLayer, createCGLayer()));
...
void CPlatformView::setBounds(int32_t x, int32_t y, int32_t width, int32_t height) {
	execute($$new(CPlatformView$$Lambda$lambda$setBounds$0, x, y, width, height));
}
...
void CPlatformView::setToolTip($String* msg) {
	execute($$new(CPlatformView$$Lambda$lambda$setToolTip$1$1, msg));
}
...
void CPlatformView::setAutoResizable(bool toResize) {
	execute($$new(CPlatformView$$Lambda$lambda$setAutoResizable$2$2, toResize));
}

bool CPlatformView::isUnderMouse() {
	$useLocalObjectStack();
	$var($AtomicBoolean, ref, $new($AtomicBoolean));
	execute($$new(CPlatformView$$Lambda$lambda$isUnderMouse$3$3, ref));
	return ref->get();
}
...
$GraphicsDevice* CPlatformView::getGraphicsDevice() {
	...
	execute($$new(CPlatformView$$Lambda$lambda$getGraphicsDevice$4$4, ref));
...
$Point* CPlatformView::getLocationOnScreen() {
	...
	execute($$new(CPlatformView$$Lambda$lambda$getLocationOnScreen$5$5, ref));
...
void CPlatformView::deliverMouseEvent($NSEvent* event) {
	...
	if (event->getType() == $CocoaConstants::NSScrollWheel) {
		...
		double var$2 = event->getScrollDeltaX();
		double var$3 = event->getScrollDeltaY();
		$nc(this->responder)->handleScrollEvent(x, y, absX, absY, var$1, var$2, var$3, event->getScrollPhase());
	} else {
		int32_t var$4 = event->getType();
		int32_t var$5 = event->getModifierFlags();
		int32_t var$6 = event->getButtonNumber();
		$nc(this->responder)->handleMouseEvent(var$4, var$5, var$6, event->getClickCount(), x, y, absX, absY);
	}
}
...
$Class* CPlatformView::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("sun.lwawt.macosx.CPlatformView$$Lambda$lambda$setBounds$0")) {
			return CPlatformView$$Lambda$lambda$setBounds$0::load$(name, initialize);
		}
		if (name->equals("sun.lwawt.macosx.CPlatformView$$Lambda$lambda$setToolTip$1$1")) {
			return CPlatformView$$Lambda$lambda$setToolTip$1$1::load$(name, initialize);
		}
		if (name->equals("sun.lwawt.macosx.CPlatformView$$Lambda$lambda$setAutoResizable$2$2")) {
			return CPlatformView$$Lambda$lambda$setAutoResizable$2$2::load$(name, initialize);
		}
		if (name->equals("sun.lwawt.macosx.CPlatformView$$Lambda$lambda$isUnderMouse$3$3")) {
			return CPlatformView$$Lambda$lambda$isUnderMouse$3$3::load$(name, initialize);
		}
		if (name->equals("sun.lwawt.macosx.CPlatformView$$Lambda$lambda$getGraphicsDevice$4$4")) {
			return CPlatformView$$Lambda$lambda$getGraphicsDevice$4$4::load$(name, initialize);
		}
		if (name->equals("sun.lwawt.macosx.CPlatformView$$Lambda$lambda$getLocationOnScreen$5$5")) {
	...
	$loadClass(CPlatformView, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CPlatformView);
	});
	return class$;
}
