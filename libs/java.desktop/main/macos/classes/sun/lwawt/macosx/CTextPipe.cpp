...
void CTextPipe::doDrawString($SurfaceData* sData, int64_t nativeStrikePtr, $String* s, double x, double y) {
	$prepareNative(doDrawString, void, $SurfaceData* sData, int64_t nativeStrikePtr, $String* s, double x, double y);
...
void CTextPipe::doDrawGlyphs($SurfaceData* sData, int64_t nativeStrikePtr, $GlyphVector* gV, float x, float y) {
	$prepareNative(doDrawGlyphs, void, $SurfaceData* sData, int64_t nativeStrikePtr, $GlyphVector* gV, float x, float y);
...
void CTextPipe::doUnicodes($SurfaceData* sData, int64_t nativeStrikePtr, $chars* unicodes, int32_t offset, int32_t length, float x, float y) {
	$prepareNative(doUnicodes, void, $SurfaceData* sData, int64_t nativeStrikePtr, $chars* unicodes, int32_t offset, int32_t length, float x, float y);
...
void CTextPipe::doOneUnicode($SurfaceData* sData, int64_t nativeStrikePtr, char16_t aUnicode, float x, float y) {
	$prepareNative(doOneUnicode, void, $SurfaceData* sData, int64_t nativeStrikePtr, char16_t aUnicode, float x, float y);
...
$Class* CTextPipe::load$($String* name, bool initialize) {
	...
	$loadClass(CTextPipe, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CTextPipe);
	});
	return class$;
}
