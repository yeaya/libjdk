#ifndef _sun_java2d_metal_MTLBlitLoops_h_
#define _sun_java2d_metal_MTLBlitLoops_h_
//$ class sun.java2d.metal.MTLBlitLoops
...
class MTLBlitLoops : public ::java::lang::Object {
	$class(MTLBlitLoops, $NO_CLASS_INIT, ::java::lang::Object)
public:
	MTLBlitLoops();
	void init$();
...
#endif // _sun_java2d_metal_MTLBlitLoops_h_