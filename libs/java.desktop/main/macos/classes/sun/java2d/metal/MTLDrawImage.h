#ifndef _sun_java2d_metal_MTLDrawImage_h_
#define _sun_java2d_metal_MTLDrawImage_h_
//$ class sun.java2d.metal.MTLDrawImage
...
class MTLDrawImage : public ::sun::java2d::pipe::DrawImage {
	$class(MTLDrawImage, $NO_CLASS_INIT, ::sun::java2d::pipe::DrawImage)
public:
	MTLDrawImage();
	void init$();
...
#endif // _sun_java2d_metal_MTLDrawImage_h_