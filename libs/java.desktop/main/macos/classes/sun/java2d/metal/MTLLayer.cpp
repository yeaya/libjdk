...
$Class* MTLLayer$$Lambda$lambda$replaceSurfaceData$0::load$($String* name, bool initialize) {
	...
	$loadClass(MTLLayer$$Lambda$lambda$replaceSurfaceData$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(MTLLayer$$Lambda$lambda$replaceSurfaceData$0);
	});
	return class$;
}
...
$Class* MTLLayer$$Lambda$lambda$validate$1$1::load$($String* name, bool initialize) {
	...
	$loadClass(MTLLayer$$Lambda$lambda$validate$1$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(MTLLayer$$Lambda$lambda$validate$1$1);
	});
	return class$;
}
...
$Class* MTLLayer$$Lambda$lambda$setScale$2$2::load$($String* name, bool initialize) {
	...
	$loadClass(MTLLayer$$Lambda$lambda$setScale$2$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(MTLLayer$$Lambda$lambda$setScale$2$2);
	});
	return class$;
}
...
$Class* MTLLayer$$Lambda$lambda$drawInMTLContext$3$3::load$($String* name, bool initialize) {
	...
	$loadClass(MTLLayer$$Lambda$lambda$drawInMTLContext$3$3, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(MTLLayer$$Lambda$lambda$drawInMTLContext$3$3);
	});
	return class$;
}
...
void MTLLayer::nativeSetInsets(int64_t layerPtr, int32_t top, int32_t left) {
	$init(MTLLayer);
	$prepareNativeStatic(nativeSetInsets, void, int64_t layerPtr, int32_t top, int32_t left);
...
void MTLLayer::validate(int64_t layerPtr, $MTLSurfaceData* mtlsd) {
	$init(MTLLayer);
	$prepareNativeStatic(validate, void, int64_t layerPtr, $MTLSurfaceData* mtlsd);
...
$SurfaceData* MTLLayer::replaceSurfaceData() {
	...
	if (this->peer != nullptr) {
		$var($Insets, insets, this->peer->getInsets());
		execute($$new(MTLLayer$$Lambda$lambda$replaceSurfaceData$0, insets));
	}
...
void MTLLayer::validate($MTLSurfaceData* mtlsd) {
	...
	try {
		execute($$new(MTLLayer$$Lambda$lambda$validate$1$1, mtlsd));
...
void MTLLayer::setScale(int32_t _scale) {
	if (this->scale != _scale) {
		this->scale = _scale;
		execute($$new(MTLLayer$$Lambda$lambda$setScale$2$2, this));
	}
}
...
void MTLLayer::drawInMTLContext() {
	...
	$var($Throwable, var$0, nullptr);
	try {
		execute($$new(MTLLayer$$Lambda$lambda$drawInMTLContext$3$3));
	} catch ($Throwable& var$1) {
		$assign(var$0, var$1);
	} /*finally*/ {
		rq->unlock();
...
void MTLLayer::lambda$replaceSurfaceData$0($Insets* insets, int64_t ptr) {
	$init(MTLLayer);
	nativeSetInsets(ptr, $nc(insets)->top, $nc(insets)->left);
}
...
$Class* MTLLayer::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("sun.java2d.metal.MTLLayer$$Lambda$lambda$replaceSurfaceData$0")) {
			return MTLLayer$$Lambda$lambda$replaceSurfaceData$0::load$(name, initialize);
		}
		if (name->equals("sun.java2d.metal.MTLLayer$$Lambda$lambda$validate$1$1")) {
			return MTLLayer$$Lambda$lambda$validate$1$1::load$(name, initialize);
		}
		if (name->equals("sun.java2d.metal.MTLLayer$$Lambda$lambda$setScale$2$2")) {
			return MTLLayer$$Lambda$lambda$setScale$2$2::load$(name, initialize);
		}
		if (name->equals("sun.java2d.metal.MTLLayer$$Lambda$lambda$drawInMTLContext$3$3")) {
	...
	$loadClass(MTLLayer, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(MTLLayer);
	});
	return class$;
}
