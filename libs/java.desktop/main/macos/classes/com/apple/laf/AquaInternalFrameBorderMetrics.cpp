...
AquaInternalFrameBorderMetrics* AquaInternalFrameBorderMetrics::getMetrics(bool isUtility) {
	...
	if (AquaInternalFrameBorderMetrics::useLegacyBorderMetrics) {
		return isUtility ? $cast(AquaInternalFrameBorderMetrics, AquaInternalFrameBorderMetrics::legacyUtilityMetrics->get()) : $cast(AquaInternalFrameBorderMetrics, AquaInternalFrameBorderMetrics::legacyStandardMetrics->get());
	} else {
		return isUtility ? $cast(AquaInternalFrameBorderMetrics, AquaInternalFrameBorderMetrics::utilityMetrics->get()) : $cast(AquaInternalFrameBorderMetrics, AquaInternalFrameBorderMetrics::standardMetrics->get());
	}
}

void AquaInternalFrameBorderMetrics::clinit$($Class* clazz) {
...
$Class* AquaInternalFrameBorderMetrics::load$($String* name, bool initialize) {
	...
	$loadClass(AquaInternalFrameBorderMetrics, name, initialize, &classInfo$$, AquaInternalFrameBorderMetrics::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(AquaInternalFrameBorderMetrics);
	});
	return class$;
}
