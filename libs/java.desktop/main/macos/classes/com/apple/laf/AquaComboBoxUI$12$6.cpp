...
void AquaComboBoxUI$12$6::applyProperty($AquaComboBoxUI* target, Object$* value) {
	...
	$$sure($AquaComboBoxButton, $AquaComboBoxUI::access$8400(target))->setIsSquare($nc($Boolean::TRUE)->equals(value));
}
...
$Class* AquaComboBoxUI$12$6::load$($String* name, bool initialize) {
	...
	$loadClass(AquaComboBoxUI$12$6, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(AquaComboBoxUI$12$6);
	});
	return class$;
}
