...
$Object* AquaProgressBarUI$1::getInstance() {
	return $new($AquaProgressBarUI$1$1, this, $$new($AquaUtilControlSize$SizeVariant, 146, 20));
}
...
$Class* AquaProgressBarUI$1::load$($String* name, bool initialize) {
	...
	$loadClass(AquaProgressBarUI$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(AquaProgressBarUI$1);
	});
	return class$;
}
