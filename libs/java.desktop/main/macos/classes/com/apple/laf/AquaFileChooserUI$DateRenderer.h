#ifndef _com_apple_laf_AquaFileChooserUI$DateRenderer_h_
#define _com_apple_laf_AquaFileChooserUI$DateRenderer_h_
//$ class com.apple.laf.AquaFileChooserUI$DateRenderer
...
class AquaFileChooserUI$DateRenderer : public ::com::apple::laf::AquaFileChooserUI$MacFCTableCellRenderer {
	$class(AquaFileChooserUI$DateRenderer, $NO_CLASS_INIT, ::com::apple::laf::AquaFileChooserUI$MacFCTableCellRenderer)
public:
...
#endif // _com_apple_laf_AquaFileChooserUI$DateRenderer_h_