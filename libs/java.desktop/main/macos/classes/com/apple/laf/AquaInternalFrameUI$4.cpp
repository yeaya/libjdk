...
$Border* AquaInternalFrameUI$4::getForegroundShadowBorder() {
	$useLocalObjectStack();
	$var($AquaUtils$Painter, var$0, $new($AquaInternalFrameUI$4$1, this));
...
$Border* AquaInternalFrameUI$4::getBackgroundShadowBorder() {
	$useLocalObjectStack();
	$var($AquaUtils$Painter, var$0, $new($AquaInternalFrameUI$4$3, this));
...
$Class* AquaInternalFrameUI$4::load$($String* name, bool initialize) {
	...
	$loadClass(AquaInternalFrameUI$4, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(AquaInternalFrameUI$4);
	});
	return class$;
}
