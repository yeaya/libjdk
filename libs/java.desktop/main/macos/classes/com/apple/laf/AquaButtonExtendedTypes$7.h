#ifndef _com_apple_laf_AquaButtonExtendedTypes$7_h_
#define _com_apple_laf_AquaButtonExtendedTypes$7_h_
//$ class com.apple.laf.AquaButtonExtendedTypes$7
...
class AquaButtonExtendedTypes$7 : public ::com::apple::laf::AquaButtonExtendedTypes$BorderDefinedTypeSpecifier {
	$class(AquaButtonExtendedTypes$7, $NO_CLASS_INIT, ::com::apple::laf::AquaButtonExtendedTypes$BorderDefinedTypeSpecifier)
public:
...
#endif // _com_apple_laf_AquaButtonExtendedTypes$7_h_