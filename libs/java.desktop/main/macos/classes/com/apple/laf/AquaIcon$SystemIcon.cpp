...
$IconUIResource* AquaIcon$SystemIcon::getFolderIconUIResource() {
	...
	return $cast($IconUIResource, AquaIcon$SystemIcon::folderIcon->get());
}

$IconUIResource* AquaIcon$SystemIcon::getOpenFolderIconUIResource() {
	$init(AquaIcon$SystemIcon);
	return $cast($IconUIResource, AquaIcon$SystemIcon::openFolderIcon->get());
}

$IconUIResource* AquaIcon$SystemIcon::getDesktopIconUIResource() {
	$init(AquaIcon$SystemIcon);
	return $cast($IconUIResource, AquaIcon$SystemIcon::desktopIcon->get());
}

$IconUIResource* AquaIcon$SystemIcon::getComputerIconUIResource() {
	$init(AquaIcon$SystemIcon);
	return $cast($IconUIResource, AquaIcon$SystemIcon::computerIcon->get());
}

$IconUIResource* AquaIcon$SystemIcon::getDocumentIconUIResource() {
	$init(AquaIcon$SystemIcon);
	return $cast($IconUIResource, AquaIcon$SystemIcon::documentIcon->get());
}

$IconUIResource* AquaIcon$SystemIcon::getHardDriveIconUIResource() {
	$init(AquaIcon$SystemIcon);
	return $cast($IconUIResource, AquaIcon$SystemIcon::hardDriveIcon->get());
}

$IconUIResource* AquaIcon$SystemIcon::getFloppyIconUIResource() {
	$init(AquaIcon$SystemIcon);
	return $cast($IconUIResource, AquaIcon$SystemIcon::floppyIcon->get());
}

AquaIcon$SystemIcon* AquaIcon$SystemIcon::getCautionIcon() {
	$init(AquaIcon$SystemIcon);
	return $cast(AquaIcon$SystemIcon, AquaIcon$SystemIcon::caut->get());
}

AquaIcon$SystemIcon* AquaIcon$SystemIcon::getStopIcon() {
	$init(AquaIcon$SystemIcon);
	return $cast(AquaIcon$SystemIcon, AquaIcon$SystemIcon::stop->get());
}
...
void AquaIcon$SystemIcon::clinit$($Class* clazz) {
...
$Class* AquaIcon$SystemIcon::load$($String* name, bool initialize) {
	...
	$loadClass(AquaIcon$SystemIcon, name, initialize, &classInfo$$, AquaIcon$SystemIcon::clinit$, []($Class* clazz) -> $Object* {
