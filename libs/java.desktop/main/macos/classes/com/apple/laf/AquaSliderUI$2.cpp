...
$Object* AquaSliderUI$2::getInstance() {
	return $new($AquaSliderUI$2$1, this, $$new($AquaUtilControlSize$SizeVariant, 23, 26));
}
...
$Class* AquaSliderUI$2::load$($String* name, bool initialize) {
	...
	$loadClass(AquaSliderUI$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(AquaSliderUI$2);
	});
	return class$;
}
