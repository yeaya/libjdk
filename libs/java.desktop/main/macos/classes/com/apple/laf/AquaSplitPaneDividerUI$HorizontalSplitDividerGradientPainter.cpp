...
AquaSplitPaneDividerUI$HorizontalSplitDividerGradientPainter* AquaSplitPaneDividerUI$HorizontalSplitDividerGradientPainter::instance() {
	...
	return $cast(AquaSplitPaneDividerUI$HorizontalSplitDividerGradientPainter, AquaSplitPaneDividerUI$HorizontalSplitDividerGradientPainter::instance$->get());
}
...
void AquaSplitPaneDividerUI$HorizontalSplitDividerGradientPainter::paintBorder($Component* c, $Graphics* g, int32_t x, int32_t y, int32_t width, int32_t height) {
	...
	g2d->setPaint($$new($GradientPaint, 0, 0, this->startColor, 0, (float)height, this->endColor));
...
void AquaSplitPaneDividerUI$HorizontalSplitDividerGradientPainter::clinit$($Class* clazz) {
...
$Class* AquaSplitPaneDividerUI$HorizontalSplitDividerGradientPainter::load$($String* name, bool initialize) {
	...
	$loadClass(AquaSplitPaneDividerUI$HorizontalSplitDividerGradientPainter, name, initialize, &classInfo$$, AquaSplitPaneDividerUI$HorizontalSplitDividerGradientPainter::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(AquaSplitPaneDividerUI$HorizontalSplitDividerGradientPainter);
	});
	return class$;
}
