...
void AquaTreeUI$TreeArrowMouseInputHandler::init$($AquaTreeUI* this$0, $TreePath* path) {
	...
	$$nc($AquaTreeUI::access$400(this$0))->addMouseListener($cast($MouseAdapter, this));
	$$nc($AquaTreeUI::access$500(this$0))->addMouseMotionListener($cast($MouseAdapter, this));
...
void AquaTreeUI$TreeArrowMouseInputHandler::removeFromSource() {
	$useLocalObjectStack();
	$$nc($AquaTreeUI::access$2000(this->this$0))->removeMouseListener($cast($MouseAdapter, this));
	$$nc($AquaTreeUI::access$2100(this->this$0))->removeMouseMotionListener($cast($MouseAdapter, this));
}
...
$Class* AquaTreeUI$TreeArrowMouseInputHandler::load$($String* name, bool initialize) {
	...
	$loadClass(AquaTreeUI$TreeArrowMouseInputHandler, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
