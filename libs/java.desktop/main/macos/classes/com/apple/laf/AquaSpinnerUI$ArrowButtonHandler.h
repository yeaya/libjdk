#ifndef _com_apple_laf_AquaSpinnerUI$ArrowButtonHandler_h_
#define _com_apple_laf_AquaSpinnerUI$ArrowButtonHandler_h_
//$ class com.apple.laf.AquaSpinnerUI$ArrowButtonHandler
...
class AquaSpinnerUI$ArrowButtonHandler : public ::javax::swing::AbstractAction, public ::java::awt::event::FocusListener, public ::java::awt::event::MouseListener {
	$class(AquaSpinnerUI$ArrowButtonHandler, $NO_CLASS_INIT, ::javax::swing::AbstractAction, ::java::awt::event::FocusListener, ::java::awt::event::MouseListener)
public:
	...
	int32_t getCalendarField(::javax::swing::JSpinner* spinnerComponent);
	...
	void select(::javax::swing::JSpinner* spinnerComponent);
...
#endif // _com_apple_laf_AquaSpinnerUI$ArrowButtonHandler_h_