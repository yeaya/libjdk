...
$Class* _AppEventHandler$_AppForegroundDispatcher::load$($String* name, bool initialize) {
	...
	$loadClass(_AppEventHandler$_AppForegroundDispatcher, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(_AppEventHandler$_AppForegroundDispatcher);
	});
	return class$;
}
