...
void bug6505523::createAndShowGUI() {
	...
	$init(bug6505523);
	$assignStatic(bug6505523::tree, $new($JTree, model));
	bug6505523::tree->setRootVisible(true);
	...
	frame->add($$new($JScrollPane, bug6505523::tree));
...
$Class* bug6505523::load$($String* name, bool initialize) {
	...
	$loadClass(bug6505523, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(bug6505523);
	});
	return class$;
}
