...
$Class* JMenuItemToolTipKeyBindingsTest$$Lambda$lambda$main$0::load$($String* name, bool initialize) {
	...
	$loadClass(JMenuItemToolTipKeyBindingsTest$$Lambda$lambda$main$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(JMenuItemToolTipKeyBindingsTest$$Lambda$lambda$main$0);
	});
	return class$;
}
...
void JMenuItemToolTipKeyBindingsTest::main($StringArray* args) {
	...
	try {
		$SwingUtilities::invokeAndWait($$new(JMenuItemToolTipKeyBindingsTest$$Lambda$lambda$main$0));
		waitForCompleting();
		...
		if (JMenuItemToolTipKeyBindingsTest::controlDialog != nullptr) {
			JMenuItemToolTipKeyBindingsTest::controlDialog->dispose();
		}
		if (JMenuItemToolTipKeyBindingsTest::testFrame != nullptr) {
			JMenuItemToolTipKeyBindingsTest::testFrame->dispose();
		}
	}
	if (var$0 != nullptr) {
		$throw(var$0);
...
void JMenuItemToolTipKeyBindingsTest::createAndShowGUI() {
	...
	JMenuItemToolTipKeyBindingsTest::controlDialog->add("North"_s, messageArea);
	...
	buttonPanel->add("West"_s, passedButton);
	buttonPanel->add("East"_s, failedButton);
	$nc(JMenuItemToolTipKeyBindingsTest::controlDialog)->add("South"_s, buttonPanel);
	...
	JMenuItemToolTipKeyBindingsTest::testFrame->setSize(200, 200);
...
void JMenuItemToolTipKeyBindingsTest::completeTest() {
	$init(JMenuItemToolTipKeyBindingsTest);
	JMenuItemToolTipKeyBindingsTest::testCompleted->set(true);
	$synchronized(JMenuItemToolTipKeyBindingsTest::testCompleted) {
		JMenuItemToolTipKeyBindingsTest::testCompleted->notifyAll();
	}
}
...
void JMenuItemToolTipKeyBindingsTest::waitForCompleting() {
	...
	$synchronized(JMenuItemToolTipKeyBindingsTest::testCompleted) {
		...
		while (!JMenuItemToolTipKeyBindingsTest::testCompleted->get()) {
			JMenuItemToolTipKeyBindingsTest::testCompleted->wait(JMenuItemToolTipKeyBindingsTest::TIMEOUT);
...
void JMenuItemToolTipKeyBindingsTest::clinit$($Class* clazz) {
...
$Class* JMenuItemToolTipKeyBindingsTest::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("JMenuItemToolTipKeyBindingsTest$$Lambda$lambda$main$0")) {
	...
	$loadClass(JMenuItemToolTipKeyBindingsTest, name, initialize, &classInfo$$, JMenuItemToolTipKeyBindingsTest::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(JMenuItemToolTipKeyBindingsTest);
	});
	return class$;
}
