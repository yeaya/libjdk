...
bool bug7199708$2$1::accept($Component* component) {
	return ($instanceOf($AbstractButton, component)) && $nc(this->val$detailsTooltip)->equals($($cast($AbstractButton, component)->getToolTipText()));
}
...
$Class* bug7199708$2$1::load$($String* name, bool initialize) {
	...
	$loadClass(bug7199708$2$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(bug7199708$2$1);
	});
	return class$;
}
