...
$Class* TestJSpinnerFocusLost$$Lambda$lambda$doTest$0::load$($String* name, bool initialize) {
	...
	$loadClass(TestJSpinnerFocusLost$$Lambda$lambda$doTest$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TestJSpinnerFocusLost$$Lambda$lambda$doTest$0);
	});
	return class$;
}
...
$Class* TestJSpinnerFocusLost$$Lambda$lambda$doTest$1$1::load$($String* name, bool initialize) {
	...
	$loadClass(TestJSpinnerFocusLost$$Lambda$lambda$doTest$1$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TestJSpinnerFocusLost$$Lambda$lambda$doTest$1$1);
	});
	return class$;
}
...
$Class* TestJSpinnerFocusLost$$Lambda$lambda$main$2$2::load$($String* name, bool initialize) {
	...
	$loadClass(TestJSpinnerFocusLost$$Lambda$lambda$main$2$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TestJSpinnerFocusLost$$Lambda$lambda$main$2$2);
	});
	return class$;
}
...
$Class* TestJSpinnerFocusLost$$Lambda$lambda$main$3$3::load$($String* name, bool initialize) {
	...
	$loadClass(TestJSpinnerFocusLost$$Lambda$lambda$main$3$3, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TestJSpinnerFocusLost$$Lambda$lambda$main$3$3);
	});
	return class$;
}
...
$Class* TestJSpinnerFocusLost$$Lambda$lambda$main$4$4::load$($String* name, bool initialize) {
	...
	$loadClass(TestJSpinnerFocusLost$$Lambda$lambda$main$4$4, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TestJSpinnerFocusLost$$Lambda$lambda$main$4$4);
	});
	return class$;
}
...
void TestJSpinnerFocusLost::init$() {
	...
	$$nc($$sure($JSpinner$DefaultEditor, $nc(this->spinner)->getEditor())->getTextField())->addFocusListener(this);
	$$nc(getContentPane())->add(this->spinner);
}

void TestJSpinnerFocusLost::doTest() {
	$useLocalObjectStack();
	blockTillDisplayed(this->spinner);
	$SwingUtilities::invokeAndWait($$new(TestJSpinnerFocusLost$$Lambda$lambda$doTest$0, this));
	try {
		$synchronized(this) {
		...
		$SwingUtilities::invokeAndWait($$new(TestJSpinnerFocusLost$$Lambda$lambda$doTest$1$1, this));
	...
	if ($$sure($Integer, $nc(this->spinner)->getValue())->intValue() != 11) {
		$nc($System::out)->println($$str({"spinner value "_s, $$str($$sure($Integer, $nc(this->spinner)->getValue())->intValue())}));
...
void TestJSpinnerFocusLost::stateChanged($ChangeEvent* e) {
	...
	int32_t value = $$sure($Integer, $nc(spinner)->getValue())->intValue();
	if (value > 10) {
		this->changing = true;
...
void TestJSpinnerFocusLost::main($StringArray* argv) {
	...
	TestJSpinnerFocusLost::robot->setAutoWaitForIdle(true);
	$nc(TestJSpinnerFocusLost::robot)->setAutoDelay(250);
	{
		...
		for (int32_t len$ = $nc(arr$)->length, i$ = 0; i$ < len$; ++i$) {
			$var($UIManager$LookAndFeelInfo, laf, arr$->get(i$));
			{
				...
				$SwingUtilities::invokeAndWait($$new(TestJSpinnerFocusLost$$Lambda$lambda$main$2$2, laf));
				$var($Throwable, var$0, nullptr);
				try {
					$SwingUtilities::invokeAndWait($$new(TestJSpinnerFocusLost$$Lambda$lambda$main$3$3));
					...
					$SwingUtilities::invokeAndWait($$new(TestJSpinnerFocusLost$$Lambda$lambda$main$4$4));
				}
				if (var$0 != nullptr) {
					$throw(var$0);
				}
...
void TestJSpinnerFocusLost::lambda$main$4() {
	...
	if (TestJSpinnerFocusLost::b != nullptr) {
		TestJSpinnerFocusLost::b->dispose();
	}
}
...
void TestJSpinnerFocusLost::lambda$doTest$0() {
	$useLocalObjectStack();
	$$nc($$sure($JSpinner$DefaultEditor, $nc(this->spinner)->getEditor())->getTextField())->requestFocus();
}
...
$Class* TestJSpinnerFocusLost::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("TestJSpinnerFocusLost$$Lambda$lambda$doTest$0")) {
			return TestJSpinnerFocusLost$$Lambda$lambda$doTest$0::load$(name, initialize);
		}
		if (name->equals("TestJSpinnerFocusLost$$Lambda$lambda$doTest$1$1")) {
			return TestJSpinnerFocusLost$$Lambda$lambda$doTest$1$1::load$(name, initialize);
		}
		if (name->equals("TestJSpinnerFocusLost$$Lambda$lambda$main$2$2")) {
			return TestJSpinnerFocusLost$$Lambda$lambda$main$2$2::load$(name, initialize);
		}
		if (name->equals("TestJSpinnerFocusLost$$Lambda$lambda$main$3$3")) {
			return TestJSpinnerFocusLost$$Lambda$lambda$main$3$3::load$(name, initialize);
		}
		if (name->equals("TestJSpinnerFocusLost$$Lambda$lambda$main$4$4")) {
	...
	$loadClass(TestJSpinnerFocusLost, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
