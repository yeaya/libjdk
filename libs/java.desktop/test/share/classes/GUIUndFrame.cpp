...
$Class* GUIUndFrame$$Lambda$lambda$new$0::load$($String* name, bool initialize) {
	...
	$loadClass(GUIUndFrame$$Lambda$lambda$new$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(GUIUndFrame$$Lambda$lambda$new$0);
	});
	return class$;
}
...
$Class* GUIUndFrame$$Lambda$lambda$new$1$1::load$($String* name, bool initialize) {
	...
	$loadClass(GUIUndFrame$$Lambda$lambda$new$1$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(GUIUndFrame$$Lambda$lambda$new$1$1);
	});
	return class$;
}
...
$Class* GUIUndFrame$$Lambda$lambda$new$2$2::load$($String* name, bool initialize) {
	...
	$loadClass(GUIUndFrame$$Lambda$lambda$new$2$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(GUIUndFrame$$Lambda$lambda$new$2$2);
	});
	return class$;
}
...
$Class* GUIUndFrame$$Lambda$lambda$new$3$3::load$($String* name, bool initialize) {
	...
	$loadClass(GUIUndFrame$$Lambda$lambda$new$3$3, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(GUIUndFrame$$Lambda$lambda$new$3$3);
	});
	return class$;
}
...
void GUIUndFrame::init$() {
	...
	$$nc(this->jframe1->getContentPane())->setLayout($$new($FlowLayout));
	...
	this->jbutton1->addActionListener($$new(GUIUndFrame$$Lambda$lambda$new$0, this));
	$set(this, jframe2, $new($JFrame));
	$$nc(this->jframe2->getContentPane())->setLayout($$new($FlowLayout));
	...
	this->jbutton2->addActionListener($$new(GUIUndFrame$$Lambda$lambda$new$1$1, this));
	$set(this, jframe3, $new($JFrame));
	$$nc(this->jframe3->getContentPane())->setLayout($$new($FlowLayout));
	...
	this->jbutton3->addActionListener($$new(GUIUndFrame$$Lambda$lambda$new$2$2, this));
	$set(this, jbutton4, $new($JButton, "Maximize me"_s));
	this->jbutton4->addActionListener($$new(GUIUndFrame$$Lambda$lambda$new$3$3, this));
...
$Class* GUIUndFrame::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("GUIUndFrame$$Lambda$lambda$new$0")) {
			return GUIUndFrame$$Lambda$lambda$new$0::load$(name, initialize);
		}
		if (name->equals("GUIUndFrame$$Lambda$lambda$new$1$1")) {
			return GUIUndFrame$$Lambda$lambda$new$1$1::load$(name, initialize);
		}
		if (name->equals("GUIUndFrame$$Lambda$lambda$new$2$2")) {
			return GUIUndFrame$$Lambda$lambda$new$2$2::load$(name, initialize);
		}
		if (name->equals("GUIUndFrame$$Lambda$lambda$new$3$3")) {
	...
	$loadClass(GUIUndFrame, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
