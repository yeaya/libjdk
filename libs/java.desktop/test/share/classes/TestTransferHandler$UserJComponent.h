#ifndef _TestTransferHandler$UserJComponent_h_
#define _TestTransferHandler$UserJComponent_h_
//$ class TestTransferHandler$UserJComponent
...
class $export TestTransferHandler$UserJComponent : public ::javax::swing::JComponent {
	$class(TestTransferHandler$UserJComponent, 0, ::javax::swing::JComponent)
public:
...
#endif // _TestTransferHandler$UserJComponent_h_