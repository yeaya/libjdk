...
$Class* Test8003400$$Lambda$lambda$main$0::load$($String* name, bool initialize) {
	...
	$loadClass(Test8003400$$Lambda$lambda$main$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Test8003400$$Lambda$lambda$main$0);
	});
	return class$;
}
...
$Class* Test8003400$$Lambda$dispose$1::load$($String* name, bool initialize) {
	...
	$loadClass(Test8003400$$Lambda$dispose$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Test8003400$$Lambda$dispose$1);
	});
	return class$;
}
		...
		for (int32_t len$ = $nc(arr$)->length, i$ = 0; i$ < len$; ++i$) {
			$var($UIManager$LookAndFeelInfo, info, arr$->get(i$));
			{
				...
				try {
					...
					$SwingUtilities::invokeAndWait($$new(Test8003400$$Lambda$lambda$main$0));
					robot->waitForIdle();
					robot->delay(500);
					...
					if (Test8003400::frame != nullptr) {
						$SwingUtilities::invokeAndWait($$new(Test8003400$$Lambda$dispose$1, Test8003400::frame));
					}
				}
				if (var$0 != nullptr) {
					$throw(var$0);
...
void Test8003400::clinit$($Class* clazz) {
...
$Class* Test8003400::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("Test8003400$$Lambda$lambda$main$0")) {
			return Test8003400$$Lambda$lambda$main$0::load$(name, initialize);
		}
		if (name->equals("Test8003400$$Lambda$dispose$1")) {
	...
	$loadClass(Test8003400, name, initialize, &classInfo$$, Test8003400::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(Test8003400);
	});
	return class$;
}
