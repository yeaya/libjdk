...
$Class* bug6236162$$Lambda$lambda$main$0::load$($String* name, bool initialize) {
	...
	$loadClass(bug6236162$$Lambda$lambda$main$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(bug6236162$$Lambda$lambda$main$0);
	});
	return class$;
}
...
void bug6236162::main($StringArray* args) {
	...
	bug6236162::robot->setAutoDelay(100);
	...
	try {
		...
		if (bug6236162::frame != nullptr) {
			$SwingUtilities::invokeAndWait($$new(bug6236162$$Lambda$lambda$main$0));
		}
	}
	if (var$0 != nullptr) {
		$throw(var$0);
...
void bug6236162::createAndShowGUI() {
	...
	bug6236162::combo->setEditable(true);
	$assignStatic(bug6236162::comboUI, $new($bug6236162$MyComboUI));
	$nc(bug6236162::combo)->setUI(bug6236162::comboUI);
	$nc(bug6236162::combo)->setSelectedIndex(3);
	$$nc($nc(bug6236162::frame)->getContentPane())->add(bug6236162::combo);
...
$Class* bug6236162::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("bug6236162$$Lambda$lambda$main$0")) {
	...
	$loadClass(bug6236162, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(bug6236162);
	});
	return class$;
}
