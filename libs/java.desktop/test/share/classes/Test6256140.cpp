...
$Class* Test6256140$$Lambda$dispose::load$($String* name, bool initialize) {
	...
	$loadClass(Test6256140$$Lambda$dispose, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Test6256140$$Lambda$dispose);
	});
	return class$;
}
...
void Test6256140::main($StringArray* args) {
	...
	try {
		...
		if (Test6256140::frame != nullptr) {
			$SwingUtilities::invokeAndWait($$new(Test6256140$$Lambda$dispose, Test6256140::frame));
		}
	}
	if (var$0 != nullptr) {
		$throw(var$0);
...
void Test6256140::createAndShowGUI() {
	...
	Test6256140::frame->setDefaultCloseOperation($JFrame::EXIT_ON_CLOSE);
	...
	$nc(Test6256140::frame)->add(Test6256140::ft);
...
void Test6256140::clinit$($Class* clazz) {
...
$Class* Test6256140::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("Test6256140$$Lambda$dispose")) {
	...
	$loadClass(Test6256140, name, initialize, &classInfo$$, Test6256140::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(Test6256140);
	});
	return class$;
}
