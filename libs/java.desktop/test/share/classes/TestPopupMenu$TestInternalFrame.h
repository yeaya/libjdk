#ifndef _TestPopupMenu$TestInternalFrame_h_
#define _TestPopupMenu$TestInternalFrame_h_
//$ class TestPopupMenu$TestInternalFrame
...
class $export TestPopupMenu$TestInternalFrame : public ::javax::swing::JInternalFrame {
	$class(TestPopupMenu$TestInternalFrame, $NO_CLASS_INIT, ::javax::swing::JInternalFrame)
public:
...
#endif // _TestPopupMenu$TestInternalFrame_h_