...
void GUIZoomFrame::init$() {
	...
	$init($Color);
	$$nc(this->jframe1->getContentPane())->setBackground($Color::red);
	...
	$$nc(this->jframe2->getContentPane())->setBackground($Color::red);
	...
	this->jbutton->setBounds(20, 100, 80, 60);
...
$Class* GUIZoomFrame::load$($String* name, bool initialize) {
	...
	$loadClass(GUIZoomFrame, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
