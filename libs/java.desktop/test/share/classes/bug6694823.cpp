...
void bug6694823::createGui() {
	...
	bug6694823::frame->setDefaultCloseOperation($JFrame::DISPOSE_ON_CLOSE);
...
$Class* bug6694823::load$($String* name, bool initialize) {
	...
	$loadClass(bug6694823, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(bug6694823);
	});
	return class$;
}
