...
void bug4529206::init$() {
	...
	jPanFrame->add(bug4529206::jToolBar1, $BorderLayout::NORTH);
	$var($JTextField, tf, $new($JTextField, "click here"_s));
	jPanFrame->add(tf);
	$nc(bug4529206::jToolBar1)->add(jButton1, nullptr);
...
$Class* bug4529206::load$($String* name, bool initialize) {
	...
	$loadClass(bug4529206, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
