...
$Class* bug4697612$$Lambda$lambda$main$0::load$($String* name, bool initialize) {
	...
	$loadClass(bug4697612$$Lambda$lambda$main$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(bug4697612$$Lambda$lambda$main$0);
	});
	return class$;
}
...
$Class* bug4697612$$Lambda$lambda$new$1$1::load$($String* name, bool initialize) {
	...
	$loadClass(bug4697612$$Lambda$lambda$new$1$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(bug4697612$$Lambda$lambda$new$1$1);
	});
	return class$;
}
...
void bug4697612::main($StringArray* args) {
	...
	bug4697612::robot->setAutoDelay(100);
	{
		$var($UIManager$LookAndFeelInfoArray, arr$, $UIManager::getInstalledLookAndFeels());
		for (int32_t len$ = $nc(arr$)->length, i$ = 0; i$ < len$; ++i$) {
			$var($UIManager$LookAndFeelInfo, laf, arr$->get(i$));
			try {
				$SwingUtilities::invokeAndWait($$new(bug4697612$$Lambda$lambda$main$0, laf));
...
void bug4697612::init$() {
	...
	try {
		...
		$SwingUtilities::invokeAndWait($$new(bug4697612$$Lambda$lambda$new$1$1));
	}
	if (var$0 != nullptr) {
		$throw(var$0);
	}
...
void bug4697612::createAndShowGUI() {
	...
	bug4697612::frame->setSize(bug4697612::FRAME_WIDTH, bug4697612::FRAME_HEIGHT);
	...
	try {
		...
		bug4697612::text->read($$new($InputStreamReader, is), nullptr);
	} catch ($IOException& e) {
		$throwNew($Error, e);
	}
	$assignStatic(bug4697612::scroller, $new($JScrollPane, bug4697612::text));
	$$nc($nc(bug4697612::frame)->getContentPane())->add(bug4697612::scroller);
...
$Class* bug4697612::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("bug4697612$$Lambda$lambda$main$0")) {
			return bug4697612$$Lambda$lambda$main$0::load$(name, initialize);
		}
		if (name->equals("bug4697612$$Lambda$lambda$new$1$1")) {
	...
	$loadClass(bug4697612, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(bug4697612);
	});
	return class$;
}
