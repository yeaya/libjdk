...
void Test6657026MetalBorders::test($Border* border) {
	...
	if (Test6657026MetalBorders::NEGATIVE->equals(actual)) {
...
void Test6657026MetalBorders::clinit$($Class* clazz) {
...
$Class* Test6657026MetalBorders::load$($String* name, bool initialize) {
	...
	$loadClass(Test6657026MetalBorders, name, initialize, &classInfo$$, Test6657026MetalBorders::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(Test6657026MetalBorders);
	});
	return class$;
}
