...
$Class* PressedIconTest$$Lambda$lambda$main$0::load$($String* name, bool initialize) {
	...
	$loadClass(PressedIconTest$$Lambda$lambda$main$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(PressedIconTest$$Lambda$lambda$main$0);
	});
	return class$;
}
...
$Class* PressedIconTest$$Lambda$lambda$main$1$1::load$($String* name, bool initialize) {
	...
	$loadClass(PressedIconTest$$Lambda$lambda$main$1$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(PressedIconTest$$Lambda$lambda$main$1$1);
	});
	return class$;
}
...
$Class* PressedIconTest$$Lambda$lambda$main$2$2::load$($String* name, bool initialize) {
	...
	$loadClass(PressedIconTest$$Lambda$lambda$main$2$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(PressedIconTest$$Lambda$lambda$main$2$2);
	});
	return class$;
}
...
void PressedIconTest::main($StringArray* args) {
	...
	$SwingUtilities::invokeAndWait($$new(PressedIconTest$$Lambda$lambda$main$0));
	robot->waitForIdle();
	$SwingUtilities::invokeAndWait($$new(PressedIconTest$$Lambda$lambda$main$1$1));
	robot->waitForIdle();
	...
	$SwingUtilities::invokeAndWait($$new(PressedIconTest$$Lambda$lambda$main$2$2));
...
void PressedIconTest::createAndShowGUI() {
	...
	PressedIconTest::frame->setSize(PressedIconTest::IMAGE_SIZE, PressedIconTest::IMAGE_SIZE);
	...
	$var($BaseMultiResolutionImage, mri, $new($BaseMultiResolutionImage, $$cast($ImageArray, $new($BufferedImageArray, {
		img1x,
		img2x
	}))));
	$var($Icon, mrIcon, $new($ImageIcon, mri));
	$var($JToggleButton, button, $new($JToggleButton));
	button->setIcon(mrIcon);
	panel->add(button, $BorderLayout::CENTER);
	$$nc($nc(PressedIconTest::frame)->getContentPane())->add(panel);
...
$Class* PressedIconTest::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("PressedIconTest$$Lambda$lambda$main$0")) {
			return PressedIconTest$$Lambda$lambda$main$0::load$(name, initialize);
		}
		if (name->equals("PressedIconTest$$Lambda$lambda$main$1$1")) {
			return PressedIconTest$$Lambda$lambda$main$1$1::load$(name, initialize);
		}
		if (name->equals("PressedIconTest$$Lambda$lambda$main$2$2")) {
	...
	$loadClass(PressedIconTest, name, initialize, &classInfo$$, PressedIconTest::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(PressedIconTest);
	});
	return class$;
}
