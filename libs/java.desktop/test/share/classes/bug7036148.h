#ifndef _bug7036148_h_
#define _bug7036148_h_
//$ class bug7036148
...
class $export bug7036148 : public ::javax::swing::JFrame {
	$class(bug7036148, $NO_CLASS_INIT, ::javax::swing::JFrame)
public:
	bug7036148();
