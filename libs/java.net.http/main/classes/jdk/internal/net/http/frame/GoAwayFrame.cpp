...
$String* GoAwayFrame::toString() {
	...
	var$0->append($($ErrorFrame::toString()));
	var$0->append(" Debugdata: "_s);
	$init($StandardCharsets);
	var$0->append($$new($String, this->debugData, $StandardCharsets::UTF_8));
	return $str(var$0);
}
...
$Class* GoAwayFrame::load$($String* name, bool initialize) {
	...
	$loadClass(GoAwayFrame, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(GoAwayFrame);
	});
	return class$;
}
