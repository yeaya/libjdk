...
$Class* Exchange$$Lambda$dbgString::load$($String* name, bool initialize) {
	...
	$loadClass(Exchange$$Lambda$dbgString, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Exchange$$Lambda$dbgString);
	});
	return class$;
}
...
$Class* Exchange$$Lambda$lambda$readBodyAsync$0$1::load$($String* name, bool initialize) {
	...
	$loadClass(Exchange$$Lambda$lambda$readBodyAsync$0$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Exchange$$Lambda$lambda$readBodyAsync$0$1);
	});
	return class$;
}
...
$Class* Exchange$$Lambda$lambda$checkCancelled$1$2::load$($String* name, bool initialize) {
	...
	$loadClass(Exchange$$Lambda$lambda$checkCancelled$1$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Exchange$$Lambda$lambda$checkCancelled$1$2);
	});
	return class$;
}
...
$Class* Exchange$$Lambda$lambda$establishExchange$2$3::load$($String* name, bool initialize) {
	...
	$loadClass(Exchange$$Lambda$lambda$establishExchange$2$3, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Exchange$$Lambda$lambda$establishExchange$2$3);
	});
	return class$;
}
...
$Class* Exchange$$Lambda$lambda$establishExchange$3$4::load$($String* name, bool initialize) {
	...
	$loadClass(Exchange$$Lambda$lambda$establishExchange$3$4, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Exchange$$Lambda$lambda$establishExchange$3$4);
	});
	return class$;
}
...
$Class* Exchange$$Lambda$lambda$expectContinue$6$5::load$($String* name, bool initialize) {
	...
	$loadClass(Exchange$$Lambda$lambda$expectContinue$6$5, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Exchange$$Lambda$lambda$expectContinue$6$5);
	});
	return class$;
}
...
$Class* Exchange$$Lambda$lambda$expectContinue$4$6::load$($String* name, bool initialize) {
	...
	$loadClass(Exchange$$Lambda$lambda$expectContinue$4$6, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Exchange$$Lambda$lambda$expectContinue$4$6);
	});
	return class$;
}
...
$Class* Exchange$$Lambda$expectContinue$7::load$($String* name, bool initialize) {
	...
	$loadClass(Exchange$$Lambda$expectContinue$7, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Exchange$$Lambda$expectContinue$7);
	});
	return class$;
}
...
$Class* Exchange$$Lambda$sendRequestBody$8::load$($String* name, bool initialize) {
	...
	$loadClass(Exchange$$Lambda$sendRequestBody$8, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Exchange$$Lambda$sendRequestBody$8);
	});
	return class$;
}
...
$Class* Exchange$$Lambda$lambda$responseAsyncImpl0$9$9::load$($String* name, bool initialize) {
	...
	$loadClass(Exchange$$Lambda$lambda$responseAsyncImpl0$9$9, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Exchange$$Lambda$lambda$responseAsyncImpl0$9$9);
	});
	return class$;
}
...
$Class* Exchange$$Lambda$lambda$responseAsyncImpl0$8$10::load$($String* name, bool initialize) {
	...
	$loadClass(Exchange$$Lambda$lambda$responseAsyncImpl0$8$10, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Exchange$$Lambda$lambda$responseAsyncImpl0$8$10);
	});
	return class$;
}
...
$Class* Exchange$$Lambda$lambda$wrapForUpgrade$11$11::load$($String* name, bool initialize) {
	...
	$loadClass(Exchange$$Lambda$lambda$wrapForUpgrade$11$11, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Exchange$$Lambda$lambda$wrapForUpgrade$11$11);
	});
	return class$;
}
...
$Class* Exchange$$Lambda$lambda$wrapForLog$12$12::load$($String* name, bool initialize) {
	...
	$loadClass(Exchange$$Lambda$lambda$wrapForLog$12$12, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Exchange$$Lambda$lambda$wrapForLog$12$12);
	});
	return class$;
}
...
$Class* Exchange$$Lambda$ignoreBody$13::load$($String* name, bool initialize) {
	...
	$loadClass(Exchange$$Lambda$ignoreBody$13, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Exchange$$Lambda$ignoreBody$13);
	});
	return class$;
}
...
$Class* Exchange$$Lambda$lambda$checkForUpgradeAsync$14$14::load$($String* name, bool initialize) {
	...
	$loadClass(Exchange$$Lambda$lambda$checkForUpgradeAsync$14$14, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Exchange$$Lambda$lambda$checkForUpgradeAsync$14$14);
	});
	return class$;
}
...
$Class* Exchange$$Lambda$drainLeftOverBytes$15::load$($String* name, bool initialize) {
	...
	$loadClass(Exchange$$Lambda$drainLeftOverBytes$15, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Exchange$$Lambda$drainLeftOverBytes$15);
	});
	return class$;
}
...
$Class* Exchange$$Lambda$lambda$checkForUpgradeAsync$13$16::load$($String* name, bool initialize) {
	...
	$loadClass(Exchange$$Lambda$lambda$checkForUpgradeAsync$13$16, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Exchange$$Lambda$lambda$checkForUpgradeAsync$13$16);
	});
	return class$;
}
...
$Class* Exchange$$Lambda$toString$17::load$($String* name, bool initialize) {
	...
	$loadClass(Exchange$$Lambda$toString$17, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Exchange$$Lambda$toString$17);
	});
	return class$;
}
...
$Class* Exchange$$Lambda$lambda$expectContinue$5$18::load$($String* name, bool initialize) {
	...
	$loadClass(Exchange$$Lambda$lambda$expectContinue$5$18, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Exchange$$Lambda$lambda$expectContinue$5$18);
	});
	return class$;
}
...
void Exchange::init$($HttpRequestImpl* request, $MultiExchange* multi) {
	$init($Utils);
	$set(this, debug, $Utils::getDebugLogger($$new(Exchange$$Lambda$dbgString, this), $Utils::DEBUG));
...
$CompletableFuture* Exchange::readBodyAsync($HttpResponse$BodyHandler* handler) {
	...
	return $cast($CompletableFuture, $$nc($nc(this->exchImpl)->readBodyAsync(handler, !$nc(this->request$)->isWebSocket(), this->parentExecutor))->whenComplete($$new(Exchange$$Lambda$lambda$readBodyAsync$0$1, this)));
}
...
void Exchange::cancel($IOException* cause) {
	$useLocalObjectStack();
	if ($nc(this->debug)->on()) {
		this->debug->log("cancel exchImpl: %s, with \"%s\""_s, $$new($ObjectArray, {
			this->exchImpl,
			cause
		}));
	}
	...
	if (impl != nullptr) {
		if (this->debug->on()) {
			this->debug->log("Cancelling exchImpl: %s"_s, $$new($ObjectArray, {this->exchImpl}));
		}
		impl->cancel(cause);
	} else {
...
void Exchange::checkCancelled() {
	...
	if (impl != nullptr) {
		if ($nc(this->debug)->on()) {
			this->debug->log("Cancelling exchImpl: %s"_s, $$new($ObjectArray, {impl}));
		}
		impl->cancel(cause);
		...
		if ($$nc($nc(this->request$)->timeout())->isPresent()) {
			int64_t var$1 = $$sure($Duration, $$nc($nc(this->request$)->timeout())->get())->getSeconds() * 1000;
			var$0 = (var$1 + $$sure($Duration, $$nc(this->request$->timeout())->get())->getNano() / 1000000);
		} else {
			var$0 = -1;
		}
...
$CompletableFuture* Exchange::checkCancelled($CompletableFuture* cf, $HttpConnection* connection) {
	$useLocalObjectStack();
	return $cast($CompletableFuture, $$sure($CompletableFuture, $nc(cf)->handle($$new(Exchange$$Lambda$lambda$checkCancelled$1$2, this, connection, cf)))->thenCompose($($Function::identity())));
}
...
$CompletableFuture* Exchange::establishExchange($HttpConnection* connection) {
	$useLocalObjectStack();
	if ($nc(this->debug)->on()) {
		this->debug->log("establishing exchange for %s,%n\t proxy=%s"_s, $$new($ObjectArray, {
			this->request$,
			$($nc(this->request$)->proxy())
		}));
	}
	...
	if (t != nullptr) {
		if (this->debug->on()) {
			this->debug->log("exchange was cancelled: returned failed cf (%s)"_s, $$new($ObjectArray, {$($String::valueOf(t))}));
		}
	...
	;
	$assign(res, $cast($CompletableFuture, $nc(cf)->whenComplete($$new(Exchange$$Lambda$lambda$establishExchange$2$3, this, cf))));
	checkCancelled();
	return $cast($CompletableFuture, $nc(res)->thenCompose($$new(Exchange$$Lambda$lambda$establishExchange$3$4, this)));
}
...
$CompletableFuture* Exchange::checkFor407($ExchangeImpl* ex, $Throwable* t$renamed, $Function* andThen) {
	...
	if ($instanceOf($ProxyAuthenticationRequired, t)) {
		if ($nc(this->debug)->on()) {
			this->debug->log("checkFor407: ProxyAuthenticationRequired: building synthetic response"_s);
		}
		$set(this, bodyIgnored, $MinimalFuture::completedFuture(nullptr));
		$var($Response, proxyResponse, $cast($ProxyAuthenticationRequired, t)->proxyResponse);
		$var($HttpConnection, c, ex == nullptr ? ($HttpConnection*)nullptr : ex->connection());
		$var($Response, syntheticResponse, $new($Response, this->request$, this, $nc(proxyResponse)->headers$, c, $nc(proxyResponse)->statusCode$, $nc(proxyResponse)->version$, true));
		return $MinimalFuture::completedFuture(syntheticResponse);
	} else if (t != nullptr) {
		if ($nc(this->debug)->on()) {
			this->debug->log("checkFor407: no response - %s"_s, $$new($ObjectArray, {$of(t)}));
		}
		return $MinimalFuture::failedFuture(t);
	} else {
		if ($nc(this->debug)->on()) {
			this->debug->log("checkFor407: all clear"_s);
		}
...
$CompletableFuture* Exchange::expectContinue($ExchangeImpl* ex) {
	...
	return $cast($CompletableFuture, $$nc($nc(ex)->getResponseAsync(this->parentExecutor))->thenCompose($$new(Exchange$$Lambda$lambda$expectContinue$6$5, this)));
}
...
$CompletableFuture* Exchange::sendRequestBody($ExchangeImpl* ex) {
	...
	if ($nc(this->debug)->on()) {
		this->debug->log("sendRequestBody"_s);
	}
	$var($CompletableFuture, cf, $cast($CompletableFuture, $$nc($nc(ex)->sendBodyAsync())->thenCompose($$new(Exchange$$Lambda$lambda$expectContinue$4$6, this))));
...
$CompletableFuture* Exchange::responseAsyncImpl0($HttpConnection* connection) {
	...
	if ($nc(this->request$)->expectContinue()) {
		this->request$->addSystemHeader("Expect"_s, "100-Continue"_s);
		$Log::logTrace("Sending Expect: 100-Continue"_s, $$new($ObjectArray, 0));
		$assign(after407Check, $new(Exchange$$Lambda$expectContinue$7, this));
	} else {
		$assign(after407Check, $new(Exchange$$Lambda$sendRequestBody$8, this));
	}
	$var($Function, afterExch407Check, $new(Exchange$$Lambda$lambda$responseAsyncImpl0$9$9, this, after407Check));
	return $cast($CompletableFuture, $$sure($CompletableFuture, $$nc(establishExchange(connection))->handle($$new(Exchange$$Lambda$lambda$responseAsyncImpl0$8$10, this, afterExch407Check)))->thenCompose($($Function::identity())));
}

$CompletableFuture* Exchange::wrapForUpgrade($CompletableFuture* cf) {
	if (this->upgrading) {
		return $cast($CompletableFuture, $nc(cf)->thenCompose($$new(Exchange$$Lambda$lambda$wrapForUpgrade$11$11, this)));
	}
	return cf;
}
...
$CompletableFuture* Exchange::wrapForLog($CompletableFuture* cf) {
	if ($Log::requests()) {
		return $cast($CompletableFuture, $nc(cf)->thenApply($$new(Exchange$$Lambda$lambda$wrapForLog$12$12)));
	}
	return cf;
}
...
$CompletableFuture* Exchange::checkForUpgradeAsync($Response* resp, $ExchangeImpl* ex) {
	...
	if (this->upgrading && (rcode == 101)) {
		...
		if ($nc(this->debug)->on()) {
			this->debug->log("Upgrading async %s"_s, $$new($ObjectArray, {$($nc(e)->connection())}));
		}
		return $cast($CompletableFuture, $$nc($nc(e)->readBodyAsync($$new(Exchange$$Lambda$ignoreBody$13, this), false, this->parentExecutor))->thenCompose($$new(Exchange$$Lambda$lambda$checkForUpgradeAsync$14$14, this, ex, e)));
	}
...
$URI* Exchange::getURIForSecurityCheck() {
	...
	$var($InetSocketAddress, authority, this->request$->authority());
	$var($URI, uri, this->request$->uri());
...
$SecurityException* Exchange::checkPermissions() {
	...
	$var($HttpHeaders, userHeaders, this->request$->getUserHeaders());
	...
	$var($String, hostHeader, $cast($String, $$nc(userHeaders->firstValue("Host"_s))->orElse(nullptr)));
	...
	if (ps != nullptr) {
		if (!$nc(method)->equals("CONNECT"_s)) {
			$var($URLPermission, proxyPerm, $Utils::permissionForProxy($(this->request$->proxy())));
...
$CompletionStage* Exchange::lambda$checkForUpgradeAsync$14($ExchangeImpl* ex, $Http1Exchange* e, Object$* v) {
	...
	return $$nc($Http2Connection::createAsync(var$0, var$1, this, $$new(Exchange$$Lambda$drainLeftOverBytes$15, e)))->thenCompose($$new(Exchange$$Lambda$lambda$checkForUpgradeAsync$13$16, this, e));
}
...
$CompletionStage* Exchange::lambda$checkForUpgradeAsync$13($Http1Exchange* e, $Http2Connection* c) {
	...
	if ($nc(this->debug)->on()) {
		this->debug->log("Getting response async %s"_s, $$new($ObjectArray, {s}));
	}
...
$Response* Exchange::lambda$wrapForLog$12($Response* response) {
	$init(Exchange);
	$Log::logResponse($$new(Exchange$$Lambda$toString$17, $nc(response)));
	return response;
}
...
$CompletableFuture* Exchange::lambda$responseAsyncImpl0$9($Function* after407Check, $ExchangeImpl* ex) {
	$useLocalObjectStack();
	return $cast($CompletableFuture, $$sure($CompletableFuture, $$nc($nc(ex)->sendHeadersAsync())->handle($$new(Exchange$$Lambda$lambda$responseAsyncImpl0$8$10, this, after407Check)))->thenCompose($($Function::identity())));
}
...
$CompletionStage* Exchange::lambda$expectContinue$6($Response* r1) {
	$useLocalObjectStack();
	$Log::logResponse($$new(Exchange$$Lambda$toString$17, $nc(r1)));
	int32_t rcode = r1->statusCode();
	if (rcode == 100) {
		$Log::logTrace("Received 100-Continue: sending body"_s, $$new($ObjectArray, 0));
		if ($nc(this->debug)->on()) {
			this->debug->log("Received 100-Continue for %s"_s, $$new($ObjectArray, {r1}));
		}
		$var($CompletableFuture, cf, $cast($CompletableFuture, $$nc($nc(this->exchImpl)->sendBodyAsync())->thenCompose($$new(Exchange$$Lambda$lambda$expectContinue$4$6, this))));
		$assign(cf, wrapForUpgrade(cf));
		$assign(cf, wrapForLog(cf));
		return cf;
	} else {
		$Log::logTrace("Expectation failed: Received {0}"_s, $$new($ObjectArray, {$($Integer::valueOf(rcode))}));
		if ($nc(this->debug)->on()) {
			this->debug->log("Expect-Continue failed (%d) for: %s"_s, $$new($ObjectArray, {
		...
		return $$nc($nc(this->exchImpl)->readBodyAsync($$new(Exchange$$Lambda$ignoreBody$13, this), false, this->parentExecutor))->thenApply($$new(Exchange$$Lambda$lambda$expectContinue$5$18, r1));
	}
}
	...
	if (t == nullptr) {
		if ($nc(this->multi)->requestCancelled()) {
			if (!this->upgraded) {
				...
				if ($nc(this->debug)->on()) {
					this->debug->log($$str({"exchange cancelled during connect: "_s, t}));
				}
				try {
					$nc(connection)->close();
				} catch ($Throwable& x) {
					if (this->debug->on()) {
						this->debug->log("Failed to close connection"_s, x);
					}
				}
				return $MinimalFuture::failedFuture(t);
			}
...
void Exchange::clinit$($Class* clazz) {
...
$Class* Exchange::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("jdk.internal.net.http.Exchange$$Lambda$dbgString")) {
			return Exchange$$Lambda$dbgString::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Exchange$$Lambda$lambda$readBodyAsync$0$1")) {
			return Exchange$$Lambda$lambda$readBodyAsync$0$1::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Exchange$$Lambda$lambda$checkCancelled$1$2")) {
			return Exchange$$Lambda$lambda$checkCancelled$1$2::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Exchange$$Lambda$lambda$establishExchange$2$3")) {
			return Exchange$$Lambda$lambda$establishExchange$2$3::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Exchange$$Lambda$lambda$establishExchange$3$4")) {
			return Exchange$$Lambda$lambda$establishExchange$3$4::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Exchange$$Lambda$lambda$expectContinue$6$5")) {
			return Exchange$$Lambda$lambda$expectContinue$6$5::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Exchange$$Lambda$lambda$expectContinue$4$6")) {
			return Exchange$$Lambda$lambda$expectContinue$4$6::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Exchange$$Lambda$expectContinue$7")) {
			return Exchange$$Lambda$expectContinue$7::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Exchange$$Lambda$sendRequestBody$8")) {
			return Exchange$$Lambda$sendRequestBody$8::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Exchange$$Lambda$lambda$responseAsyncImpl0$9$9")) {
			return Exchange$$Lambda$lambda$responseAsyncImpl0$9$9::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Exchange$$Lambda$lambda$responseAsyncImpl0$8$10")) {
			return Exchange$$Lambda$lambda$responseAsyncImpl0$8$10::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Exchange$$Lambda$lambda$wrapForUpgrade$11$11")) {
			return Exchange$$Lambda$lambda$wrapForUpgrade$11$11::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Exchange$$Lambda$lambda$wrapForLog$12$12")) {
			return Exchange$$Lambda$lambda$wrapForLog$12$12::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Exchange$$Lambda$ignoreBody$13")) {
			return Exchange$$Lambda$ignoreBody$13::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Exchange$$Lambda$lambda$checkForUpgradeAsync$14$14")) {
			return Exchange$$Lambda$lambda$checkForUpgradeAsync$14$14::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Exchange$$Lambda$drainLeftOverBytes$15")) {
			return Exchange$$Lambda$drainLeftOverBytes$15::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Exchange$$Lambda$lambda$checkForUpgradeAsync$13$16")) {
			return Exchange$$Lambda$lambda$checkForUpgradeAsync$13$16::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Exchange$$Lambda$toString$17")) {
			return Exchange$$Lambda$toString$17::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Exchange$$Lambda$lambda$expectContinue$5$18")) {
	...
	$loadClass(Exchange, name, initialize, &classInfo$$, Exchange::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(Exchange);
	});
	return class$;
}
