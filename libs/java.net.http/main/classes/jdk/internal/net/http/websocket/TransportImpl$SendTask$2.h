#ifndef _jdk_internal_net_http_websocket_TransportImpl$SendTask$2_h_
#define _jdk_internal_net_http_websocket_TransportImpl$SendTask$2_h_
//$ class jdk.internal.net.http.websocket.TransportImpl$SendTask$2
...
class TransportImpl$SendTask$2 : public ::jdk::internal::net::http::websocket::MessageQueue$QueueCallback {
	$class(TransportImpl$SendTask$2, $NO_CLASS_INIT, ::jdk::internal::net::http::websocket::MessageQueue$QueueCallback)
public:
	TransportImpl$SendTask$2();
...
#endif // _jdk_internal_net_http_websocket_TransportImpl$SendTask$2_h_