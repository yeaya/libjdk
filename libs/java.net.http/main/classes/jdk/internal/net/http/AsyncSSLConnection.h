#ifndef _jdk_internal_net_http_AsyncSSLConnection_h_
#define _jdk_internal_net_http_AsyncSSLConnection_h_
//$ class jdk.internal.net.http.AsyncSSLConnection
...
class $export AsyncSSLConnection : public ::jdk::internal::net::http::AbstractAsyncSSLConnection {
	$class(AsyncSSLConnection, $NO_CLASS_INIT, ::jdk::internal::net::http::AbstractAsyncSSLConnection)
public:
	AsyncSSLConnection();
	void init$(::java::net::InetSocketAddress* addr, ::jdk::internal::net::http::HttpClientImpl* client, $StringArray* alpn);
	...
	::jdk::internal::net::http::PlainHttpConnection* plainConnection = nullptr;
...
#endif // _jdk_internal_net_http_AsyncSSLConnection_h_