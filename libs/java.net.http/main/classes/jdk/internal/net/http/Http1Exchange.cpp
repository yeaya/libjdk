...
$Class* Http1Exchange$$Lambda$dbgString::load$($String* name, bool initialize) {
	...
	$loadClass(Http1Exchange$$Lambda$dbgString, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Http1Exchange$$Lambda$dbgString);
	});
	return class$;
}
...
$Class* Http1Exchange$$Lambda$lambda$sendHeadersAsync$0$1::load$($String* name, bool initialize) {
	...
	$loadClass(Http1Exchange$$Lambda$lambda$sendHeadersAsync$0$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Http1Exchange$$Lambda$lambda$sendHeadersAsync$0$1);
	});
	return class$;
}
...
$Class* Http1Exchange$$Lambda$lambda$sendHeadersAsync$1$2::load$($String* name, bool initialize) {
	...
	$loadClass(Http1Exchange$$Lambda$lambda$sendHeadersAsync$1$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Http1Exchange$$Lambda$lambda$sendHeadersAsync$1$2);
	});
	return class$;
}
...
$Class* Http1Exchange$$Lambda$lambda$sendHeadersAsync$4$3::load$($String* name, bool initialize) {
	...
	$loadClass(Http1Exchange$$Lambda$lambda$sendHeadersAsync$4$3, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Http1Exchange$$Lambda$lambda$sendHeadersAsync$4$3);
	});
	return class$;
}
...
$Class* Http1Exchange$$Lambda$lambda$sendHeadersAsync$5$4::load$($String* name, bool initialize) {
	...
	$loadClass(Http1Exchange$$Lambda$lambda$sendHeadersAsync$5$4, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Http1Exchange$$Lambda$lambda$sendHeadersAsync$5$4);
	});
	return class$;
}
...
$Class* Http1Exchange$$Lambda$lambda$cancelIfFailed$6$5::load$($String* name, bool initialize) {
	...
	$loadClass(Http1Exchange$$Lambda$lambda$cancelIfFailed$6$5, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Http1Exchange$$Lambda$lambda$cancelIfFailed$6$5);
	});
	return class$;
}
...
$Class* Http1Exchange$$Lambda$lambda$sendBodyAsync$7$6::load$($String* name, bool initialize) {
	...
	$loadClass(Http1Exchange$$Lambda$lambda$sendBodyAsync$7$6, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Http1Exchange$$Lambda$lambda$sendBodyAsync$7$6);
	});
	return class$;
}
...
$Class* Http1Exchange$$Lambda$lambda$sendBodyAsync$8$7::load$($String* name, bool initialize) {
	...
	$loadClass(Http1Exchange$$Lambda$lambda$sendBodyAsync$8$7, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Http1Exchange$$Lambda$lambda$sendBodyAsync$8$7);
	});
	return class$;
}
...
$Class* Http1Exchange$$Lambda$runInline$8::load$($String* name, bool initialize) {
	...
	$loadClass(Http1Exchange$$Lambda$runInline$8, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Http1Exchange$$Lambda$runInline$8);
	});
	return class$;
}
...
$Class* Http1Exchange$$Lambda$lambda$cancelImpl$9$9::load$($String* name, bool initialize) {
	...
	$loadClass(Http1Exchange$$Lambda$lambda$cancelImpl$9$9, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Http1Exchange$$Lambda$lambda$cancelImpl$9$9);
	});
	return class$;
}
...
$Class* Http1Exchange$$Lambda$cancelSubscription$10::load$($String* name, bool initialize) {
	...
	$loadClass(Http1Exchange$$Lambda$cancelSubscription$10, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Http1Exchange$$Lambda$cancelSubscription$10);
	});
	return class$;
}
...
$Class* Http1Exchange$$Lambda$lambda$sendHeadersAsync$2$11::load$($String* name, bool initialize) {
	...
	$loadClass(Http1Exchange$$Lambda$lambda$sendHeadersAsync$2$11, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Http1Exchange$$Lambda$lambda$sendHeadersAsync$2$11);
	});
	return class$;
}
...
$Class* Http1Exchange$$Lambda$lambda$getOutgoing$12$12::load$($String* name, bool initialize) {
	...
	$loadClass(Http1Exchange$$Lambda$lambda$getOutgoing$12$12, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Http1Exchange$$Lambda$lambda$getOutgoing$12$12);
	});
	return class$;
}
...
$Class* Http1Exchange$$Lambda$requestMoreBody$13::load$($String* name, bool initialize) {
	...
	$loadClass(Http1Exchange$$Lambda$requestMoreBody$13, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Http1Exchange$$Lambda$requestMoreBody$13);
	});
	return class$;
}
...
$Class* Http1Exchange$$Lambda$lambda$sendHeadersAsync$3$14::load$($String* name, bool initialize) {
	...
	$loadClass(Http1Exchange$$Lambda$lambda$sendHeadersAsync$3$14, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Http1Exchange$$Lambda$lambda$sendHeadersAsync$3$14);
	});
	return class$;
}
...
void Http1Exchange::init$($Exchange* exchange, $HttpConnection* connection) {
	...
	$init($Utils);
	$set(this, debug, $Utils::getDebugLogger($$new(Http1Exchange$$Lambda$dbgString, this), $Utils::DEBUG));
...
void Http1Exchange::connectFlows($HttpConnection* connection) {
	...
	if ($nc(this->debug)->on()) {
		this->debug->log("%s connecting flows"_s, $$new($ObjectArray, {tube}));
	}
...
$CompletableFuture* Http1Exchange::sendHeadersAsync() {
	$useLocalObjectStack();
	if ($nc(this->debug)->on()) {
		this->debug->log("Sending headers only"_s);
	}
	...
	if (this->debug->on()) {
		this->debug->log("response created in advance"_s);
	}
	$var($CompletableFuture, connectCF, nullptr);
	if (!$nc(this->connection$)->connected()) {
		if (this->debug->on()) {
			this->debug->log("initiating connect async"_s);
		}
		$assign(connectCF, $cast($CompletableFuture, $$nc(this->connection$->connectAsync(this->exchange))->thenCompose($$new(Http1Exchange$$Lambda$lambda$sendHeadersAsync$0$1, this))));
		...
		if (cancelled != nullptr) {
			if ($nc(this->client$)->isSelectorThread()) {
				$nc(this->executor)->execute($$new(Http1Exchange$$Lambda$lambda$sendHeadersAsync$1$2, connectCF, cancelled));
			} else {
	...
	return $cast($CompletableFuture, $$sure($CompletableFuture, $nc(connectCF)->thenCompose($$new(Http1Exchange$$Lambda$lambda$sendHeadersAsync$4$3, this)))->thenCompose($$new(Http1Exchange$$Lambda$lambda$sendHeadersAsync$5$4, this)));
}

void Http1Exchange::cancelIfFailed($Flow$Subscription* s) {
	$nc($nc(this->asyncReceiver)->whenFinished)->whenCompleteAsync($$new(Http1Exchange$$Lambda$lambda$cancelIfFailed$6$5, this, s), this->executor);
}

$CompletableFuture* Http1Exchange::sendBodyAsync() {
	$useLocalObjectStack();
	if (!Http1Exchange::$assertionsDisabled && !this->headersSentCF->isDone()) {
		$throwNew($AssertionError);
	}
	if ($nc(this->debug)->on()) {
		this->debug->log("sendBodyAsync"_s);
	}
	try {
		$set(this, bodySubscriber, $nc(this->requestAction)->continueRequest());
		if (this->debug->on()) {
			this->debug->log("bodySubscriber is %s"_s, $$new($ObjectArray, {this->bodySubscriber == nullptr ? ($Object*)nullptr : $of($nc(this->bodySubscriber)->getClass())}));
		}
		if (this->bodySubscriber == nullptr) {
			...
			$$sure($CompletableFuture, $nc($nc(this->bodySubscriber)->whenSubscribed)->thenAccept($$new(Http1Exchange$$Lambda$lambda$sendBodyAsync$7$6, this)))->thenAccept($$new(Http1Exchange$$Lambda$lambda$sendBodyAsync$8$7, this));
		}
	} catch ($Throwable& t) {
		cancelImpl(t);
		this->bodySentCF->completeExceptionally(t);
	}
...
$CompletableFuture* Http1Exchange::getResponseAsync($Executor* executor) {
	$useLocalObjectStack();
	if ($nc(this->debug)->on()) {
		this->debug->log("reading headers"_s);
	}
	...
	if (cause != nullptr) {
		...
		if (this->debug->on()) {
			this->debug->log(acknowledged ? ($$str({"completed response with "_s, cause})) : ($$str({"response already completed, ignoring "_s, cause})));
		}
	}
...
$ByteBuffer* Http1Exchange::drainLeftOverBytes() {
	$synchronized(this->lock) {
		...
		$init($Utils);
		return this->asyncReceiver->drain($Utils::EMPTY_BYTEBUFFER);
	}
}
...
void Http1Exchange::cancelImpl($Throwable* cause) {
	...
	$synchronized(this->lock) {
		...
		if ($nc(this->debug)->on()) {
			this->debug->log($$str({$($nc(this->request$)->uri()), ": "_s, error}));
		}
		bool var$0 = this->requestAction != nullptr && this->requestAction->finished() && this->response != nullptr;
		if (var$0 && $nc(this->response)->finished()) {
			return;
		}
		$nc(this->writePublisher->writeScheduler)->stop();
		if ($nc(this->operations)->isEmpty()) {
			int64_t var$1 = 0;
			if ($$nc($nc(this->request$)->timeout())->isPresent()) {
				int64_t var$2 = $$sure($Duration, $$nc($nc(this->request$)->timeout())->get())->getSeconds() * 1000;
				var$1 = (var$2 + $$sure($Duration, $$nc(this->request$->timeout())->get())->getNano() / 1000000);
			} else {
				var$1 = -1;
			}
			...
			{
				$var($Iterator, i$, this->operations->iterator());
				for (; $nc(i$)->hasNext();) {
	...
	try {
		...
		if (toComplete != nullptr) {
			$var($Executor, exec, $nc(this->client$)->isSelectorThread() ? this->executor : $cast($Executor, $new(Http1Exchange$$Lambda$runInline$8, this)));
			$var($Throwable, x, error);
			while (!toComplete->isEmpty()) {
				$var($CompletableFuture, cf, $cast($CompletableFuture, toComplete->poll()));
				$nc(exec)->execute($$new(Http1Exchange$$Lambda$lambda$cancelImpl$9$9, this, cf, x));
			}
		}
...
void Http1Exchange::appendToOutgoing($Http1Exchange$DataPair* dp) {
	if ($nc(this->debug)->on()) {
		this->debug->log($$str({"appending to outgoing "_s, dp}));
	}
	this->outgoing->add(dp);
	$nc(this->writePublisher->writeScheduler)->runOrSchedule();
}
...
void Http1Exchange::requestMoreBody() {
	try {
		if ($nc(this->debug)->on()) {
			this->debug->log("requesting more request body from the subscriber"_s);
		}
		$nc(this->bodySubscriber)->request(1);
	} catch ($Throwable& t) {
		if ($nc(this->debug)->on()) {
			this->debug->log("Subscription::request failed"_s, t);
		}
		cancelImpl(t);
		this->bodySentCF->completeExceptionally(t);
	}
...
void Http1Exchange::cancelUpstreamSubscription() {
	...
	if ($nc(this->debug)->on()) {
		this->debug->log("cancelling upstream publisher"_s);
	}
	if (this->bodySubscriber != nullptr) {
		$nc(exec)->execute($$new(Http1Exchange$$Lambda$cancelSubscription$10, $nc(this->bodySubscriber)));
	} else if (this->debug->on()) {
		this->debug->log("bodySubscriber is null"_s);
	}
}
...
$Http1Exchange$DataPair* Http1Exchange::getOutgoing() {
	$useLocalObjectStack();
	$var($Executor, exec, $nc(this->client$)->theExecutor());
	$var($Http1Exchange$DataPair, dp, $cast($Http1Exchange$DataPair, this->outgoing->pollFirst()));
	if (this->writePublisher->cancelled) {
		cancelUpstreamSubscription();
		this->headersSentCF->completeAsync($$new(Http1Exchange$$Lambda$lambda$sendHeadersAsync$2$11, this), exec);
		this->bodySentCF->completeAsync($$new(Http1Exchange$$Lambda$lambda$sendHeadersAsync$2$11, this), exec);
		return nullptr;
	}
	if (dp == nullptr) {
		return nullptr;
	...
	if ($nc(dp)->throwable != nullptr) {
		...
		$nc(exec)->execute($$new(Http1Exchange$$Lambda$lambda$getOutgoing$12$12, this, dp));
		return dp;
	}
	...
	case 1:
		...
		if ($nc(this->debug)->on()) {
			this->debug->log("initiating completion of headersSentCF"_s);
		}
		this->headersSentCF->completeAsync($$new(Http1Exchange$$Lambda$lambda$sendHeadersAsync$2$11, this), exec);
		break;
	case 2:
		$init($Http1Exchange$Http1BodySubscriber);
		if (dp->data == $Http1Exchange$Http1BodySubscriber::COMPLETED) {
			$synchronized(this->lock) {
				$set(this, state, $Http1Exchange$State::COMPLETING);
			}
			if ($nc(this->debug)->on()) {
				this->debug->log("initiating completion of bodySentCF"_s);
			}
			this->bodySentCF->completeAsync($$new(Http1Exchange$$Lambda$lambda$sendHeadersAsync$2$11, this), exec);
		} else {
			$nc(exec)->execute($$new(Http1Exchange$$Lambda$requestMoreBody$13, this));
		}
		break;
	case 3:
	case 4:
...
void Http1Exchange::lambda$getOutgoing$12($Http1Exchange$DataPair* dp) {
	this->headersSentCF->completeExceptionally($nc(dp)->throwable);
	this->bodySentCF->completeExceptionally(dp->throwable);
	$nc(this->connection$)->close();
}
...
void Http1Exchange::lambda$cancelImpl$9($CompletableFuture* cf, $Throwable* x) {
	...
	if ($nc(cf)->completeExceptionally(x)) {
		if ($nc(this->debug)->on()) {
			this->debug->log("%s: completed cf with %s"_s, $$new($ObjectArray, {
				$($nc(this->request$)->uri()),
				x
			}));
		}
...
void Http1Exchange::lambda$cancelIfFailed$6($Flow$Subscription* s, $Void* r, $Throwable* t) {
	if ($nc(this->debug)->on()) {
		this->debug->log("asyncReceiver finished (failed=%s)"_s, $$new($ObjectArray, {$of(t)}));
	}
	if (t != nullptr) {
		$nc(s)->cancel();
...
$CompletionStage* Http1Exchange::lambda$sendHeadersAsync$4($Void* unused) {
	...
	try {
		$nc($nc(this->asyncReceiver)->whenFinished)->whenComplete($$new(Http1Exchange$$Lambda$lambda$sendHeadersAsync$3$14, this));
		connectFlows(this->connection$);
		if ($nc(this->debug)->on()) {
			this->debug->log("requestAction.headers"_s);
		}
		...
		if (this->debug->on()) {
			this->debug->log("setting outgoing with headers"_s);
		}
		if (!Http1Exchange::$assertionsDisabled && !this->outgoing->isEmpty()) {
		...
		if ($nc(this->debug)->on()) {
			this->debug->log("Failed to send headers: %s"_s, t);
		}
		this->headersSentCF->completeExceptionally(t);
		this->bodySentCF->completeExceptionally(t);
		$nc(this->connection$)->close();
...
void Http1Exchange::lambda$sendHeadersAsync$3($Void* r, $Throwable* t) {
	...
	if (t != nullptr) {
		...
		if (!this->headersSentCF->isDone()) {
			this->headersSentCF->completeAsync($$new(Http1Exchange$$Lambda$lambda$sendHeadersAsync$2$11, this), this->executor);
		}
	}
}
...
void Http1Exchange::clinit$($Class* clazz) {
...
$Class* Http1Exchange::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("jdk.internal.net.http.Http1Exchange$$Lambda$dbgString")) {
			return Http1Exchange$$Lambda$dbgString::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Http1Exchange$$Lambda$lambda$sendHeadersAsync$0$1")) {
			return Http1Exchange$$Lambda$lambda$sendHeadersAsync$0$1::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Http1Exchange$$Lambda$lambda$sendHeadersAsync$1$2")) {
			return Http1Exchange$$Lambda$lambda$sendHeadersAsync$1$2::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Http1Exchange$$Lambda$lambda$sendHeadersAsync$4$3")) {
			return Http1Exchange$$Lambda$lambda$sendHeadersAsync$4$3::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Http1Exchange$$Lambda$lambda$sendHeadersAsync$5$4")) {
			return Http1Exchange$$Lambda$lambda$sendHeadersAsync$5$4::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Http1Exchange$$Lambda$lambda$cancelIfFailed$6$5")) {
			return Http1Exchange$$Lambda$lambda$cancelIfFailed$6$5::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Http1Exchange$$Lambda$lambda$sendBodyAsync$7$6")) {
			return Http1Exchange$$Lambda$lambda$sendBodyAsync$7$6::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Http1Exchange$$Lambda$lambda$sendBodyAsync$8$7")) {
			return Http1Exchange$$Lambda$lambda$sendBodyAsync$8$7::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Http1Exchange$$Lambda$runInline$8")) {
			return Http1Exchange$$Lambda$runInline$8::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Http1Exchange$$Lambda$lambda$cancelImpl$9$9")) {
			return Http1Exchange$$Lambda$lambda$cancelImpl$9$9::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Http1Exchange$$Lambda$cancelSubscription$10")) {
			return Http1Exchange$$Lambda$cancelSubscription$10::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Http1Exchange$$Lambda$lambda$sendHeadersAsync$2$11")) {
			return Http1Exchange$$Lambda$lambda$sendHeadersAsync$2$11::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Http1Exchange$$Lambda$lambda$getOutgoing$12$12")) {
			return Http1Exchange$$Lambda$lambda$getOutgoing$12$12::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Http1Exchange$$Lambda$requestMoreBody$13")) {
			return Http1Exchange$$Lambda$requestMoreBody$13::load$(name, initialize);
		}
		if (name->equals("jdk.internal.net.http.Http1Exchange$$Lambda$lambda$sendHeadersAsync$3$14")) {
	...
	$loadClass(Http1Exchange, name, initialize, &classInfo$$, Http1Exchange::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(Http1Exchange);
	});
	return class$;
}
