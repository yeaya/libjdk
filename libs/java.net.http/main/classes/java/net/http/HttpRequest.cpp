...
$Class* HttpRequest$$Lambda$lambda$newBuilder$1::load$($String* name, bool initialize) {
	...
	$loadClass(HttpRequest$$Lambda$lambda$newBuilder$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(HttpRequest$$Lambda$lambda$newBuilder$1);
	});
	return class$;
}
...
$Class* HttpRequest$$Lambda$version$1::load$($String* name, bool initialize) {
	...
	$loadClass(HttpRequest$$Lambda$version$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(HttpRequest$$Lambda$version$1);
	});
	return class$;
}
...
$Class* HttpRequest$$Lambda$timeout$2::load$($String* name, bool initialize) {
	...
	$loadClass(HttpRequest$$Lambda$timeout$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(HttpRequest$$Lambda$timeout$2);
	});
	return class$;
}
...
$Class* HttpRequest$$Lambda$lambda$newBuilder$2$3::load$($String* name, bool initialize) {
	...
	$loadClass(HttpRequest$$Lambda$lambda$newBuilder$2$3, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(HttpRequest$$Lambda$lambda$newBuilder$2$3);
	});
	return class$;
}
...
$Class* HttpRequest$$Lambda$lambda$newBuilder$3$4::load$($String* name, bool initialize) {
	...
	$loadClass(HttpRequest$$Lambda$lambda$newBuilder$3$4, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(HttpRequest$$Lambda$lambda$newBuilder$3$4);
	});
	return class$;
}
...
$Class* HttpRequest$$Lambda$lambda$newBuilder$0$5::load$($String* name, bool initialize) {
	...
	$loadClass(HttpRequest$$Lambda$lambda$newBuilder$0$5, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(HttpRequest$$Lambda$lambda$newBuilder$0$5);
	});
	return class$;
}
...
$HttpRequest$Builder* HttpRequest::newBuilder(HttpRequest* request, $BiPredicate* filter) {
	...
	$$nc($nc(headers)->map())->forEach($$new(HttpRequest$$Lambda$lambda$newBuilder$1, builder));
	$$nc(request->version())->ifPresent($$new(HttpRequest$$Lambda$version$1, builder));
	$$nc(request->timeout())->ifPresent($$new(HttpRequest$$Lambda$timeout$2, builder));
	$var($String, method, request->method());
	$var($Consumer, var$0, $new(HttpRequest$$Lambda$lambda$newBuilder$2$3, builder, method));
	$$nc(request->bodyPublisher())->ifPresentOrElse(var$0, $$new(HttpRequest$$Lambda$lambda$newBuilder$3$4, method, builder));
	return builder;
}
...
bool HttpRequest::equals(Object$* obj) {
	...
	if (!$$nc(that->uri())->equals($(this->uri()))) {
		return false;
	}
	if (!$$nc(that->headers())->equals($(this->headers()))) {
		return false;
	}
	return true;
}
...
void HttpRequest::lambda$newBuilder$1($HttpRequest$Builder* builder, $String* name, $List* values) {
	$nc(values)->forEach($$new(HttpRequest$$Lambda$lambda$newBuilder$0$5, builder, name));
}
...
$Class* HttpRequest::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("java.net.http.HttpRequest$$Lambda$lambda$newBuilder$1")) {
			return HttpRequest$$Lambda$lambda$newBuilder$1::load$(name, initialize);
		}
		if (name->equals("java.net.http.HttpRequest$$Lambda$version$1")) {
			return HttpRequest$$Lambda$version$1::load$(name, initialize);
		}
		if (name->equals("java.net.http.HttpRequest$$Lambda$timeout$2")) {
			return HttpRequest$$Lambda$timeout$2::load$(name, initialize);
		}
		if (name->equals("java.net.http.HttpRequest$$Lambda$lambda$newBuilder$2$3")) {
			return HttpRequest$$Lambda$lambda$newBuilder$2$3::load$(name, initialize);
		}
		if (name->equals("java.net.http.HttpRequest$$Lambda$lambda$newBuilder$3$4")) {
			return HttpRequest$$Lambda$lambda$newBuilder$3$4::load$(name, initialize);
		}
		if (name->equals("java.net.http.HttpRequest$$Lambda$lambda$newBuilder$0$5")) {
	...
	$loadClass(HttpRequest, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(HttpRequest);
	});
	return class$;
}
