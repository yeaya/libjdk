...
$Class* RMIJRMPServerImpl$$Lambda$lambda$new$0::load$($String* name, bool initialize) {
	...
	$loadClass(RMIJRMPServerImpl$$Lambda$lambda$new$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(RMIJRMPServerImpl$$Lambda$lambda$new$0);
	});
	return class$;
}
...
$Class* RMIJRMPServerImpl$$Lambda$checkPackageAccess$1::load$($String* name, bool initialize) {
	...
	$loadClass(RMIJRMPServerImpl$$Lambda$checkPackageAccess$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(RMIJRMPServerImpl$$Lambda$checkPackageAccess$1);
	});
	return class$;
}
...
$Class* RMIJRMPServerImpl$$Lambda$newClientCheckInput$2::load$($String* name, bool initialize) {
	...
	$loadClass(RMIJRMPServerImpl$$Lambda$newClientCheckInput$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(RMIJRMPServerImpl$$Lambda$newClientCheckInput$2);
	});
	return class$;
}
...
void RMIJRMPServerImpl::init$(int32_t port, $RMIClientSocketFactory* csf, $RMIServerSocketFactory* ssf, $Map* env) {
	...
	$var($String, credentialsFilter, $cast($String, this->env->get($RMIConnectorServer::CREDENTIALS_FILTER_PATTERN)));
	if (credentialsTypes != nullptr && credentialsFilter != nullptr) {
		...
		$set(this, allowedTypes, $cast($Set, $$nc($$nc($Arrays::stream(credentialsTypes))->filter($$new(RMIJRMPServerImpl$$Lambda$lambda$new$0)))->collect($($Collectors::toSet()))));
		$$nc($nc(this->allowedTypes)->stream())->forEach($$new(RMIJRMPServerImpl$$Lambda$checkPackageAccess$1));
		$set(this, cFilter, $new(RMIJRMPServerImpl$$Lambda$newClientCheckInput$2, this));
	} else {
		$set(this, allowedTypes, nullptr);
		$set(this, cFilter, nullptr);
	}
	$var($String, userJmxFilter, $cast($String, this->env->get($RMIConnectorServer::SERIAL_FILTER_PATTERN)));
...
$Class* RMIJRMPServerImpl::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("javax.management.remote.rmi.RMIJRMPServerImpl$$Lambda$lambda$new$0")) {
			return RMIJRMPServerImpl$$Lambda$lambda$new$0::load$(name, initialize);
		}
		if (name->equals("javax.management.remote.rmi.RMIJRMPServerImpl$$Lambda$checkPackageAccess$1")) {
			return RMIJRMPServerImpl$$Lambda$checkPackageAccess$1::load$(name, initialize);
		}
		if (name->equals("javax.management.remote.rmi.RMIJRMPServerImpl$$Lambda$newClientCheckInput$2")) {
	...
	$loadClass(RMIJRMPServerImpl, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
