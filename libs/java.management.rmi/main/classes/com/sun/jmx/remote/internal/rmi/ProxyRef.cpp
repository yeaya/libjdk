...
$Object* ProxyRef::invoke($Remote* obj, $Method* method, $ObjectArray* params, int64_t opnum) {
	return $nc(this->ref)->invoke(obj, method, params, opnum);
}
...
$Class* ProxyRef::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"done", "(Ljava/rmi/server/RemoteCall;)V", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(ProxyRef, done, void, $RemoteCall*), "java.rmi.RemoteException", nullptr, donemethodAnnotations$$},
		...
		{"invoke", "(Ljava/rmi/server/RemoteCall;)V", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(ProxyRef, invoke, void, $RemoteCall*), "java.lang.Exception", nullptr, invokemethodAnnotations$$},
		...
		{"newCall", "(Ljava/rmi/server/RemoteObject;[Ljava/rmi/server/Operation;IJ)Ljava/rmi/server/RemoteCall;", nullptr, $PUBLIC | $DEPRECATED, $virtualMethod(ProxyRef, newCall, $RemoteCall*, $RemoteObject*, $OperationArray*, int32_t, int64_t), "java.rmi.RemoteException", nullptr, newCallmethodAnnotations$$},
	...
	$loadClass(ProxyRef, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(ProxyRef);
	});
	return class$;
}
