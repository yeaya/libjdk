...
$MethodInfo _GNUStyleOptions$5_MethodInfo_[] = {
	{"<init>", "(ZLsun/tools/jar/GNUStyleOptions$OptionType;[Ljava/lang/String;)V", nullptr, $TRANSIENT, $method(static_cast<void(GNUStyleOptions$5::*)(bool,$GNUStyleOptions$OptionType*,$StringArray*)>(&GNUStyleOptions$5::init$))},
...
$EnclosingMethodInfo _GNUStyleOptions$5_EnclosingMethodInfo_ = {
	"sun.tools.jar.GNUStyleOptions",
	nullptr,
	nullptr
};

$InnerClassInfo _GNUStyleOptions$5_InnerClassesInfo_[] = {
...
$ClassInfo _GNUStyleOptions$5_ClassInfo_ = {
	$ACC_SUPER,
	"sun.tools.jar.GNUStyleOptions$5",
	"sun.tools.jar.GNUStyleOptions$Option",
	nullptr,
	nullptr,
	_GNUStyleOptions$5_MethodInfo_,
	nullptr,
	&_GNUStyleOptions$5_EnclosingMethodInfo_,
	_GNUStyleOptions$5_InnerClassesInfo_,
	nullptr,
	nullptr,
	nullptr,
	"sun.tools.jar.GNUStyleOptions"
...
$Object* allocate$GNUStyleOptions$5($Class* clazz) {
	return $of($alloc(GNUStyleOptions$5));
}
...
void GNUStyleOptions$5::process($Main* tool, $String* opt, $String* arg) {
	...
	if ($nc(tool)->cflag || $nc(tool)->iflag || $nc(tool)->tflag || $nc(tool)->uflag || $nc(tool)->dflag || $nc(tool)->validate) {
...
$Class* GNUStyleOptions$5::load$($String* name, bool initialize) {
	$loadClass(GNUStyleOptions$5, name, initialize, &_GNUStyleOptions$5_ClassInfo_, allocate$GNUStyleOptions$5);
	return class$;
}
