...
$Class* Main$Hasher$$Lambda$lambda$new$0::load$($String* name, bool initialize) {
	...
	$loadClass(Main$Hasher$$Lambda$lambda$new$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Main$Hasher$$Lambda$lambda$new$0);
	});
	return class$;
}
...
$Class* Main$Hasher$$Lambda$lambda$new$1$1::load$($String* name, bool initialize) {
	...
	$loadClass(Main$Hasher$$Lambda$lambda$new$1$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Main$Hasher$$Lambda$lambda$new$1$1);
	});
	return class$;
}
...
$Class* Main$Hasher$$Lambda$name$2::load$($String* name, bool initialize) {
	...
	$loadClass(Main$Hasher$$Lambda$name$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Main$Hasher$$Lambda$name$2);
	});
	return class$;
}
...
$Class* Main$Hasher$$Lambda$lambda$new$2$3::load$($String* name, bool initialize) {
	...
	$loadClass(Main$Hasher$$Lambda$lambda$new$2$3, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Main$Hasher$$Lambda$lambda$new$2$3);
	});
	return class$;
}
...
void Main$Hasher::init$($Main* this$0, $ModuleDescriptor* descriptor, $String* fname) {
	...
	$set(this, finder, $ModuleFinder::compose($$new($ModuleFinderArray, {
		this$0->moduleFinder,
		$$new($Main$Hasher$2, this, this$0, descriptor, mref)
	})));
	$var($Set, roots, $cast($Set, $$nc($$nc($$nc($$nc($nc(this->finder)->findAll())->stream())->map($$new(Main$Hasher$$Lambda$lambda$new$0)))->filter($$new(Main$Hasher$$Lambda$lambda$new$1$1, this)))->collect($($Collectors::toSet()))));
	...
	$set(this, modules, $cast($Set, $$nc($$nc($$nc($$nc($nc(config)->modules())->stream())->map($$new(Main$Hasher$$Lambda$name$2)))->filter($$new(Main$Hasher$$Lambda$lambda$new$2$3, roots, system)))->collect($($Collectors::toSet()))));
...
$ModuleHashes* Main$Hasher::computeHashes($String* name) {
	...
	return $cast($ModuleHashes, $$nc($nc(this->hashesBuilder)->computeHashes($($Set::of(name))))->get(name));
}
...
$Class* Main$Hasher::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("sun.tools.jar.Main$Hasher$$Lambda$lambda$new$0")) {
			return Main$Hasher$$Lambda$lambda$new$0::load$(name, initialize);
		}
		if (name->equals("sun.tools.jar.Main$Hasher$$Lambda$lambda$new$1$1")) {
			return Main$Hasher$$Lambda$lambda$new$1$1::load$(name, initialize);
		}
		if (name->equals("sun.tools.jar.Main$Hasher$$Lambda$name$2")) {
			return Main$Hasher$$Lambda$name$2::load$(name, initialize);
		}
		if (name->equals("sun.tools.jar.Main$Hasher$$Lambda$lambda$new$2$3")) {
	...
	$loadClass(Main$Hasher, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Main$Hasher);
	});
	return class$;
}
