...
$ObjectArray2* jar_ko::getContents() {
	...
	return $new($ObjectArray2, {
		$$new($ObjectArray, {
			"error.bad.cflag"_s,
			u"\'c\' 플래그를 사용하려면 Manifest 또는 입력 파일을 지정해야 합니다!"_s
		}),
		$$new($ObjectArray, {
			"error.bad.dflag"_s,
			u"\'-d, --describe-module\' 옵션에는 입력 파일을 지정할 필요가 없습니다."_s
		}),
		$$new($ObjectArray, {
			"error.bad.eflag"_s,
			u"\'e\' 플래그 및 Manifest를 \'Main-Class\' 속성과 함께 지정할 수\n없습니다!"_s
		}),
		$$new($ObjectArray, {
			"error.bad.file.arg"_s,
			u"파일 인수 구문을 분석하는 중 오류가 발생했습니다."_s
		}),
		$$new($ObjectArray, {
			"error.bad.option"_s,
			u"-{ctxuid} 옵션 중 하나를 지정해야 합니다."_s
		}),
		$$new($ObjectArray, {
			"error.bad.reason"_s,
			u"잘못된 원인: {0}은(는) deprecated, deprecated-for-removal 또는 incubating 중 하나여야 합니다."_s
		}),
		$$new($ObjectArray, {
			"error.bad.uflag"_s,
			u"\'u\' 플래그를 사용하려면 Manifest, \'e\' 플래그 또는 입력 파일을 지정해야 합니다!"_s
		}),
		$$new($ObjectArray, {
			"error.cant.open"_s,
			u"열 수 없음: {0}"_s
		...
		$$new($ObjectArray, {
			"error.create.dir"_s,
			u"{0}: 디렉토리를 생성할 수 없습니다."_s
		}),
		$$new($ObjectArray, {
			"error.create.tempfile"_s,
			u"임시 파일을 생성할 수 없습니다."_s
		}),
		$$new($ObjectArray, {
			"error.hash.dep"_s,
			u"모듈 {0} 종속성을 해시하는 중 모듈 경로에서 {1} 모듈을 찾을 수 없습니다."_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"처리 중 올바르지 않은 길이가 발견됨: {0}"_s
		}),
		$$new($ObjectArray, {
			"error.invalid.versioned.module.attribute"_s,
			u"부적합한 모듈 기술자 속성 {0}"_s
		}),
		$$new($ObjectArray, {
			"error.missing.arg"_s,
			u"{0} 옵션에 인수가 필요합니다."_s
		}),
		$$new($ObjectArray, {
			"error.missing.provider"_s,
			u"서비스 제공자를 찾을 수 없음: {0}"_s
		}),
		$$new($ObjectArray, {
			"error.module.descriptor.not.found"_s,
			u"모듈 기술자를 찾을 수 없음"_s
		}),
		$$new($ObjectArray, {
			"error.module.options.without.info"_s,
			u"module-info.class 없이 --module-version 또는 --hash-modules 중 하나"_s
		}),
		$$new($ObjectArray, {
			"error.multiple.main.operations"_s,
			u"\'-cuxtid\' 옵션을 여러 개 지정할 수 없습니다."_s
		}),
		$$new($ObjectArray, {
			"error.no.operative.descriptor"_s,
			u"릴리스에 대한 작동 기술자 없음: {0}"_s
		}),
		$$new($ObjectArray, {
			"error.no.root.descriptor"_s,
			u"루트 모듈 기술자가 없습니다. --release를 지정하십시오."_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"{1} 릴리스에 대해 예상치 않은 버전이 지정된 항목 {0}"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"릴리스 {0}이(가) 부적합함. 9 이상이어야 합니다."_s
		}),
		$$new($ObjectArray, {
			"error.unable.derive.automodule"_s,
			u"모듈 기술자를 파생할 수 없음: {0}"_s
		}),
		$$new($ObjectArray, {
			"error.unexpected.module-info"_s,
			u"예상치 않은 모듈 기술자 {0}"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"  -c, --create               아카이브를 생성합니다."_s
		}),
		$$new($ObjectArray, {
			"main.help.opt.main.describe-module"_s,
			u"  -d, --describe-module      모듈 기술자 또는 자동 모듈 이름을 인쇄합니다."_s
		}),
		$$new($ObjectArray, {
			"main.help.opt.main.extract"_s,
			u"  -x, --extract              명명된(또는 모든) 파일을 아카이브에서 추출합니다."_s
		}),
		$$new($ObjectArray, {
			"main.help.opt.main.generate-index"_s,
			u"  -i, --generate-index=FILE  지정된 jar 아카이브에 대한 인덱스 정보를\n                             생성합니다."_s
		}),
		$$new($ObjectArray, {
			"main.help.opt.main.list"_s,
			u"  -t, --list                 아카이브에 대한 목차를 나열합니다."_s
		}),
		$$new($ObjectArray, {
			"main.help.opt.main.update"_s,
			u"  -u, --update               기존 jar 아카이브를 업데이트합니다."_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			"out.automodule"_s,
			u"모듈 기술자를 찾을 수 없습니다. 자동 모듈을 파생했습니다."_s
		}),
		$$new($ObjectArray, {
			"out.create"_s,
			u"  생성됨: {0}"_s
...
$Class* jar_ko::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(jar_ko, init$, void)},
		{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL, $virtualMethod(jar_ko, getContents, $ObjectArray2*)},
		{}
	};
	$ClassInfo classInfo$$ = {
	...
	$loadClass(jar_ko, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(jar_ko);
	});
	return class$;
}
