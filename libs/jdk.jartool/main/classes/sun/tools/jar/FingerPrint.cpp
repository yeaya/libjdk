...
$MethodInfo _FingerPrint_MethodInfo_[] = {
	{"<init>", "(Ljava/lang/String;Ljava/lang/String;I[B)V", nullptr, $PUBLIC, $method(static_cast<void(FingerPrint::*)($String*,$String*,int32_t,$bytes*)>(&FingerPrint::init$)), "java.io.IOException"},
	{"basename", "()Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(FingerPrint::*)()>(&FingerPrint::basename))},
	{"className", "()Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(FingerPrint::*)()>(&FingerPrint::className))},
	{"entryName", "()Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(FingerPrint::*)()>(&FingerPrint::entryName))},
	{"getClassAttributes", "([B)Lsun/tools/jar/FingerPrint$ClassAttributes;", nullptr, $PRIVATE, $method(static_cast<$FingerPrint$ClassAttributes*(FingerPrint::*)($bytes*)>(&FingerPrint::getClassAttributes))},
	{"isCafeBabe", "([B)Z", nullptr, $PRIVATE, $method(static_cast<bool(FingerPrint::*)($bytes*)>(&FingerPrint::isCafeBabe))},
	{"isClass", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(FingerPrint::*)()>(&FingerPrint::isClass))},
	{"isCompatibleVersion", "(Lsun/tools/jar/FingerPrint;)Z", nullptr, $PUBLIC, $method(static_cast<bool(FingerPrint::*)(FingerPrint*)>(&FingerPrint::isCompatibleVersion))},
	{"isEqual", "([B[B)Z", nullptr, $PRIVATE, $method(static_cast<bool(FingerPrint::*)($bytes*,$bytes*)>(&FingerPrint::isEqual))},
	{"isIdentical", "(Lsun/tools/jar/FingerPrint;)Z", nullptr, $PUBLIC, $method(static_cast<bool(FingerPrint::*)(FingerPrint*)>(&FingerPrint::isIdentical))},
	{"isNestedClass", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(FingerPrint::*)()>(&FingerPrint::isNestedClass))},
	{"isPublicClass", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(FingerPrint::*)()>(&FingerPrint::isPublicClass))},
	{"isSameAPI", "(Lsun/tools/jar/FingerPrint;)Z", nullptr, $PUBLIC, $method(static_cast<bool(FingerPrint::*)(FingerPrint*)>(&FingerPrint::isSameAPI))},
	{"mrversion", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(FingerPrint::*)()>(&FingerPrint::mrversion))},
	{"outerClassName", "()Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(FingerPrint::*)()>(&FingerPrint::outerClassName))},
	{"sha1", "([B)[B", nullptr, $PRIVATE, $method(static_cast<$bytes*(FingerPrint::*)($bytes*)>(&FingerPrint::sha1))},
	{"sha1", "([BI)[B", nullptr, $PRIVATE, $method(static_cast<$bytes*(FingerPrint::*)($bytes*,int32_t)>(&FingerPrint::sha1))},
	{}
};
