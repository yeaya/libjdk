...
$MethodInfo _GNUStyleOptions$16_MethodInfo_[] = {
	{"<init>", "(ZLsun/tools/jar/GNUStyleOptions$OptionType;[Ljava/lang/String;)V", nullptr, $TRANSIENT, $method(static_cast<void(GNUStyleOptions$16::*)(bool,$GNUStyleOptions$OptionType*,$StringArray*)>(&GNUStyleOptions$16::init$))},
	{"isExtra", "()Z", nullptr, 0},
