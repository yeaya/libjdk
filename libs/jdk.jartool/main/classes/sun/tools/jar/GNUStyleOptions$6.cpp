...
$MethodInfo _GNUStyleOptions$6_MethodInfo_[] = {
	{"<init>", "(ZLsun/tools/jar/GNUStyleOptions$OptionType;[Ljava/lang/String;)V", nullptr, $TRANSIENT, $method(static_cast<void(GNUStyleOptions$6::*)(bool,$GNUStyleOptions$OptionType*,$StringArray*)>(&GNUStyleOptions$6::init$))},
