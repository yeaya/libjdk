...
char16_t IBM29626C$Decoder::decodeDouble(int32_t byte1, int32_t byte2) {
	if (byte1 == 142) {
		...
		char16_t c = $nc(this->dec0201)->decode((int8_t)byte2);
		if (byte2 >= 224 && byte2 <= 228) {
			c = IBM29626C$Decoder::g1_c->charAt(byte2 - 224);
		}
		return c;
	}
	if ((byte1 >= 161 && byte1 <= 254) && (byte2 >= 161 && byte2 <= 254)) {
		char16_t c = (char16_t)((byte1 << 8) + byte2);
		int32_t idx = IBM29626C$Decoder::G2_b->indexOf(c);
		if (idx > -1) {
			return IBM29626C$Decoder::G2_c->charAt(idx);
		}
	}
...
char16_t IBM29626C$Decoder::decodeDoubleG3(int32_t byte1, int32_t byte2) {
	if ((byte1 >= 161 && byte1 <= 254) && (byte2 >= 161 && byte2 <= 254)) {
		char16_t c = (char16_t)((byte1 << 8) + byte2);
		int32_t idx = IBM29626C$Decoder::G3_b->indexOf(c);
		if (idx > -1) {
			return IBM29626C$Decoder::G3_c->charAt(idx);
		}
	}
...
void IBM29626C$Decoder::clinit$($Class* clazz) {
	$useLocalObjectStack();
...
$Class* IBM29626C$Decoder::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"<init>", "(Ljava/nio/charset/Charset;)V", nullptr, $PROTECTED, $method(IBM29626C$Decoder, init$, void, $Charset*)},
		{"<init>", "(Ljava/nio/charset/Charset;FFLsun/nio/cs/SingleByte$Decoder;Lsun/nio/cs/DoubleByte$Decoder;Lsun/nio/cs/DoubleByte$Decoder;)V", nullptr, $PROTECTED, $method(IBM29626C$Decoder, init$, void, $Charset*, float, float, $SingleByte$Decoder*, $DoubleByte$Decoder*, $DoubleByte$Decoder*)},
		{"decodeArrayLoop", "(Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;)Ljava/nio/charset/CoderResult;", nullptr, $PRIVATE, $method(IBM29626C$Decoder, decodeArrayLoop, $CoderResult*, $ByteBuffer*, $CharBuffer*)},
		{"decodeBufferLoop", "(Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;)Ljava/nio/charset/CoderResult;", nullptr, $PRIVATE, $method(IBM29626C$Decoder, decodeBufferLoop, $CoderResult*, $ByteBuffer*, $CharBuffer*)},
		{"decodeDouble", "(II)C", nullptr, $PROTECTED, $virtualMethod(IBM29626C$Decoder, decodeDouble, char16_t, int32_t, int32_t)},
		{"decodeDoubleG3", "(II)C", nullptr, $PROTECTED, $virtualMethod(IBM29626C$Decoder, decodeDoubleG3, char16_t, int32_t, int32_t)},
		{"decodeLoop", "(Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;)Ljava/nio/charset/CoderResult;", nullptr, $PUBLIC, $virtualMethod(IBM29626C$Decoder, decodeLoop, $CoderResult*, $ByteBuffer*, $CharBuffer*)},
		{"decodeSingle", "(I)C", nullptr, $PROTECTED, $virtualMethod(IBM29626C$Decoder, decodeSingle, char16_t, int32_t)},
		{"decodeUDC", "(III)C", nullptr, $PROTECTED, $virtualMethod(IBM29626C$Decoder, decodeUDC, char16_t, int32_t, int32_t, int32_t)},
		{"implFlush", "(Ljava/nio/CharBuffer;)Ljava/nio/charset/CoderResult;", nullptr, $PUBLIC, $virtualMethod(IBM29626C$Decoder, implFlush, $CoderResult*, $CharBuffer*)},
		{"implReset", "()V", nullptr, $PUBLIC, $virtualMethod(IBM29626C$Decoder, implReset, void)},
	...
	$loadClass(IBM29626C$Decoder, name, initialize, &classInfo$$, IBM29626C$Decoder::clinit$, []($Class* clazz) -> $Object* {
