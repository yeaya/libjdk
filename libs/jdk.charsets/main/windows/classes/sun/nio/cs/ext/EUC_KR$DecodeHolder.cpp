...
void EUC_KR$DecodeHolder::clinit$($Class* clazz) {
	...
	$assignStatic(EUC_KR$DecodeHolder::b2c, $new($charArray2, EUC_KR$DecodeHolder::b2cStr->length));
	{
		for (int32_t i = 0; i < EUC_KR$DecodeHolder::b2cStr->length; ++i) {
			if (EUC_KR$DecodeHolder::b2cStr->get(i) == nullptr) {
				$init($DoubleByte);
				EUC_KR$DecodeHolder::b2c->set(i, $DoubleByte::B2C_UNMAPPABLE);
			} else {
				EUC_KR$DecodeHolder::b2c->set(i, $($nc(EUC_KR$DecodeHolder::b2cStr->get(i))->toCharArray()));
			}
		}
		$assignStatic(EUC_KR$DecodeHolder::b2cSB, EUC_KR$DecodeHolder::b2cSBStr->toCharArray());
	}
}
...
$Class* EUC_KR$DecodeHolder::load$($String* name, bool initialize) {
	...
	$loadClass(EUC_KR$DecodeHolder, name, initialize, &classInfo$$, EUC_KR$DecodeHolder::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(EUC_KR$DecodeHolder);
	});
	return class$;
}
