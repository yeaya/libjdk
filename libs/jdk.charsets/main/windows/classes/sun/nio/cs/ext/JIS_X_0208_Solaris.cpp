...
$Class* JIS_X_0208_Solaris::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		...
		{"<init>", "()V", nullptr, $PUBLIC, $method(JIS_X_0208_Solaris, init$, void)},
		{"contains", "(Ljava/nio/charset/Charset;)Z", nullptr, $PUBLIC, $virtualMethod(JIS_X_0208_Solaris, contains, bool, $Charset*)},
		{"historicalName", "()Ljava/lang/String;", nullptr, $PUBLIC, $virtualMethod(JIS_X_0208_Solaris, historicalName, $String*)},
		{"newDecoder", "()Ljava/nio/charset/CharsetDecoder;", nullptr, $PUBLIC, $virtualMethod(JIS_X_0208_Solaris, newDecoder, $CharsetDecoder*)},
		{"newEncoder", "()Ljava/nio/charset/CharsetEncoder;", nullptr, $PUBLIC, $virtualMethod(JIS_X_0208_Solaris, newEncoder, $CharsetEncoder*)},
	...
	$loadClass(JIS_X_0208_Solaris, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
