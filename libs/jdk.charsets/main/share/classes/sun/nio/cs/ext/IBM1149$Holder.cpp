...
void IBM1149$Holder::clinit$($Class* clazz) {
	$useLocalObjectStack();
	...
	$assignStatic(IBM1149$Holder::b2c, IBM1149$Holder::b2cTable->toCharArray());
	...
	$assignStatic(IBM1149$Holder::c2bIndex, $new($chars, 256));
	{
		...
		$assign(b2cMap, IBM1149$Holder::b2cTable->toCharArray());
...
$Class* IBM1149$Holder::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PRIVATE, $method(IBM1149$Holder, init$, void)},
		{}
	};
	...
	$loadClass(IBM1149$Holder, name, initialize, &classInfo$$, IBM1149$Holder::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(IBM1149$Holder);
	});
	return class$;
}
