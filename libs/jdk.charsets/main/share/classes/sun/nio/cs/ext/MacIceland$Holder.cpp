...
$Class* MacIceland$Holder::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PRIVATE, $method(MacIceland$Holder, init$, void)},
		{}
	};
	...
	$loadClass(MacIceland$Holder, name, initialize, &classInfo$$, MacIceland$Holder::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(MacIceland$Holder);
	});
	return class$;
}
