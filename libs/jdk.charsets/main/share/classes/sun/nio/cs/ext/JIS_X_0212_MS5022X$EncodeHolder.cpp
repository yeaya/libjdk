...
void JIS_X_0212_MS5022X$EncodeHolder::clinit$($Class* clazz) {
	$useLocalObjectStack();
...
$Class* JIS_X_0212_MS5022X$EncodeHolder::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, 0, $method(JIS_X_0212_MS5022X$EncodeHolder, init$, void)},
		{}
	};
	...
	$loadClass(JIS_X_0212_MS5022X$EncodeHolder, name, initialize, &classInfo$$, JIS_X_0212_MS5022X$EncodeHolder::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(JIS_X_0212_MS5022X$EncodeHolder);
	});
	return class$;
}
