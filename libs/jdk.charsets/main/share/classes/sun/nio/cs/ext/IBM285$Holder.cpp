...
void IBM285$Holder::clinit$($Class* clazz) {
	$useLocalObjectStack();
	...
	$assignStatic(IBM285$Holder::b2c, IBM285$Holder::b2cTable->toCharArray());
	...
	$assignStatic(IBM285$Holder::c2bIndex, $new($chars, 256));
	{
		...
		$assign(b2cMap, IBM285$Holder::b2cTable->toCharArray());
...
$Class* IBM285$Holder::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PRIVATE, $method(IBM285$Holder, init$, void)},
		{}
	};
	...
	$loadClass(IBM285$Holder, name, initialize, &classInfo$$, IBM285$Holder::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(IBM285$Holder);
	});
	return class$;
}
