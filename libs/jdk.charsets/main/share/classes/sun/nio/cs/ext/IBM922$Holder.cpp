...
$Class* IBM922$Holder::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PRIVATE, $method(IBM922$Holder, init$, void)},
		{}
	};
	...
	$loadClass(IBM922$Holder, name, initialize, &classInfo$$, IBM922$Holder::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(IBM922$Holder);
	});
	return class$;
}
