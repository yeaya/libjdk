...
void IBM1025$Holder::clinit$($Class* clazz) {
	...
	$assignStatic(IBM1025$Holder::c2bIndex, $new($chars, 256));
	{
		...
		$assign(b2cMap, IBM1025$Holder::b2cTable->toCharArray());
...
$Class* IBM1025$Holder::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PRIVATE, $method(IBM1025$Holder, init$, void)},
		{}
	};
	...
	$loadClass(IBM1025$Holder, name, initialize, &classInfo$$, IBM1025$Holder::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(IBM1025$Holder);
	});
	return class$;
}
