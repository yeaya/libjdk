...
void IBM935$DecodeHolder::clinit$($Class* clazz) {
	...
	$assignStatic(IBM935$DecodeHolder::b2c, $new($charArray2, IBM935$DecodeHolder::b2cStr->length));
	{
		for (int32_t i = 0; i < IBM935$DecodeHolder::b2cStr->length; ++i) {
			if (IBM935$DecodeHolder::b2cStr->get(i) == nullptr) {
				$init($DoubleByte);
				IBM935$DecodeHolder::b2c->set(i, $DoubleByte::B2C_UNMAPPABLE);
			} else {
				IBM935$DecodeHolder::b2c->set(i, $($nc(IBM935$DecodeHolder::b2cStr->get(i))->toCharArray()));
			}
		}
		$assignStatic(IBM935$DecodeHolder::b2cSB, IBM935$DecodeHolder::b2cSBStr->toCharArray());
	}
}
...
$Class* IBM935$DecodeHolder::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, 0, $method(IBM935$DecodeHolder, init$, void)},
		{}
	};
	...
	$loadClass(IBM935$DecodeHolder, name, initialize, &classInfo$$, IBM935$DecodeHolder::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(IBM935$DecodeHolder);
	});
	return class$;
}
