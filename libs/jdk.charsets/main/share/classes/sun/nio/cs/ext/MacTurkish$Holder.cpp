...
$Class* MacTurkish$Holder::load$($String* name, bool initialize) {
	...
	$loadClass(MacTurkish$Holder, name, initialize, &classInfo$$, MacTurkish$Holder::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(MacTurkish$Holder);
	});
	return class$;
}
