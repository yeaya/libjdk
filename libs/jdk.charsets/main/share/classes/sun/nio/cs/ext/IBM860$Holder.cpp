...
void IBM860$Holder::clinit$($Class* clazz) {
	$useLocalObjectStack();
	...
	$assignStatic(IBM860$Holder::b2c, IBM860$Holder::b2cTable->toCharArray());
...
$Class* IBM860$Holder::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PRIVATE, $method(IBM860$Holder, init$, void)},
		{}
	};
	...
	$loadClass(IBM860$Holder, name, initialize, &classInfo$$, IBM860$Holder::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(IBM860$Holder);
	});
	return class$;
}
