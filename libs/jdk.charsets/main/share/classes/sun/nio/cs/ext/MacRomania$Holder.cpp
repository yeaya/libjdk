...
$Class* MacRomania$Holder::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PRIVATE, $method(MacRomania$Holder, init$, void)},
		{}
	};
	...
	$loadClass(MacRomania$Holder, name, initialize, &classInfo$$, MacRomania$Holder::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(MacRomania$Holder);
	});
	return class$;
}
