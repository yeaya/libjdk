...
void IBM1146$Holder::clinit$($Class* clazz) {
	...
	$assignStatic(IBM1146$Holder::c2bIndex, $new($chars, 256));
	{
		...
		$assign(b2cMap, IBM1146$Holder::b2cTable->toCharArray());
...
$Class* IBM1146$Holder::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PRIVATE, $method(IBM1146$Holder, init$, void)},
		{}
	};
	...
	$loadClass(IBM1146$Holder, name, initialize, &classInfo$$, IBM1146$Holder::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(IBM1146$Holder);
	});
	return class$;
}
