...
$Class* IBM865$Holder::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PRIVATE, $method(IBM865$Holder, init$, void)},
		{}
	};
	...
	$loadClass(IBM865$Holder, name, initialize, &classInfo$$, IBM865$Holder::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(IBM865$Holder);
	});
	return class$;
}
