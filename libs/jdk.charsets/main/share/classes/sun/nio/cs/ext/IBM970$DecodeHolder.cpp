...
void IBM970$DecodeHolder::clinit$($Class* clazz) {
	...
	$assignStatic(IBM970$DecodeHolder::b2c, $new($charArray2, IBM970$DecodeHolder::b2cStr->length));
	{
		for (int32_t i = 0; i < IBM970$DecodeHolder::b2cStr->length; ++i) {
			if (IBM970$DecodeHolder::b2cStr->get(i) == nullptr) {
				$init($DoubleByte);
				IBM970$DecodeHolder::b2c->set(i, $DoubleByte::B2C_UNMAPPABLE);
			} else {
				IBM970$DecodeHolder::b2c->set(i, $($nc(IBM970$DecodeHolder::b2cStr->get(i))->toCharArray()));
			}
		}
		$assignStatic(IBM970$DecodeHolder::b2cSB, IBM970$DecodeHolder::b2cSBStr->toCharArray());
	}
}
...
$Class* IBM970$DecodeHolder::load$($String* name, bool initialize) {
	...
	$loadClass(IBM970$DecodeHolder, name, initialize, &classInfo$$, IBM970$DecodeHolder::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(IBM970$DecodeHolder);
	});
	return class$;
}
