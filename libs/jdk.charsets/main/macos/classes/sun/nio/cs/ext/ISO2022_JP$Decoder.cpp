		...
		while (sp < sl) {
			...
			if (b1 == 27 || b1 == 14 || b1 == 15) {
				if (b1 == 27) {
					...
					b2 = sa->get(sp + inputSize++) & 0xff;
					if (b2 == u'(') {
						b3 = sa->get(sp + inputSize++) & 0xff;
						if (b3 == u'B') {
							this->currentState = 0;
						} else if (b3 == u'J') {
							this->currentState = 1;
	...
	try {
		while (src->hasRemaining()) {
			...
			case 1:
				switch (b1) {
				case 92:
					dst->put((char16_t)0xa5);
					break;
				case 126:
					dst->put((char16_t)0x203e);
					break;
				default:
					dst->put((char16_t)b1);
					break;
			...
			case 6:
				...
				dst->put((char16_t)(b1 + 0x0000ff40));
				break;
			}
			mark += inputSize;
		}
...
void ISO2022_JP$Decoder::clinit$($Class* clazz) {
...
$Class* ISO2022_JP$Decoder::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"<init>", "(Ljava/nio/charset/Charset;)V", nullptr, $PRIVATE, $method(ISO2022_JP$Decoder, init$, void, $Charset*)},
		{"<init>", "(Ljava/nio/charset/Charset;Lsun/nio/cs/DoubleByte$Decoder;Lsun/nio/cs/DoubleByte$Decoder;)V", nullptr, $PROTECTED, $method(ISO2022_JP$Decoder, init$, void, $Charset*, $DoubleByte$Decoder*, $DoubleByte$Decoder*)},
		{"decodeArrayLoop", "(Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;)Ljava/nio/charset/CoderResult;", nullptr, $PRIVATE, $method(ISO2022_JP$Decoder, decodeArrayLoop, $CoderResult*, $ByteBuffer*, $CharBuffer*)},
		{"decodeBufferLoop", "(Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;)Ljava/nio/charset/CoderResult;", nullptr, $PRIVATE, $method(ISO2022_JP$Decoder, decodeBufferLoop, $CoderResult*, $ByteBuffer*, $CharBuffer*)},
		{"decodeLoop", "(Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;)Ljava/nio/charset/CoderResult;", nullptr, $PUBLIC, $virtualMethod(ISO2022_JP$Decoder, decodeLoop, $CoderResult*, $ByteBuffer*, $CharBuffer*)},
		{"implFlush", "(Ljava/nio/CharBuffer;)Ljava/nio/charset/CoderResult;", nullptr, $PUBLIC, $virtualMethod(ISO2022_JP$Decoder, implFlush, $CoderResult*, $CharBuffer*)},
		{"implReset", "()V", nullptr, $PUBLIC, $virtualMethod(ISO2022_JP$Decoder, implReset, void)},
	...
	$loadClass(ISO2022_JP$Decoder, name, initialize, &classInfo$$, ISO2022_JP$Decoder::clinit$, []($Class* clazz) -> $Object* {
