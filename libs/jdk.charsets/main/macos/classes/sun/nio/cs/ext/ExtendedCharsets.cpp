...
void ExtendedCharsets::init$() {
	...
	charset("x-windows-950"_s, "MS950"_s, $$new($StringArray, {
		"ms950"_s,
		"windows-950"_s
	}));
	charset("x-windows-874"_s, "MS874"_s, $$new($StringArray, {
		"ms874"_s,
		"ms-874"_s,
		"windows-874"_s
	}));
	...
	charset("x-mswin-936"_s, "MS936"_s, $$new($StringArray, {
		"ms936"_s,
		"ms_936"_s
	}));
	...
	charset("x-windows-949"_s, "MS949"_s, $$new($StringArray, {
		"ms949"_s,
		"windows949"_s,
		"windows-949"_s,
		"ms_949"_s
	...
	charset("windows-1255"_s, "MS1255"_s, $$new($StringArray, {"cp1255"_s}));
	charset("windows-1256"_s, "MS1256"_s, $$new($StringArray, {"cp1256"_s}));
	charset("windows-1258"_s, "MS1258"_s, $$new($StringArray, {"cp1258"_s}));
