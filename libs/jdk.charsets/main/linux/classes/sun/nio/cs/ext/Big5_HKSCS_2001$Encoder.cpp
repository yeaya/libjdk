...
void Big5_HKSCS_2001$Encoder::clinit$($Class* clazz) {
...
$Class* Big5_HKSCS_2001$Encoder::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "(Ljava/nio/charset/Charset;)V", nullptr, $PRIVATE, $method(Big5_HKSCS_2001$Encoder, init$, void, $Charset*)},
		{}
	};
	...
	$loadClass(Big5_HKSCS_2001$Encoder, name, initialize, &classInfo$$, Big5_HKSCS_2001$Encoder::clinit$, []($Class* clazz) -> $Object* {
