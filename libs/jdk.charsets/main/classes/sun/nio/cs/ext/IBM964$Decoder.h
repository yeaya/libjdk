#ifndef _sun_nio_cs_ext_IBM964$Decoder_h_
#define _sun_nio_cs_ext_IBM964$Decoder_h_
//$ class sun.nio.cs.ext.IBM964$Decoder
...
class IBM964$Decoder : public ::java::nio::charset::CharsetDecoder {
	$class(IBM964$Decoder, 0, ::java::nio::charset::CharsetDecoder)
public:
	IBM964$Decoder();
	...
	$String* mappingTableG2 = nullptr;
	static $String* byteToCharTable;
	static $String* mappingTableG1;
	static $String* mappingTableG2a2;
	static $String* mappingTableG2ac;
	static $String* mappingTableG2ad;
};
...
#endif // _sun_nio_cs_ext_IBM964$Decoder_h_