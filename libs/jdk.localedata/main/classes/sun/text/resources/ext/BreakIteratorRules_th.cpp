...
$Class* BreakIteratorRules_th::load$($String* name, bool initialize) {
	...
	$loadClass(BreakIteratorRules_th, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(BreakIteratorRules_th);
	});
	return class$;
}
