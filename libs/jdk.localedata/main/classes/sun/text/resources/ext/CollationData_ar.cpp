...
$Class* CollationData_ar::load$($String* name, bool initialize) {
	...
	$loadClass(CollationData_ar, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(CollationData_ar);
	});
	return class$;
}
