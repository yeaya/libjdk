...
$Class* FormatData_ha::load$($String* name, bool initialize) {
	...
	$loadClass(FormatData_ha, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(FormatData_ha);
	});
	return class$;
}
