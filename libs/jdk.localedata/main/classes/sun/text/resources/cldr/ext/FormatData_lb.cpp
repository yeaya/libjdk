...
$ObjectArray2* FormatData_lb::getContents() {
	...
	$var($ObjectArray2, data, $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			...
			"Biergerlechen islamesche Kalenner"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			"calendarname.roc"_s,
			"Kalenner vun der Republik China"_s
		}),
		$$new($ObjectArray, {
...
$Class* FormatData_lb::load$($String* name, bool initialize) {
	...
	$loadClass(FormatData_lb, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(FormatData_lb);
	});
	return class$;
}
