...
$ObjectArray2* FormatData_fur::getContents() {
	...
	$var($ObjectArray2, data, $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			"calendarname.roc"_s,
			"calendari de Republiche di Cine"_s
		}),
		$$new($ObjectArray, {
...
$Class* FormatData_fur::load$($String* name, bool initialize) {
	...
	$loadClass(FormatData_fur, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(FormatData_fur);
	});
	return class$;
}
