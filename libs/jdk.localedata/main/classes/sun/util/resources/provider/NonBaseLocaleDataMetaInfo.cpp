...
$String* NonBaseLocaleDataMetaInfo::getSupportedLocaleString($String* resourceName) {
	...
	return $cast($String, NonBaseLocaleDataMetaInfo::resourceNameToLocales->getOrDefault(resourceName, ""_s));
}
...
$Class* NonBaseLocaleDataMetaInfo::load$($String* name, bool initialize) {
	...
	$loadClass(NonBaseLocaleDataMetaInfo, name, initialize, &classInfo$$, NonBaseLocaleDataMetaInfo::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(NonBaseLocaleDataMetaInfo);
	});
	return class$;
}
