...
$ObjectArray2* TimeZoneNames_hi::getContents() {
	...
	$var($ObjectArray2, data, $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			...
			u"विंसेनेस, इंडियाना"_s
		}),
		$$new($ObjectArray, {
			"timezone.excity.Antarctica/DumontDUrville"_s,
			u"ड्यूमोंट डी अर्विले"_s
		}),
		$$new($ObjectArray, {
