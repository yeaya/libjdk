...
$Class* TimeZoneNames_mk::load$($String* name, bool initialize) {
	...
	$loadClass(TimeZoneNames_mk, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TimeZoneNames_mk);
	});
	return class$;
}
