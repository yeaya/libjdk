...
$ObjectArray2* TimeZoneNames_pl::getContents() {
	...
	$var($ObjectArray2, data, $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			...
			u"Republika Zielonego Przylądka"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"Beulah, Dakota Północna"_s
		}),
		$$new($ObjectArray, {
			"timezone.excity.America/North_Dakota/Center"_s,
			u"Center, Dakota Północna"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"New Salem, Dakota Północna"_s
		})
	}));
	return data;
}
...
$Class* TimeZoneNames_pl::load$($String* name, bool initialize) {
	...
	$loadClass(TimeZoneNames_pl, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TimeZoneNames_pl);
	});
	return class$;
}
