...
$Class* TimeZoneNames_no::load$($String* name, bool initialize) {
	...
	$loadClass(TimeZoneNames_no, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TimeZoneNames_no);
	});
	return class$;
}
