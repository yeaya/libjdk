...
$ObjectArray2* TimeZoneNames_cy::getContents() {
	...
	$var($ObjectArray2, data, $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			...
			"Beulah, Gogledd Dakota"_s
		}),
		$$new($ObjectArray, {
			"timezone.excity.America/North_Dakota/Center"_s,
			"Center, Gogledd Dakota"_s
		}),
		$$new($ObjectArray, {
...
$Class* TimeZoneNames_cy::load$($String* name, bool initialize) {
	...
	$loadClass(TimeZoneNames_cy, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(TimeZoneNames_cy);
	});
	return class$;
}
