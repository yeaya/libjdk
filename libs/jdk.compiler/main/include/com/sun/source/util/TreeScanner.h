#ifndef _com_sun_source_util_TreeScanner_h_
#define _com_sun_source_util_TreeScanner_h_
//$ class com.sun.source.util.TreeScanner
...
class $import TreeScanner : public ::com::sun::source::tree::TreeVisitor {
	$class(TreeScanner, $NO_CLASS_INIT, ::com::sun::source::tree::TreeVisitor)
public:
	TreeScanner();
	void init$();
	virtual $Object* reduce(Object$* r1, Object$* r2);
	virtual $Object* scan(::com::sun::source::tree::Tree* tree, Object$* p);
	virtual $Object* scan(::java::lang::Iterable* nodes, Object$* p);
	$Object* scanAndReduce(::com::sun::source::tree::Tree* node, Object$* p, Object$* r);
...
#endif // _com_sun_source_util_TreeScanner_h_