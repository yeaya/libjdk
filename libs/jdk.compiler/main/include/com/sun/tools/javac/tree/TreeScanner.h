#ifndef _com_sun_tools_javac_tree_TreeScanner_h_
#define _com_sun_tools_javac_tree_TreeScanner_h_
//$ class com.sun.tools.javac.tree.TreeScanner
...
class $import TreeScanner : public ::com::sun::tools::javac::tree::JCTree$Visitor {
	$class(TreeScanner, $NO_CLASS_INIT, ::com::sun::tools::javac::tree::JCTree$Visitor)
public:
	TreeScanner();
	void init$();
	virtual void scan(::com::sun::tools::javac::tree::JCTree* tree);
	virtual void scan(::com::sun::tools::javac::util::List* trees);
	...
	virtual void visitGuardPattern(::com::sun::tools::javac::tree::JCTree$JCGuardPattern* that) override;
	...
	virtual void visitParenthesizedPattern(::com::sun::tools::javac::tree::JCTree$JCParenthesizedPattern* that) override;
	...
	virtual void visitTypeBoundKind(::com::sun::tools::javac::tree::JCTree$TypeBoundKind* that) override;
...
#endif // _com_sun_tools_javac_tree_TreeScanner_h_