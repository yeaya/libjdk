#ifndef _com_sun_tools_javac_comp_Resolve$BadVarargsMethod_h_
#define _com_sun_tools_javac_comp_Resolve$BadVarargsMethod_h_
//$ class com.sun.tools.javac.comp.Resolve$BadVarargsMethod
...
class $import Resolve$BadVarargsMethod : public ::com::sun::tools::javac::comp::Resolve$ResolveError {
	$class(Resolve$BadVarargsMethod, $NO_CLASS_INIT, ::com::sun::tools::javac::comp::Resolve$ResolveError)
public:
	Resolve$BadVarargsMethod();
	using ::com::sun::tools::javac::comp::Resolve$ResolveError::accept;
	using ::com::sun::tools::javac::comp::Resolve$ResolveError::clone;
	void init$(::com::sun::tools::javac::comp::Resolve* this$0, ::com::sun::tools::javac::comp::Resolve$ResolveError* delegatedError);
	...
	::com::sun::tools::javac::comp::Resolve$ResolveError* delegatedError = nullptr;
};
...
#endif // _com_sun_tools_javac_comp_Resolve$BadVarargsMethod_h_