...
class $import LambdaToMethod$LambdaAnalyzerPreprocessor$ReferenceTranslationContext : public ::com::sun::tools::javac::comp::LambdaToMethod$LambdaAnalyzerPreprocessor$TranslationContext {
