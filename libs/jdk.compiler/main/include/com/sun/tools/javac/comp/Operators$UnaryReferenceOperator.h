#ifndef _com_sun_tools_javac_comp_Operators$UnaryReferenceOperator_h_
#define _com_sun_tools_javac_comp_Operators$UnaryReferenceOperator_h_
//$ class com.sun.tools.javac.comp.Operators$UnaryReferenceOperator
...
class $import Operators$UnaryReferenceOperator : public ::com::sun::tools::javac::comp::Operators$UnaryOperatorHelper {
	$class(Operators$UnaryReferenceOperator, $NO_CLASS_INIT, ::com::sun::tools::javac::comp::Operators$UnaryOperatorHelper)
public:
	Operators$UnaryReferenceOperator();
...
#endif // _com_sun_tools_javac_comp_Operators$UnaryReferenceOperator_h_