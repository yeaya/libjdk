#ifndef _com_sun_tools_javac_comp_Operators$BinaryShiftOperator_h_
#define _com_sun_tools_javac_comp_Operators$BinaryShiftOperator_h_
//$ class com.sun.tools.javac.comp.Operators$BinaryShiftOperator
...
class $import Operators$BinaryShiftOperator : public ::com::sun::tools::javac::comp::Operators$BinaryOperatorHelper {
	$class(Operators$BinaryShiftOperator, $NO_CLASS_INIT, ::com::sun::tools::javac::comp::Operators$BinaryOperatorHelper)
public:
	Operators$BinaryShiftOperator();
...
#endif // _com_sun_tools_javac_comp_Operators$BinaryShiftOperator_h_