...
$Class* JavadocHelper$OnDemandJavadocHelper$PatchModuleFileManager$1::load$($String* name, bool initialize) {
	...
	$loadClass(JavadocHelper$OnDemandJavadocHelper$PatchModuleFileManager$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(JavadocHelper$OnDemandJavadocHelper$PatchModuleFileManager$1);
	});
	return class$;
}
