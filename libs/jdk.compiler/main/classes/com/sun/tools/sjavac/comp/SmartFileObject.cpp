...
bool SmartFileObject::equals(Object$* other) {
	return $nc(this->file)->equals(other);
}
...
void SmartFileObject::clinit$($Class* clazz) {
...
$Class* SmartFileObject::load$($String* name, bool initialize) {
	...
	$loadClass(SmartFileObject, name, initialize, &classInfo$$, SmartFileObject::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(SmartFileObject);
	});
	return class$;
}
