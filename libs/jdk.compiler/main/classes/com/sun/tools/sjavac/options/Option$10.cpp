...
$Class* Option$10::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V", nullptr, $PRIVATE, $method(Option$10, init$, void, $String*, int32_t, $String*, $String*)},
		{"processMatching", "(Lcom/sun/tools/sjavac/options/ArgumentIterator;Lcom/sun/tools/sjavac/options/OptionHelper;)V", nullptr, $PROTECTED, $virtualMethod(Option$10, processMatching, void, $ArgumentIterator*, $OptionHelper*)},
		{}
	};
	...
	$loadClass(Option$10, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
