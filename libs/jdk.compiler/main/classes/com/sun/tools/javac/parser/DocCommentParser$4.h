#ifndef _com_sun_tools_javac_parser_DocCommentParser$4_h_
#define _com_sun_tools_javac_parser_DocCommentParser$4_h_
//$ class com.sun.tools.javac.parser.DocCommentParser$4
...
class DocCommentParser$4 : public ::com::sun::tools::javac::parser::DocCommentParser$TagParser {
	$class(DocCommentParser$4, $NO_CLASS_INIT, ::com::sun::tools::javac::parser::DocCommentParser$TagParser)
public:
	DocCommentParser$4();
...
#endif // _com_sun_tools_javac_parser_DocCommentParser$4_h_