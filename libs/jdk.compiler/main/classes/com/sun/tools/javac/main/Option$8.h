#ifndef _com_sun_tools_javac_main_Option$8_h_
#define _com_sun_tools_javac_main_Option$8_h_
//$ class com.sun.tools.javac.main.Option$8
...
class Option$8 : public ::com::sun::tools::javac::main::Option {
	$class(Option$8, $NO_CLASS_INIT, ::com::sun::tools::javac::main::Option)
public:
	Option$8();
...
#endif // _com_sun_tools_javac_main_Option$8_h_