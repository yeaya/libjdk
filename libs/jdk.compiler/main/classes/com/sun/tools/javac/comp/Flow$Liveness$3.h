#ifndef _com_sun_tools_javac_comp_Flow$Liveness$3_h_
#define _com_sun_tools_javac_comp_Flow$Liveness$3_h_
//$ class com.sun.tools.javac.comp.Flow$Liveness$3
...
class Flow$Liveness$3 : public ::com::sun::tools::javac::comp::Flow$Liveness {
	$class(Flow$Liveness$3, $NO_CLASS_INIT, ::com::sun::tools::javac::comp::Flow$Liveness)
public:
	Flow$Liveness$3();
...
#endif // _com_sun_tools_javac_comp_Flow$Liveness$3_h_