#ifndef _com_sun_tools_javac_comp_Resolve$8_h_
#define _com_sun_tools_javac_comp_Resolve$8_h_
//$ class com.sun.tools.javac.comp.Resolve$8
...
class Resolve$8 : public ::com::sun::tools::javac::comp::Resolve$LogResolveHelper {
	$class(Resolve$8, $NO_CLASS_INIT, ::com::sun::tools::javac::comp::Resolve$LogResolveHelper)
public:
	Resolve$8();
...
#endif // _com_sun_tools_javac_comp_Resolve$8_h_