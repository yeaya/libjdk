...
$JCDiagnostic$Note* CompilerProperties$Notes::DeprecatedFilename($File* arg0) {
	$init(CompilerProperties$Notes);
	return $new($JCDiagnostic$Note, "compiler"_s, "deprecated.filename"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Note* CompilerProperties$Notes::DeprecatedFilenameAdditional($File* arg0) {
	$init(CompilerProperties$Notes);
	return $new($JCDiagnostic$Note, "compiler"_s, "deprecated.filename.additional"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Note* CompilerProperties$Notes::PreviewPlural($Source* arg0) {
	$init(CompilerProperties$Notes);
	return $new($JCDiagnostic$Note, "compiler"_s, "preview.plural"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Note* CompilerProperties$Notes::PreviewPluralAdditional($Source* arg0) {
	$init(CompilerProperties$Notes);
	return $new($JCDiagnostic$Note, "compiler"_s, "preview.plural.additional"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Note* CompilerProperties$Notes::ProcMessager($String* arg0) {
	$init(CompilerProperties$Notes);
	return $new($JCDiagnostic$Note, "compiler"_s, "proc.messager"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Note* CompilerProperties$Notes::RemovalFilename($File* arg0) {
	$init(CompilerProperties$Notes);
	return $new($JCDiagnostic$Note, "compiler"_s, "removal.filename"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Note* CompilerProperties$Notes::RemovalFilenameAdditional($File* arg0) {
	$init(CompilerProperties$Notes);
	return $new($JCDiagnostic$Note, "compiler"_s, "removal.filename.additional"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Note* CompilerProperties$Notes::UncheckedFilename($File* arg0) {
	$init(CompilerProperties$Notes);
	return $new($JCDiagnostic$Note, "compiler"_s, "unchecked.filename"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Note* CompilerProperties$Notes::UncheckedFilenameAdditional($File* arg0) {
	$init(CompilerProperties$Notes);
	return $new($JCDiagnostic$Note, "compiler"_s, "unchecked.filename.additional"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Note* CompilerProperties$Notes::VerboseL2mDeduplicate($Symbol* arg0) {
	$init(CompilerProperties$Notes);
	return $new($JCDiagnostic$Note, "compiler"_s, "verbose.l2m.deduplicate"_s, $$new($ObjectArray, {arg0}));
}
...
void CompilerProperties$Notes::clinit$($Class* clazz) {
	$useLocalObjectStack();
...
$Class* CompilerProperties$Notes::load$($String* name, bool initialize) {
	...
	$loadClass(CompilerProperties$Notes, name, initialize, &classInfo$$, CompilerProperties$Notes::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(CompilerProperties$Notes);
	});
	return class$;
}
