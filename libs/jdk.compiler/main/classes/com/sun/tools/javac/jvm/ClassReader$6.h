#ifndef _com_sun_tools_javac_jvm_ClassReader$6_h_
#define _com_sun_tools_javac_jvm_ClassReader$6_h_
//$ class com.sun.tools.javac.jvm.ClassReader$6
...
class ClassReader$6 : public ::com::sun::tools::javac::jvm::ClassReader$AttributeReader {
	$class(ClassReader$6, $NO_CLASS_INIT, ::com::sun::tools::javac::jvm::ClassReader$AttributeReader)
public:
	ClassReader$6();
...
#endif // _com_sun_tools_javac_jvm_ClassReader$6_h_