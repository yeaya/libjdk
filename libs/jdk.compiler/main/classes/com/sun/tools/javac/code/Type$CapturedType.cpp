...
$Object* Type$CapturedType::accept($Type$Visitor* v, Object$* s) {
	return $nc(v)->visitCapturedType(this, s);
}
...
$String* Type$CapturedType::toString() {
	...
	sb->append($mod((hashCode() & (int64_t)0xffffffff), $Printer::PRIME));
	sb->append(" of "_s);
...
$Class* Type$CapturedType::load$($String* name, bool initialize) {
	...
	$loadClass(Type$CapturedType, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
