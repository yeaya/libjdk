...
$Class* Operators$BinaryOperatorHelper$$Lambda$lambda$doLookup$0::load$($String* name, bool initialize) {
	...
	$loadClass(Operators$BinaryOperatorHelper$$Lambda$lambda$doLookup$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Operators$BinaryOperatorHelper$$Lambda$lambda$doLookup$0);
	});
	return class$;
}
...
$Class* Operators$BinaryOperatorHelper$$Lambda$lambda$addBinaryOperator$1$1::load$($String* name, bool initialize) {
	...
	$loadClass(Operators$BinaryOperatorHelper$$Lambda$lambda$addBinaryOperator$1$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Operators$BinaryOperatorHelper$$Lambda$lambda$addBinaryOperator$1$1);
	});
	return class$;
}
...
$Symbol$OperatorSymbol* Operators$BinaryOperatorHelper::doLookup($Type* t1, $Type* t2) {
	return doLookup($$new(Operators$BinaryOperatorHelper$$Lambda$lambda$doLookup$0, this, t1, t2));
}
...
bool Operators$BinaryOperatorHelper::isBinaryOperatorApplicable($Symbol$OperatorSymbol* op, $Type* t1, $Type* t2) {
	...
	return var$0 && this->this$0->types->isSameType($cast($Type, $nc(formals->tail)->head), t2);
}
...
Operators$BinaryOperatorHelper* Operators$BinaryOperatorHelper::addBinaryOperator($Operators$OperatorType* arg1, $Operators$OperatorType* arg2, $Operators$OperatorType* res, $ints* opcode) {
	$set(this, operatorSuppliers, $nc(this->operatorSuppliers)->prepend($$new(Operators$BinaryOperatorHelper$$Lambda$lambda$addBinaryOperator$1$1, this, arg1, arg2, res, opcode)));
	return this;
}
...
$Class* Operators$BinaryOperatorHelper::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("com.sun.tools.javac.comp.Operators$BinaryOperatorHelper$$Lambda$lambda$doLookup$0")) {
			return Operators$BinaryOperatorHelper$$Lambda$lambda$doLookup$0::load$(name, initialize);
		}
		if (name->equals("com.sun.tools.javac.comp.Operators$BinaryOperatorHelper$$Lambda$lambda$addBinaryOperator$1$1")) {
	...
	$loadClass(Operators$BinaryOperatorHelper, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
