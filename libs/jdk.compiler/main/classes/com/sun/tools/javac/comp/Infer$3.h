#ifndef _com_sun_tools_javac_comp_Infer$3_h_
#define _com_sun_tools_javac_comp_Infer$3_h_
//$ class com.sun.tools.javac.comp.Infer$3
...
class Infer$3 : public ::com::sun::tools::javac::comp::Infer$AbstractIncorporationEngine {
	$class(Infer$3, $NO_CLASS_INIT, ::com::sun::tools::javac::comp::Infer$AbstractIncorporationEngine)
public:
	Infer$3();
...
#endif // _com_sun_tools_javac_comp_Infer$3_h_