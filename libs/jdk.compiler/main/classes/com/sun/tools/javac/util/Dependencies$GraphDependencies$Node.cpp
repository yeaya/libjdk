...
void Dependencies$GraphDependencies$Node::init$($Symbol$ClassSymbol* value) {
	...
	$set(this, depsByKind, $new($EnumMap, $Dependencies$CompletionCause::class$));
	{
		...
		for (int32_t len$ = arr$->length, i$ = 0; i$ < len$; ++i$) {
			...
			{
				$nc(this->depsByKind)->put(depKind, $$new($ArrayList));
			}
		}
	}
}
...
bool Dependencies$GraphDependencies$Node::equals(Object$* obj) {
	...
	bool var$0 = var$1;
	return var$0 && $nc($cast($Symbol$ClassSymbol, this->data))->equals($nc(node)->data);
}

int32_t Dependencies$GraphDependencies$Node::hashCode() {
	return $nc($cast($Symbol$ClassSymbol, this->data))->hashCode();
}

$GraphUtils$DependencyKindArray* Dependencies$GraphDependencies$Node::getSupportedDependencyKinds() {
	return $cast($GraphUtils$DependencyKindArray, $Dependencies$CompletionCause::values());
}
...
$Class* Dependencies$GraphDependencies$Node::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"<init>", "(Lcom/sun/tools/javac/code/Symbol$ClassSymbol;)V", nullptr, 0, $method(Dependencies$GraphDependencies$Node, init$, void, $Symbol$ClassSymbol*)},
		{"addDependency", "(Lcom/sun/tools/javac/util/GraphUtils$DependencyKind;Lcom/sun/tools/javac/util/Dependencies$GraphDependencies$Node;)V", nullptr, 0, $virtualMethod(Dependencies$GraphDependencies$Node, addDependency, void, $GraphUtils$DependencyKind*, Dependencies$GraphDependencies$Node*)},
		{"dependencyAttributes", "(Lcom/sun/tools/javac/util/Dependencies$GraphDependencies$Node;Lcom/sun/tools/javac/util/GraphUtils$DependencyKind;)Ljava/util/Properties;", nullptr, $PUBLIC, $virtualMethod(Dependencies$GraphDependencies$Node, dependencyAttributes, $Properties*, Dependencies$GraphDependencies$Node*, $GraphUtils$DependencyKind*)},
		{"dependencyAttributes", "(Lcom/sun/tools/javac/util/GraphUtils$DottableNode;Lcom/sun/tools/javac/util/GraphUtils$DependencyKind;)Ljava/util/Properties;", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC, $virtualMethod(Dependencies$GraphDependencies$Node, dependencyAttributes, $Properties*, $GraphUtils$DottableNode*, $GraphUtils$DependencyKind*)},
		{"equals", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC, $virtualMethod(Dependencies$GraphDependencies$Node, equals, bool, Object$*)},
		{"getDependenciesByKind", "(Lcom/sun/tools/javac/util/GraphUtils$DependencyKind;)Ljava/util/Collection;", "(Lcom/sun/tools/javac/util/GraphUtils$DependencyKind;)Ljava/util/Collection<+Lcom/sun/tools/javac/util/Dependencies$GraphDependencies$Node;>;", $PUBLIC, $virtualMethod(Dependencies$GraphDependencies$Node, getDependenciesByKind, $Collection*, $GraphUtils$DependencyKind*)},
		{"getSupportedDependencyKinds", "()[Lcom/sun/tools/javac/util/GraphUtils$DependencyKind;", nullptr, $PUBLIC, $virtualMethod(Dependencies$GraphDependencies$Node, getSupportedDependencyKinds, $GraphUtils$DependencyKindArray*)},
		{"hashCode", "()I", nullptr, $PUBLIC, $virtualMethod(Dependencies$GraphDependencies$Node, hashCode, int32_t)},
		{"nodeAttributes", "()Ljava/util/Properties;", nullptr, $PUBLIC, $virtualMethod(Dependencies$GraphDependencies$Node, nodeAttributes, $Properties*)},
		{"toString", "()Ljava/lang/String;", nullptr, $PUBLIC, $virtualMethod(Dependencies$GraphDependencies$Node, toString, $String*)},
		{}
	};
	...
	$loadClass(Dependencies$GraphDependencies$Node, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
