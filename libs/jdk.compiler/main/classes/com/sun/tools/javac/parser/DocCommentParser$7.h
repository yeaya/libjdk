#ifndef _com_sun_tools_javac_parser_DocCommentParser$7_h_
#define _com_sun_tools_javac_parser_DocCommentParser$7_h_
//$ class com.sun.tools.javac.parser.DocCommentParser$7
...
class DocCommentParser$7 : public ::com::sun::tools::javac::parser::DocCommentParser$TagParser {
	$class(DocCommentParser$7, $NO_CLASS_INIT, ::com::sun::tools::javac::parser::DocCommentParser$TagParser)
public:
	DocCommentParser$7();
...
#endif // _com_sun_tools_javac_parser_DocCommentParser$7_h_