...
void DocCommentParser$Phase::clinit$($Class* clazz) {
...
$Class* DocCommentParser$Phase::load$($String* name, bool initialize) {
	...
	$loadClass(DocCommentParser$Phase, name, initialize, &classInfo$$, DocCommentParser$Phase::clinit$, []($Class* clazz) -> $Object* {
