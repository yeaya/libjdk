...
$ObjectArray2* compiler_zh_CN::getContents() {
	...
	return $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			...
			u"不允许在使用 --release 时从系统模块 {0} 导出程序包:"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.add.reads.with.release"_s,
			u"不允许在使用 --release 时为系统模块 {0} 添加读取维边:"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.addmods.all.module.path.invalid"_s,
			u"--add-modules ALL-MODULE-PATH 只能在编译未命名模块或在自动模块的上下文中编译时使用"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"接收方参数不允许使用传统数组记号"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.array.and.varargs"_s,
			u"无法在{2}中同时声明{0}和{1}"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"从发行版 1.4 开始, \'\'assert\'\' 为关键字, 不能用作标识符"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"意外的 @FunctionalInterface 注释"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.bad.functional.intf.anno.1"_s,
			u"意外的 @FunctionalInterface 注释\n{0}"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"无法将{4} {5}中的{0} {1}应用到给定类型;\n需要: {2}\n找到:    {3}\n原因: {6}"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.cant.apply.symbols"_s,
			u"对于{1}({2}), 找不到合适的{0}"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"对于 @interfaces, 不允许 \'\'extends\'\'"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"类不得扩展密封类：{0}（因为它未列在其 \'\'permits\'\' 子句中）"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"无法在调用超类型构造器之前引用{0}"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.cant.ref.non.effectively.final.var"_s,
			u"从{1}引用的本地变量必须是最终变量或实际上的最终变量"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"无法从参数化的类型中选择静态类"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.cant.type.annotate.scoping"_s,
			u"无法使用 type-use 注释 {0} 来注释确定作用域结构"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"有 \'\'catch\'\', 但是没有 \'\'try\'\'"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.clash.with.pkg.of.same.name"_s,
			u"{0} {1}与带有相同名称的程序包冲突"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"{1} {2} 中的默认方法{0}覆盖了 java.lang.Object 的成员"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.does.not.override.abstract"_s,
			u"{0}不是抽象的, 并且未覆盖{2}中的抽象方法{1}"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"重复的 provides 指令: 服务 {0}, 实现 {1}"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.duplicate.requires"_s,
			u"重复的 requires 指令: {0}"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"-A 需要一个参数; 使用 \'\'-Akey\'\' 或 \'\'-Akey=value\'\'"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"从发行版 5 开始, \'\'enum\'\' 为关键字, 不能用作标识符"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"枚举 switch case 标签必须为枚举常量的非限定名称"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.enum.no.finalize"_s,
			u"枚举不能有 finalize 方法"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.enum.no.subclassing"_s,
			u"类无法直接扩展 java.lang.Enum"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"可从 --patch-module 和 --module-source-path 访问文件, 但该文件在每个路径中属于不同的模块: {0}, {1}"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.file.sb.on.source.or.patch.path.for.module"_s,
			u"文件应在源路径或模块的补丁程序路径中"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"泛型类不能扩展 java.lang.Throwable"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"记录中不允许使用实例初始化程序"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.instanceof.pattern.no.subtype"_s,
			u"模式类型 {0} 是表达式类型 {1} 的子类型"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"注释处理程序选项 \'\'{0}\'\' 中的关键字不是以点分隔的标识符序列"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"对于常量池来说, 字符串 \"{0}...\" 的 UTF8 表示过长"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"从内部类中访问本地变量{0}; 需要被声明为最终类型"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.locn.bad.module-info"_s,
			u"读取 {0} 中的 module-info.class 时出现问题"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"--patch-module 选项的参数无效: {0}"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.locn.module-info.not.allowed.on.patch.path"_s,
			u"在补丁程序路径中不允许 module-info.class: {0}"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"模块声明应该在名为 module-info.java 的文件中"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.module.name.mismatch"_s,
			u"模块名称 {0} 与预期名称 {1} 不匹配"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.module.non.zero.opens"_s,
			u"打开的模块 {0} 具有非零 opens_count"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"{0}在{1}的条目中没有匹配项; 需要{2}"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.no.opens.unless.strong"_s,
			u"只允许在强模块中使用 \'\'opens\'\'"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"文件 module-info.java 中不允许使用程序包声明"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"yield 在 switch 表达式外部"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.no.switch.expression.qualify"_s,
			u"yield 在 switch 表达式外部\n（要调用称为 yield 的方法，请通过接收方或类型名称限定 yield）"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"没有任何文件系统提供方可处理此文件: {0}"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.non-static.cant.be.ref"_s,
			u"无法从静态上下文中引用非静态 {0} {1}"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"{0}在{1}中不是公共的; 无法从外部程序包中对其进行访问"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"类型参数{0}不在类型变量{1}的范围内"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.operator.cant.be.applied"_s,
			u"一元运算符 \'\'{0}\'\' 的操作数类型{1}错误"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"不再支持源选项 {0}。请使用 {1} 或更高版本。"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.option.removed.target"_s,
			u"不再支持目标选项 {0}。请使用 {1} 或更高版本。"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"模块 {0} 同时从 {2} 和 {3} 读取程序包 {1}"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.package.clash.from.requires.in.unnamed"_s,
			u"未命名的模块同时从 {1} 和 {2} 读取程序包 {0}"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"程序包注释应在文件 package-info.java 中"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.pkg.clashes.with.class.of.same.name"_s,
			u"程序包{0}与带有相同名称的类冲突"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"源发行版 {0} 与 --enable-preview 一起使用时无效\n（仅发行版 {1} 支持预览语言功能）"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.preview.without.source.or.release"_s,
			u"--enable-preview 必须与 -source 或 --release 一起使用"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"服务配置文件不正确, 或构造处理程序对象{0}时抛出异常错误"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"注释处理程序 \'\'{0}\'\' 未实现 javax.annotation.processing.Processor"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.proc.service.problem"_s,
			u"创建服务加载器以加载处理程序时出错。"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.processorpath.no.processormodulepath"_s,
			u"-processorpath 与 --processor-module-path 的组合非法"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.profile.bootclasspath.conflict"_s,
			u"概要信息和引导类路径选项不能同时使用"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"类型变量后面不能带有其他限制范围"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.type.var.more.than.once"_s,
			u"类型变量{0}在{1}的结果类型中多次出现; 必须对其进行实例化"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.type.var.more.than.once.in.result"_s,
			u"类型变量{0}在{1}的类型中多次出现; 必须对其进行实例化"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"变量 {0} 未在默认构造器中初始化"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.varargs.and.old.array.syntax"_s,
			u"variable-arity 参数中不允许使用传统数组记号"_s
		}),
		$$new($ObjectArray, {
			"compiler.err.varargs.and.receiver"_s,
			u"接收方参数不允许使用 varargs 记号"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"存取方法 {0} 的返回类型必须与记录组件 {1} 的类型相匹配"_s
		}),
		$$new($ObjectArray, {
			"compiler.misc.anachronistic.module.info"_s,
			u"在 {0}.{1} 版类文件中找到模块声明"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"错误的 RuntimeInvisibleParameterAnnotations 属性: {0}"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"{1} 中的 {0} 无法隐藏 {3} 中的 {2}"_s
		}),
		$$new($ObjectArray, {
			"compiler.misc.cant.implement"_s,
			u"{1}中的{0}无法实现{3}中的{2}"_s
		}),
		$$new($ObjectArray, {
			"compiler.misc.cant.override"_s,
			u"{1}中的{0}无法覆盖{3}中的{2}"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"仅显示前 {0} 个错误（共 {1} 个）；若要查看更多错误，请使用 -Xmaxerrs"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"仅显示前 {0} 个警告（共 {1} 个）；若要查看更多错误，请使用 -Xmaxwarns"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"致命错误: 在类路径或引导类路径中找不到程序包 java.lang"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"不能将隐式类型和显式类型的参数混合使用"_s
		}),
		$$new($ObjectArray, {
			"compiler.misc.inaccessible.varargs.type"_s,
			u"形式 varargs 元素类型{0}无法从 {1} {2} 进行访问"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"{0} {1}从类型 {4} 和 {5} 中继承了{2}({3}) 的不相关默认值"_s
		}),
		$$new($ObjectArray, {
			"compiler.misc.incompatible.upper.bounds"_s,
			u"推论变量 {0} 具有不兼容的上限 {1}"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"不存在类型变量{0}的实例, 以使{1}与{2}一致"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"lambda 表达式需要显式目标类型"_s
		}),
		$$new($ObjectArray, {
			"compiler.misc.local.missing.init"_s,
			u"无法在不带初始化程序的变量上使用 \'\'var\'\'"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"不能将原始构造器引用与构造器的显式类型参数一起使用"_s
		}),
		$$new($ObjectArray, {
			"compiler.misc.must.not.be.same.class"_s,
			u"permits 子句中存在非法自引用"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"程序包 {0} 已在模块 {1} 中声明, 但该模块未将它导出到模块 {2}"_s
		}),
		$$new($ObjectArray, {
			"compiler.misc.not.def.access.not.exported.to.module.from.unnamed"_s,
			u"程序包 {0} 已在模块 {1} 中声明, 但该模块未将它导出到未命名模块"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"{1}中的{0}覆盖了{3}中的{2}"_s
		}),
		$$new($ObjectArray, {
			"compiler.misc.unchecked.implement"_s,
			u"{1}中的{0}实现了{3}中的{2}"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"类文件具有错误的版本 {0}.{1}, 应为 {2}.{3}"_s
		}),
		$$new($ObjectArray, {
			"compiler.misc.x.print.processor.info"_s,
			u"处理程序{0}与{1}匹配并返回{2}。"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"某些消息已经过简化; 请使用 -Xdiags:verbose 重新编译以获得完整输出"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"通过 javax.lang.model.util.Elements.{0} 在模块 \'\'{2}\'\' 中找到了多个名为 \'\'{1}\'\' 的元素。"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"某些输入文件还使用预览语言功能。"_s
		}),
		$$new($ObjectArray, {
			"compiler.note.preview.recompile"_s,
			u"有关详细信息，请使用 -Xlint:preview 重新编译。"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"{0}: 主版本 {1} 比 {2} 新, 此编译器支持最新的主版本。\n建议升级此编译器。"_s
		}),
		$$new($ObjectArray, {
			"compiler.warn.constant.SVUID"_s,
			u"serialVersionUID 在类{0}中必须是常量"_s
		}),
		$$new($ObjectArray, {
			"compiler.warn.deprecated.annotation.has.no.effect"_s,
			u"@Deprecated 注释对此 {0} 声明没有任何效果"_s
		}),
		$$new($ObjectArray, {
			"compiler.warn.diamond.redundant.args"_s,
			u"新表达式中存在冗余类型参数 (改用 diamond 运算符)。"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"文件 {0} 的修改日期是未来的日期"_s
		}),
		$$new($ObjectArray, {
			"compiler.warn.finally.cannot.complete"_s,
			u"finally 子句无法正常完成"_s
		}),
		$$new($ObjectArray, {
			"compiler.warn.forward.ref"_s,
			u"先引用变量 \'\'{0}\'\', 然后再对其初始化"_s
		}),
		$$new($ObjectArray, {
			"compiler.warn.future.attr"_s,
			u"{1}.{2} 版类文件中引入的 {0} 属性在 {3}.{4} 版类文件中被忽略"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"必须在类{0}中将 serialVersionUID 声明为 static final"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"模块 {2} 中的 {0} {1} 对需要该模块的客户机不可访问"_s
		}),
		$$new($ObjectArray, {
			"compiler.warn.leaks.not.accessible.not.required.transitive"_s,
			u"未使用 \'\'requires transitive\'\' 间接导出模块 {2} 中的 {0} {1}"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"模块 {2} 中的 {0} {1} 可能对需要该模块的所有客户机都不可见"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"serialVersionUID 在类{0}中必须是 long 类型"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"导出的程序包 {1} 中的类 {0} 未声明显式构造器，因此将向模块 {2} 的客户机公开默认构造器"_s
		}),
		$$new($ObjectArray, {
			"compiler.warn.missing.SVUID"_s,
			u"可序列化类{0}没有 serialVersionUID 的定义"_s
		}),
		$$new($ObjectArray, {
			"compiler.warn.missing.deprecated.annotation"_s,
			u"未使用 @Deprecated 对已过时的项目进行注释"_s
		}),
		$$new($ObjectArray, {
			"compiler.warn.module.for.option.not.found"_s,
			u"找不到 {0} 选项中的模块名称: {1}"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"{0}; 被覆盖的方法为 bridge 方法"_s
		}),
		$$new($ObjectArray, {
			"compiler.warn.override.equals.but.not.hashcode"_s,
			u"类{0}覆盖了 equals, 但该类或任何超类都未覆盖 hashCode 方法"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"错误的路径元素 \"{0}\": 没有这种文件或目录"_s
		}),
		$$new($ObjectArray, {
			"compiler.warn.pkg-info.already.seen"_s,
			u"已找到程序包{0}的 package-info.java 文件"_s
		}),
		$$new($ObjectArray, {
			"compiler.warn.poor.choice.for.module.name"_s,
			u"模块名称组成部分 {0} 应避免以数字结尾"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"无法创建带有非法名称 \'\'{0}\'\' 的文件。"_s
		}),
		$$new($ObjectArray, {
			"compiler.warn.proc.malformed.supported.string"_s,
			u"处理程序 \'\'{1}\'\' 为支持的注释类型返回格式错误的字符串 \'\'{0}\'\'"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"类型 \'\'{0}\'\' 的文件未关闭; 将不针对这些类型进行注释处理"_s
		}),
		$$new($ObjectArray, {
			"compiler.warn.proc.unmatched.processor.options"_s,
			u"以下选项未被任何处理程序识别: \'\'{0}\'\'"_s
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			u"Varargs 方法可能导致来自不可具体化 varargs 参数 {0} 的堆污染"_s
		}),
		$$new($ObjectArray, {
...
$Class* compiler_zh_CN::load$($String* name, bool initialize) {
	...
	$loadClass(compiler_zh_CN, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(compiler_zh_CN);
	});
	return class$;
}
