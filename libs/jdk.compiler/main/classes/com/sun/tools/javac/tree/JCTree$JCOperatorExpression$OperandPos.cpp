...
void JCTree$JCOperatorExpression$OperandPos::clinit$($Class* clazz) {
...
$Class* JCTree$JCOperatorExpression$OperandPos::load$($String* name, bool initialize) {
	...
	$loadClass(JCTree$JCOperatorExpression$OperandPos, name, initialize, &classInfo$$, JCTree$JCOperatorExpression$OperandPos::clinit$, []($Class* clazz) -> $Object* {
