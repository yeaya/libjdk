#ifndef _com_sun_tools_javac_jvm_ClassReader$4_h_
#define _com_sun_tools_javac_jvm_ClassReader$4_h_
//$ class com.sun.tools.javac.jvm.ClassReader$4
...
class ClassReader$4 : public ::com::sun::tools::javac::jvm::ClassReader$AttributeReader {
	$class(ClassReader$4, $NO_CLASS_INIT, ::com::sun::tools::javac::jvm::ClassReader$AttributeReader)
public:
	ClassReader$4();
...
#endif // _com_sun_tools_javac_jvm_ClassReader$4_h_