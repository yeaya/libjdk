#ifndef _com_sun_tools_javac_comp_Resolve$StaticError_h_
#define _com_sun_tools_javac_comp_Resolve$StaticError_h_
//$ class com.sun.tools.javac.comp.Resolve$StaticError
...
class $export Resolve$StaticError : public ::com::sun::tools::javac::comp::Resolve$InvalidSymbolError {
	$class(Resolve$StaticError, $NO_CLASS_INIT, ::com::sun::tools::javac::comp::Resolve$InvalidSymbolError)
public:
	Resolve$StaticError();
...
#endif // _com_sun_tools_javac_comp_Resolve$StaticError_h_