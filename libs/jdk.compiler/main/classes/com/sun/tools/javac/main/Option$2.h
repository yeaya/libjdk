#ifndef _com_sun_tools_javac_main_Option$2_h_
#define _com_sun_tools_javac_main_Option$2_h_
//$ class com.sun.tools.javac.main.Option$2
...
class Option$2 : public ::com::sun::tools::javac::main::Option {
	$class(Option$2, $NO_CLASS_INIT, ::com::sun::tools::javac::main::Option)
public:
	Option$2();
...
#endif // _com_sun_tools_javac_main_Option$2_h_