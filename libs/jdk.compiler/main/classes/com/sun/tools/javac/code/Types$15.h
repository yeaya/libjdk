#ifndef _com_sun_tools_javac_code_Types$15_h_
#define _com_sun_tools_javac_code_Types$15_h_
//$ class com.sun.tools.javac.code.Types$15
...
class Types$15 : public ::com::sun::tools::javac::code::Types$UnaryVisitor {
	$class(Types$15, $NO_CLASS_INIT, ::com::sun::tools::javac::code::Types$UnaryVisitor)
public:
	Types$15();
	void init$(::com::sun::tools::javac::code::Types* this$0);
	using ::com::sun::tools::javac::code::Types$UnaryVisitor::visit;
	virtual ::com::sun::tools::javac::code::Type* visitArrayType(::com::sun::tools::javac::code::Type$ArrayType* t, ::java::lang::Void* ignored);
...
#endif // _com_sun_tools_javac_code_Types$15_h_