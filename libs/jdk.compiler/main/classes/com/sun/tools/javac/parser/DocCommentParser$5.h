#ifndef _com_sun_tools_javac_parser_DocCommentParser$5_h_
#define _com_sun_tools_javac_parser_DocCommentParser$5_h_
//$ class com.sun.tools.javac.parser.DocCommentParser$5
...
class DocCommentParser$5 : public ::com::sun::tools::javac::parser::DocCommentParser$TagParser {
	$class(DocCommentParser$5, $NO_CLASS_INIT, ::com::sun::tools::javac::parser::DocCommentParser$TagParser)
public:
	DocCommentParser$5();
...
#endif // _com_sun_tools_javac_parser_DocCommentParser$5_h_