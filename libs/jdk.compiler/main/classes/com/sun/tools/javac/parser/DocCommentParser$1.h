#ifndef _com_sun_tools_javac_parser_DocCommentParser$1_h_
#define _com_sun_tools_javac_parser_DocCommentParser$1_h_
//$ class com.sun.tools.javac.parser.DocCommentParser$1
...
class DocCommentParser$1 : public ::com::sun::tools::javac::parser::DocCommentParser$TagParser {
	$class(DocCommentParser$1, $NO_CLASS_INIT, ::com::sun::tools::javac::parser::DocCommentParser$TagParser)
public:
	DocCommentParser$1();
...
#endif // _com_sun_tools_javac_parser_DocCommentParser$1_h_