#ifndef _com_sun_tools_javac_tree_TreeCopier_h_
#define _com_sun_tools_javac_tree_TreeCopier_h_
//$ class com.sun.tools.javac.tree.TreeCopier
...
class $export TreeCopier : public ::com::sun::source::tree::TreeVisitor {
	$class(TreeCopier, $NO_CLASS_INIT, ::com::sun::source::tree::TreeVisitor)
public:
	TreeCopier();
	void init$(::com::sun::tools::javac::tree::TreeMaker* M);
	virtual ::com::sun::tools::javac::tree::JCTree* copy(::com::sun::tools::javac::tree::JCTree* tree);
	virtual ::com::sun::tools::javac::tree::JCTree* copy(::com::sun::tools::javac::tree::JCTree* tree, Object$* p);
	virtual ::com::sun::tools::javac::util::List* copy(::com::sun::tools::javac::util::List* trees);
	virtual ::com::sun::tools::javac::util::List* copy(::com::sun::tools::javac::util::List* trees, Object$* p);
	...
	::com::sun::tools::javac::tree::TreeMaker* M = nullptr;
};
...
#endif // _com_sun_tools_javac_tree_TreeCopier_h_