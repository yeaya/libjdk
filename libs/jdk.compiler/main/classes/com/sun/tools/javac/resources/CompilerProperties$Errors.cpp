...
$JCDiagnostic$Error* CompilerProperties$Errors::AbstractCantBeInstantiated($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "abstract.cant.be.instantiated"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::AddExportsWithRelease($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "add.exports.with.release"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::AddReadsWithRelease($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "add.reads.with.release"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::AlreadyDefinedSingleImport($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "already.defined.single.import"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::AlreadyDefinedStaticSingleImport($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "already.defined.static.single.import"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::AlreadyDefinedThisUnit($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "already.defined.this.unit"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::AnnotationNotValidForType($Type* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "annotation.not.valid.for.type"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::AnnotationTypeNotApplicableToType($Type* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "annotation.type.not.applicable.to.type"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::AnonymousDiamondMethodDoesNotOverrideSuperclass($JCDiagnostic* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "anonymous.diamond.method.does.not.override.superclass"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::ArrayReqButFound($Type* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "array.req.but.found"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::BadFunctionalIntfAnno1($JCDiagnostic* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "bad.functional.intf.anno.1"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::BadInitializer($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "bad.initializer"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::CallMustBeFirstStmtInCtor($Name* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "call.must.be.first.stmt.in.ctor"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::CallToSuperNotAllowedInEnumCtor($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "call.to.super.not.allowed.in.enum.ctor"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::CantAssignValToFinalVar($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "cant.assign.val.to.final.var"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::CantDeref($Type* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "cant.deref"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::CantInheritFromFinal($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "cant.inherit.from.final"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::CantInheritFromSealed($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "cant.inherit.from.sealed"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::CantRefBeforeCtorCalled($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "cant.ref.before.ctor.called"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::CantTypeAnnotateScoping($List* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "cant.type.annotate.scoping"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::CantTypeAnnotateScoping1($Attribute$Compound* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "cant.type.annotate.scoping.1"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::ClassInUnnamedModuleCantExtendSealedInDiffPackage($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "class.in.unnamed.module.cant.extend.sealed.in.diff.package"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::ConflictingExports($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "conflicting.exports"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::ConflictingExportsToModule($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "conflicting.exports.to.module"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::ConflictingOpens($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "conflicting.opens"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::ConflictingOpensToModule($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "conflicting.opens.to.module"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::CyclicAnnotationElement($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "cyclic.annotation.element"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::CyclicInheritance($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "cyclic.inheritance"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::CyclicRequires($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "cyclic.requires"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::DoesntExist($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "doesnt.exist"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::DuplicateAnnotationInvalidRepeated($Type* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "duplicate.annotation.invalid.repeated"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::DuplicateAnnotationMissingContainer($Type* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "duplicate.annotation.missing.container"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::DuplicateClass($Name* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "duplicate.class"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::DuplicateModule($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "duplicate.module"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::DuplicateRequires($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "duplicate.requires"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::DuplicateUses($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "duplicate.uses"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::EnclClassRequired($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "encl.class.required"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::ExceptAlreadyCaught($Type* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "except.already.caught"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::ExceptNeverThrownInTry($Type* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "except.never.thrown.in.try"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::Expected($Tokens$TokenKind* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "expected"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::ExpectedStr($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "expected.str"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::FileNotDirectory($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "file.not.directory"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::FileNotFound($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "file.not.found"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::FinalParameterMayNotBeAssigned($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "final.parameter.may.not.be.assigned"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::FirstStatementMustBeCallToAnotherConstructor($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "first.statement.must.be.call.to.another.constructor"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::IclsCantHaveStaticDecl($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "icls.cant.have.static.decl"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::IllegalChar($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "illegal.char"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::IllegalInitializerForType($Type* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "illegal.initializer.for.type"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::IllegalQualNotIcls($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "illegal.qual.not.icls"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::IllegalRecordComponentName($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "illegal.record.component.name"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::IllegalRefToRestrictedType($Name* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "illegal.ref.to.restricted.type"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::IllegalStaticIntfMethCall($Type* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "illegal.static.intf.meth.call"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::ImportRequiresCanonical($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "import.requires.canonical"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::IncompatibleThrownTypesInMref($List* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "incompatible.thrown.types.in.mref"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::IntNumberTooLarge($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "int.number.too.large"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::IntfAnnotationCantHaveTypeParams($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "intf.annotation.cant.have.type.params"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::InvalidAKey($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "invalid.A.key"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::InvalidFlag($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "invalid.flag"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::InvalidLambdaParameterDeclaration($JCDiagnostic$Fragment* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "invalid.lambda.parameter.declaration"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::InvalidModuleSpecifier($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "invalid.module.specifier"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::InvalidPath($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "invalid.path"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::InvalidPermitsClause($JCDiagnostic$Fragment* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "invalid.permits.clause"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::InvalidProfile($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "invalid.profile"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::InvalidRepeatableAnnotation($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "invalid.repeatable.annotation"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::InvalidRepeatableAnnotationInvalidValue($Type* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "invalid.repeatable.annotation.invalid.value"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::InvalidRepeatableAnnotationNoValue($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "invalid.repeatable.annotation.no.value"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::InvalidRepeatableAnnotationNotApplicableInContext($Type* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "invalid.repeatable.annotation.not.applicable.in.context"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::InvalidRepeatableAnnotationRepeatedAndContainerPresent($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "invalid.repeatable.annotation.repeated.and.container.present"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::InvalidSource($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "invalid.source"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::InvalidSupertypeRecord($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "invalid.supertype.record"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::InvalidTarget($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "invalid.target"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::IsPreview($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "is.preview"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::LabelAlreadyInUse($Name* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "label.already.in.use"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::LimitStringOverflow($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "limit.string.overflow"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::LocalClassesCantExtendSealed($JCDiagnostic$Fragment* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "local.classes.cant.extend.sealed"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::LocalVarAccessedFromIclsNeedsFinal($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "local.var.accessed.from.icls.needs.final"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::LocnBadModuleInfo($Path* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "locn.bad.module-info"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::LocnCantGetModuleNameForJar($Path* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "locn.cant.get.module.name.for.jar"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::LocnCantReadDirectory($Path* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "locn.cant.read.directory"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::LocnCantReadFile($Path* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "locn.cant.read.file"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::LocnInvalidArgForXpatch($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "locn.invalid.arg.for.xpatch"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::LocnModuleInfoNotAllowedOnPatchPath($JavaFileObject* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "locn.module-info.not.allowed.on.patch.path"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::ModNotAllowedHere($Set* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "mod.not.allowed.here"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::ModifierNotAllowedHere($Name* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "modifier.not.allowed.here"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::ModuleNonZeroOpens($Name* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "module.non.zero.opens"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::ModuleNotFound($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "module.not.found"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::ModuleNotFoundInModuleSourcePath($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "module.not.found.in.module.source.path"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::MultiModuleOutdirCannotBeExplodedModule($Path* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "multi-module.outdir.cannot.be.exploded.module"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::MulticatchParameterMayNotBeAssigned($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "multicatch.parameter.may.not.be.assigned"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::NoEnclInstanceOfTypeInScope($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "no.encl.instance.of.type.in.scope"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::NoSuperclass($Type* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "no.superclass"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::NoValueForOption($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "no.value.for.option"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::NoZipfsForArchive($Path* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "no.zipfs.for.archive"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::NonSealedWithNoSealedSupertype($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "non.sealed.with.no.sealed.supertype"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::NotAnnotationType($Type* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "not.annotation.type"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::NotEnclClass($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "not.encl.class"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::NotLoopLabel($Name* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "not.loop.label"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::OptionTooMany($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "option.too.many"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::Orphaned($Tokens$TokenKind* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "orphaned"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::OverrideStatic($JCDiagnostic* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "override.static"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::PackageEmptyOrNotFound($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "package.empty.or.not.found"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::PackageInOtherModule($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "package.in.other.module"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::PkgClashesWithClassOfSameName($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "pkg.clashes.with.class.of.same.name"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::PluginNotFound($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "plugin.not.found"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::PreviewFeatureDisabled($JCDiagnostic* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "preview.feature.disabled"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::PreviewFeatureDisabledPlural($JCDiagnostic* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "preview.feature.disabled.plural"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::ProbFoundReq($JCDiagnostic* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "prob.found.req"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::ProcBadConfigFile($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "proc.bad.config.file"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::ProcCantFindClass($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "proc.cant.find.class"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::ProcCantLoadClass($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "proc.cant.load.class"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::ProcMessager($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "proc.messager"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::ProcNoExplicitAnnotationProcessingRequested($Collection* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "proc.no.explicit.annotation.processing.requested"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::ProcProcessorCantInstantiate($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "proc.processor.cant.instantiate"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::ProcProcessorNotFound($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "proc.processor.not.found"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::ProcProcessorWrongType($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "proc.processor.wrong.type"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::QualifiedNewOfStaticClass($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "qualified.new.of.static.class"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::ReleaseBootclasspathConflict($Option* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "release.bootclasspath.conflict"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::RepeatedProvidesForService($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "repeated.provides.for.service"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::RepeatedValueForModuleSourcePath($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "repeated.value.for.module.source.path"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::RepeatedValueForPatchModule($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "repeated.value.for.patch.module"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::ReqArg($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "req.arg"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::RestrictedTypeNotAllowedArray($Name* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "restricted.type.not.allowed.array"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::RestrictedTypeNotAllowedCompound($Name* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "restricted.type.not.allowed.compound"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::RestrictedTypeNotAllowedHere($Name* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "restricted.type.not.allowed.here"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::ServiceDefinitionIsEnum($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "service.definition.is.enum"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::ServiceImplementationDoesntHaveANoArgsConstructor($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "service.implementation.doesnt.have.a.no.args.constructor"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::ServiceImplementationIsAbstract($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "service.implementation.is.abstract"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::ServiceImplementationIsInner($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "service.implementation.is.inner"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::ServiceImplementationNoArgsConstructorNotPublic($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "service.implementation.no.args.constructor.not.public"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::ServiceImplementationNotInRightModule($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "service.implementation.not.in.right.module"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::SourceCantOverwriteInputFile($JavaFileObject* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "source.cant.overwrite.input.file"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::StackSimError($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "stack.sim.error"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::TooManyPatchedModules($Set* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "too.many.patched.modules"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::TryResourceMayNotBeAssigned($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "try.resource.may.not.be.assigned"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::TryWithResourcesExprEffectivelyFinalVar($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "try.with.resources.expr.effectively.final.var"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::TypeDoesntTakeParams($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "type.doesnt.take.params"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::UndefLabel($Name* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "undef.label"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::UnmatchedQuote($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "unmatched.quote"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::UnreportedExceptionDefaultConstructor($Type* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "unreported.exception.default.constructor"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::UnreportedExceptionNeedToCatchOrThrow($Type* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "unreported.exception.need.to.catch.or.throw"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::UnsupportedEncoding($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "unsupported.encoding"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::UnsupportedReleaseVersion($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "unsupported.release.version"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::VarMightAlreadyBeAssigned($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "var.might.already.be.assigned"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::VarMightBeAssignedInLoop($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "var.might.be.assigned.in.loop"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::VarMightNotHaveBeenInitialized($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "var.might.not.have.been.initialized"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Error* CompilerProperties$Errors::VarNotInitializedInDefaultConstructor($Symbol* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "var.not.initialized.in.default.constructor"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Error* CompilerProperties$Errors::WrongNumberTypeArgs($String* arg0) {
	$init(CompilerProperties$Errors);
	return $new($JCDiagnostic$Error, "compiler"_s, "wrong.number.type.args"_s, $$new($ObjectArray, {arg0}));
}

void CompilerProperties$Errors::clinit$($Class* clazz) {
	$useLocalObjectStack();
...
$Class* CompilerProperties$Errors::load$($String* name, bool initialize) {
	...
	$loadClass(CompilerProperties$Errors, name, initialize, &classInfo$$, CompilerProperties$Errors::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(CompilerProperties$Errors);
	});
	return class$;
}
