#ifndef _com_sun_tools_javac_jvm_ClassReader$2_h_
#define _com_sun_tools_javac_jvm_ClassReader$2_h_
//$ class com.sun.tools.javac.jvm.ClassReader$2
...
class ClassReader$2 : public ::com::sun::tools::javac::jvm::ClassReader$AttributeReader {
	$class(ClassReader$2, $NO_CLASS_INIT, ::com::sun::tools::javac::jvm::ClassReader$AttributeReader)
public:
	ClassReader$2();
...
#endif // _com_sun_tools_javac_jvm_ClassReader$2_h_