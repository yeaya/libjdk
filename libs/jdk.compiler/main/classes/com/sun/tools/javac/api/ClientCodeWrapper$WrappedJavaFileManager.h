#ifndef _com_sun_tools_javac_api_ClientCodeWrapper$WrappedJavaFileManager_h_
#define _com_sun_tools_javac_api_ClientCodeWrapper$WrappedJavaFileManager_h_
//$ class com.sun.tools.javac.api.ClientCodeWrapper$WrappedJavaFileManager
...
class $export ClientCodeWrapper$WrappedJavaFileManager : public ::javax::tools::JavaFileManager {
	$class(ClientCodeWrapper$WrappedJavaFileManager, $NO_CLASS_INIT, ::javax::tools::JavaFileManager)
public:
	ClientCodeWrapper$WrappedJavaFileManager();
	void init$(::com::sun::tools::javac::api::ClientCodeWrapper* this$0, ::javax::tools::JavaFileManager* clientJavaFileManager);
	...
	::javax::tools::JavaFileManager* clientJavaFileManager = nullptr;
};
...
#endif // _com_sun_tools_javac_api_ClientCodeWrapper$WrappedJavaFileManager_h_