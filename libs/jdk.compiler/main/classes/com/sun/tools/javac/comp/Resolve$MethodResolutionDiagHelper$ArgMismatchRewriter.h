...
class $export Resolve$MethodResolutionDiagHelper$ArgMismatchRewriter : public ::com::sun::tools::javac::comp::Resolve$MethodResolutionDiagHelper$DiagnosticRewriter {
