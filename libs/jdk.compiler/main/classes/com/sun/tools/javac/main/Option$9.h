#ifndef _com_sun_tools_javac_main_Option$9_h_
#define _com_sun_tools_javac_main_Option$9_h_
//$ class com.sun.tools.javac.main.Option$9
...
class Option$9 : public ::com::sun::tools::javac::main::Option {
	$class(Option$9, $NO_CLASS_INIT, ::com::sun::tools::javac::main::Option)
public:
	Option$9();
...
#endif // _com_sun_tools_javac_main_Option$9_h_