...
$Object* JCTree$JCWhileLoop::accept($TreeVisitor* v, Object$* d) {
	return $nc(v)->visitWhileLoop(this, d);
}
...
$Class* JCTree$JCWhileLoop::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"<init>", "(Lcom/sun/tools/javac/tree/JCTree$JCExpression;Lcom/sun/tools/javac/tree/JCTree$JCStatement;)V", nullptr, $PROTECTED, $method(JCTree$JCWhileLoop, init$, void, $JCTree$JCExpression*, $JCTree$JCStatement*)},
		{"accept", "(Lcom/sun/tools/javac/tree/JCTree$Visitor;)V", nullptr, $PUBLIC, $virtualMethod(JCTree$JCWhileLoop, accept, void, $JCTree$Visitor*)},
		{"accept", "(Lcom/sun/source/tree/TreeVisitor;Ljava/lang/Object;)Ljava/lang/Object;", "<R:Ljava/lang/Object;D:Ljava/lang/Object;>(Lcom/sun/source/tree/TreeVisitor<TR;TD;>;TD;)TR;", $PUBLIC, $virtualMethod(JCTree$JCWhileLoop, accept, $Object*, $TreeVisitor*, Object$*)},
		{"getCondition", "()Lcom/sun/tools/javac/tree/JCTree$JCExpression;", nullptr, $PUBLIC, $virtualMethod(JCTree$JCWhileLoop, getCondition, $ExpressionTree*)},
		{"getKind", "()Lcom/sun/source/tree/Tree$Kind;", nullptr, $PUBLIC, $virtualMethod(JCTree$JCWhileLoop, getKind, $Tree$Kind*)},
		{"getStatement", "()Lcom/sun/tools/javac/tree/JCTree$JCStatement;", nullptr, $PUBLIC, $virtualMethod(JCTree$JCWhileLoop, getStatement, $StatementTree*)},
		{"getTag", "()Lcom/sun/tools/javac/tree/JCTree$Tag;", nullptr, $PUBLIC, $virtualMethod(JCTree$JCWhileLoop, getTag, $JCTree$Tag*)},
	...
	$loadClass(JCTree$JCWhileLoop, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
