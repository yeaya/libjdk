#ifndef _com_sun_tools_javac_comp_Operators$BinaryBooleanOperator_h_
#define _com_sun_tools_javac_comp_Operators$BinaryBooleanOperator_h_
//$ class com.sun.tools.javac.comp.Operators$BinaryBooleanOperator
...
class $export Operators$BinaryBooleanOperator : public ::com::sun::tools::javac::comp::Operators$BinaryOperatorHelper {
	$class(Operators$BinaryBooleanOperator, $NO_CLASS_INIT, ::com::sun::tools::javac::comp::Operators$BinaryOperatorHelper)
public:
	Operators$BinaryBooleanOperator();
...
#endif // _com_sun_tools_javac_comp_Operators$BinaryBooleanOperator_h_