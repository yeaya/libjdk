...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::AnonymousClass($Name* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "anonymous.class"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::BadClassFile($Name* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "bad.class.file"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::BadConstantValueType($Type* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "bad.constant.value.type"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::BadEnclosingMethod($Symbol* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "bad.enclosing.method"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::BadIntersectionTargetForFunctionalExpr($JCDiagnostic* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "bad.intersection.target.for.functional.expr"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::CanonicalMustNotHaveStrongerAccess($Set* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "canonical.must.not.have.stronger.access"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::CapturedType(int32_t arg0) {
	$init(CompilerProperties$Fragments);
	$useLocalObjectStack();
	return $new($JCDiagnostic$Fragment, "compiler"_s, "captured.type"_s, $$new($ObjectArray, {$($Integer::valueOf(arg0))}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::ClassFileNotFound($Name* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "class.file.not.found"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::ClassIsNotSealed($String* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "class.is.not.sealed"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::CountError(int32_t arg0) {
	$init(CompilerProperties$Fragments);
	$useLocalObjectStack();
	return $new($JCDiagnostic$Fragment, "compiler"_s, "count.error"_s, $$new($ObjectArray, {$($Integer::valueOf(arg0))}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::CountErrorPlural(int32_t arg0) {
	$init(CompilerProperties$Fragments);
	$useLocalObjectStack();
	return $new($JCDiagnostic$Fragment, "compiler"_s, "count.error.plural"_s, $$new($ObjectArray, {$($Integer::valueOf(arg0))}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::CountWarn(int32_t arg0) {
	$init(CompilerProperties$Fragments);
	$useLocalObjectStack();
	return $new($JCDiagnostic$Fragment, "compiler"_s, "count.warn"_s, $$new($ObjectArray, {$($Integer::valueOf(arg0))}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::CountWarnPlural(int32_t arg0) {
	$init(CompilerProperties$Fragments);
	$useLocalObjectStack();
	return $new($JCDiagnostic$Fragment, "compiler"_s, "count.warn.plural"_s, $$new($ObjectArray, {$($Integer::valueOf(arg0))}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::Diamond($Symbol* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "diamond"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::DiamondAndExplicitParams($Type* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "diamond.and.explicit.params"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::DiamondNonGeneric($Type* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "diamond.non.generic"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::DoesntExtendSealed($Type* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "doesnt.extend.sealed"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::EqBounds($List* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "eq.bounds"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::ExceptionMessage($String* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "exception.message"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::FatalErrCantLocateCtor($Type* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "fatal.err.cant.locate.ctor"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::FatalErrCantLocateField($Name* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "fatal.err.cant.locate.field"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::FatalErrCantLocateMeth($Name* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "fatal.err.cant.locate.meth"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::FileDoesNotContainPackage($Symbol* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "file.does.not.contain.package"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::FileDoesntContainClass($Name* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "file.doesnt.contain.class"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::IncompatibleRetTypeInLambda($JCDiagnostic* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "incompatible.ret.type.in.lambda"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::IncompatibleRetTypeInMref($JCDiagnostic* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "incompatible.ret.type.in.mref"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::IncompatibleTypeInConditional($JCDiagnostic* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "incompatible.type.in.conditional"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::IncompatibleTypeInSwitchExpression($JCDiagnostic* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "incompatible.type.in.switch.expression"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::InferArgLengthMismatch($List* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "infer.arg.length.mismatch"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::IntersectionType(int32_t arg0) {
	$init(CompilerProperties$Fragments);
	$useLocalObjectStack();
	return $new($JCDiagnostic$Fragment, "compiler"_s, "intersection.type"_s, $$new($ObjectArray, {$($Integer::valueOf(arg0))}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::IsATypeVariable($Type* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "is.a.type.variable"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::IsDuplicated($Type* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "is.duplicated"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::LowerBounds($List* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "lower.bounds"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::MethodDescriptorInvalid($Name* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "method.descriptor.invalid"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::MissingRetVal($Type* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "missing.ret.val"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::ModuleNonZeroOpens($Name* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "module.non.zero.opens"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::MustNotBeSupertype($Type* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "must.not.be.supertype"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::NoConformingAssignmentExists($JCDiagnostic* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "no.conforming.assignment.exists"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::NoSuitableFunctionalIntfInst($Type* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "no.suitable.functional.intf.inst"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::NotAFunctionalIntf($Symbol* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "not.a.functional.intf"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::NotAnIntfComponent($Symbol* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "not.an.intf.component"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::PartialInstSig($Type* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "partial.inst.sig"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::ProbFoundReq($JCDiagnostic* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "prob.found.req"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::ThrowsClauseNotAllowedForCanonicalConstructor($JCDiagnostic$Fragment* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "throws.clause.not.allowed.for.canonical.constructor"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::TryNotApplicableToType($JCDiagnostic* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "try.not.applicable.to.type"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::TypeParameter($Type* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "type.parameter"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::UpperBounds($List* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "upper.bounds"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::VarargsArgumentMismatch($JCDiagnostic* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "varargs.argument.mismatch"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::VarargsTrustmeOnNonVarargsAccessor($Symbol* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "varargs.trustme.on.non.varargs.accessor"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::VarargsTrustmeOnNonVarargsMeth($Symbol* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "varargs.trustme.on.non.varargs.meth"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::VarargsTrustmeOnReifiableVarargs($Type* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "varargs.trustme.on.reifiable.varargs"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::VarargsTrustmeOnVirtualVarargs($Symbol* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "varargs.trustme.on.virtual.varargs"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::VarargsTrustmeOnVirtualVarargsFinalOnly($Symbol* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "varargs.trustme.on.virtual.varargs.final.only"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::VerboseCheckingAttribution($Symbol* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "verbose.checking.attribution"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::VerboseClasspath($String* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "verbose.classpath"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::VerboseLoading($String* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "verbose.loading"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::VerboseParsingDone($String* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "verbose.parsing.done"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::VerboseParsingStarted($File* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "verbose.parsing.started"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::VerboseSourcepath($String* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "verbose.sourcepath"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::VerboseTotal($String* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "verbose.total"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::VerboseWroteFile($File* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "verbose.wrote.file"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::WhereDescriptionCaptured1($Set* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "where.description.captured.1"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::WhereDescriptionIntersection($Set* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "where.description.intersection"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::WhereDescriptionIntersection1($Set* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "where.description.intersection.1"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::WhereDescriptionTypevar($Set* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "where.description.typevar"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Fragment* CompilerProperties$Fragments::WhereDescriptionTypevar1($Set* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "where.description.typevar.1"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::WrongNumberTypeArgs($String* arg0) {
	$init(CompilerProperties$Fragments);
	return $new($JCDiagnostic$Fragment, "compiler"_s, "wrong.number.type.args"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Fragment* CompilerProperties$Fragments::XPrintRounds(int32_t arg0, $String* arg1, $Set* arg2, bool arg3) {
	...
	return $new($JCDiagnostic$Fragment, "compiler"_s, "x.print.rounds"_s, $$new($ObjectArray, {
		...
		arg1,
		arg2,
		$($Boolean::valueOf(arg3))
	}));
}

void CompilerProperties$Fragments::clinit$($Class* clazz) {
	$useLocalObjectStack();
...
$Class* CompilerProperties$Fragments::load$($String* name, bool initialize) {
	...
	$loadClass(CompilerProperties$Fragments, name, initialize, &classInfo$$, CompilerProperties$Fragments::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(CompilerProperties$Fragments);
	});
	return class$;
}
