...
$Class* Scope$FilterImportScope$$Lambda$lambda$getSymbols$1::load$($String* name, bool initialize) {
	...
	$loadClass(Scope$FilterImportScope$$Lambda$lambda$getSymbols$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Scope$FilterImportScope$$Lambda$lambda$getSymbols$1);
	});
	return class$;
}
...
$Class* Scope$FilterImportScope$$Lambda$lambda$getSymbolsByName$3$1::load$($String* name, bool initialize) {
	...
	$loadClass(Scope$FilterImportScope$$Lambda$lambda$getSymbolsByName$3$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Scope$FilterImportScope$$Lambda$lambda$getSymbolsByName$3$1);
	});
	return class$;
}
...
$Class* Scope$FilterImportScope$$Lambda$iterator$2::load$($String* name, bool initialize) {
	...
	$loadClass(Scope$FilterImportScope$$Lambda$iterator$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Scope$FilterImportScope$$Lambda$iterator$2);
	});
	return class$;
}
...
$Class* Scope$FilterImportScope$$Lambda$lambda$getSymbols$0$3::load$($String* name, bool initialize) {
	...
	$loadClass(Scope$FilterImportScope$$Lambda$lambda$getSymbols$0$3, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Scope$FilterImportScope$$Lambda$lambda$getSymbols$0$3);
	});
	return class$;
}
...
$Iterable* Scope$FilterImportScope::getSymbols($Predicate* sf, $Scope$LookupKind* lookupKind) {
	...
	try {
		...
		return $new(Scope$FilterImportScope$$Lambda$lambda$getSymbols$1, this, results);
...
$Iterable* Scope$FilterImportScope::getSymbolsByName($Name* name, $Predicate* sf, $Scope$LookupKind* lookupKind) {
	...
	try {
		...
		$var($List, results, si->importFrom($cast($Symbol$TypeSymbol, $nc(this->origin)->owner), $($List::nil())));
		return $new(Scope$FilterImportScope$$Lambda$lambda$getSymbolsByName$3$1, this, results);
	} catch ($Symbol$CompletionFailure& cf) {
		$nc(this->cfHandler)->accept(this->imp, cf);
		return $Collections::emptyList();
	}
...
$Iterator* Scope$FilterImportScope::lambda$getSymbolsByName$3($List* results) {
	$useLocalObjectStack();
	$var($Iterator, var$0, $Iterators::createCompoundIterator($cast($AbstractCollection, results), $$new(Scope$FilterImportScope$$Lambda$iterator$2)));
	return $Iterators::createFilterIterator(var$0, $$new(Scope$FilterImportScope$$Lambda$lambda$getSymbols$0$3, this));
}
...
$Class* Scope$FilterImportScope::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("com.sun.tools.javac.code.Scope$FilterImportScope$$Lambda$lambda$getSymbols$1")) {
			return Scope$FilterImportScope$$Lambda$lambda$getSymbols$1::load$(name, initialize);
		}
		if (name->equals("com.sun.tools.javac.code.Scope$FilterImportScope$$Lambda$lambda$getSymbolsByName$3$1")) {
			return Scope$FilterImportScope$$Lambda$lambda$getSymbolsByName$3$1::load$(name, initialize);
		}
		if (name->equals("com.sun.tools.javac.code.Scope$FilterImportScope$$Lambda$iterator$2")) {
			return Scope$FilterImportScope$$Lambda$iterator$2::load$(name, initialize);
		}
		if (name->equals("com.sun.tools.javac.code.Scope$FilterImportScope$$Lambda$lambda$getSymbols$0$3")) {
	...
	$loadClass(Scope$FilterImportScope, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Scope$FilterImportScope);
	});
	return class$;
}
