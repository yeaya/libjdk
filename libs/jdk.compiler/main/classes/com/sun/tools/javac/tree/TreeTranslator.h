#ifndef _com_sun_tools_javac_tree_TreeTranslator_h_
#define _com_sun_tools_javac_tree_TreeTranslator_h_
//$ class com.sun.tools.javac.tree.TreeTranslator
...
class $export TreeTranslator : public ::com::sun::tools::javac::tree::JCTree$Visitor {
	$class(TreeTranslator, $NO_CLASS_INIT, ::com::sun::tools::javac::tree::JCTree$Visitor)
public:
	TreeTranslator();
	void init$();
	virtual ::com::sun::tools::javac::tree::JCTree* translate(::com::sun::tools::javac::tree::JCTree* tree);
	virtual ::com::sun::tools::javac::util::List* translate(::com::sun::tools::javac::util::List* trees);
	virtual ::com::sun::tools::javac::util::List* translateAnnotations(::com::sun::tools::javac::util::List* trees);
	virtual ::com::sun::tools::javac::util::List* translateCases(::com::sun::tools::javac::util::List* trees);
	virtual ::com::sun::tools::javac::util::List* translateCatchers(::com::sun::tools::javac::util::List* trees);
	virtual ::com::sun::tools::javac::util::List* translateTypeParams(::com::sun::tools::javac::util::List* trees);
	virtual ::com::sun::tools::javac::util::List* translateVarDefs(::com::sun::tools::javac::util::List* trees);
...
#endif // _com_sun_tools_javac_tree_TreeTranslator_h_