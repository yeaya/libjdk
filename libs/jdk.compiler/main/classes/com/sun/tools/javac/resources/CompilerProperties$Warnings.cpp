...
$JCDiagnostic$Warning* CompilerProperties$Warnings::AccessToMemberFromSerializableElement($Symbol* arg0) {
	...
	return $new($JCDiagnostic$Warning, "compiler"_s, "access.to.member.from.serializable.element"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::AccessToMemberFromSerializableLambda($Symbol* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "access.to.member.from.serializable.lambda"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::ConstantSVUID($Symbol* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "constant.SVUID"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::DeprecatedAnnotationHasNoEffect($Kinds$KindName* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "deprecated.annotation.has.no.effect"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::DirPathElementNotDirectory($File* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "dir.path.element.not.directory"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::DirPathElementNotFound($Path* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "dir.path.element.not.found"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::FileFromFuture($File* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "file.from.future"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::ForwardRef($Symbol* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "forward.ref"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::HasBeenDeprecatedForRemovalModule($Symbol* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "has.been.deprecated.for.removal.module"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::HasBeenDeprecatedModule($Symbol* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "has.been.deprecated.module"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::IllegalRefToRestrictedType($Name* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "illegal.ref.to.restricted.type"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::ImproperSVUID($Symbol* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "improper.SVUID"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::IncubatingModules($String* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "incubating.modules"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::InvalidArchiveFile($Path* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "invalid.archive.file"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::InvalidPath($String* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "invalid.path"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::IsPreview($Symbol* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "is.preview"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::IsPreviewReflective($Symbol* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "is.preview.reflective"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::LintOption($Option* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "lintOption"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::LocnUnknownFileOnModulePath($Path* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "locn.unknown.file.on.module.path"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::LongSVUID($Symbol* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "long.SVUID"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::MissingSVUID($Symbol* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "missing.SVUID"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::ModuleNotFound($Symbol* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "module.not.found"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::OptionObsoleteSource($String* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "option.obsolete.source"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::OptionObsoleteTarget($Target* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "option.obsolete.target"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::OutdirIsInExplodedModule($Path* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "outdir.is.in.exploded.module"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::OverrideBridge($JCDiagnostic* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "override.bridge"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::OverrideEqualsButNotHashcode($Symbol* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "override.equals.but.not.hashcode"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::OverrideVarargsExtra($JCDiagnostic* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "override.varargs.extra"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::OverrideVarargsMissing($JCDiagnostic* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "override.varargs.missing"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::PackageEmptyOrNotFound($Symbol* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "package.empty.or.not.found"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::PathElementNotFound($Path* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "path.element.not.found"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::PkgInfoAlreadySeen($Symbol* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "pkg-info.already.seen"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::PoorChoiceForModuleName($Name* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "poor.choice.for.module.name"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::PositionOverflow(int32_t arg0) {
	$init(CompilerProperties$Warnings);
	$useLocalObjectStack();
	return $new($JCDiagnostic$Warning, "compiler"_s, "position.overflow"_s, $$new($ObjectArray, {$($Integer::valueOf(arg0))}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::PreviewFeatureUse($JCDiagnostic* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "preview.feature.use"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::PreviewFeatureUsePlural($JCDiagnostic* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "preview.feature.use.plural"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::ProcAnnotationsWithoutProcessors($Set* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "proc.annotations.without.processors"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::ProcFileCreateLastRound($String* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "proc.file.create.last.round"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::ProcFileReopening($String* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "proc.file.reopening"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::ProcIllegalFileName($String* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "proc.illegal.file.name"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::ProcMessager($String* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "proc.messager"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::ProcPackageDoesNotExist($String* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "proc.package.does.not.exist"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::ProcRedundantTypesWithWildcard($String* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "proc.redundant.types.with.wildcard"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::ProcTypeAlreadyExists($String* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "proc.type.already.exists"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::ProcTypeRecreate($String* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "proc.type.recreate"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::ProcUnclosedTypeFiles($Set* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "proc.unclosed.type.files"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::ProcUnmatchedProcessorOptions($String* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "proc.unmatched.processor.options"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::RedundantCast($Type* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "redundant.cast"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::SelfRef($Symbol* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "self.ref"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::ServiceProvidedButNotExportedOrUsed($Symbol* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "service.provided.but.not.exported.or.used"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::SourceNoBootclasspath($String* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "source.no.bootclasspath"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::SourceNoSystemModulesPath($String* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "source.no.system.modules.path"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::SunProprietary($Symbol* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "sun.proprietary"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::TryResourceNotReferenced($Symbol* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "try.resource.not.referenced"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::TryResourceThrowsInterruptedExc($Type* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "try.resource.throws.interrupted.exc"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::UncheckedGenericArrayCreation($Type* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "unchecked.generic.array.creation"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::UncheckedVarargsNonReifiableType($Type* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "unchecked.varargs.non.reifiable.type"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::UnexpectedArchiveFile($Path* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "unexpected.archive.file"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::UnreachableCatch($List* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "unreachable.catch"_s, $$new($ObjectArray, {arg0}));
}

$JCDiagnostic$Warning* CompilerProperties$Warnings::UnreachableCatch1($List* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "unreachable.catch.1"_s, $$new($ObjectArray, {arg0}));
}
...
$JCDiagnostic$Warning* CompilerProperties$Warnings::VarargsUnsafeUseVarargsParam($Symbol* arg0) {
	$init(CompilerProperties$Warnings);
	return $new($JCDiagnostic$Warning, "compiler"_s, "varargs.unsafe.use.varargs.param"_s, $$new($ObjectArray, {arg0}));
}

void CompilerProperties$Warnings::clinit$($Class* clazz) {
	$useLocalObjectStack();
...
$Class* CompilerProperties$Warnings::load$($String* name, bool initialize) {
	...
	$loadClass(CompilerProperties$Warnings, name, initialize, &classInfo$$, CompilerProperties$Warnings::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(CompilerProperties$Warnings);
	});
	return class$;
}
