#ifndef _com_sun_tools_javac_code_DeferredCompletionFailureHandler$2_h_
#define _com_sun_tools_javac_code_DeferredCompletionFailureHandler$2_h_
//$ class com.sun.tools.javac.code.DeferredCompletionFailureHandler$2
...
class DeferredCompletionFailureHandler$2 : public ::com::sun::tools::javac::code::DeferredCompletionFailureHandler$Handler {
	$class(DeferredCompletionFailureHandler$2, $NO_CLASS_INIT, ::com::sun::tools::javac::code::DeferredCompletionFailureHandler$Handler)
public:
	DeferredCompletionFailureHandler$2();
	...
	static void lambda$uninstall$0(::com::sun::tools::javac::code::DeferredCompletionFailureHandler$FlipSymbolDescription* f);
...
#endif // _com_sun_tools_javac_code_DeferredCompletionFailureHandler$2_h_