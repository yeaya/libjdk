#ifndef _com_sun_tools_javac_main_Option$3_h_
#define _com_sun_tools_javac_main_Option$3_h_
//$ class com.sun.tools.javac.main.Option$3
...
class Option$3 : public ::com::sun::tools::javac::main::Option {
	$class(Option$3, $NO_CLASS_INIT, ::com::sun::tools::javac::main::Option)
public:
	Option$3();
	...
	virtual bool matches($String* option) override;
...
#endif // _com_sun_tools_javac_main_Option$3_h_