#ifndef _com_sun_tools_javac_jvm_ClassReader$7_h_
#define _com_sun_tools_javac_jvm_ClassReader$7_h_
//$ class com.sun.tools.javac.jvm.ClassReader$7
...
class ClassReader$7 : public ::com::sun::tools::javac::jvm::ClassReader$AttributeReader {
	$class(ClassReader$7, $NO_CLASS_INIT, ::com::sun::tools::javac::jvm::ClassReader$AttributeReader)
public:
	ClassReader$7();
...
#endif // _com_sun_tools_javac_jvm_ClassReader$7_h_