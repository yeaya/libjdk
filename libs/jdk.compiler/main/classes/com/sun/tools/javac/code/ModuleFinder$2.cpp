...
void ModuleFinder$2::clinit$($Class* clazz) {
	$useLocalObjectStack();
	$assignStatic(ModuleFinder$2::$SwitchMap$javax$tools$StandardLocation, $new($ints, $($StandardLocation::values())->length));
	{
		try {
			ModuleFinder$2::$SwitchMap$javax$tools$StandardLocation->set($StandardLocation::MODULE_PATH->ordinal(), 1);
		} catch ($NoSuchFieldError& ex) {
		}
		try {
			ModuleFinder$2::$SwitchMap$javax$tools$StandardLocation->set($StandardLocation::MODULE_SOURCE_PATH->ordinal(), 2);
		} catch ($NoSuchFieldError& ex) {
		}
		try {
			ModuleFinder$2::$SwitchMap$javax$tools$StandardLocation->set($StandardLocation::SYSTEM_MODULES->ordinal(), 3);
		} catch ($NoSuchFieldError& ex) {
		}
		try {
			ModuleFinder$2::$SwitchMap$javax$tools$StandardLocation->set($StandardLocation::UPGRADE_MODULE_PATH->ordinal(), 4);
		} catch ($NoSuchFieldError& ex) {
		}
	}
	...
	{
		try {
			ModuleFinder$2::$SwitchMap$javax$tools$JavaFileObject$Kind->set($JavaFileObject$Kind::SOURCE->ordinal(), 1);
		} catch ($NoSuchFieldError& ex) {
		}
		try {
			ModuleFinder$2::$SwitchMap$javax$tools$JavaFileObject$Kind->set($JavaFileObject$Kind::CLASS->ordinal(), 2);
		} catch ($NoSuchFieldError& ex) {
		}
	}
}
...
$Class* ModuleFinder$2::load$($String* name, bool initialize) {
	...
	$loadClass(ModuleFinder$2, name, initialize, &classInfo$$, ModuleFinder$2::clinit$, []($Class* clazz) -> $Object* {
