#ifndef _com_sun_tools_javac_comp_Attr$3_h_
#define _com_sun_tools_javac_comp_Attr$3_h_
//$ class com.sun.tools.javac.comp.Attr$3
...
class Attr$3 : public ::com::sun::tools::javac::comp::Check$NestedCheckContext {
	$class(Attr$3, $NO_CLASS_INIT, ::com::sun::tools::javac::comp::Check$NestedCheckContext)
public:
	Attr$3();
...
#endif // _com_sun_tools_javac_comp_Attr$3_h_