#ifndef _com_sun_tools_javac_main_Option$5_h_
#define _com_sun_tools_javac_main_Option$5_h_
//$ class com.sun.tools.javac.main.Option$5
...
class Option$5 : public ::com::sun::tools::javac::main::Option {
	$class(Option$5, $NO_CLASS_INIT, ::com::sun::tools::javac::main::Option)
public:
	Option$5();
...
#endif // _com_sun_tools_javac_main_Option$5_h_