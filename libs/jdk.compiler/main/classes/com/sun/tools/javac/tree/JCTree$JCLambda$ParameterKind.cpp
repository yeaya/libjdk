...
void JCTree$JCLambda$ParameterKind::clinit$($Class* clazz) {
...
$Class* JCTree$JCLambda$ParameterKind::load$($String* name, bool initialize) {
	...
	$loadClass(JCTree$JCLambda$ParameterKind, name, initialize, &classInfo$$, JCTree$JCLambda$ParameterKind::clinit$, []($Class* clazz) -> $Object* {
