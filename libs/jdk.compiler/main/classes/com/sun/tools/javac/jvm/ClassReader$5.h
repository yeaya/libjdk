#ifndef _com_sun_tools_javac_jvm_ClassReader$5_h_
#define _com_sun_tools_javac_jvm_ClassReader$5_h_
//$ class com.sun.tools.javac.jvm.ClassReader$5
...
class ClassReader$5 : public ::com::sun::tools::javac::jvm::ClassReader$AttributeReader {
	$class(ClassReader$5, $NO_CLASS_INIT, ::com::sun::tools::javac::jvm::ClassReader$AttributeReader)
public:
	ClassReader$5();
...
#endif // _com_sun_tools_javac_jvm_ClassReader$5_h_