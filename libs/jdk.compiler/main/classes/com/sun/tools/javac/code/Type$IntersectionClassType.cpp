...
$MethodInfo _Type$IntersectionClassType_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/tools/javac/util/List;Lcom/sun/tools/javac/code/Symbol$ClassSymbol;Z)V", "(Lcom/sun/tools/javac/util/List<Lcom/sun/tools/javac/code/Type;>;Lcom/sun/tools/javac/code/Symbol$ClassSymbol;Z)V", $PUBLIC, $method(Type$IntersectionClassType, init$, void, $List*, $Symbol$ClassSymbol*, bool)},
	...
	{"getBounds", "()Ljava/util/List;", "()Ljava/util/List<+Ljavax/lang/model/type/TypeMirror;>;", $PUBLIC, $virtualMethod(Type$IntersectionClassType, getBounds, $1List*)},
	{"getComponents", "()Lcom/sun/tools/javac/util/List;", "()Lcom/sun/tools/javac/util/List<Lcom/sun/tools/javac/code/Type;>;", $PUBLIC, $virtualMethod(Type$IntersectionClassType, getComponents, $List*)},
	{"getExplicitComponents", "()Lcom/sun/tools/javac/util/List;", "()Lcom/sun/tools/javac/util/List<Lcom/sun/tools/javac/code/Type;>;", $PUBLIC, $virtualMethod(Type$IntersectionClassType, getExplicitComponents, $List*)},
