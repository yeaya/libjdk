...
void Scope$ScopeImpl$2::init$($Scope$ScopeImpl* this$0, $Name* val$name, $Predicate* val$sf, $Scope$LookupKind* val$lookupKind) {
	...
	this->seenRemoveCount = $nc(this->currentEntry)->scope != nullptr ? this->currentEntry->scope->removeCount : -1;
}

bool Scope$ScopeImpl$2::hasNext() {
	if ($nc(this->currentEntry)->scope != nullptr && this->seenRemoveCount != this->currentEntry->scope->removeCount && !this->currentEntry->scope->includes(this->currentEntry->sym)) {
		doNext();
	}
	$init($Scope$LookupKind);
	return $nc(this->currentEntry)->scope != nullptr && (this->val$lookupKind == $Scope$LookupKind::RECURSIVE || this->currentEntry->scope == this->this$0);
}
...
$Class* Scope$ScopeImpl$2::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "(Lcom/sun/tools/javac/code/Scope$ScopeImpl;Lcom/sun/tools/javac/util/Name;Ljava/util/function/Predicate;Lcom/sun/tools/javac/code/Scope$LookupKind;)V", "()V", 0, $method(Scope$ScopeImpl$2, init$, void, $Scope$ScopeImpl*, $Name*, $Predicate*, $Scope$LookupKind*)},
		{"doNext", "()Lcom/sun/tools/javac/code/Symbol;", nullptr, $PRIVATE, $method(Scope$ScopeImpl$2, doNext, $Symbol*)},
		{"hasNext", "()Z", nullptr, $PUBLIC, $virtualMethod(Scope$ScopeImpl$2, hasNext, bool)},
		{"next", "()Lcom/sun/tools/javac/code/Symbol;", nullptr, $PUBLIC, $virtualMethod(Scope$ScopeImpl$2, next, $Object*)},
		{"remove", "()V", nullptr, $PUBLIC, $virtualMethod(Scope$ScopeImpl$2, remove, void)},
		{}
	};
	...
	$loadClass(Scope$ScopeImpl$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Scope$ScopeImpl$2);
	});
	return class$;
}
