...
$Class* ClassFinder$BadClassFile$$Lambda$lambda$new$0::load$($String* name, bool initialize) {
	...
	$loadClass(ClassFinder$BadClassFile$$Lambda$lambda$new$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(ClassFinder$BadClassFile$$Lambda$lambda$new$0);
	});
	return class$;
}
...
void ClassFinder$BadClassFile::init$($Symbol$TypeSymbol* sym, $JavaFileObject* file, $JCDiagnostic* diag, $JCDiagnostic$Factory* diagFactory, $DeferredCompletionFailureHandler* dcfh) {
	$Symbol$CompletionFailure::init$(sym, $$new(ClassFinder$BadClassFile$$Lambda$lambda$new$0, file, diag, diagFactory), dcfh);
}
...
$Class* ClassFinder$BadClassFile::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("com.sun.tools.javac.code.ClassFinder$BadClassFile$$Lambda$lambda$new$0")) {
	...
	$loadClass(ClassFinder$BadClassFile, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(ClassFinder$BadClassFile);
	});
	return class$;
}
