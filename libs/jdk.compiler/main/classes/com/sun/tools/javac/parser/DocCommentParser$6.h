#ifndef _com_sun_tools_javac_parser_DocCommentParser$6_h_
#define _com_sun_tools_javac_parser_DocCommentParser$6_h_
//$ class com.sun.tools.javac.parser.DocCommentParser$6
...
class DocCommentParser$6 : public ::com::sun::tools::javac::parser::DocCommentParser$TagParser {
	$class(DocCommentParser$6, $NO_CLASS_INIT, ::com::sun::tools::javac::parser::DocCommentParser$TagParser)
public:
	DocCommentParser$6();
...
#endif // _com_sun_tools_javac_parser_DocCommentParser$6_h_