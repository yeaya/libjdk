...
$Class* DeferredAttr$$Lambda$lambda$attribSpeculativeLambda$0::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(DeferredAttr$$Lambda$lambda$attribSpeculativeLambda$0, init$, void)},
		{"test", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC, $virtualMethod(DeferredAttr$$Lambda$lambda$attribSpeculativeLambda$0, test, bool, Object$*)},
		{}
	};
	$ClassInfo classInfo$$ = {
		$PUBLIC | $FINAL,
	...
	$loadClass(DeferredAttr$$Lambda$lambda$attribSpeculativeLambda$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DeferredAttr$$Lambda$lambda$attribSpeculativeLambda$0);
	});
	return class$;
}
...
$Class* DeferredAttr$$Lambda$lambda$attribSpeculativeLambda$1$1::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "()V", nullptr, $PUBLIC, $method(DeferredAttr$$Lambda$lambda$attribSpeculativeLambda$1$1, init$, void)},
		{"apply", "(Ljava/lang/Object;)Ljava/lang/Object;", nullptr, $PUBLIC, $virtualMethod(DeferredAttr$$Lambda$lambda$attribSpeculativeLambda$1$1, apply, $Object*, Object$*)},
		{}
	};
	$ClassInfo classInfo$$ = {
		$PUBLIC | $FINAL,
	...
	$loadClass(DeferredAttr$$Lambda$lambda$attribSpeculativeLambda$1$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(DeferredAttr$$Lambda$lambda$attribSpeculativeLambda$1$1);
	});
	return class$;
}
...
void DeferredAttr::init$($Context* context) {
	...
	$nc(context)->put(DeferredAttr::deferredAttrKey, this);
...
$JCTree$JCLambda* DeferredAttr::attribSpeculativeLambda($JCTree$JCLambda* that, $Env* env, $Attr$ResultInfo* resultInfo) {
	...
	stats->addAll($cast($AbstractCollection, $nc(that)->params));
	...
	$var($JCTree$JCBlock, lambdaBlock, $$nc($nc(this->make)->at(that->pos$))->Block(0, $(stats->toList())));
	...
	try {
		...
		$var($List, args, $cast($List, $$nc($$nc($$nc($$sure($List, $nc(speculativeTree)->getStatements())->stream())->filter($$new(DeferredAttr$$Lambda$lambda$attribSpeculativeLambda$0)))->map($$new(DeferredAttr$$Lambda$lambda$attribSpeculativeLambda$1$1)))->collect($($List::collector()))));
		$var($JCTree, lambdaBody, $cast($JCTree, $$sure($List, speculativeTree->getStatements())->last()));
		$init($JCTree$Tag);
		if ($nc(lambdaBody)->hasTag($JCTree$Tag::RETURN)) {
			$assign(lambdaBody, $cast($JCTree$JCReturn, lambdaBody)->expr);
		}
		$var($JCTree$JCLambda, speculativeLambda, this->make->Lambda(args, lambdaBody));
...
$JCTree* DeferredAttr::attribSpeculative($JCTree* tree, $Env* env, $Attr$ResultInfo* resultInfo, $Supplier* diagHandlerCreator, $DeferredAttr$AttributionMode* attributionMode, $ArgumentAttr$LocalCacheContext* localCache) {
	$useLocalObjectStack();
	$var($Env, speculativeEnv, $nc(env)->dup(tree, $($nc($cast($AttrContext, $nc(env)->info))->dup($($nc($nc(($cast($AttrContext, $nc(env)->info)))->scope)->dupUnshared($nc($nc(($cast($AttrContext, $nc(env)->info)))->scope)->owner))))));
	$set($nc($cast($AttrContext, $nc(speculativeEnv)->info)), attributionMode, attributionMode);
	$var($Log$DiagnosticHandler, deferredDiagnosticHandler, diagHandlerCreator != nullptr ? $cast($Log$DiagnosticHandler, diagHandlerCreator->get()) : $cast($Log$DiagnosticHandler, $new($DeferredAttr$DeferredAttrDiagHandler, this->log, tree)));
...
void DeferredAttr::clinit$($Class* clazz) {
...
$Class* DeferredAttr::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("com.sun.tools.javac.comp.DeferredAttr$$Lambda$lambda$attribSpeculativeLambda$0")) {
			return DeferredAttr$$Lambda$lambda$attribSpeculativeLambda$0::load$(name, initialize);
		}
		if (name->equals("com.sun.tools.javac.comp.DeferredAttr$$Lambda$lambda$attribSpeculativeLambda$1$1")) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "(Lcom/sun/tools/javac/util/Context;)V", nullptr, $PROTECTED, $method(DeferredAttr, init$, void, $Context*)},
		{"attribSpeculative", "(Lcom/sun/tools/javac/tree/JCTree;Lcom/sun/tools/javac/comp/Env;Lcom/sun/tools/javac/comp/Attr$ResultInfo;)Lcom/sun/tools/javac/tree/JCTree;", "(Lcom/sun/tools/javac/tree/JCTree;Lcom/sun/tools/javac/comp/Env<Lcom/sun/tools/javac/comp/AttrContext;>;Lcom/sun/tools/javac/comp/Attr$ResultInfo;)Lcom/sun/tools/javac/tree/JCTree;", 0, $virtualMethod(DeferredAttr, attribSpeculative, $JCTree*, $JCTree*, $Env*, $Attr$ResultInfo*)},
		{"attribSpeculative", "(Lcom/sun/tools/javac/tree/JCTree;Lcom/sun/tools/javac/comp/Env;Lcom/sun/tools/javac/comp/Attr$ResultInfo;Lcom/sun/tools/javac/comp/ArgumentAttr$LocalCacheContext;)Lcom/sun/tools/javac/tree/JCTree;", "(Lcom/sun/tools/javac/tree/JCTree;Lcom/sun/tools/javac/comp/Env<Lcom/sun/tools/javac/comp/AttrContext;>;Lcom/sun/tools/javac/comp/Attr$ResultInfo;Lcom/sun/tools/javac/comp/ArgumentAttr$LocalCacheContext;)Lcom/sun/tools/javac/tree/JCTree;", 0, $virtualMethod(DeferredAttr, attribSpeculative, $JCTree*, $JCTree*, $Env*, $Attr$ResultInfo*, $ArgumentAttr$LocalCacheContext*)},
		{"attribSpeculative", "(Lcom/sun/tools/javac/tree/JCTree;Lcom/sun/tools/javac/comp/Env;Lcom/sun/tools/javac/comp/Attr$ResultInfo;Lcom/sun/tools/javac/tree/TreeCopier;Ljava/util/function/Supplier;Lcom/sun/tools/javac/comp/DeferredAttr$AttributionMode;Lcom/sun/tools/javac/comp/ArgumentAttr$LocalCacheContext;)Lcom/sun/tools/javac/tree/JCTree;", "<Z:Ljava/lang/Object;>(Lcom/sun/tools/javac/tree/JCTree;Lcom/sun/tools/javac/comp/Env<Lcom/sun/tools/javac/comp/AttrContext;>;Lcom/sun/tools/javac/comp/Attr$ResultInfo;Lcom/sun/tools/javac/tree/TreeCopier<TZ;>;Ljava/util/function/Supplier<Lcom/sun/tools/javac/util/Log$DiagnosticHandler;>;Lcom/sun/tools/javac/comp/DeferredAttr$AttributionMode;Lcom/sun/tools/javac/comp/ArgumentAttr$LocalCacheContext;)Lcom/sun/tools/javac/tree/JCTree;", 0, $virtualMethod(DeferredAttr, attribSpeculative, $JCTree*, $JCTree*, $Env*, $Attr$ResultInfo*, $TreeCopier*, $Supplier*, $DeferredAttr$AttributionMode*, $ArgumentAttr$LocalCacheContext*)},
		{"attribSpeculative", "(Lcom/sun/tools/javac/tree/JCTree;Lcom/sun/tools/javac/comp/Env;Lcom/sun/tools/javac/comp/Attr$ResultInfo;Ljava/util/function/Supplier;Lcom/sun/tools/javac/comp/DeferredAttr$AttributionMode;Lcom/sun/tools/javac/comp/ArgumentAttr$LocalCacheContext;)Lcom/sun/tools/javac/tree/JCTree;", "<Z:Ljava/lang/Object;>(Lcom/sun/tools/javac/tree/JCTree;Lcom/sun/tools/javac/comp/Env<Lcom/sun/tools/javac/comp/AttrContext;>;Lcom/sun/tools/javac/comp/Attr$ResultInfo;Ljava/util/function/Supplier<Lcom/sun/tools/javac/util/Log$DiagnosticHandler;>;Lcom/sun/tools/javac/comp/DeferredAttr$AttributionMode;Lcom/sun/tools/javac/comp/ArgumentAttr$LocalCacheContext;)Lcom/sun/tools/javac/tree/JCTree;", 0, $virtualMethod(DeferredAttr, attribSpeculative, $JCTree*, $JCTree*, $Env*, $Attr$ResultInfo*, $Supplier*, $DeferredAttr$AttributionMode*, $ArgumentAttr$LocalCacheContext*)},
		{"attribSpeculativeLambda", "(Lcom/sun/tools/javac/tree/JCTree$JCLambda;Lcom/sun/tools/javac/comp/Env;Lcom/sun/tools/javac/comp/Attr$ResultInfo;)Lcom/sun/tools/javac/tree/JCTree$JCLambda;", "(Lcom/sun/tools/javac/tree/JCTree$JCLambda;Lcom/sun/tools/javac/comp/Env<Lcom/sun/tools/javac/comp/AttrContext;>;Lcom/sun/tools/javac/comp/Attr$ResultInfo;)Lcom/sun/tools/javac/tree/JCTree$JCLambda;", 0, $virtualMethod(DeferredAttr, attribSpeculativeLambda, $JCTree$JCLambda*, $JCTree$JCLambda*, $Env*, $Attr$ResultInfo*)},
		{"instance", "(Lcom/sun/tools/javac/util/Context;)Lcom/sun/tools/javac/comp/DeferredAttr;", nullptr, $PUBLIC | $STATIC, $staticMethod(DeferredAttr, instance, DeferredAttr*, $Context*)},
		{"lambda$attribSpeculativeLambda$0", "(Lcom/sun/tools/javac/tree/JCTree$JCStatement;)Z", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $staticMethod(DeferredAttr, lambda$attribSpeculativeLambda$0, bool, $JCTree$JCStatement*)},
		{"lambda$attribSpeculativeLambda$1", "(Lcom/sun/tools/javac/tree/JCTree$JCStatement;)Lcom/sun/tools/javac/tree/JCTree$JCVariableDecl;", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $staticMethod(DeferredAttr, lambda$attribSpeculativeLambda$1, $JCTree$JCVariableDecl*, $JCTree$JCStatement*)},
		{}
	};
	...
	$loadClass(DeferredAttr, name, initialize, &classInfo$$, DeferredAttr::clinit$, []($Class* clazz) -> $Object* {
		return $alloc(DeferredAttr);
	});
	return class$;
}
