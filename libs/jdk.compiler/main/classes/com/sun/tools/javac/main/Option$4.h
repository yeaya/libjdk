#ifndef _com_sun_tools_javac_main_Option$4_h_
#define _com_sun_tools_javac_main_Option$4_h_
//$ class com.sun.tools.javac.main.Option$4
...
class Option$4 : public ::com::sun::tools::javac::main::Option {
	$class(Option$4, $NO_CLASS_INIT, ::com::sun::tools::javac::main::Option)
public:
	Option$4();
...
#endif // _com_sun_tools_javac_main_Option$4_h_