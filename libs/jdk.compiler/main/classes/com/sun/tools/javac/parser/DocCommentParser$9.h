#ifndef _com_sun_tools_javac_parser_DocCommentParser$9_h_
#define _com_sun_tools_javac_parser_DocCommentParser$9_h_
//$ class com.sun.tools.javac.parser.DocCommentParser$9
...
class DocCommentParser$9 : public ::com::sun::tools::javac::parser::DocCommentParser$TagParser {
	$class(DocCommentParser$9, $NO_CLASS_INIT, ::com::sun::tools::javac::parser::DocCommentParser$TagParser)
public:
	DocCommentParser$9();
...
#endif // _com_sun_tools_javac_parser_DocCommentParser$9_h_