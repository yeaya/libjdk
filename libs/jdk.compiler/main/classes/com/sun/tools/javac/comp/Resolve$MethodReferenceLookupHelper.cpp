...
$Resolve$ReferenceLookupHelper* Resolve$MethodReferenceLookupHelper::unboundLookup($InferenceContext* inferenceContext) {
	if ($TreeInfo::isStaticSelector($nc(this->referenceTree)->expr, this->this$0->names)) {
		...
		if (var$0) {
			$init($TypeTag);
			bool var$1 = $nc($cast($Type, this->argtypes->head))->hasTag($TypeTag::NONE);
			var$0 = var$1 || $nc(this->this$0->types)->isSubtypeUnchecked($($nc(inferenceContext)->asUndetVar($cast($Type, this->argtypes->head))), this->originalSite);
		}
		if (var$0) {
...
$Class* Resolve$MethodReferenceLookupHelper::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		{"<init>", "(Lcom/sun/tools/javac/comp/Resolve;Lcom/sun/tools/javac/tree/JCTree$JCMemberReference;Lcom/sun/tools/javac/util/Name;Lcom/sun/tools/javac/code/Type;Lcom/sun/tools/javac/util/List;Lcom/sun/tools/javac/util/List;Lcom/sun/tools/javac/comp/Resolve$MethodResolutionPhase;)V", "(Lcom/sun/tools/javac/tree/JCTree$JCMemberReference;Lcom/sun/tools/javac/util/Name;Lcom/sun/tools/javac/code/Type;Lcom/sun/tools/javac/util/List<Lcom/sun/tools/javac/code/Type;>;Lcom/sun/tools/javac/util/List<Lcom/sun/tools/javac/code/Type;>;Lcom/sun/tools/javac/comp/Resolve$MethodResolutionPhase;)V", 0, $method(Resolve$MethodReferenceLookupHelper, init$, void, $Resolve*, $JCTree$JCMemberReference*, $Name*, $Type*, $List*, $List*, $Resolve$MethodResolutionPhase*)},
		{"lookup", "(Lcom/sun/tools/javac/comp/Env;Lcom/sun/tools/javac/comp/Resolve$MethodResolutionPhase;)Lcom/sun/tools/javac/code/Symbol;", "(Lcom/sun/tools/javac/comp/Env<Lcom/sun/tools/javac/comp/AttrContext;>;Lcom/sun/tools/javac/comp/Resolve$MethodResolutionPhase;)Lcom/sun/tools/javac/code/Symbol;", $FINAL, $virtualMethod(Resolve$MethodReferenceLookupHelper, lookup, $Symbol*, $Env*, $Resolve$MethodResolutionPhase*)},
		{"referenceKind", "(Lcom/sun/tools/javac/code/Symbol;)Lcom/sun/tools/javac/tree/JCTree$JCMemberReference$ReferenceKind;", nullptr, 0, $virtualMethod(Resolve$MethodReferenceLookupHelper, referenceKind, $JCTree$JCMemberReference$ReferenceKind*, $Symbol*)},
		{"unboundLookup", "(Lcom/sun/tools/javac/comp/InferenceContext;)Lcom/sun/tools/javac/comp/Resolve$ReferenceLookupHelper;", nullptr, 0, $virtualMethod(Resolve$MethodReferenceLookupHelper, unboundLookup, $Resolve$ReferenceLookupHelper*, $InferenceContext*)},
		{}
	};
	...
	$loadClass(Resolve$MethodReferenceLookupHelper, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Resolve$MethodReferenceLookupHelper);
	});
	return class$;
}
