...
$Class* Operators$$Lambda$lambda$resolveUnary$0::load$($String* name, bool initialize) {
	...
	$loadClass(Operators$$Lambda$lambda$resolveUnary$0, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Operators$$Lambda$lambda$resolveUnary$0);
	});
	return class$;
}
...
$Class* Operators$$Lambda$lambda$resolveUnary$1$1::load$($String* name, bool initialize) {
	...
	$loadClass(Operators$$Lambda$lambda$resolveUnary$1$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Operators$$Lambda$lambda$resolveUnary$1$1);
	});
	return class$;
}
...
$Class* Operators$$Lambda$lambda$resolveUnary$2$2::load$($String* name, bool initialize) {
	...
	$loadClass(Operators$$Lambda$lambda$resolveUnary$2$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Operators$$Lambda$lambda$resolveUnary$2$2);
	});
	return class$;
}
...
$Class* Operators$$Lambda$lambda$resolveBinary$3$3::load$($String* name, bool initialize) {
	...
	$loadClass(Operators$$Lambda$lambda$resolveBinary$3$3, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Operators$$Lambda$lambda$resolveBinary$3$3);
	});
	return class$;
}
...
$Class* Operators$$Lambda$lambda$resolveBinary$4$4::load$($String* name, bool initialize) {
	...
	$loadClass(Operators$$Lambda$lambda$resolveBinary$4$4, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Operators$$Lambda$lambda$resolveBinary$4$4);
	});
	return class$;
}
...
$Class* Operators$$Lambda$lambda$resolveBinary$5$5::load$($String* name, bool initialize) {
	...
	$loadClass(Operators$$Lambda$lambda$resolveBinary$5$5, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Operators$$Lambda$lambda$resolveBinary$5$5);
	});
	return class$;
}
...
$Class* Operators$$Lambda$lambda$makeOperator$6$6::load$($String* name, bool initialize) {
	...
	$loadClass(Operators$$Lambda$lambda$makeOperator$6$6, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Operators$$Lambda$lambda$makeOperator$6$6);
	});
	return class$;
}
...
$Class* Operators$$Lambda$lambda$reportErrorIfNeeded$7$7::load$($String* name, bool initialize) {
	...
	$loadClass(Operators$$Lambda$lambda$reportErrorIfNeeded$7$7, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Operators$$Lambda$lambda$reportErrorIfNeeded$7$7);
	});
	return class$;
}
...
$Class* Operators$$Lambda$isIntegral$8::load$($String* name, bool initialize) {
	...
	$loadClass(Operators$$Lambda$isIntegral$8, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Operators$$Lambda$isIntegral$8);
	});
	return class$;
}
...
$Class* Operators$$Lambda$stream$9::load$($String* name, bool initialize) {
	...
	$loadClass(Operators$$Lambda$stream$9, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Operators$$Lambda$stream$9);
	});
	return class$;
}
...
$Class* Operators$$Lambda$lambda$lookupBinaryOp$8$10::load$($String* name, bool initialize) {
	...
	$loadClass(Operators$$Lambda$lambda$lookupBinaryOp$8$10, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Operators$$Lambda$lambda$lookupBinaryOp$8$10);
	});
	return class$;
}
...
$Class* Operators$$Lambda$lambda$lookupBinaryOp$9$11::load$($String* name, bool initialize) {
	...
	$loadClass(Operators$$Lambda$lambda$lookupBinaryOp$9$11, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(Operators$$Lambda$lambda$lookupBinaryOp$9$11);
	});
	return class$;
}
...
void Operators::init$($Context* context) {
	...
	$nc(context)->put(Operators::operatorsKey, this);
...
$Type* Operators::binaryPromotion($Type* t1, $Type* t2) {
	...
	$var($Type, unboxedT2, this->types->unboxedTypeOrType(t2));
	...
	if (var$0 && $nc(unboxedT2)->isNumeric()) {
		...
		if (var$1 || unboxedT2->hasTag($TypeTag::DOUBLE)) {
			...
			bool var$2 = unboxedT1->hasTag($TypeTag::FLOAT);
			if (var$2 || unboxedT2->hasTag($TypeTag::FLOAT)) {
				return $nc(this->syms)->floatType;
			} else {
				bool var$3 = unboxedT1->hasTag($TypeTag::LONG);
				if (var$3 || unboxedT2->hasTag($TypeTag::LONG)) {
	...
	} else if (this->types->isSameType(unboxedT1, unboxedT2)) {
		return unboxedT1;
	} else {
...
$Symbol$OperatorSymbol* Operators::resolveUnary($JCDiagnostic$DiagnosticPosition* pos, $JCTree$Tag* tag, $Type* op) {
	$useLocalObjectStack();
	$var($Map, var$0, this->unaryOperators);
	$var($Predicate, var$1, $new(Operators$$Lambda$lambda$resolveUnary$0, op));
	$var($Function, var$2, $new(Operators$$Lambda$lambda$resolveUnary$1$1, op));
	return resolve(tag, var$0, var$1, var$2, $$new(Operators$$Lambda$lambda$resolveUnary$2$2, this, pos, tag, op));
}

$Symbol$OperatorSymbol* Operators::resolveBinary($JCDiagnostic$DiagnosticPosition* pos, $JCTree$Tag* tag, $Type* op1, $Type* op2) {
	$useLocalObjectStack();
	$var($Map, var$0, this->binaryOperators);
	$var($Predicate, var$1, $new(Operators$$Lambda$lambda$resolveBinary$3$3, op1, op2));
	$var($Function, var$2, $new(Operators$$Lambda$lambda$resolveBinary$4$4, op1, op2));
	return resolve(tag, var$0, var$1, var$2, $$new(Operators$$Lambda$lambda$resolveBinary$5$5, this, pos, tag, op1, op2));
}
...
$Symbol$OperatorSymbol* Operators::resolve($JCTree$Tag* tag, $Map* opMap, $Predicate* opTestFunc, $Function* resolveFunc, $Supplier* noResultFunc) {
	$useLocalObjectStack();
	return $cast($Symbol$OperatorSymbol, $$nc($$nc($$nc($$nc($$sure($List, $nc(opMap)->get($(operatorName(tag))))->stream())->filter(opTestFunc))->map(resolveFunc))->findFirst())->orElseGet(noResultFunc));
}

$Symbol$OperatorSymbol* Operators::makeOperator($Name* name, $List* formals, $Operators$OperatorType* res, $ints* opcodes) {
	$useLocalObjectStack();
	$var($List, var$0, $cast($List, $$nc($$nc($nc(formals)->stream())->map($$new(Operators$$Lambda$lambda$makeOperator$6$6, this)))->collect($($List::collector()))));
	...
	return $new($Symbol$OperatorSymbol, name, opType, mergeOpcodes(opcodes), this->syms->noSymbol);
}
...
$Symbol$OperatorSymbol* Operators::reportErrorIfNeeded($JCDiagnostic$DiagnosticPosition* pos, $JCTree$Tag* tag, $TypeArray* args) {
	$useLocalObjectStack();
	if ($$nc($Stream::of(args))->noneMatch($$new(Operators$$Lambda$lambda$reportErrorIfNeeded$7$7))) {
		$var($Name, opName, operatorName(tag));
		$var($JCDiagnostic$Error, opError, ($nc(args)->length) == 1 ? $CompilerProperties$Errors::OperatorCantBeApplied(opName, args->get(0)) : $CompilerProperties$Errors::OperatorCantBeApplied1(opName, args->get(0), args->get(1)));
...
void Operators::initUnaryOperators() {
	...
	initOperators(this->unaryOperators, $$cast($Operators$OperatorHelperArray, $new($Operators$UnaryOperatorHelperArray, {
		...
		$($$nc($$new($Operators$UnaryNumericOperator, this, $JCTree$Tag::COMPL, $$new(Operators$$Lambda$isIntegral$8))->addUnaryOperator($Operators$OperatorType::LONG, $Operators$OperatorType::LONG, $$new($ints, {131})))->addUnaryOperator($Operators$OperatorType::INT, $Operators$OperatorType::INT, $$new($ints, {130}))),
...
void Operators::initBinaryOperators() {
	...
	$init($JCTree$Tag);
	$init($Operators$OperatorType);
	initOperators(this->binaryOperators, $$cast($Operators$OperatorHelperArray, $new($Operators$BinaryOperatorHelperArray, {
		...
		$($$nc($$new($Operators$BinaryNumericOperator, this, $JCTree$Tag::BITAND, $$new(Operators$$Lambda$isIntegral$8))->addBinaryOperator($Operators$OperatorType::LONG, $Operators$OperatorType::LONG, $Operators$OperatorType::LONG, $$new($ints, {127})))->addBinaryOperator($Operators$OperatorType::INT, $Operators$OperatorType::INT, $Operators$OperatorType::INT, $$new($ints, {126}))),
		...
		$($$nc($$new($Operators$BinaryNumericOperator, this, $JCTree$Tag::BITOR, $$new(Operators$$Lambda$isIntegral$8))->addBinaryOperator($Operators$OperatorType::LONG, $Operators$OperatorType::LONG, $Operators$OperatorType::LONG, $$new($ints, {129})))->addBinaryOperator($Operators$OperatorType::INT, $Operators$OperatorType::INT, $Operators$OperatorType::INT, $$new($ints, {128}))),
		...
		$($$nc($$new($Operators$BinaryNumericOperator, this, $JCTree$Tag::BITXOR, $$new(Operators$$Lambda$isIntegral$8))->addBinaryOperator($Operators$OperatorType::LONG, $Operators$OperatorType::LONG, $Operators$OperatorType::LONG, $$new($ints, {131})))->addBinaryOperator($Operators$OperatorType::INT, $Operators$OperatorType::INT, $Operators$OperatorType::INT, $$new($ints, {130}))),
...
$Symbol$OperatorSymbol* Operators::lookupBinaryOp($Predicate* applicabilityTest) {
	$useLocalObjectStack();
	return $cast($Symbol$OperatorSymbol, $$nc($$nc($$nc($$nc($$nc($$nc($$nc($nc(this->binaryOperators)->values())->stream())->flatMap($$new(Operators$$Lambda$stream$9)))->map($$new(Operators$$Lambda$lambda$lookupBinaryOp$8$10, applicabilityTest)))->distinct())->filter($$new(Operators$$Lambda$lambda$lookupBinaryOp$9$11, this)))->findFirst())->get());
}
...
bool Operators::lambda$reportErrorIfNeeded$7($Type* t) {
	...
	$init($TypeTag);
	return var$0 || t->hasTag($TypeTag::NONE);
}
...
$Class* Operators::load$($String* name, bool initialize) {
	if (name != nullptr) {
		if (name->equals("com.sun.tools.javac.comp.Operators$$Lambda$lambda$resolveUnary$0")) {
			return Operators$$Lambda$lambda$resolveUnary$0::load$(name, initialize);
		}
		if (name->equals("com.sun.tools.javac.comp.Operators$$Lambda$lambda$resolveUnary$1$1")) {
			return Operators$$Lambda$lambda$resolveUnary$1$1::load$(name, initialize);
		}
		if (name->equals("com.sun.tools.javac.comp.Operators$$Lambda$lambda$resolveUnary$2$2")) {
			return Operators$$Lambda$lambda$resolveUnary$2$2::load$(name, initialize);
		}
		if (name->equals("com.sun.tools.javac.comp.Operators$$Lambda$lambda$resolveBinary$3$3")) {
			return Operators$$Lambda$lambda$resolveBinary$3$3::load$(name, initialize);
		}
		if (name->equals("com.sun.tools.javac.comp.Operators$$Lambda$lambda$resolveBinary$4$4")) {
			return Operators$$Lambda$lambda$resolveBinary$4$4::load$(name, initialize);
		}
		if (name->equals("com.sun.tools.javac.comp.Operators$$Lambda$lambda$resolveBinary$5$5")) {
			return Operators$$Lambda$lambda$resolveBinary$5$5::load$(name, initialize);
		}
		if (name->equals("com.sun.tools.javac.comp.Operators$$Lambda$lambda$makeOperator$6$6")) {
			return Operators$$Lambda$lambda$makeOperator$6$6::load$(name, initialize);
		}
		if (name->equals("com.sun.tools.javac.comp.Operators$$Lambda$lambda$reportErrorIfNeeded$7$7")) {
			return Operators$$Lambda$lambda$reportErrorIfNeeded$7$7::load$(name, initialize);
		}
		if (name->equals("com.sun.tools.javac.comp.Operators$$Lambda$isIntegral$8")) {
			return Operators$$Lambda$isIntegral$8::load$(name, initialize);
		}
		if (name->equals("com.sun.tools.javac.comp.Operators$$Lambda$stream$9")) {
			return Operators$$Lambda$stream$9::load$(name, initialize);
		}
		if (name->equals("com.sun.tools.javac.comp.Operators$$Lambda$lambda$lookupBinaryOp$8$10")) {
			return Operators$$Lambda$lambda$lookupBinaryOp$8$10::load$(name, initialize);
		}
		if (name->equals("com.sun.tools.javac.comp.Operators$$Lambda$lambda$lookupBinaryOp$9$11")) {
	...
	$CompoundAttribute initOperatorsmethodAnnotations$$[] = {
