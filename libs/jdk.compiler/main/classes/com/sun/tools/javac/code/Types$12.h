#ifndef _com_sun_tools_javac_code_Types$12_h_
#define _com_sun_tools_javac_code_Types$12_h_
//$ class com.sun.tools.javac.code.Types$12
...
class Types$12 : public ::com::sun::tools::javac::code::Types$SimpleVisitor {
	$class(Types$12, $NO_CLASS_INIT, ::com::sun::tools::javac::code::Types$SimpleVisitor)
public:
	Types$12();
	void init$(::com::sun::tools::javac::code::Types* this$0);
	virtual ::com::sun::tools::javac::code::Type* visitArrayType(::com::sun::tools::javac::code::Type$ArrayType* t, ::com::sun::tools::javac::code::Symbol* sym);
	virtual $Object* visitArrayType(::com::sun::tools::javac::code::Type$ArrayType* t, Object$* sym) override;
...
#endif // _com_sun_tools_javac_code_Types$12_h_