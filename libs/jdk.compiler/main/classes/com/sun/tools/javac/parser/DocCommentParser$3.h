#ifndef _com_sun_tools_javac_parser_DocCommentParser$3_h_
#define _com_sun_tools_javac_parser_DocCommentParser$3_h_
//$ class com.sun.tools.javac.parser.DocCommentParser$3
...
class DocCommentParser$3 : public ::com::sun::tools::javac::parser::DocCommentParser$TagParser {
	$class(DocCommentParser$3, $NO_CLASS_INIT, ::com::sun::tools::javac::parser::DocCommentParser$TagParser)
public:
	DocCommentParser$3();
...
#endif // _com_sun_tools_javac_parser_DocCommentParser$3_h_