...
void Attribute$RetentionPolicy::clinit$($Class* clazz) {
...
$Class* Attribute$RetentionPolicy::load$($String* name, bool initialize) {
	...
	$loadClass(Attribute$RetentionPolicy, name, initialize, &classInfo$$, Attribute$RetentionPolicy::clinit$, []($Class* clazz) -> $Object* {
