#ifndef _com_sun_tools_javac_parser_DocCommentParser$8_h_
#define _com_sun_tools_javac_parser_DocCommentParser$8_h_
//$ class com.sun.tools.javac.parser.DocCommentParser$8
...
class DocCommentParser$8 : public ::com::sun::tools::javac::parser::DocCommentParser$TagParser {
	$class(DocCommentParser$8, $NO_CLASS_INIT, ::com::sun::tools::javac::parser::DocCommentParser$TagParser)
public:
	DocCommentParser$8();
...
#endif // _com_sun_tools_javac_parser_DocCommentParser$8_h_