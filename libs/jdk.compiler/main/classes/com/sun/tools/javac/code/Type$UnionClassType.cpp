...
void Type$UnionClassType::init$($Type$ClassType* ct, $1List* alternatives) {
	$Type$ClassType::init$($nc(ct)->outer_field, $nc(ct)->typarams_field, $nc(ct)->tsym);
	$set(this, allparams_field, ct->allparams_field);
...
$List* Type$UnionClassType::getAlternatives() {
...
$Object* Type$UnionClassType::accept($TypeVisitor* v, Object$* p) {
	return $nc(v)->visitUnion(this, p);
}

$Iterable* Type$UnionClassType::getAlternativeTypes() {
	return $cast($AbstractCollection, this->alternatives_field);
}
...
$Class* Type$UnionClassType::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"<init>", "(Lcom/sun/tools/javac/code/Type$ClassType;Lcom/sun/tools/javac/util/List;)V", "(Lcom/sun/tools/javac/code/Type$ClassType;Lcom/sun/tools/javac/util/List<+Lcom/sun/tools/javac/code/Type;>;)V", $PUBLIC, $method(Type$UnionClassType, init$, void, $Type$ClassType*, $1List*)},
		...
		{"getAlternatives", "()Ljava/util/List;", "()Ljava/util/List<+Ljavax/lang/model/type/TypeMirror;>;", $PUBLIC, $virtualMethod(Type$UnionClassType, getAlternatives, $List*)},
	...
	$loadClass(Type$UnionClassType, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
