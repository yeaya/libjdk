...
class $export Resolve$MostSpecificCheck$MostSpecificCheckContext$MostSpecificFunctionReturnChecker : public ::com::sun::tools::javac::comp::DeferredAttr$PolyScanner {
