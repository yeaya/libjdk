...
$Class* Symbol$MethodSymbol$1::load$($String* name, bool initialize) {
	...
	$MethodInfo methodInfos$$[] = {
		...
		{"getAnnotationMirrors", "()Ljava/util/List;", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC, $virtualMethod(Symbol$MethodSymbol$1, getAnnotationMirrors, $1List*)},
		...
		{"getParameters", "()Ljava/util/List;", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC, $virtualMethod(Symbol$MethodSymbol$1, getParameters, $List*)},
		...
		{"getThrownTypes", "()Ljava/util/List;", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC, $virtualMethod(Symbol$MethodSymbol$1, getThrownTypes, $List*)},
		{"getTypeParameters", "()Ljava/util/List;", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC, $virtualMethod(Symbol$MethodSymbol$1, getTypeParameters, $List*)},
	...
	$loadClass(Symbol$MethodSymbol$1, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
