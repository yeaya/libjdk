#ifndef _com_sun_tools_javac_code_Types$2_h_
#define _com_sun_tools_javac_code_Types$2_h_
//$ class com.sun.tools.javac.code.Types$2
...
class Types$2 : public ::com::sun::tools::javac::code::Types$SimpleVisitor {
	$class(Types$2, $NO_CLASS_INIT, ::com::sun::tools::javac::code::Types$SimpleVisitor)
public:
	Types$2();
...
#endif // _com_sun_tools_javac_code_Types$2_h_