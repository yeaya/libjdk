#ifndef _com_sun_tools_javac_comp_Resolve$7_h_
#define _com_sun_tools_javac_comp_Resolve$7_h_
//$ class com.sun.tools.javac.comp.Resolve$7
...
class Resolve$7 : public ::com::sun::tools::javac::comp::Resolve$LogResolveHelper {
	$class(Resolve$7, $NO_CLASS_INIT, ::com::sun::tools::javac::comp::Resolve$LogResolveHelper)
public:
	Resolve$7();
...
#endif // _com_sun_tools_javac_comp_Resolve$7_h_