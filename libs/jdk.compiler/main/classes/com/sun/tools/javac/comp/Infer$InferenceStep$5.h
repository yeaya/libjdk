#ifndef _com_sun_tools_javac_comp_Infer$InferenceStep$5_h_
#define _com_sun_tools_javac_comp_Infer$InferenceStep$5_h_
//$ class com.sun.tools.javac.comp.Infer$InferenceStep$5
...
class Infer$InferenceStep$5 : public ::com::sun::tools::javac::comp::Infer$InferenceStep {
	$class(Infer$InferenceStep$5, $NO_CLASS_INIT, ::com::sun::tools::javac::comp::Infer$InferenceStep)
public:
	Infer$InferenceStep$5();
...
#endif // _com_sun_tools_javac_comp_Infer$InferenceStep$5_h_