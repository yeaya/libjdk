#ifndef _com_sun_tools_javac_code_Symtab$4_h_
#define _com_sun_tools_javac_code_Symtab$4_h_
//$ class com.sun.tools.javac.code.Symtab$4
...
class Symtab$4 : public ::com::sun::tools::javac::code::Symbol$ModuleSymbol {
	$class(Symtab$4, $NO_CLASS_INIT, ::com::sun::tools::javac::code::Symbol$ModuleSymbol)
public:
	Symtab$4();
...
#endif // _com_sun_tools_javac_code_Symtab$4_h_