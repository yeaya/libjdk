...
$MethodInfo _Symbol$RecordComponent_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/tools/javac/util/Name;Lcom/sun/tools/javac/code/Type;Lcom/sun/tools/javac/code/Symbol;)V", nullptr, $PUBLIC, $method(Symbol$RecordComponent, init$, void, $Name*, $Type*, $Symbol*)},
	{"<init>", "(Lcom/sun/tools/javac/code/Symbol$VarSymbol;Lcom/sun/tools/javac/util/List;)V", "(Lcom/sun/tools/javac/code/Symbol$VarSymbol;Lcom/sun/tools/javac/util/List<Lcom/sun/tools/javac/tree/JCTree$JCAnnotation;>;)V", $PUBLIC, $method(Symbol$RecordComponent, init$, void, $Symbol$VarSymbol*, $List*)},
	...
	{"getOriginalAnnos", "()Lcom/sun/tools/javac/util/List;", "()Lcom/sun/tools/javac/util/List<Lcom/sun/tools/javac/tree/JCTree$JCAnnotation;>;", $PUBLIC, $virtualMethod(Symbol$RecordComponent, getOriginalAnnos, $List*)},
