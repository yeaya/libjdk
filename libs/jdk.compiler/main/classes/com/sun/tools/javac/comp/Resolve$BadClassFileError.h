#ifndef _com_sun_tools_javac_comp_Resolve$BadClassFileError_h_
#define _com_sun_tools_javac_comp_Resolve$BadClassFileError_h_
//$ class com.sun.tools.javac.comp.Resolve$BadClassFileError
...
class $export Resolve$BadClassFileError : public ::com::sun::tools::javac::comp::Resolve$InvalidSymbolError {
	$class(Resolve$BadClassFileError, $NO_CLASS_INIT, ::com::sun::tools::javac::comp::Resolve$InvalidSymbolError)
public:
	Resolve$BadClassFileError();
	...
	void init$(::com::sun::tools::javac::comp::Resolve* this$0, ::com::sun::tools::javac::code::Symbol$CompletionFailure* ex);
	...
	::com::sun::tools::javac::code::Symbol$CompletionFailure* ex = nullptr;
};
...
#endif // _com_sun_tools_javac_comp_Resolve$BadClassFileError_h_