#ifndef _com_sun_tools_javac_code_Type$ArrayType$1_h_
#define _com_sun_tools_javac_code_Type$ArrayType$1_h_
//$ class com.sun.tools.javac.code.Type$ArrayType$1
...
class Type$ArrayType$1 : public ::com::sun::tools::javac::code::Type$ArrayType {
	$class(Type$ArrayType$1, $NO_CLASS_INIT, ::com::sun::tools::javac::code::Type$ArrayType)
public:
	Type$ArrayType$1();
...
#endif // _com_sun_tools_javac_code_Type$ArrayType$1_h_