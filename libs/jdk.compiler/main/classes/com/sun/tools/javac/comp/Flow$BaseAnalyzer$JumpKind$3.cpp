...
$Class* Flow$BaseAnalyzer$JumpKind$3::load$($String* name, bool initialize) {
	$MethodInfo methodInfos$$[] = {
		{"<init>", "(Ljava/lang/String;ILcom/sun/tools/javac/tree/JCTree$Tag;)V", nullptr, $PRIVATE, $method(Flow$BaseAnalyzer$JumpKind$3, init$, void, $String*, int32_t, $JCTree$Tag*)},
		{"getTarget", "(Lcom/sun/tools/javac/tree/JCTree;)Lcom/sun/tools/javac/tree/JCTree;", nullptr, 0, $virtualMethod(Flow$BaseAnalyzer$JumpKind$3, getTarget, $JCTree*, $JCTree*)},
		{}
	};
	...
	$loadClass(Flow$BaseAnalyzer$JumpKind$3, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
