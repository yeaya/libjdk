...
$Class* RichDiagnosticFormatter$2::load$($String* name, bool initialize) {
	...
	$loadClass(RichDiagnosticFormatter$2, name, initialize, &classInfo$$, []($Class* clazz) -> $Object* {
		return $alloc(RichDiagnosticFormatter$2);
	});
	return class$;
}
