#ifndef _com_sun_tools_javac_comp_Attr$8_h_
#define _com_sun_tools_javac_comp_Attr$8_h_
//$ class com.sun.tools.javac.comp.Attr$8
...
class Attr$8 : public ::com::sun::tools::javac::comp::Attr$PostAttrAnalyzer {
	$class(Attr$8, $NO_CLASS_INIT, ::com::sun::tools::javac::comp::Attr$PostAttrAnalyzer)
public:
	Attr$8();
...
#endif // _com_sun_tools_javac_comp_Attr$8_h_