...
class $export LambdaToMethod$LambdaAnalyzerPreprocessor$LambdaTranslationContext : public ::com::sun::tools::javac::comp::LambdaToMethod$LambdaAnalyzerPreprocessor$TranslationContext {
