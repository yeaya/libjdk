#ifndef _com_sun_tools_javac_file_JavacFileManager$DirectoryContainer_h_
#define _com_sun_tools_javac_file_JavacFileManager$DirectoryContainer_h_
//$ class com.sun.tools.javac.file.JavacFileManager$DirectoryContainer
...
class JavacFileManager$DirectoryContainer : public ::com::sun::tools::javac::file::JavacFileManager$Container {
	$class(JavacFileManager$DirectoryContainer, $NO_CLASS_INIT, ::com::sun::tools::javac::file::JavacFileManager$Container)
public:
	JavacFileManager$DirectoryContainer();
	void init$(::com::sun::tools::javac::file::JavacFileManager* this$0, ::java::nio::file::Path* directory);
...
#endif // _com_sun_tools_javac_file_JavacFileManager$DirectoryContainer_h_