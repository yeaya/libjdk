...
- **Java Compiler**: Complete javac implementation for Java source compilation
- **Annotation Processing**: Annotation processor framework
- **Compiler API**: Programmatic compiler access
- **Diagnostic Support**: Compilation error and warning reporting
- **Source Code Analysis**: AST parsing and analysis
- **Bytecode Generation**: Java bytecode generation
...
- **java.compiler**: Java compiler API (required)
- **jdk.zipfs**: ZIP file system support (required)
